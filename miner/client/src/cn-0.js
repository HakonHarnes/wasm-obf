...
var ASM_CONSTS = {
 ...
 140936: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 141019: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 141088: () => { return window.innerWidth; },  
 141118: () => { return window.innerHeight; }
};
