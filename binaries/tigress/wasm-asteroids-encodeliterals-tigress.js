...
var wasmBinaryFile;
  wasmBinaryFile = 'wasm-asteroids-encodeliterals-tigress.wasm';
...
var ASM_CONSTS = {
 ...
 140312: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 140395: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 140464: () => { return window.innerWidth; },  
 140494: () => { return window.innerHeight; }
};
