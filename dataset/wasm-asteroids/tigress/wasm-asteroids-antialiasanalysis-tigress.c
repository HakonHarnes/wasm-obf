...
/* Generated by Tigress v3.2 (https://tigress.wtf), 16:15:15-2023/03/15 */
...
void *_3__functionPtrArray[]  = 
  {      & init,      & init_player,      & init_player - 892,      & divide_vector, 
        & add_vector,      & update_player,      & init_player,      & init_asteroids, 
        & emscripten_set_main_loop,      & emscripten_set_main_loop + 678};
...
{ 
  ...
  tmp = ((int (*)(int width , int height ))_3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )((_2_entropy + 9) - (((_2_entropy + 9) + (_2_entropy + 9)) & ((long )(_2_entropy + 9) >> 31L))) % 10) * 3 + 0] % _1_main__opaque_array[5] + -3)])(640,
                                                                                                                                                                                                                                                               480);
  if (tmp == 1) {
    return (0);
  }
  ...
  i = 0;
  while (i < 3) {
    ((void (*)(struct player *p___0 ))_3__functionPtrArray[(_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(& lives[i]);
    _3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )(((_2_entropy | 10) + ((long )(_2_entropy | 10) >> 31L)) ^ ((long )(_2_entropy | 10) >> 31L)) % 10) * 3 + 0] % _1_main__opaque_array[5] + -1)] = & r12;
    lives[i].lives = 1;
    j = 0;
    while (j < 3) {
      ((void (*)(struct vector2d *v , float n ))_3__functionPtrArray[(((_2_alwaysZero & ((_2_entropy & ~ 6) + 6)) * (_2_alwaysZero | ((_2_entropy & ~ 6) + 6)) + (_2_alwaysZero & ~ ((_2_entropy & ~ 6) + 6)) * (~ _2_alwaysZero & ((_2_entropy & ~ 6) + 6))) - ~ 3) - 1UL])(& lives[i].obj_vert[j],
                                                                                                                                                                                                                                                                             (float )2);
      j ++;
    }
    top_left.x = (float )(20 + offset);
    top_left.y = (float )20;
    ((void (*)(struct vector2d *a , struct vector2d *b ))_3__functionPtrArray[4 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(& top_left,
                                                                                                                                         & translation);
    _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + 1] = (void *)1273713;
    lives[i].location = top_left;
    ((void (*)(struct player *p___0 ))_3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )(((_2_entropy + 7) ^ ((long )(_2_entropy + 7) >> 31L)) - ((long )(_2_entropy + 7) >> 31L)) % 10) * 3 + 1] % _1_main__opaque_array[11] + 0)])(& lives[i]);
    offset += 20;
    i ++;
  }
  ((void (*)(struct player *p___0 ))_3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )((_2_entropy - 5) - (((_2_entropy - 5) << 1UL) & ((long )(_2_entropy - 5) >> 31L))) % 10) * 3 + 0] % _1_main__opaque_array[5] + 3)])(& p);
  _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) + 1] = _3__functionPtrArray[4];
  ((void (*)(struct asteroid *asteroids___0 , int size ))_3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )(((_2_entropy ^ 10) + ((long )(_2_entropy ^ 10) >> 31L)) ^ ((long )(_2_entropy ^ 10) >> 31L)) % 10) * 3 + 0] % _1_main__opaque_array[5] + 4)])(asteroids,
                                                                                                                                                                                                                                                                          27);
  ((void (*)(void (*func)(void) , int fps , int simulate_infinite_loop ))_3__functionPtrArray[(int )(_1_main__opaque_array[((unsigned int )(((_2_entropy + 7) ^ ((long )(_2_entropy + 7) >> 31L)) - ((long )(_2_entropy + 7) >> 31L)) % 10) * 3 + 0] % _1_main__opaque_array[5] + 5)])(& mainloop,
                                                                                                                                                                                                                                                                                       0,
                                                                                                                                                                                                                                                                                       1);
  _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + 1] = & _1_main__BEGIN_1;
  return (0);
}
}
