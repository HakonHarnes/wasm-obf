...
#line 77
    draw_line(pixel_buffer, (int )p___0->world_vert[0].x, (int )p___0->world_vert[0].y,
              (int )p___0->world_vert[1].x, (int )p___0->world_vert[1].y, 0xffffffff);
#line 78
    draw_line(pixel_buffer, (int )p___0->world_vert[1].x, (int )p___0->world_vert[1].y,
              (int )p___0->world_vert[2].x, (int )p___0->world_vert[2].y, 0xffffffff);
#line 79
    draw_line(pixel_buffer, (int )p___0->world_vert[2].x, (int )p___0->world_vert[2].y,
              (int )p___0->world_vert[0].x, (int )p___0->world_vert[0].y, 0xffffffff);
  }
#line 91
  i = 0;
#line 91
