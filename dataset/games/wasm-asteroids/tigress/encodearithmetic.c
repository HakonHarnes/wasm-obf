...
/* Generated by Tigress v3.2 (https://tigress.wtf), 06:06:38-2023/04/23 */
...
{ 
  ...
  i = 0;
  while (((unsigned int )(((((3 - i) & - (3 >= i)) << 1) & (((3 - i) & - (3 >= i)) >> 31)) - ((3 - i) & - (3 >= i))) >> 31U) & 1) {
  ...
  i = 0;
  while (((unsigned int )((i & ~ 3) | (~ (i ^ 3) & (i - 3))) >> 31U) & 1) {
...
{ 
  ...
  if ((float )320 < p___0->location.x) {
    p___0->location.x = (float )-320;
  }
  if (p___0->location.y < (float )-240) {
    p___0->location.y = (float )240;
  }
  if ((float )240 < p___0->location.y) {
    p___0->location.y = (float )-240;
  }
  i = 0;
  while (((unsigned int )((i & ~ 3) | (~ (i ^ 3) & (i - 3))) >> 31U) & 1) {
    ...
    if ((float )640 <= p___0->bullets[i].location.x) {
      p___0->bullets[i].alive = (enum boolean )1;
    }
    if (p___0->bullets[i].location.y < (float )0) {
      p___0->bullets[i].alive = (enum boolean )1;
    } else
    if ((float )480 <= p___0->bullets[i].location.y) {
      p___0->bullets[i].alive = (enum boolean )1;
    }
    i = (i - ~ 1) - 1;
  }
...
{ 
  ...
  if (((unsigned int )((x2 & ~ x1) | (~ (x2 ^ x1) & (x2 - x1))) >> 31U) & 1) {
    temp_x = x1;
    temp_y = y1___0;
    x1 = x2;
    y1___0 = y2;
  ...
  dx = (x2 ^ x1) - ((~ x2 & x1) << 1);
  dy = ((y2 & ~ y1___0) << 1) - (y2 ^ y1___0);
  tmp___1 = fabs((double )dy);
  if (tmp___1 <= (double )dx) {
    slope = (float )dy / (float )dx;
    if (((unsigned int )((y1___0 | ~ y2) & ((y1___0 ^ y2) | ~ (y2 - y1___0))) >> 31U) & 1) {
      ...
      i = 0;
      i = 1;
      while (((unsigned int )((~ (i ^ dx) >> 1) + (i & ~ dx)) >> 31U) & 1) {
        x = ((x1 | i) << 1) - (x1 ^ i);
    ...
    if (((unsigned int )((y2 & ~ y1___0) | (~ (y2 ^ y1___0) & (y2 - y1___0))) >> 31U) & 1) {
      ...
      i___0 = 0;
      i___0 = 1;
      while (((unsigned int )((~ (i___0 ^ dx) >> 1) + (i___0 & ~ dx)) >> 31U) & 1) {
        x___0 = ((x1 ^ ~ i___0) + ((x1 | i___0) + (x1 | i___0))) + 1;
        draw_pixel(pixel_buffer, x___0, y___0, colour);
        error___0 += slope;
        if ((double )error___0 <= - 0.5) {
          y___0 = (y___0 ^ 1) - ((~ y___0 & 1) + (~ y___0 & 1));
          error___0 += (float )1;
        }
        i___0 = ((i___0 | 1) << 1) - (i___0 ^ 1);
      }
    }
  }
  tmp___5 = fabs((double )dy);
  if ((double )dx < tmp___5) {
    slope___0 = (float )dx / (float )dy;
    if (((unsigned int )((y1___0 & ~ y2) | (~ (y1___0 ^ y2) & (y1___0 - y2))) >> 31U) & 1) {
      ...
      i___1 = 0;
      i___1 = 1;
      while (((unsigned int )((~ (i___1 ^ dy) >> 1) + (i___1 & ~ dy)) >> 31U) & 1) {
        y___1 = (y1___0 - ~ i___1) - 1;
        draw_pixel(pixel_buffer, x___1, y___1, colour);
        error___1 += slope___0;
        if (0.5 <= (double )error___1) {
          x___1 = (x___1 ^ 1) + ((x___1 & 1) << 1);
          error___1 -= (float )1;
        }
        i___1 = ((i___1 | 1) + (i___1 | 1)) - (i___1 ^ 1);
      }
    }
    if (((unsigned int )((y2 & ~ y1___0) | (~ (y2 ^ y1___0) & (y2 - y1___0))) >> 31U) & 1) {
      ...
      while (1) {
        ...
        y___2 = (y1___0 + ~ i___2) + 1;
        draw_pixel(pixel_buffer, x___2, y___2, colour);
        error___2 += slope___0;
        if ((double )error___2 <= - 0.5) {
          x___2 = ((x___2 ^ ~ 1) + ((x___2 | 1) << 1)) + 1;
          error___2 += (float )1;
        }
        i___2 = ((i___2 | 1) << 1) - (i___2 ^ 1);
      }
    }
  }
  return (0);
...
{ 
  ...
  translation.y = (float )240;
  i = 0;
  while (((unsigned int )(((((size - i) & - (size >= i)) >> 31) - ((size - i) & - (size >= i))) ^ (((size - i) & - (size >= i)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  while (((unsigned int )(((((size - i) & - (size >= i)) >> 31) - ((size - i) & - (size >= i))) ^ (((size - i) & - (size >= i)) >> 31)) >> 31U) & 1) {
    ...
    tmp___5 = rand();
    degrees = (float )((tmp___5 % 100 - ~ 1000) - 1) / (float )1000;
    if (((unsigned int )((50 | ~ sign_x) & ((50 ^ sign_x) | ~ (sign_x - 50))) >> 31U) & 1) {
      vx = - vx;
      lx = ~ (lx - 1);
      degrees = - degrees;
    }
    if (((unsigned int )((50 | ~ sign_y) & ((50 ^ sign_y) | ~ (sign_y - 50))) >> 31U) & 1) {
      vy = - vy;
      ly = ~ (ly - 1);
    }
    if (((unsigned int )((i & ~ 3) | (~ (i ^ 3) & (i - 3))) >> 31U) & 1) {
    ...
    j = 0;
    while (((unsigned int )(((((10 - j) & - (10 >= j)) + ((10 - j) & - (10 >= j))) & (((10 - j) & - (10 >= j)) >> 31)) - ((10 - j) & - (10 >= j))) >> 31U) & 1) {
...
{ 
  ...
  while (1) {
    ...
    case 32: 
    if (((unsigned int )(- p.lives & ~ p.lives) >> 31U) & 1) {
      shoot_bullet(& p);
    }
    break;
    }
  ...
  res = tmp___3;
  if (((unsigned int )((res - -1) | (-1 - res)) >> 31U) & 1) {
    p.lives = (p.lives + ~ 1) + 1;
    ...
    i = 2;
    i = 3;
    while (((unsigned int )(~ i) >> 31U) & 1) {
      if (((unsigned int )(- lives[i].lives & ~ lives[i].lives) >> 31U) & 1) {
        lives[i].lives = 0;
        break;
      }
      i = (i & ~ 1) - (~ i & 1);
  ...
  translation.y = (float )-240;
  i___0 = 0;
  while (((unsigned int )((i___0 - 3) ^ ((i___0 ^ 3) & ((i___0 - 3) ^ i___0))) >> 31U) & 1) {
    if ((unsigned int )p.bullets[i___0].alive == 0U) {
      ...
      index___0 = tmp___5;
      if (((unsigned int )((((index___0 - -1) << 1) & ((index___0 - -1) >> 31)) - (index___0 - -1)) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )((640 | ~ x) & ((640 ^ x) | ~ (x - 640))) >> 31U) & 1) {
    return (1);
  } else
  if (((unsigned int )((480 | ~ y) & ((480 ^ y) | ~ (y - 480))) >> 31U) & 1) {
    return (1);
  }
  position = (uint32_t )(((((y & 640) * (y | 640) + (y & ~ 640) * (~ y & 640)) | x) << 1) - (((y & 640) * (y | 640) + (y & ~ 640) * (~ y & 640)) ^ x));
...
{ 
  ...
  count = 0;
  i = 0;
  while (((unsigned int )(((((length - i) & - (length >= i)) >> 31) - ((length - i) & - (length >= i))) ^ (((length - i) & - (length >= i)) >> 31)) >> 31U) & 1) {
    if (((unsigned int )((((a + i)->alive ^ ((a + i)->alive >> 31)) - ((a + i)->alive >> 31)) - 1) >> 31U) & 1) {
      if (((unsigned int )(~ ((count - 3) | (3 - count))) >> 31U) & 1) {
        break;
      }
      (a + i)->location = v;
...
{ 
  ...
  i = 0;
  i = 0;
  while (((unsigned int )((((3 - i) & - (3 >= i)) >> 31) - (((3 - i) & - (3 >= i)) ^ (((3 - i) & - (3 >= i)) >> 31))) >> 31U) & 1) {
    if ((int )(((((((unsigned int )p___0->bullets[i].alive - 1U) + (1U << 31)) + ((int )(((unsigned int )p___0->bullets[i].alive - 1U) + (1U << 31)) >> 31)) ^ ((int )(((unsigned int )p___0->bullets[i].alive - 1U) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
...
{ 
  ...
  i = 0;
  i = 0;
  while (((unsigned int )((i - size) ^ ((i ^ size) & ((i - size) ^ i))) >> 31U) & 1) {
    if (((unsigned int )(~ (((asteroids___0 + i)->alive - 1) | (1 - (asteroids___0 + i)->alive))) >> 31U) & 1) {
...
{ 
  ...
  translation.y = (float )-240;
  i = 0;
  while (((unsigned int )(((((3 - i) & - (3 >= i)) + ((3 - i) & - (3 >= i))) & (((3 - i) & - (3 >= i)) >> 31)) - ((3 - i) & - (3 >= i))) >> 31U) & 1) {
    init_player(& lives[i]);
    lives[i].lives = 1;
    j = 0;
    while (((unsigned int )((j & ~ 3) | (~ (j ^ 3) & (j - 3))) >> 31U) & 1) {
      divide_vector(& lives[i].obj_vert[j], (float )2);
      j = (j ^ 1) + ((j & 1) << 1);
    }
    top_left.x = (float )((20 | offset) + (20 & offset));
    top_left.y = (float )20;
    add_vector(& top_left, & translation);
    lives[i].location = top_left;
    update_player(& lives[i]);
    offset = ((offset ^ ~ 20) + ((offset | 20) << 1)) + 1;
    i = (i | 1) + (i & 1);
  }
  init_player(& p);
...
{ 
  ...
  buffer_size = 307200;
  i = 0;
  while (((unsigned int )((i & ~ buffer_size) | (~ (i ^ buffer_size) & (i - buffer_size))) >> 31U) & 1) {
...
{ 
  ...
  tmp___2 = malloc((307200UL & sizeof(Uint32 )) * (307200UL | sizeof(Uint32 )) + (307200UL & ~ sizeof(Uint32 )) * (~ 307200UL & sizeof(Uint32 )));
...
{ 
  ...
  i = 0;
  i = 0;
  while (((unsigned int )(((((10 - i) & - (10 >= i)) << 1) & (((10 - i) & - (10 >= i)) >> 31)) - ((10 - i) & - (10 >= i))) >> 31U) & 1) {
    multiply_vector(& a->obj_vert[i], (float )88);
    i = (i ^ 1) + ((i & 1) << 1);
  }
  if (((unsigned int )((((size - 2) + (1 << 31)) ^ (((size - 2) + (1 << 31)) >> 31)) - (((size - 2) + (1 << 31)) >> 31)) >> 31U) & 1) {
    i = 0;
    while (((unsigned int )(((((10 - i) & - (10 >= i)) + ((10 - i) & - (10 >= i))) & (((10 - i) & - (10 >= i)) >> 31)) - ((10 - i) & - (10 >= i))) >> 31U) & 1) {
  ...
  if (((unsigned int )((((size - 1) + (1 << 31)) ^ (((size - 1) + (1 << 31)) >> 31)) - (((size - 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
    i = 0;
    while (((unsigned int )((i - 10) ^ ((i ^ 10) & ((i - 10) ^ i))) >> 31U) & 1) {
  ...
  if (((unsigned int )(((size + (size >> 31)) ^ (size >> 31)) - 1) >> 31U) & 1) {
    i = 0;
...
{ 
  ...
  i = 0;
  i = 0;
  while (((unsigned int )((i - 3) ^ ((i ^ 3) & ((i - 3) ^ i))) >> 31U) & 1) {
...
{ 
  ...
  {
  i = 0;
  if (((unsigned int )(- p___0->lives & ~ p___0->lives) >> 31U) & 1) {
