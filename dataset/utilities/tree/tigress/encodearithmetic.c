...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:27:34-2023/04/23 */
...
{ 
  ...
  if (metafirst) {
    if (((unsigned int )(~ (((int )info___1[0] - 91) | (91 - (int )info___1[0]))) >> 31U) & 1) {
      html_print(info___1);
    ...
    if (((unsigned int )(((((int )info___1[0] - 91) + (1 << 31)) + ((((int )info___1[0] - 91) + (1 << 31)) >> 31)) ^ ((((int )info___1[0] - 91) + (1 << 31)) >> 31)) >> 31U) & 1) {
      html_print(info___1);
      fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"%s%s"),
              sp, sp);
    }
...
{ 
  ...
  {
  if ((int )(((((unsigned int )(*a)->isdir - (unsigned int )(*b)->isdir) | ((unsigned int )(*b)->isdir - (unsigned int )(*a)->isdir)) >> 31U) & 1U)) {
    if ((*a)->isdir) {
      tmp = -1;
    } else {
      tmp = 1;
...
{ 
  ...
  if (dflag) {
    if ((int )((((((tot.dirs - 1UL) + (1UL << 31)) + ((long )((tot.dirs - 1UL) + (1UL << 31)) >> 31L)) ^ ((long )((tot.dirs - 1UL) + (1UL << 31)) >> 31L)) >> 31UL) & 1UL)) {
      tmp___0 = (char *)"y";
    } else {
      tmp___0 = (char *)"ies";
    }
    ...
    if ((int )((((((tot.files - 1UL) ^ ((long )(tot.files - 1UL) >> 31L)) - ((long )(tot.files - 1UL) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
      tmp___1 = (char *)"";
    } else {
      tmp___1 = (char *)"s";
    }
    if ((int )(((((tot.dirs - 1UL) + (1UL << 31)) - ((((tot.dirs - 1UL) + (1UL << 31)) + ((tot.dirs - 1UL) + (1UL << 31))) & ((long )((tot.dirs - 1UL) + (1UL << 31)) >> 31L))) >> 31UL) & 1UL)) {
      tmp___2 = (char *)"y";
    } else {
      tmp___2 = (char *)"ies";
    }
...
{ 
  ...
  {
  if ((int )(((((int )((unsigned int )(*a)->isdir - (unsigned int )(*b)->isdir) >> 31) - (((unsigned int )(*a)->isdir - (unsigned int )(*b)->isdir) ^ ((int )((unsigned int )(*a)->isdir - (unsigned int )(*b)->isdir) >> 31))) >> 31U) & 1U)) {
    if ((*a)->isdir) {
      tmp = 1;
    } else {
      tmp = -1;
...
{ 
  ...
  i = 0;
  while (*(s + i)) {
    if (((unsigned int )(((((int )*(s + i) - 32) + (1 << 31)) ^ ((((int )*(s + i) - 32) + (1 << 31)) >> 31)) - ((((int )*(s + i) - 32) + (1 << 31)) >> 31)) >> 31U) & 1) {
  ...
  while ((unsigned long )inf != (unsigned long )((void *)0)) {
    ...
    while ((unsigned long )com != (unsigned long )((void *)0)) {
      ...
      while ((unsigned long )p != (unsigned long )((void *)0)) {
        ...
        if (((unsigned int )((((tmp - 1) + ((tmp - 1) >> 31)) ^ ((tmp - 1) >> 31)) - 1) >> 31U) & 1) {
          return (com);
        }
        if (top) {
          tmp___0 = patmatch(name, p->pattern, isdir);
          if (((unsigned int )((((tmp___0 - 1) + (1 << 31)) ^ (((tmp___0 - 1) + (1 << 31)) >> 31)) - (((tmp___0 - 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
            return (com);
          }
        }
        p = p->next;
...
{ 
  ...
  {
  i = 0;
  while (((unsigned int )((((pattern - i) & - (pattern >= i)) >> 31) - (((pattern - i) & - (pattern >= i)) ^ (((pattern - i) & - (pattern >= i)) >> 31))) >> 31U) & 1) {
...
{ 
  ...
  v = tmp;
  if (((unsigned int )(((v + (1 << 31)) + ((v + (1 << 31)) >> 31)) ^ ((v + (1 << 31)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  info.isdir = (bool )((int )((~ ((((~ st->st_mode | 61440U) - ~ st->st_mode) - 16384U) | (16384U - ((~ st->st_mode | 61440U) - ~ st->st_mode))) >> 31U) & 1U));
  info.issok = (bool )((int )((~ ((((~ st->st_mode | 61440U) - ~ st->st_mode) - 49152U) | (49152U - ((~ st->st_mode | 61440U) - ~ st->st_mode))) >> 31U) & 1U));
  info.isfifo = (bool )((int )(((((((~ st->st_mode | 61440U) - ~ st->st_mode) - 4096U) + (1U << 31)) - ((((((~ st->st_mode | 61440U) - ~ st->st_mode) - 4096U) + (1U << 31)) << 1U) & ((int )((((~ st->st_mode | 61440U) - ~ st->st_mode) - 4096U) + (1U << 31)) >> 31))) >> 31U) & 1U));
  if (((~ st->st_mode | 73U) + st->st_mode) + 1U) {
    info.isexe = (bool )1;
  } else {
    info.isexe = (bool )0;
  }
...
{ 
  ...
  if (timefmt) {
    ...
    tmp = time((time_t *)0);
    c = tmp;
    if ((int )(((unsigned long long )((c & ~ t) | (~ (c ^ t) & (c - t))) >> 63ULL) & 1LL)) {
      strftime((char */* __restrict  */)(buf___0), (size_t___0 )255, (char const   */* __restrict  */)"%b %e  %Y",
               (struct tm  const  */* __restrict  */)tm);
    } else
    if ((int )(((unsigned long long )((((c - (((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) & - (c >= ((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) >> 63LL) - (((c - (((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) & - (c >= ((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) ^ (((c - (((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) & - (c >= ((t | 16070400LL) + (t | 16070400LL)) - (t ^ 16070400LL))) >> 63LL))) >> 63ULL) & 1LL)) {
      strftime((char */* __restrict  */)(buf___0), (size_t___0 )255, (char const   */* __restrict  */)"%b %e  %Y",
               (struct tm  const  */* __restrict  */)tm);
    } else {
...
{ 
  ...
  {
  if (! noindent) {
    if (((unsigned int )(~ level) >> 31U) & 1) {
      xml_indent((level + ~ 1) + 1);
    }
  }
  if (noindent) {
    tmp = (char *)"";
...
{ 
  ...
  {
  uent = (int )((~ uid | 255U) - ~ uid);
  p = utable[uent];
  o = p;
  while (p) {
    if ((int )(((((uid - p->xid) - (((uid - p->xid) + (uid - p->xid)) & ((int )(uid - p->xid) >> 31))) - 1U) >> 31U) & 1U)) {
      return (p->name);
    } else
    if ((int )((((~ uid & p->xid) | ((~ uid | p->xid) & (uid - p->xid))) >> 31U) & 1U)) {
      break;
    }
    o = p;
    p = p->nxt;
  ...
  if ((unsigned long )ent != (unsigned long )((void *)0)) {
    ...
    tmp___1 = xmalloc((tmp___0 ^ 1UL) + ((tmp___0 & 1UL) + (tmp___0 & 1UL)));
    ...
    tmp___3 = xmalloc(((tmp___2 ^ ~ 1UL) + ((tmp___2 | 1UL) + (tmp___2 | 1UL))) + 1UL);
    t->name = strcpy((char *)((char */* __restrict  */)tmp___3), (char const   *)((char const   */* __restrict  */)(ubuf)));
  }
  t->xid = uid;
  t->nxt = p;
  if ((int )(((((((unsigned long )p - (unsigned long )utable[uent]) + ((long )((unsigned long )p - (unsigned long )utable[uent]) >> 31L)) ^ ((long )((unsigned long )p - (unsigned long )utable[uent]) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
    utable[uent] = t;
  } else {
    o->nxt = t;
  }
...
{ 
  ...
  if (((unsigned int )(((((mb_cur_max - 1) & - (mb_cur_max >= 1)) >> 31) - ((mb_cur_max - 1) & - (mb_cur_max >= 1))) ^ (((mb_cur_max - 1) & - (mb_cur_max >= 1)) >> 31)) >> 31U) & 1) {
    tmp = strlen((char const   *)s);
    c = (int )(((tmp | 1UL) + (tmp | 1UL)) - (tmp ^ 1UL));
    tmp___0 = xmalloc((sizeof(wchar_t___1 ) & (unsigned long )c) * (sizeof(wchar_t___1 ) | (unsigned long )c) + (sizeof(wchar_t___1 ) & ~ ((unsigned long )c)) * (~ sizeof(wchar_t___1 ) & (unsigned long )c));
    ws = (wchar_t___1 *)tmp___0;
    tmp___2 = mbstowcs((wchar_t___0 */* __restrict  */)ws, (char const   */* __restrict  */)s,
                       (size_t___1 )c);
    if ((int )(((((((unsigned long long )tmp___2 - 0xffffffffffffffffULL) << 1ULL) & ((long long )((unsigned long long )tmp___2 - 0xffffffffffffffffULL) >> 63LL)) - ((unsigned long long )tmp___2 - 0xffffffffffffffffULL)) >> 63ULL) & 1ULL)) {
      if (Qflag) {
        putc('\"', outfile);
      }
      tp = ws;
      while (1) {
        if (*tp) {
          if (! (((unsigned int )((((c - 1) & - (c >= 1)) >> 31) - (((c - 1) & - (c >= 1)) ^ (((c - 1) & - (c >= 1)) >> 31))) >> 31U) & 1)) {
            break;
          }
        } else {
          break;
  ...
  while (*s) {
    ...
    if (((unsigned int )((~ (7 ^ c) >> 1) + (7 & ~ c)) >> 31U) & 1) {
      if (((unsigned int )((c | ~ 13) & ((c ^ 13) | ~ (13 - c))) >> 31U) & 1) {
        goto _L;
      } else {
        goto _L___2;
      }
    ...
    if (((unsigned int )((((c - 34) + ((c - 34) >> 31)) ^ ((c - 34) >> 31)) - 1) >> 31U) & 1) {
      if (Qflag) {
        goto _L;
      } else {
        goto _L___1;
    ...
    _L___1: 
    if (((unsigned int )((((c - 32) + (1 << 31)) + (((c - 32) + (1 << 31)) >> 31)) ^ (((c - 32) + (1 << 31)) >> 31)) >> 31U) & 1) {
      if (! Qflag) {
        _L: 
        putc('\\', outfile);
        if (((unsigned int )((13 & ~ c) | (~ (13 ^ c) & (13 - c))) >> 31U) & 1) {
          putc(c, outfile);
        } else {
          putc((int )*("abtnvfr" + (((c & ~ 7) + (c & ~ 7)) - (c ^ 7))), outfile);
        }
      } else {
        goto _L___0;
      }
      ...
      if (qflag) {
        if (((unsigned int )((((mb_cur_max - 1) & - (mb_cur_max >= 1)) >> 31) - (((mb_cur_max - 1) & - (mb_cur_max >= 1)) ^ (((mb_cur_max - 1) & - (mb_cur_max >= 1)) >> 31))) >> 31U) & 1) {
          if (((unsigned int )((((c - 127) & - (c >= 127)) >> 31) - (((c - 127) & - (c >= 127)) ^ (((c - 127) & - (c >= 127)) >> 31))) >> 31U) & 1) {
            putc(c, outfile);
          } else {
            putc('?', outfile);
          }
...
{ 
  ...
  if (((unsigned int )(((((int )*(pattern___0 + 0) - 47) + (1 << 31)) ^ ((((int )*(pattern___0 + 0) - 47) + (1 << 31)) >> 31)) - ((((int )*(pattern___0 + 0) - 47) + (1 << 31)) >> 31)) >> 31U) & 1) {
    tmp___0 = 1;
  } else {
    tmp___0 = 0;
  }
  ...
  tmp___3 = xmalloc((tmp___2 - ~ 1UL) - 1UL);
...
{ 
  ...
  {
  hp = (int )(((~ inode | 255ULL) + inode) + 1ULL);
  ip = itable[hp];
  pp = ip;
  while (ip) {
    if ((int )((((~ inode & ip->inode) | (~ (inode ^ ip->inode) & (inode - ip->inode))) >> 63ULL) & 1ULL)) {
      break;
    }
    if ((int )((~ ((ip->inode - inode) | (inode - ip->inode)) >> 63ULL) & 1ULL)) {
      if ((int )((((~ device | ip->device) & ((device ^ ip->device) | ~ (ip->device - device))) >> 31U) & 1U)) {
        break;
      }
    }
    pp = ip;
  ...
  if (ip) {
    if ((int )(((((ip->inode - inode) + (1ULL << 63)) - ((((ip->inode - inode) + (1ULL << 63)) << 1ULL) & ((long long )((ip->inode - inode) + (1ULL << 63)) >> 63LL))) >> 63ULL) & 1ULL)) {
      if ((int )((~ ((ip->device - device) | (device - ip->device)) >> 31U) & 1U)) {
        return;
      }
    }
  }
  ...
  it->device = device;
  it->nxt = ip;
  if ((int )((~ (((unsigned long )ip - (unsigned long )itable[hp]) | ((unsigned long )itable[hp] - (unsigned long )ip)) >> 31UL) & 1UL)) {
    itable[hp] = it;
  } else {
    pp->nxt = it;
  }
...
{ 
  ...
  {
  if ((int )(((unsigned long long )((((a - b) + (1LL << 63)) + (((a - b) + (1LL << 63)) >> 63LL)) ^ (((a - b) + (1LL << 63)) >> 63LL)) >> 63ULL) & 1LL)) {
    tmp___0 = 0;
  } else {
    if ((int )(((unsigned long long )((a - b) ^ ((a ^ b) & ((a - b) ^ a))) >> 63ULL) & 1LL)) {
      tmp = 1;
    } else {
      tmp = -1;
    }
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )(((((int )buf___1[0] - 35) + (1 << 31)) ^ ((((int )buf___1[0] - 35) + (1 << 31)) >> 31)) - ((((int )buf___1[0] - 35) + (1 << 31)) >> 31)) >> 31U) & 1) {
      continue;
    }
    gittrim(buf___1);
    tmp___0 = strlen((char const   *)(buf___1));
    if ((int )((((~ tmp___0 & 1UL) | (~ (tmp___0 ^ 1UL) & (tmp___0 - 1UL))) >> 31UL) & 1UL)) {
      continue;
    }
    if (((unsigned int )(((((int )buf___1[0] - 9) + (((int )buf___1[0] - 9) >> 31)) ^ (((int )buf___1[0] - 9) >> 31)) - 1) >> 31U) & 1) {
      tmp___1 = lines;
      lines = ((lines ^ ~ 1) + ((lines | 1) << 1)) + 1;
      ...
      if (lines) {
        if (phead) {
          ...
          i = 0;
          while (((unsigned int )((((lines - i) & - (lines >= i)) >> 31) - (((lines - i) & - (lines >= i)) ^ (((lines - i) & - (lines >= i)) >> 31))) >> 31U) & 1) {
            free((void *)line[i]);
            i = ((i ^ ~ 1) + ((i | 1) << 1)) + 1;
          }
        }
  ...
  if (phead) {
    ...
    i___0 = 0;
    while (((unsigned int )((i___0 - lines) ^ ((i___0 ^ lines) & ((i___0 - lines) ^ i___0))) >> 31U) & 1) {
      free((void *)line[i___0]);
      i___0 = (i___0 ^ 1) + ((i___0 & 1) << 1);
    }
  }
  fclose(fp);
  ...
  tmp___10 = xmalloc((tmp___9 - ~ 1UL) - 1UL);
...
{ 
  ...
  fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"  "));
  i = 0;
  while (((unsigned int )((i - maxlevel) ^ ((i ^ maxlevel) & ((i - maxlevel) ^ i))) >> 31U) & 1) {
    fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"  "));
    i = ((i | 1) + (i | 1)) - (i ^ 1);
  }
  return;
...
{ 
  ...
  {
  n = 128;
  tmp = xmalloc((sizeof(char *) & (unsigned long )n) * (sizeof(char *) | (unsigned long )n) + (sizeof(char *) & ~ ((unsigned long )n)) * (~ sizeof(char *) & (unsigned long )n));
  w = (char **)tmp;
  tmp___0 = 0;
  *nwrds = tmp___0;
  *(w + tmp___0) = strtok((char */* __restrict  */)str, (char const   */* __restrict  */)delim);
  while (*(w + *nwrds)) {
    if (((unsigned int )(~ ((*nwrds - (((n & ~ 2) + (n & ~ 2)) - (n ^ 2))) | ((((n & ~ 2) + (n & ~ 2)) - (n ^ 2)) - *nwrds))) >> 31U) & 1) {
      n = (n ^ 256) + ((n & 256) + (n & 256));
      tmp___1 = xrealloc((void *)w, (sizeof(char *) & (unsigned long )n) * (sizeof(char *) | (unsigned long )n) + (sizeof(char *) & ~ ((unsigned long )n)) * (~ sizeof(char *) & (unsigned long )n));
      w = (char **)tmp___1;
    }
    *nwrds = ((*nwrds | 1) + (*nwrds | 1)) - (*nwrds ^ 1);
...
{ 
  ...
  if (ansilines) {
    ...
    i = 1;
    while (1) {
      if (((unsigned int )((~ (i ^ maxlevel) >> 1) + (i & ~ maxlevel)) >> 31U) & 1) {
        if (! *(dirs + i)) {
          break;
        }
      } else {
      ...
      if (*(dirs + ((i | 1) + (i & 1)))) {
        if (((unsigned int )((((*(dirs + i) - 1) + ((*(dirs + i) - 1) >> 31)) ^ ((*(dirs + i) - 1) >> 31)) - 1) >> 31U) & 1) {
    ...
    while (1) {
      ...
      if (*(dirs + (((i ^ ~ 1) + ((i | 1) << 1)) + 1))) {
        if (((unsigned int )(~ ((*(dirs + i) - 1) | (1 - *(dirs + i)))) >> 31U) & 1) {
...
{ 
  ...
  ctrl = (char *)"0-------btn-fr------------------";
  while (*s) {
    if (((unsigned int )(((int )((unsigned char )*s) - 32) ^ (((int )((unsigned char )*s) ^ 32) & (((int )((unsigned char )*s) - 32) ^ (int )((unsigned char )*s)))) >> 31U) & 1) {
      if (((unsigned int )(((int )*(ctrl + (int )((unsigned char )*s)) - 45) | (45 - (int )*(ctrl + (int )((unsigned char )*s)))) >> 31U) & 1) {
    ...
    if (((unsigned int )(~ (((int )*s - 34) | (34 - (int )*s))) >> 31U) & 1) {
      fprintf((FILE *)((FILE */* __restrict  */)fd), (char const   *)((char const   */* __restrict  */)"\\%c"),
              (int )*s);
    } else
    if (((unsigned int )(((((int )*s - 92) + (((int )*s - 92) >> 31)) ^ (((int )*s - 92) >> 31)) - 1) >> 31U) & 1) {
      fprintf((FILE *)((FILE */* __restrict  */)fd), (char const   *)((char const   */* __restrict  */)"\\%c"),
              (int )*s);
    } else {
      fprintf((FILE *)((FILE */* __restrict  */)fd), (char const   *)((char const   */* __restrict  */)"%c"),
...
{ 
  ...
  while ((unsigned long )ent != (unsigned long )((void *)0)) {
    ...
    if (! aflag) {
      if (! root) {
        if (((unsigned int )(~ (((int )*(ent->name + 0) - 46) | (46 - (int )*(ent->name + 0)))) >> 31U) & 1) {
          show = 0;
        }
      }
    }
    ...
    if (show) {
      ...
      count = ((count ^ ~ 1) + ((count | 1) + (count | 1))) + 1;
    } else {
  ...
  tmp___3 = xmalloc((sizeof(struct _info *) & (unsigned long )(((count ^ ~ 1) + ((count | 1) << 1)) + 1)) * (sizeof(struct _info *) | (unsigned long )(((count ^ ~ 1) + ((count | 1) << 1)) + 1)) + (sizeof(struct _info *) & ~ ((unsigned long )(((count ^ ~ 1) + ((count | 1) << 1)) + 1))) * (~ sizeof(struct _info *) & (unsigned long )(((count ^ ~ 1) + ((count | 1) << 1)) + 1)));
...
{ 
  ...
  if (metafirst) {
    if (((unsigned int )(~ (((int )info___0[0] - 91) | (91 - (int )info___0[0]))) >> 31U) & 1) {
      fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"%s  "),
              info___0);
    }
    if (! noindent) {
    ...
    if (((unsigned int )((((int )info___0[0] - 91) + (1 << 31)) - (((((int )info___0[0] - 91) + (1 << 31)) << 1) & ((((int )info___0[0] - 91) + (1 << 31)) >> 31))) >> 31U) & 1) {
      fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"%s  "),
              info___0);
    }
  }
...
{ 
  ...
  tmp___1 = xmalloc(((tmp___0 | 1UL) << 1UL) - (tmp___0 ^ 1UL));
...
{ 
  ...
  es = ((unsigned int )(((((int )*(dir + ((tmp + ~ 1UL) + 1UL)) - 47) + (((int )*(dir + ((tmp + ~ 1UL) + 1UL)) - 47) >> 31)) ^ (((int )*(dir + ((tmp + ~ 1UL) + 1UL)) - 47) >> 31)) - 1) >> 31U) & 1;
  if ((unsigned long )path == (unsigned long )((void *)0)) {
    tmp___0 = strlen((char const   *)dir);
    pathsize = (long )((tmp___0 ^ 4096UL) + ((tmp___0 & 4096UL) + (tmp___0 & 4096UL)));
  ...
  *n = -1;
  ...
  ne = 30;
  tmp___2 = xmalloc((sizeof(struct _info *) & (unsigned long )ne) * (sizeof(struct _info *) | (unsigned long )ne) + (sizeof(struct _info *) & ~ ((unsigned long )ne)) * (~ sizeof(struct _info *) & (unsigned long )ne));
  ...
  while (1) {
    ...
    if (! aflag) {
      if (((unsigned int )(~ (((int )ent->d_name[0] - 46) | (46 - (int )ent->d_name[0]))) >> 31U) & 1) {
        continue;
      }
    }
    tmp___9 = strlen((char const   *)dir);
    tmp___10 = strlen((char const   *)(ent->d_name));
    if ((int )((((~ ((size_t___0 )pathsize) & (((((tmp___9 - ~ tmp___10) - 1UL) ^ ~ 2UL) + ((((tmp___9 - ~ tmp___10) - 1UL) | 2UL) << 1UL)) + 1UL)) | (~ ((size_t___0 )pathsize ^ (((((tmp___9 - ~ tmp___10) - 1UL) ^ ~ 2UL) + ((((tmp___9 - ~ tmp___10) - 1UL) | 2UL) << 1UL)) + 1UL)) & ((size_t___0 )pathsize - (((((tmp___9 - ~ tmp___10) - 1UL) ^ ~ 2UL) + ((((tmp___9 - ~ tmp___10) - 1UL) | 2UL) << 1UL)) + 1UL)))) >> 31UL) & 1UL)) {
      tmp___6 = strlen((char const   *)dir);
      tmp___7 = strlen((char const   *)(ent->d_name));
      pathsize = (long )((((((tmp___6 ^ ~ tmp___7) + ((tmp___6 | tmp___7) + (tmp___6 | tmp___7))) + 1UL) | 4096UL) << 1UL) - ((((tmp___6 ^ ~ tmp___7) + ((tmp___6 | tmp___7) + (tmp___6 | tmp___7))) + 1UL) ^ 4096UL));
    ...
    if (info___1) {
      if (showinfo) {
        ...
        if (com) {
          ...
          tmp___11 = xmalloc((sizeof(char *) & (unsigned long )(((i | 1) + (i | 1)) - (i ^ 1))) * (sizeof(char *) | (unsigned long )(((i | 1) + (i | 1)) - (i ^ 1))) + (sizeof(char *) & ~ ((unsigned long )(((i | 1) + (i | 1)) - (i ^ 1)))) * (~ sizeof(char *) & (unsigned long )(((i | 1) + (i | 1)) - (i ^ 1))));
          info___1->comment = (char **)tmp___11;
          i = 0;
          while ((unsigned long )*(com->desc + i) != (unsigned long )((void *)0)) {
            tmp___12 = strlen((char const   *)*(com->desc + i));
            tmp___13 = xmalloc((tmp___12 | 1UL) + (tmp___12 & 1UL));
      ...
      if (((unsigned int )((((p - ((ne ^ 1) - ((~ ne & 1) << 1))) + ((p - ((ne ^ 1) - ((~ ne & 1) << 1))) >> 31)) ^ ((p - ((ne ^ 1) - ((~ ne & 1) << 1))) >> 31)) - 1) >> 31U) & 1) {
        ne = (ne | 20) + (ne & 20);
        tmp___14 = xrealloc((void *)dl, (sizeof(struct _info *) & (unsigned long )ne) * (sizeof(struct _info *) | (unsigned long )ne) + (sizeof(struct _info *) & ~ ((unsigned long )ne)) * (~ sizeof(struct _info *) & (unsigned long )ne));
  ...
  tmp___17 = p;
  *n = tmp___17;
  if (((unsigned int )(~ tmp___17 & (tmp___17 - 1)) >> 31U) & 1) {
    free((void *)dl);
    return ((struct _info **)((void *)0));
  }
...
{ 
  ...
  while (1) {
    if (ifmt[i]) {
      if (! ((int )((((((int )(((~ m | 61440U) - ~ m) - (unsigned int )ifmt[i]) >> 31) - (((~ m | 61440U) - ~ m) - (unsigned int )ifmt[i])) ^ ((int )(((~ m | 61440U) - ~ m) - (unsigned int )ifmt[i]) >> 31)) >> 31U) & 1U))) {
        break;
      }
    } else {
      break;
  ...
  b = 256;
  i = 0;
  while (((unsigned int )((i & ~ 9) | (~ (i ^ 9) & (i - 9))) >> 31U) & 1) {
    if (((~ m | (unsigned int )b) + m) + 1U) {
      buf[i + 1] = perms[i];
    } else {
      buf[i + 1] = (char )'-';
    }
  ...
  if ((~ m | 2048U) - ~ m) {
    if (((unsigned int )(((((int )buf[3] - 45) + (((int )buf[3] - 45) >> 31)) ^ (((int )buf[3] - 45) >> 31)) - 1) >> 31U) & 1) {
      buf[3] = (char )'S';
    } else {
      buf[3] = (char )'s';
    }
  ...
  if (((~ m | 1024U) + m) + 1U) {
    if (((unsigned int )((((int )buf[6] - 45) + (1 << 31)) - (((((int )buf[6] - 45) + (1 << 31)) << 1) & ((((int )buf[6] - 45) + (1 << 31)) >> 31))) >> 31U) & 1) {
      buf[6] = (char )'S';
    } else {
      buf[6] = (char )'s';
    }
  ...
  if (((~ m | 512U) + m) + 1U) {
    if (((unsigned int )(~ (((int )buf[9] - 45) | (45 - (int )buf[9]))) >> 31U) & 1) {
      buf[9] = (char )'T';
    } else {
      buf[9] = (char )'t';
    }
...
{ 
  ...
  fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"  "));
  i = 0;
  while (((unsigned int )((((maxlevel - i) & - (maxlevel >= i)) >> 31) - (((maxlevel - i) & - (maxlevel >= i)) ^ (((maxlevel - i) & - (maxlevel >= i)) >> 31))) >> 31U) & 1) {
    fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"  "));
    i = (i ^ 1) + ((i & 1) + (i & 1));
  }
  return;
...
{ 
  ...
  dirlen = (int )tmp;
  pathlen = (dirlen ^ 257) + ((dirlen & 257) + (dirlen & 257));
  err = (char *)((void *)0);
  tmp___0 = strlen((char const   *)dirname);
  es = ((unsigned int )(((((int )*(dirname + ((tmp___0 + ~ 1UL) + 1UL)) - 47) + (1 << 31)) ^ ((((int )*(dirname + ((tmp___0 + ~ 1UL) + 1UL)) - 47) + (1 << 31)) >> 31)) - ((((int )*(dirname + ((tmp___0 + ~ 1UL) + 1UL)) - 47) + (1 << 31)) >> 31)) >> 31U) & 1;
  n = 0;
  while (*(dir + n)) {
    n = ((n | 1) + (n | 1)) - (n ^ 1);
  }
  ...
  tmp___1 = xmalloc((sizeof(char ) & (unsigned long )pathlen) * (sizeof(char ) | (unsigned long )pathlen) + (sizeof(char ) & ~ ((unsigned long )pathlen)) * (~ sizeof(char ) & (unsigned long )pathlen));
  ...
  while ((unsigned long )*dir != (unsigned long )((void *)0)) {
    ...
    err = (char *)((void *)0);
    if ((*dir)->isdir) {
      tot.dirs = (tot.dirs ^ 1UL) + ((tot.dirs & 1UL) << 1UL);
      found = findino((*dir)->inode, (*dir)->dev);
      if (! found) {
        saveino((*dir)->inode, (*dir)->dev);
      }
      if (xdev) {
        if (! ((int )((((((dev - (*dir)->dev) + (dev - (*dir)->dev)) & ((int )(dev - (*dir)->dev) >> 31)) - (dev - (*dir)->dev)) >> 31U) & 1U))) {
          goto _L___0;
        }
      } else
      _L___0: 
      ...
      if ((*dir)->lnk) {
        if (lflag) {
          ...
          newpath = path___0;
          if ((*dir)->lnk) {
            if (((unsigned int )(~ (((int )*((*dir)->lnk) - 47) | (47 - (int )*((*dir)->lnk)))) >> 31U) & 1) {
              newpath = (*dir)->lnk;
            } else
            if (fflag) {
          ...
          if (((unsigned int )(~ Level) >> 31U) & 1) {
            if (((unsigned int )((Level - lev) ^ ((Level ^ lev) & ((Level - lev) ^ Level))) >> 31U) & 1) {
              if (Rflag) {
                outsave = outfile;
                paths[0] = newpath;
                paths[1] = (char *)((void *)0);
                tmp___3 = strlen((char const   *)newpath);
                tmp___4 = xmalloc(((tmp___3 | 13UL) << 1UL) - (tmp___3 ^ 13UL));
                output = (char *)tmp___4;
                tmp___5 = xmalloc((sizeof(int ) & (unsigned long )((lev - ~ 2) - 1)) * (sizeof(int ) | (unsigned long )((lev - ~ 2) - 1)) + (sizeof(int ) & ~ ((unsigned long )((lev - ~ 2) - 1))) * (~ sizeof(int ) & (unsigned long )((lev - ~ 2) - 1)));
                dirsave = (int *)tmp___5;
                memcpy((void */* __restrict  */)dirsave, (void const   */* __restrict  */)dirs,
                       (sizeof(int ) & (unsigned long )(((lev | 1) << 1) - (lev ^ 1))) * (sizeof(int ) | (unsigned long )(((lev | 1) << 1) - (lev ^ 1))) + (sizeof(int ) & ~ ((unsigned long )(((lev | 1) << 1) - (lev ^ 1)))) * (~ sizeof(int ) & (unsigned long )(((lev | 1) << 1) - (lev ^ 1))));
          ...
          if (descend) {
            if (hasfulltree) {
              ...
              if (((unsigned int )(- flimit & ~ flimit) >> 31U) & 1) {
                if (((unsigned int )((flimit & ~ n) | (~ (flimit ^ n) & (flimit - n))) >> 31U) & 1) {
                  err = errbuf;
                  sprintf((char *)((char */* __restrict  */)err), (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
                          n);
                  errors = ((errors ^ ~ 1) + ((errors | 1) + (errors | 1))) + 1;
                  free_dir(subdir);
                  subdir = (struct _info **)((void *)0);
                }
              }
      ...
      tot.files = ((tot.files ^ ~ 1UL) + ((tot.files | 1UL) << 1UL)) + 1UL;
    }
    if (Jflag) {
      if (errors) {
        tmp___6 = 1;
    ...
    needsclosed = (*(lc.printfile))(dirname, filename, *dir, ((((descend | htmldescend) + (descend | htmldescend)) - (descend ^ htmldescend)) | tmp___6) + ((((descend | htmldescend) + (descend | htmldescend)) - (descend ^ htmldescend)) & tmp___6));
    if (err) {
      (*(lc.error))(err);
    }
    if (descend) {
      (*(lc.newline))(*dir, lev, 0, 0);
      subtotal = listdir(newpath, subdir, ((lev | 1) << 1) - (lev ^ 1), dev, hasfulltree);
      tot.dirs = ((tot.dirs ^ ~ subtotal.dirs) + ((tot.dirs | subtotal.dirs) + (tot.dirs | subtotal.dirs))) + 1UL;
      tot.files = (tot.files - ~ subtotal.files) - 1UL;
      tot.size = (tot.size | subtotal.size) + (tot.size & subtotal.size);
    } else
    if (! needsclosed) {
    ...
    tot.size = (tot.size | (*dir)->size) + (tot.size & (*dir)->size);
    if ((unsigned long )ig != (unsigned long )((void *)0)) {
      ig = pop_filterstack();
    }
    if ((unsigned long )inf != (unsigned long )((void *)0)) {
...
{ 
  ...
  if (file) {
    if (file->lnk) {
      mt = (int )(((~ file->mode | 61440U) + file->mode) + 1U);
    } else {
      mt = (int )((~ file->mode | 61440U) - ~ file->mode);
    }
  } else {
    mt = 0;
  }
  t = 0;
  while (ifmt[t]) {
    if (((unsigned int )(~ ((ifmt[t] - (int const   )mt) | ((int const   )mt - ifmt[t]))) >> 31U) & 1) {
      break;
    }
    t = ((t | 1) + (t | 1)) - (t ^ 1);
  }
...
{ 
  ...
  {
  if ((int )(((unsigned long long )(~ (((*a)->ctime - (*b)->ctime) | ((*b)->ctime - (*a)->ctime))) >> 63ULL) & 1LL)) {
    v = strcoll((char const   *)(*a)->name, (char const   *)(*b)->name);
    if (reverse) {
      tmp = ~ (v - 1);
    } else {
  ...
  if ((int )(((unsigned long long )(~ (((*a)->ctime - (*b)->ctime) | ((*b)->ctime - (*a)->ctime))) >> 63ULL) & 1LL)) {
    ...
    if ((int )(((unsigned long long )(((*a)->ctime - (*b)->ctime) ^ (((*a)->ctime ^ (*b)->ctime) & (((*a)->ctime - (*b)->ctime) ^ (*a)->ctime))) >> 63ULL) & 1LL)) {
      tmp___0 = -1;
    } else {
      tmp___0 = 1;
    }
...
{ 
  ...
  switch (((~ ((int )mode) | 61440) + (int )mode) + 1) {
  case 4096: 
  ...
  return (tmp___2);
  case 16384: 
  if ((~ ((int )mode) | 512) - ~ ((int )mode)) {
    if ((~ ((int )mode) | 2) - ~ ((int )mode)) {
  ...
  return (tmp___9);
  case 32768: 
  if ((~ ((int )mode) | 2048) - ~ ((int )mode)) {
    tmp___10 = print_color(15);
    if (tmp___10) {
      return (1);
    }
  }
  if (((~ ((int )mode) | 1024) + (int )mode) + 1) {
    tmp___11 = print_color(16);
    if (tmp___11) {
      return (1);
    }
  }
  if ((~ ((int )mode) | 73) - ~ ((int )mode)) {
  ...
  while (e) {
    ...
    xl = (int )tmp___14;
    if (((unsigned int )((((l - xl) & - (l >= xl)) >> 31) - (((l - xl) & - (l >= xl)) ^ (((l - xl) & - (l >= xl)) >> 31))) >> 31U) & 1) {
      tmp___15 = name + ((l + ~ xl) + 1);
    } else {
      tmp___15 = name;
    }
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )((((int )buf___1[0] - 35) + (1 << 31)) - (((((int )buf___1[0] - 35) + (1 << 31)) << 1) & ((((int )buf___1[0] - 35) + (1 << 31)) >> 31))) >> 31U) & 1) {
      continue;
    }
    rev = ((unsigned int )((((int )buf___1[0] - 33) + (1 << 31)) - (((((int )buf___1[0] - 33) + (1 << 31)) << 1) & ((((int )buf___1[0] - 33) + (1 << 31)) >> 31))) >> 31U) & 1;
    gittrim(buf___1);
  ...
  tmp___4 = xmalloc((tmp___3 | 1UL) + (tmp___3 & 1UL));
...
{ 
  ...
  while (*(dirname + i)) {
    if (fflag) {
      ...
      j = (int )tmp;
      while (1) {
        if (((unsigned int )((((j - 1) & - (j >= 1)) >> 31) - (((j - 1) & - (j >= 1)) ^ (((j - 1) & - (j >= 1)) >> 31))) >> 31U) & 1) {
          if (((unsigned int )(((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) << 1))) - 47) + (1 << 31)) + ((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) << 1))) - 47) + (1 << 31)) >> 31)) ^ ((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) << 1))) - 47) + (1 << 31)) >> 31)) >> 31U) & 1) {
            j = (j & ~ 1) - (~ j & 1);
            *(*(dirname + i) + j) = (char)0;
          }
        }
        if (((unsigned int )(((((j - 1) & - (j >= 1)) >> 31) - ((j - 1) & - (j >= 1))) ^ (((j - 1) & - (j >= 1)) >> 31)) >> 31U) & 1) {
          if (! (((unsigned int )((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) + (~ j & 1)))) - 47) + (1 << 31)) - (((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) + (~ j & 1)))) - 47) + (1 << 31)) + (((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) + (~ j & 1)))) - 47) + (1 << 31))) & ((((int )*(*(dirname + i) + ((j ^ 1) - ((~ j & 1) + (~ j & 1)))) - 47) + (1 << 31)) >> 31))) >> 31U) & 1)) {
            break;
          }
        } else {
          break;
    ...
    if (! dir) {
      if (n) {
        ...
        (*(lc.newline))(info___1, 0, 0, (unsigned long )*(dirname + (((i | 1) + (i | 1)) - (i ^ 1))) != (unsigned long )((void *)0));
        errors = ((errors | 1) << 1) - (errors ^ 1);
      } else {
        goto _L___0;
      }
    } else
    ...
    if (((unsigned int )(- flimit & ~ flimit) >> 31U) & 1) {
      if (((unsigned int )((flimit & ~ n) | (~ (flimit ^ n) & (flimit - n))) >> 31U) & 1) {
        sprintf((char *)((char */* __restrict  */)(errbuf)), (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
                n);
        (*(lc.error))(errbuf);
        (*(lc.newline))(info___1, 0, 0, (unsigned long )*(dirname + (((i ^ ~ 1) + ((i | 1) << 1)) + 1)) != (unsigned long )((void *)0));
        errors = (errors ^ 1) + ((errors & 1) + (errors & 1));
      } else {
        goto _L;
      }
    } else {
    ...
    if (needsclosed) {
      (*(lc.close))(info___1, 0, (unsigned long )*(dirname + (((i ^ ~ 1) + ((i | 1) << 1)) + 1)) != (unsigned long )((void *)0));
    }
    if (duflag) {
      tot.size = info___1->size;
    } else {
      tot.size = (tot.size ^ st.st_size) + ((tot.size & st.st_size) + (tot.size & st.st_size));
    }
    if ((unsigned long )ig != (unsigned long )((void *)0)) {
      ig = pop_filterstack();
    }
...
{ 
  ...
  while (1) {
    ...
    while ((unsigned long )p != (unsigned long )((void *)0)) {
      if (p->relative) {
        tmp___0 = patmatch(name, p->pattern, isdir);
        if (((unsigned int )(~ ((tmp___0 - 1) | (1 - tmp___0))) >> 31U) & 1) {
          filter = 1;
          break;
        }
      } else {
        ...
        if (((unsigned int )(~ ((tmp___1 - 1) | (1 - tmp___1))) >> 31U) & 1) {
          filter = 1;
          break;
        }
      }
  ...
  while (ig) {
    ...
    while ((unsigned long )p != (unsigned long )((void *)0)) {
      if (p->relative) {
        ...
        if (((unsigned int )(~ ((tmp___3 - 1) | (1 - tmp___3))) >> 31U) & 1) {
          return (0);
        }
      } else {
        ...
        if (((unsigned int )(~ ((tmp___4 - 1) | (1 - tmp___4))) >> 31U) & 1) {
          return (0);
        }
      }
      p = p->next;
...
{ 
  ...
  {
  gent = (int )((~ gid | 255U) - ~ gid);
  p = gtable[gent];
  o = p;
  while (p) {
    if ((int )((((((gid - p->xid) + (1U << 31)) + ((int )((gid - p->xid) + (1U << 31)) >> 31)) ^ ((int )((gid - p->xid) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
      return (p->name);
    } else
    if ((int )((((~ gid & p->xid) | ((~ gid | p->xid) & (gid - p->xid))) >> 31U) & 1U)) {
      break;
    }
    o = p;
    p = p->nxt;
  ...
  if ((unsigned long )ent != (unsigned long )((void *)0)) {
    ...
    tmp___3 = xmalloc((tmp___2 ^ 1UL) + ((tmp___2 & 1UL) << 1UL));
    t->name = strcpy((char *)((char */* __restrict  */)tmp___3), (char const   *)((char const   */* __restrict  */)(gbuf)));
  }
  t->xid = gid;
  t->nxt = p;
  if ((int )((~ (((unsigned long )p - (unsigned long )gtable[gent]) | ((unsigned long )gtable[gent] - (unsigned long )p)) >> 31UL) & 1UL)) {
    gtable[gent] = t;
  } else {
    o->nxt = t;
  }
...
{ 
  ...
  while ((unsigned long )ptr != (unsigned long )((void *)0)) {
    ...
    if (((unsigned int )(((cmp + (cmp >> 31)) ^ (cmp >> 31)) - 1) >> 31U) & 1) {
      return (ptr);
    }
    if (((unsigned int )(cmp ^ (((cmp + cmp) & (cmp >> 31)) - cmp)) >> 31U) & 1) {
      break;
    }
    prev___0 = ptr;
    ptr = ptr->next;
  ...
  n = newent(name);
  n->next = ptr;
  if ((int )((~ (((unsigned long )prev___0 - (unsigned long )ptr) | ((unsigned long )ptr - (unsigned long )prev___0)) >> 31UL) & 1UL)) {
    *dir = n;
  } else {
    prev___0->next = n;
  }
...
{ 
  ...
  com->pattern = phead;
  tmp___0 = xmalloc((sizeof(char *) & (unsigned long )(((lines | 1) + (lines | 1)) - (lines ^ 1))) * (sizeof(char *) | (unsigned long )(((lines | 1) + (lines | 1)) - (lines ^ 1))) + (sizeof(char *) & ~ ((unsigned long )(((lines | 1) + (lines | 1)) - (lines ^ 1)))) * (~ sizeof(char *) & (unsigned long )(((lines | 1) + (lines | 1)) - (lines ^ 1))));
  com->desc = (char **)tmp___0;
  i = 0;
  while (((unsigned int )((i & ~ lines) | (~ (i ^ lines) & (i - lines))) >> 31U) & 1) {
    *(com->desc + i) = *(line + i);
    i = ((i ^ ~ 1) + ((i | 1) + (i | 1))) + 1;
  }
...
{ 
  ...
  {
  m = (int )((~ mode | 61440U) - ~ mode);
  if (! dflag) {
    if (((unsigned int )(~ ((m - 16384) | (16384 - m))) >> 31U) & 1) {
      return ((char )'/');
    } else {
      goto _L;
    }
  ...
  _L: 
  if (((unsigned int )(~ ((m - 49152) | (49152 - m))) >> 31U) & 1) {
    return ((char )'=');
  } else
  if (((unsigned int )(~ ((m - 4096) | (4096 - m))) >> 31U) & 1) {
    return ((char )'|');
  } else
  if (((unsigned int )((((m - 40960) + (1 << 31)) + (((m - 40960) + (1 << 31)) >> 31)) ^ (((m - 40960) + (1 << 31)) >> 31)) >> 31U) & 1) {
    return ((char )'@');
  } else
  if (((unsigned int )(~ ((m - 32768) | (32768 - m))) >> 31U) & 1) {
    if ((~ mode | 73U) - ~ mode) {
      return ((char )'*');
    }
  }
...
{ 
  ...
  pathsize___0 = 65536L;
  tmp___3 = xmalloc((sizeof(char *) & (unsigned long )pathsize___0) * (sizeof(char *) | (unsigned long )pathsize___0) + (sizeof(char *) & ~ ((unsigned long )pathsize___0)) * (~ sizeof(char *) & (unsigned long )pathsize___0));
  ...
  while (1) {
    ...
    while (1) {
      if (l) {
        tmp___6 = isspace((int )*(path___0 + ((l ^ 1) - ((~ l & 1) + (~ l & 1)))));
        if (! tmp___6) {
          break;
        }
      } else {
    ...
    while (1) {
      s = nextpc(& spath, & tok);
      if (((unsigned int )(((tok + (tok >> 31)) ^ (tok >> 31)) - 1) >> 31U) & 1) {
        goto __Cont;
      }
      switch (tok) {
      case 0: 
      ...
      case 1: 
      ent = search(cwd, s);
      if (((unsigned int )(~ ((tok - 1) | (1 - tok))) >> 31U) & 1) {
        ent->isdir = (bool )1;
      ...
      __Cont: 
      if (((unsigned int )(((tok - 2) >> 31) - ((tok - 2) ^ ((tok - 2) >> 31))) >> 31U) & 1) {
        if (! (((unsigned int )((((tok - 3) >> 31) - (tok - 3)) ^ ((tok - 3) >> 31)) >> 31U) & 1)) {
          break;
        }
      } else {
        break;
  ...
  if ((int )((((((long )((unsigned long )fp - (unsigned long )stdin) >> 31L) - ((unsigned long )fp - (unsigned long )stdin)) ^ ((long )((unsigned long )fp - (unsigned long )stdin) >> 31L)) >> 31UL) & 1UL)) {
    fclose(fp);
  }
...
{ 
  ...
  if (file->lnk) {
    mt = ((~ file->mode | 61440U) + file->mode) + 1U;
  } else {
    mt = (~ file->mode | 61440U) - ~ file->mode;
  }
  t = 0;
  while (ifmt[t]) {
    if ((int )(((((((mode_t )ifmt[t] - mt) ^ ((int )((mode_t )ifmt[t] - mt) >> 31)) - ((int )((mode_t )ifmt[t] - mt) >> 31)) - 1U) >> 31U) & 1U)) {
      break;
    }
    t = ((t | 1) << 1) - (t ^ 1);
  }
...
{ 
  ...
  if (((unsigned int )(~ (((int )*(s + 0) - 42) | (42 - (int )*(s + 0)))) >> 31U) & 1) {
    return (25);
  }
  i = 0;
  while (cmds[i].cmdnum) {
...
{ 
  ...
  colorize = (bool )1;
  i___0 = 0;
  while (((unsigned int )((i___0 & ~ 25) | (~ (i___0 ^ 25) & (i___0 - 25))) >> 31U) & 1) {
    color_code[i___0] = (char *)((void *)0);
    i___0 = (i___0 | 1) + (i___0 & 1);
  }
  tmp___3 = strlen((char const   *)s);
  tmp___4 = xmalloc(((tmp___3 | 1UL) << 1UL) - (tmp___3 ^ 1UL));
  ...
  while (*(arg + i)) {
    ...
    if (*(c + 1)) {
      ...
      if (((unsigned int )(((tmp___10 + (tmp___10 >> 31)) ^ (tmp___10 >> 31)) - 1) >> 31U) & 1) {
    ...
    if (*(c + 1)) {
      ...
      tmp___12 = xmalloc((tmp___11 | 1UL) + (tmp___11 & 1UL));
  ...
  if (! color_code[24]) {
    ...
    tmp___20 = xmalloc((tmp___19 | 1UL) + (tmp___19 & 1UL));
...
{ 
  ...
  if ((int )((~ (((((~ lst.st_mode | 61440U) + lst.st_mode) + 1U) - 40960U) | (40960U - (((~ lst.st_mode | 61440U) + lst.st_mode) + 1U))) >> 31U) & 1U)) {
    rs = stat((char const   */* __restrict  */)path___0, (struct stat */* __restrict  */)(& st));
    if (((unsigned int )rs >> 31U) & 1) {
  ...
  isdir = (int )((((((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) ^ ((int )((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) >> 31)) - ((int )((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) >> 31)) >> 31U) & 1U);
  if (gitignore) {
  ...
  if ((int )(((((((((~ lst.st_mode | 61440U) + lst.st_mode) + 1U) - 16384U) << 1U) & ((int )((((~ lst.st_mode | 61440U) + lst.st_mode) + 1U) - 16384U) >> 31)) - ((((~ lst.st_mode | 61440U) + lst.st_mode) + 1U) - 16384U)) >> 31U) & 1U)) {
    if (lflag) {
      if (! ((int )(((((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) - ((((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) << 1U) & ((int )((((~ st.st_mode | 61440U) - ~ st.st_mode) - 16384U) + (1U << 31)) >> 31))) >> 31U) & 1U))) {
        goto _L;
      }
    } else
    _L: 
  ...
  if (dflag) {
    if ((int )(((((((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 16384U) << 1U) & ((int )((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 16384U) >> 31)) - ((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 16384U)) >> 31U) & 1U)) {
      return ((struct _info *)((void *)0));
    }
  }
  ...
  tmp___6 = xmalloc(((tmp___5 ^ ~ 1UL) + ((tmp___5 | 1UL) + (tmp___5 | 1UL))) + 1UL);
  ...
  ent->issok = (bool )((int )(((((((~ st.st_mode | 61440U) - ~ st.st_mode) - 49152U) + (1U << 31)) - ((((((~ st.st_mode | 61440U) - ~ st.st_mode) - 49152U) + (1U << 31)) << 1U) & ((int )((((~ st.st_mode | 61440U) - ~ st.st_mode) - 49152U) + (1U << 31)) >> 31))) >> 31U) & 1U));
  ent->isfifo = (bool )((int )(((((((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 4096U) + ((int )((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 4096U) >> 31)) ^ ((int )((((~ st.st_mode | 61440U) + st.st_mode) + 1U) - 4096U) >> 31)) - 1U) >> 31U) & 1U));
  if (((~ st.st_mode | 73U) + st.st_mode) + 1U) {
    ent->isexe = (bool )1;
  } else {
    ent->isexe = (bool )0;
  ...
  if ((int )((~ (((((~ lst.st_mode | 61440U) + lst.st_mode) + 1U) - 40960U) | (40960U - (((~ lst.st_mode | 61440U) + lst.st_mode) + 1U))) >> 31U) & 1U)) {
    if ((int )(((unsigned long long )(((off_t )lbufsize & ~ ((lst.st_size ^ 1LL) + ((lst.st_size & 1LL) + (lst.st_size & 1LL)))) | (~ ((off_t )lbufsize ^ ((lst.st_size ^ 1LL) + ((lst.st_size & 1LL) + (lst.st_size & 1LL)))) & ((off_t )lbufsize - ((lst.st_size ^ 1LL) + ((lst.st_size & 1LL) + (lst.st_size & 1LL)))))) >> 63ULL) & 1LL)) {
      lbufsize = (int )((lst.st_size | 8192LL) + (lst.st_size & 8192LL));
      tmp___7 = xrealloc((void *)lbuf, (size_t___0 )lbufsize);
      lbuf = (char *)tmp___7;
    }
    tmp___12 = readlink((char const   */* __restrict  */)path___0, (char */* __restrict  */)lbuf,
                        (size_t___0 )((lbufsize & ~ 1) - (~ lbufsize & 1)));
    len = (int )tmp___12;
    if (((unsigned int )len >> 31U) & 1) {
      tmp___8 = strlen("[Error reading symbolic link information]");
      tmp___9 = xmalloc((tmp___8 - ~ 1UL) - 1UL);
      ...
      *(lbuf + len) = (char)0;
      ...
      tmp___11 = xmalloc((tmp___10 | 1UL) + (tmp___10 & 1UL));
...
{ 
  ...
  while (1) {
    ...
    size = (size & 2) * (size | 2) + (size & ~ 2) * (~ size & 2);
    free((void *)buffer);
...
{ 
  ...
  {
  if (((unsigned int )(~ ((lines - 1) | (1 - lines))) >> 31U) & 1) {
    fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"%s "),
            linedraw->csingle);
  } else
  if (((unsigned int )(~ line & (line - 1)) >> 31U) & 1) {
    fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"%s "),
            linedraw->ctop);
  } else
  if (((unsigned int )((line - 2) ^ ((line ^ 2) & ((line - 2) ^ line))) >> 31U) & 1) {
    if (((unsigned int )((((lines - 2) + ((lines - 2) >> 31)) ^ ((lines - 2) >> 31)) - 1) >> 31U) & 1) {
    ...
    if (((unsigned int )((((line - ((lines + ~ 1) + 1)) + (1 << 31)) + (((line - ((lines + ~ 1) + 1)) + (1 << 31)) >> 31)) ^ (((line - ((lines + ~ 1) + 1)) + (1 << 31)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  flimit = 0;
  maxdirs = 4096;
  tmp = xmalloc((sizeof(int ) & (unsigned long )maxdirs) * (sizeof(int ) | (unsigned long )maxdirs) + (sizeof(int ) & ~ ((unsigned long )maxdirs)) * (~ sizeof(int ) & (unsigned long )maxdirs));
  dirs = (int *)tmp;
  memset((void *)dirs, 0, (sizeof(int ) & (unsigned long )maxdirs) * (sizeof(int ) | (unsigned long )maxdirs) + (sizeof(int ) & ~ ((unsigned long )maxdirs)) * (~ sizeof(int ) & (unsigned long )maxdirs));
  *(dirs + 0) = 0;
  Level = -1;
  setlocale(0, "");
  setlocale(3, "");
  ...
  i = 1;
  n = i;
  while (((unsigned int )((i & ~ argc) | (~ (i ^ argc) & (i - argc))) >> 31U) & 1) {
    n = (n ^ 1) + ((n & 1) << 1);
    if (optf) {
      if (((unsigned int )(((((int )*(*(argv + i) + 0) - 45) ^ (((int )*(*(argv + i) + 0) - 45) >> 31)) - (((int )*(*(argv + i) + 0) - 45) >> 31)) - 1) >> 31U) & 1) {
        if (*(*(argv + i) + 1)) {
          j = 1;
          while (*(*(argv + i) + j)) {
            switch ((int )*(*(argv + i) + j)) {
            ...
            if (((unsigned int )(((((maxpattern & ~ 1) + (maxpattern & ~ 1)) - (maxpattern ^ 1)) | ~ pattern) & (((((maxpattern & ~ 1) + (maxpattern & ~ 1)) - (maxpattern ^ 1)) ^ pattern) | ~ (pattern - (((maxpattern & ~ 1) + (maxpattern & ~ 1)) - (maxpattern ^ 1))))) >> 31U) & 1) {
              maxpattern = ((maxpattern | 10) + (maxpattern | 10)) - (maxpattern ^ 10);
              tmp___5 = xrealloc((void *)patterns, (sizeof(char *) & (unsigned long )maxpattern) * (sizeof(char *) | (unsigned long )maxpattern) + (sizeof(char *) & ~ ((unsigned long )maxpattern)) * (~ sizeof(char *) & (unsigned long )maxpattern));
              patterns = (char **)tmp___5;
            }
            tmp___6 = pattern;
            pattern = (pattern ^ 1) + ((pattern & 1) << 1);
            tmp___7 = n;
            n = (n - ~ 1) - 1;
            ...
            *(patterns + pattern) = (char *)((void *)0);
            ...
            if (((unsigned int )(((((maxipattern & ~ 1) << 1) - (maxipattern ^ 1)) | ~ ipattern) & (((((maxipattern & ~ 1) << 1) - (maxipattern ^ 1)) ^ ipattern) | ~ (ipattern - (((maxipattern & ~ 1) << 1) - (maxipattern ^ 1))))) >> 31U) & 1) {
              maxipattern = (maxipattern ^ 10) + ((maxipattern & 10) + (maxipattern & 10));
              tmp___8 = xrealloc((void *)ipatterns, (sizeof(char *) & (unsigned long )maxipattern) * (sizeof(char *) | (unsigned long )maxipattern) + (sizeof(char *) & ~ ((unsigned long )maxipattern)) * (~ sizeof(char *) & (unsigned long )maxipattern));
              ipatterns = (char **)tmp___8;
            }
            tmp___9 = ipattern;
            ipattern = (ipattern | 1) + (ipattern & 1);
            tmp___10 = n;
            n = (n ^ 1) + ((n & 1) + (n & 1));
            ...
            *(ipatterns + ipattern) = (char *)((void *)0);
            ...
            tmp___14 = strtoul((char const   */* __restrict  */)sLevel, (char **/* __restrict  */)((void *)0),
                               0);
            Level = (int )(((tmp___14 & ~ 1UL) + (tmp___14 & ~ 1UL)) - (tmp___14 ^ 1UL));
            if (((unsigned int )Level >> 31U) & 1) {
            ...
            if (((unsigned int )(~ ((j - 1) | (1 - j))) >> 31U) & 1) {
              ...
              if (! tmp___21) {
                ...
                j = (int )((tmp___20 ^ 1UL) - ((~ tmp___20 & 1UL) + (~ tmp___20 & 1UL)));
                inodeflag = (bool )1;
                break;
              }
              ...
              if (! tmp___23) {
                ...
                j = (int )((tmp___22 & ~ 1UL) - (~ tmp___22 & 1UL));
                devflag = (bool )1;
                break;
              }
              ...
              if (! tmp___25) {
                ...
                j = (int )((tmp___24 ^ 1UL) - ((~ tmp___24 & 1UL) + (~ tmp___24 & 1UL)));
                noreport = (bool )1;
                break;
              }
              ...
              if (! tmp___27) {
                ...
                j = (int )((tmp___26 & ~ 1UL) - (~ tmp___26 & 1UL));
                nolinks = (bool )1;
                break;
              }
              ...
              if (! tmp___35) {
                j = 11;
                if (((unsigned int )(~ (((int )*(*(argv + i) + 11) - 61) | (61 - (int )*(*(argv + i) + 11)))) >> 31U) & 1) {
                  if (*(*(argv + i) + 12)) {
                    flimit = atoi((char const   *)(*(argv + i) + 12));
                    tmp___32 = strlen((char const   *)*(argv + i));
                    j = (int )(((tmp___32 & ~ 1UL) + (tmp___32 & ~ 1UL)) - (tmp___32 ^ 1UL));
                    break;
                  } else {
                ...
                if ((unsigned long )*(argv + n) != (unsigned long )((void *)0)) {
                  ...
                  j = (int )((tmp___34 ^ 1UL) - ((~ tmp___34 & 1UL) + (~ tmp___34 & 1UL)));
                } else {
                  fprintf((FILE *)((FILE */* __restrict  */)stderr), (char const   *)((char const   */* __restrict  */)"tree: missing argument to --filelimit\n"));
                  exit(1);
                }
              ...
              if (! tmp___39) {
                j = 9;
                if (((unsigned int )((((int )*(*(argv + i) + j) - 61) - ((((int )*(*(argv + i) + j) - 61) + ((int )*(*(argv + i) + j) - 61)) & (((int )*(*(argv + i) + j) - 61) >> 31))) - 1) >> 31U) & 1) {
                  charset = (char const   *)(*(argv + i) + 10);
                  if (*charset) {
                    tmp___36 = strlen((char const   *)*(argv + i));
                    j = (int )((tmp___36 + ~ 1UL) + 1UL);
                    break;
                  } else {
              ...
              if (! tmp___43) {
                ...
                j = (int )(((tmp___42 & ~ 1UL) + (tmp___42 & ~ 1UL)) - (tmp___42 ^ 1UL));
                sflag = (bool )1;
                duflag = (bool )1;
                break;
              }
              ...
              if (! tmp___45) {
                ...
                j = (int )((tmp___44 & ~ 1UL) - (~ tmp___44 & 1UL));
                pruneflag = (bool )1;
                break;
              }
              ...
              if (! tmp___52) {
                j = 9;
                if (((unsigned int )((((int )*(*(argv + i) + j) - 61) - ((((int )*(*(argv + i) + j) - 61) << 1) & (((int )*(*(argv + i) + j) - 61) >> 31))) - 1) >> 31U) & 1) {
                  j = (j - ~ 1) - 1;
                  if (*(*(argv + i) + j)) {
                    tmp___46 = strlen((char const   *)(*(argv + i) + j));
                    tmp___47 = xmalloc(((tmp___46 | 1UL) << 1UL) - (tmp___46 ^ 1UL));
                    timefmt = strcpy((char *)((char */* __restrict  */)tmp___47),
                                     (char const   *)((char const   */* __restrict  */)(*(argv + i) + j)));
                    tmp___48 = strlen((char const   *)*(argv + i));
                    j = (int )((tmp___48 & ~ 1UL) - (~ tmp___48 & 1UL));
                    break;
                  } else {
              ...
              if (! tmp___54) {
                ...
                j = (int )(((tmp___53 & ~ 1UL) << 1UL) - (tmp___53 ^ 1UL));
                ignorecase = (bool )1;
                break;
              }
              ...
              if (! tmp___62) {
                j = 6;
                if (((unsigned int )(~ (((int )*(*(argv + i) + j) - 61) | (61 - (int )*(*(argv + i) + j)))) >> 31U) & 1) {
                  j = ((j ^ ~ 1) + ((j | 1) << 1)) + 1;
                  if (*(*(argv + i) + j)) {
                    stmp = *(argv + i) + j;
                    tmp___57 = strlen((char const   *)*(argv + i));
                    j = (int )(((tmp___57 & ~ 1UL) + (tmp___57 & ~ 1UL)) - (tmp___57 ^ 1UL));
                  } else {
                ...
                if ((unsigned long )*(argv + n) != (unsigned long )((void *)0)) {
                  ...
                  j = (int )(((tmp___59 & ~ 1UL) + (tmp___59 & ~ 1UL)) - (tmp___59 ^ 1UL));
                } else {
                  fprintf((FILE *)((FILE */* __restrict  */)stderr), (char const   *)((char const   */* __restrict  */)"tree: missing argument to --sort\n"));
                  exit(1);
                }
                ...
                while (sorts[k].name) {
                  ...
                  if (((unsigned int )((tmp___60 + (1 << 31)) - (((tmp___60 + (1 << 31)) + (tmp___60 + (1 << 31))) & ((tmp___60 + (1 << 31)) >> 31))) >> 31U) & 1) {
              ...
              if (! tmp___66) {
                ...
                j = (int )((tmp___65 ^ 1UL) - ((~ tmp___65 & 1UL) << 1UL));
                metafirst = (bool )1;
                break;
              }
              ...
              if (! tmp___68) {
                ...
                j = (int )((tmp___67 ^ 1UL) - ((~ tmp___67 & 1UL) << 1UL));
                gitignore = (bool )1;
                break;
              }
              ...
              if (! tmp___70) {
                ...
                j = (int )((tmp___69 & ~ 1UL) - (~ tmp___69 & 1UL));
                showinfo = (bool )1;
                break;
              }
      ...
      if (! dirname) {
        q = 30;
        tmp___71 = xmalloc((sizeof(char *) & (unsigned long )q) * (sizeof(char *) | (unsigned long )q) + (sizeof(char *) & ~ ((unsigned long )q)) * (~ sizeof(char *) & (unsigned long )q));
        dirname = (char **)tmp___71;
      } else
      if (((unsigned int )(~ ((p - ((q & ~ 2) - (~ q & 2))) | (((q & ~ 2) - (~ q & 2)) - p))) >> 31U) & 1) {
        q = ((q ^ ~ 20) + ((q | 20) + (q | 20))) + 1;
        tmp___72 = xrealloc((void *)dirname, (sizeof(char *) & (unsigned long )q) * (sizeof(char *) | (unsigned long )q) + (sizeof(char *) & ~ ((unsigned long )q)) * (~ sizeof(char *) & (unsigned long )q));
        dirname = (char **)tmp___72;
      }
      tmp___73 = p;
      p = (p | 1) + (p & 1);
      tmp___74 = strlen((char const   *)*(argv + i));
      tmp___75 = xmalloc(((tmp___74 ^ ~ 1UL) + ((tmp___74 | 1UL) << 1UL)) + 1UL);
  ...
  if ((unsigned long )dirname == (unsigned long )((void *)0)) {
    tmp___76 = xmalloc((sizeof(char *) & 2UL) * (sizeof(char *) | 2UL) + (sizeof(char *) & ~ 2UL) * (~ sizeof(char *) & 2UL));
    dirname = (char **)tmp___76;
    tmp___77 = strlen(".");
    tmp___78 = xmalloc(((tmp___77 | 1UL) << 1UL) - (tmp___77 ^ 1UL));
  ...
  if (Rflag) {
    if (((unsigned int )((((Level - -1) + ((Level - -1) >> 31)) ^ ((Level - -1) >> 31)) - 1) >> 31U) & 1) {
      Rflag = (bool )0;
    }
  }
  if (gitignore) {
...
{ 
  ...
  while (it) {
    if ((int )((((~ inode & it->inode) | ((~ inode | it->inode) & (inode - it->inode))) >> 63ULL) & 1ULL)) {
      break;
    }
    if ((int )((~ ((it->inode - inode) | (inode - it->inode)) >> 63ULL) & 1ULL)) {
      if ((int )((((~ device | it->device) & ((device ^ it->device) | ~ (it->device - device))) >> 31U) & 1U)) {
        break;
      }
    }
    it = it->nxt;
  ...
  if (it) {
    if ((int )((((((it->inode - inode) + ((long long )(it->inode - inode) >> 63LL)) ^ ((long long )(it->inode - inode) >> 63LL)) - 1ULL) >> 63ULL) & 1ULL)) {
      if ((int )((~ ((it->device - device) | (device - it->device)) >> 31U) & 1U)) {
        return (1);
      }
    }
  }
...
{ 
  ...
  *err = (char *)((void *)0);
  if (((unsigned int )(~ Level) >> 31U) & 1) {
    if ((int )((((~ ((u_long )Level) & lev) | ((~ ((u_long )Level) | lev) & ((u_long )Level - lev))) >> 31UL) & 1UL)) {
      return ((struct _info **)((void *)0));
    }
  }
  if (xdev) {
  ...
  if (matchdirs) {
    if (pattern) {
      ...
      while ((int )(((((unsigned long )start_rel_path - (unsigned long )d) | ((unsigned long )d - (unsigned long )start_rel_path)) >> 31UL) & 1UL)) {
        if (((unsigned int )(~ (((int )*start_rel_path - 47) | (47 - (int )*start_rel_path))) >> 31U) & 1) {
          lev_tmp = (lev_tmp ^ 1UL) - ((~ lev_tmp & 1UL) + (~ lev_tmp & 1UL));
        }
        if (lev_tmp <= 0UL) {
          if (*start_rel_path) {
            start_rel_path ++;
  ...
  if (((unsigned int )(((n ^ (n >> 31)) - (n >> 31)) - 1) >> 31U) & 1) {
  ...
  if (((unsigned int )(flimit ^ ((flimit >> 31) - (flimit ^ (flimit >> 31)))) >> 31U) & 1) {
    if (((unsigned int )((((n - flimit) & - (n >= flimit)) >> 31) - (((n - flimit) & - (n >= flimit)) ^ (((n - flimit) & - (n >= flimit)) >> 31))) >> 31U) & 1) {
      sprintf((char *)((char */* __restrict  */)path___0), (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
              n);
      tmp___5 = strlen((char const   *)path___0);
      tmp___6 = xmalloc((tmp___5 ^ 1UL) + ((tmp___5 & 1UL) + (tmp___5 & 1UL)));
  ...
  if ((int )((((~ ((u_long )(((maxdirs & ~ 1) + (maxdirs & ~ 1)) - (maxdirs ^ 1))) | lev) & (((u_long )(((maxdirs & ~ 1) + (maxdirs & ~ 1)) - (maxdirs ^ 1)) ^ lev) | ~ (lev - (u_long )(((maxdirs & ~ 1) + (maxdirs & ~ 1)) - (maxdirs ^ 1))))) >> 31UL) & 1UL)) {
    maxdirs = ((maxdirs | 1024) + (maxdirs | 1024)) - (maxdirs ^ 1024);
    tmp___7 = xrealloc((void *)dirs, (sizeof(int ) & (unsigned long )maxdirs) * (sizeof(int ) | (unsigned long )maxdirs) + (sizeof(int ) & ~ ((unsigned long )maxdirs)) * (~ sizeof(int ) & (unsigned long )maxdirs));
    dirs = (int *)tmp___7;
  }
  while (*dir) {
    if ((*dir)->isdir) {
      if (xdev) {
        if (! ((int )((((dev - (*dir)->dev) | ((*dir)->dev - dev)) >> 31U) & 1U))) {
          goto _L___1;
        }
      } else {
        _L___1: 
        if ((*dir)->lnk) {
          if (lflag) {
            ...
            if (tmp___16) {
              ...
              tmp___9 = xmalloc(((tmp___8 | 1UL) + (tmp___8 | 1UL)) - (tmp___8 ^ 1UL));
              (*dir)->err = strcpy((char *)((char */* __restrict  */)tmp___9), (char const   *)((char const   */* __restrict  */)"recursive, not followed"));
            } else {
              saveino((*dir)->inode, (*dir)->dev);
              if (((unsigned int )(((((int )*((*dir)->lnk) - 47) + (((int )*((*dir)->lnk) - 47) >> 31)) ^ (((int )*((*dir)->lnk) - 47) >> 31)) - 1) >> 31U) & 1) {
                (*dir)->child = unix_getfulltree((*dir)->lnk, (lev - ~ 1UL) - 1UL,
                                                 dev, & (*dir)->size, & (*dir)->err);
              } else {
                tmp___13 = strlen((char const   *)d);
                tmp___14 = strlen((char const   *)(*dir)->lnk);
                if ((int )((((~ ((size_t___0 )pathsize___0) & ((((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL) + ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL)) - ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) ^ 2UL))) | ((~ ((size_t___0 )pathsize___0) | ((((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL) + ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL)) - ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) ^ 2UL))) & ((size_t___0 )pathsize___0 - ((((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL) + ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) | 2UL)) - ((((tmp___13 | tmp___14) + (tmp___13 | tmp___14)) - (tmp___13 ^ tmp___14)) ^ 2UL))))) >> 31UL) & 1UL)) {
                  tmp___10 = strlen((char const   *)d);
                  tmp___11 = strlen((char const   *)(*dir)->name);
                  pathsize___0 = (long )((((tmp___10 | tmp___11) + (tmp___10 & tmp___11)) | 1024UL) + (((tmp___10 | tmp___11) + (tmp___10 & tmp___11)) & 1024UL));
                ...
                (*dir)->child = unix_getfulltree(path___0, (lev - ~ 1UL) - 1UL, dev,
                                                 & (*dir)->size, & (*dir)->err);
              }
            }
          }
          ...
          if ((int )((((~ ((size_t___0 )pathsize___0) & ((((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) ^ ~ 2UL) + (((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL) + ((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL))) + 1UL)) | ((~ ((size_t___0 )pathsize___0) | ((((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) ^ ~ 2UL) + (((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL) + ((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL))) + 1UL)) & ((size_t___0 )pathsize___0 - ((((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) ^ ~ 2UL) + (((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL) + ((((tmp___20 ^ ~ tmp___21) + ((tmp___20 | tmp___21) + (tmp___20 | tmp___21))) + 1UL) | 2UL))) + 1UL)))) >> 31UL) & 1UL)) {
            tmp___17 = strlen((char const   *)d);
            tmp___18 = strlen((char const   *)(*dir)->name);
            pathsize___0 = (long )((((tmp___17 - ~ tmp___18) - 1UL) | 1024UL) + (((tmp___17 - ~ tmp___18) - 1UL) & 1024UL));
          ...
          saveino((*dir)->inode, (*dir)->dev);
          (*dir)->child = unix_getfulltree(path___0, ((lev ^ ~ 1UL) + ((lev | 1UL) << 1UL)) + 1UL,
                                           dev, & (*dir)->size, & (*dir)->err);
        }
        if (pruneflag) {
    ...
    if (duflag) {
      *size = (*size | (*dir)->size) + (*size & (*dir)->size);
    }
    dir ++;
  }
  if (topsort) {
  ...
  free((void *)path___0);
  if (((unsigned int )((n + (1 << 31)) - (((n + (1 << 31)) << 1) & ((n + (1 << 31)) >> 31))) >> 31U) & 1) {
    free_dir(sav);
    return ((struct _info **)((void *)0));
  }
  if ((unsigned long )ig != (unsigned long )((void *)0)) {
...
{ 
  ...
  {
  if ((int )(((unsigned long long )(((((*a)->mtime - (*b)->mtime) + (1LL << 63)) + ((((*a)->mtime - (*b)->mtime) + (1LL << 63)) >> 63LL)) ^ ((((*a)->mtime - (*b)->mtime) + (1LL << 63)) >> 63LL)) >> 63ULL) & 1LL)) {
    v = strcoll((char const   *)(*a)->name, (char const   *)(*b)->name);
    if (reverse) {
      tmp = ~ v + 1;
    } else {
  ...
  if ((int )(((unsigned long long )(~ (((*a)->mtime - (*b)->mtime) | ((*b)->mtime - (*a)->mtime))) >> 63ULL) & 1LL)) {
    v = 0;
  } else {
    if ((int )(((unsigned long long )((((((*b)->mtime - (*a)->mtime) & - ((*b)->mtime >= (*a)->mtime)) + (((*b)->mtime - (*a)->mtime) & - ((*b)->mtime >= (*a)->mtime))) & ((((*b)->mtime - (*a)->mtime) & - ((*b)->mtime >= (*a)->mtime)) >> 63LL)) - (((*b)->mtime - (*a)->mtime) & - ((*b)->mtime >= (*a)->mtime))) >> 63ULL) & 1LL)) {
      tmp___0 = -1;
    } else {
      tmp___0 = 1;
    }
...
{ 
  ...
  {
  if (((unsigned int )(postdir | ~ (- postdir)) >> 31U) & 1) {
    fprintf((FILE *)((FILE */* __restrict  */)outfile), (char const   *)((char const   */* __restrict  */)"\n"));
  }
  if (file) {
    if (file->comment) {
      infosize = 0;
      if (metafirst) {
        if (((unsigned int )(((((int )info___0[0] - 91) + (1 << 31)) ^ ((((int )info___0[0] - 91) + (1 << 31)) >> 31)) - ((((int )info___0[0] - 91) + (1 << 31)) >> 31)) >> 31U) & 1) {
          tmp = strlen((char const   *)(info___0));
          infosize = (int )(((tmp ^ ~ 2UL) + ((tmp | 2UL) + (tmp | 2UL))) + 1UL);
        } else {
          infosize = 0;
        }
      }
      ...
      *(dirs + (((level | 1) + (level | 1)) - (level ^ 1))) = 1;
      line = 0;
      while (((unsigned int )((line - lines) ^ ((line ^ lines) & ((line - lines) ^ line))) >> 31U) & 1) {
        if (metafirst) {
...
{ 
  ...
  {
  if (((unsigned int )((n - 2) ^ ((n ^ 2) & ((n - 2) ^ n))) >> 31U) & 1) {
    tmp = stderr;
  } else {
    tmp = stdout;
  }
  ...
  if (((unsigned int )(((((2 - n) & - (2 >= n)) >> 31) - ((2 - n) & - (2 >= n))) ^ (((2 - n) & - (2 >= n)) >> 31)) >> 31U) & 1) {
    return;
  }
...
{ 
  ...
  pprev = (char)0;
  if (bar) {
    if ((int )((((((unsigned long )bar - (unsigned long )pat) + (1UL << 31)) - (((((unsigned long )bar - (unsigned long )pat) + (1UL << 31)) + (((unsigned long )bar - (unsigned long )pat) + (1UL << 31))) & ((long )(((unsigned long )bar - (unsigned long )pat) + (1UL << 31)) >> 31L))) >> 31UL) & 1UL)) {
      return (-1);
    } else
    if (! *(bar + 1)) {
      return (-1);
  ...
  while (1) {
    ...
    case 91: 
    pat ++;
    if (((unsigned int )(((((int )*pat - 94) >> 31) - ((int )*pat - 94)) ^ (((int )*pat - 94) >> 31)) >> 31U) & 1) {
      n = 1;
      match = 0;
    } else {
      pat ++;
    ...
    while (((unsigned int )(((int )*pat - 93) | (93 - (int )*pat)) >> 31U) & 1) {
      if (((unsigned int )(((((int )*pat - 92) + (1 << 31)) ^ ((((int )*pat - 92) + (1 << 31)) >> 31)) - ((((int )*pat - 92) + (1 << 31)) >> 31)) >> 31U) & 1) {
        pat ++;
      }
      if (! *pat) {
        return (-1);
      }
      if (((unsigned int )(((((int )*(pat + 1) - 45) + (1 << 31)) ^ ((((int )*(pat + 1) - 45) + (1 << 31)) >> 31)) - ((((int )*(pat + 1) - 45) + (1 << 31)) >> 31)) >> 31U) & 1) {
        m = (int )*pat;
        pat += 2;
        if (((unsigned int )(~ (((int )*pat - 92) | (92 - (int )*pat))) >> 31U) & 1) {
          if (*pat) {
            pat ++;
          }
        }
        ...
        if (((unsigned int )(((int )tmp___1 | ~ ((int )tmp___0)) & (((int )tmp___1 ^ (int )tmp___0) | ~ ((int )tmp___0 - (int )tmp___1))) >> 31U) & 1) {
          tmp___2 = cond_lower(*buf___1);
          tmp___3 = cond_lower(*pat);
          if (((unsigned int )((~ ((int )tmp___2 ^ (int )tmp___3) >> 1) + ((int )tmp___2 & ~ ((int )tmp___3))) >> 31U) & 1) {
            match = n;
          }
        }
        if (! *pat) {
        ...
        if (((unsigned int )(((((int )tmp___4 - (int )tmp___5) + (1 << 31)) + ((((int )tmp___4 - (int )tmp___5) + (1 << 31)) >> 31)) ^ ((((int )tmp___4 - (int )tmp___5) + (1 << 31)) >> 31)) >> 31U) & 1) {
          match = n;
        }
      }
      pat ++;
    ...
    match = 0;
    if (((unsigned int )(~ (((int )*pat - 42) | (42 - (int )*pat))) >> 31U) & 1) {
      pat ++;
      if (! *pat) {
        return (1);
      }
      while (1) {
        ...
        if (((unsigned int )((((int )pprev - 47) + (1 << 31)) - (((((int )pprev - 47) + (1 << 31)) << 1) & ((((int )pprev - 47) + (1 << 31)) >> 31))) >> 31U) & 1) {
          if (((unsigned int )(((((int )*pat - 47) ^ (((int )*pat - 47) >> 31)) - (((int )*pat - 47) >> 31)) - 1) >> 31U) & 1) {
            if (*(pat + 1)) {
        ...
        while (1) {
          if (*buf___1) {
            if (! (((unsigned int )(((int )*buf___1 - 47) | (47 - (int )*buf___1)) >> 31U) & 1)) {
              break;
            }
          } else {
            break;
    ...
    tmp___8 = buf___1;
    buf___1 ++;
    match = ((unsigned int )(((((int )*tmp___8 - (int )*pat) + (((int )*tmp___8 - (int )*pat) >> 31)) ^ (((int )*tmp___8 - (int )*pat) >> 31)) - 1) >> 31U) & 1;
    break;
    case 92: 
    if (*pat) {
      pat ++;
    ...
    match = ((unsigned int )(((((int )tmp___10 - (int )tmp___11) + (((int )tmp___10 - (int )tmp___11) >> 31)) ^ (((int )tmp___10 - (int )tmp___11) >> 31)) - 1) >> 31U) & 1;
    break;
    }
    tmp___12 = pat;
    pat ++;
    pprev = *tmp___12;
    if (((unsigned int )((match & ~ 1) | (~ (match ^ 1) & (match - 1))) >> 31U) & 1) {
      return (match);
    }
  }
  if (! *buf___1) {
...
{ 
  ...
  if (dflag) {
    if ((int )((~ ((tot.dirs - 1UL) | (1UL - tot.dirs)) >> 31UL) & 1UL)) {
      tmp___0 = (char *)"y";
    } else {
      tmp___0 = (char *)"ies";
    }
    ...
    if ((int )((((((tot.dirs - 1UL) ^ ((long )(tot.dirs - 1UL) >> 31L)) - ((long )(tot.dirs - 1UL) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
      tmp___2 = (char *)"y";
    } else {
      tmp___2 = (char *)"ies";
    }
...
{ 
  ...
  {
  tmp = strlen((char const   *)s);
  e = (int )((tmp ^ 1UL) - ((~ tmp & 1UL) << 1UL));
  if (((unsigned int )(((((int )*(s + e) - 10) + (((int )*(s + e) - 10) >> 31)) ^ (((int )*(s + e) - 10) >> 31)) - 1) >> 31U) & 1) {
    e = (e & ~ 1) - (~ e & 1);
  }
  i = e;
  while (((unsigned int )(~ i) >> 31U) & 1) {
    if (((unsigned int )(((((int )*(s + i) - 32) + ((int )*(s + i) - 32)) & (((int )*(s + i) - 32) >> 31)) - ((int )*(s + i) - 32)) >> 31U) & 1) {
      break;
    }
    if (i) {
      if (((unsigned int )(((int )*(s + ((i ^ 1) - ((~ i & 1) + (~ i & 1)))) - 92) | (92 - (int )*(s + ((i ^ 1) - ((~ i & 1) + (~ i & 1)))))) >> 31U) & 1) {
        e = (e + ~ 1) + 1;
      }
    }
    i = (i & ~ 1) - (~ i & 1);
  }
  *(s + (((e ^ ~ 1) + ((e | 1) << 1)) + 1)) = (char )'\000';
  e = 0;
  i = e;
  while (((unsigned int )((int )*(s + i) | - ((int )*(s + i))) >> 31U) & 1) {
    if (((unsigned int )(((((int )*(s + i) - 92) ^ (((int )*(s + i) - 92) >> 31)) - (((int )*(s + i) - 92) >> 31)) - 1) >> 31U) & 1) {
      i = (i ^ 1) + ((i & 1) << 1);
    }
    tmp___0 = e;
    e = (e | 1) + (e & 1);
  ...
  *(buf___1 + n) = (char)0;
  ...
  if (gflag) {
    ...
    tmp___6 = sprintf((char *)((char */* __restrict  */)(buf___1 + n)), (char const   *)((char const   */* __restrict  */)" %-8.32s"),
                      tmp___5);
    n = (n | tmp___6) + (n & tmp___6);
  }
  if (sflag) {
    tmp___7 = psize(buf___1 + n, ent->size);
    n = ((n | tmp___7) + (n | tmp___7)) - (n ^ tmp___7);
  }
  if (Dflag) {
    if (cflag) {
      tmp___8 = ent->ctime;
    ...
    tmp___10 = sprintf((char *)((char */* __restrict  */)(buf___1 + n)), (char const   *)((char const   */* __restrict  */)" %s"),
                       tmp___9);
    n = ((n ^ ~ tmp___10) + ((n | tmp___10) << 1)) + 1;
  }
  if (((unsigned int )(~ (((int )*(buf___1 + 0) - 32) | (32 - (int )*(buf___1 + 0)))) >> 31U) & 1) {
    *(buf___1 + 0) = (char )'[';
...
{ 
  ...
  t = 0;
  while (ifmt[t]) {
    if ((int )(((((((mode_t )ifmt[t] - mt) + (1U << 31)) ^ ((int )(((mode_t )ifmt[t] - mt) + (1U << 31)) >> 31)) - ((int )(((mode_t )ifmt[t] - mt) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
      break;
    }
    t = ((t | 1) << 1) - (t ^ 1);
  }
...
{ 
  ...
  {
  i = 0;
  while (((unsigned int )(((((ipattern - i) & - (ipattern >= i)) >> 31) - ((ipattern - i) & - (ipattern >= i))) ^ (((ipattern - i) & - (ipattern >= i)) >> 31)) >> 31U) & 1) {
  ...
  if (file) {
    ...
    if (! nolinks) {
      ...
      if ((unsigned long )dirname != (unsigned long )((void *)0)) {
        tmp___0 = strlen((char const   *)dirname);
        len = (int )tmp___0;
        if (((unsigned int )((~ (htmldirlen ^ len) >> 1) + (htmldirlen & ~ len)) >> 31U) & 1) {
          tmp___1 = htmldirlen;
        } else {
          tmp___1 = 0;
        }
        ...
        if (((unsigned int )((1 & ~ descend) | (~ (1 ^ descend) & (1 - descend))) >> 31U) & 1) {
        ...
        if (((unsigned int )((((descend - 1) & - (descend >= 1)) >> 31) - (((descend - 1) & - (descend >= 1)) ^ (((descend - 1) & - (descend >= 1)) >> 31))) >> 31U) & 1) {
...
{ 
  ...
  if ((int )((~ (((unsigned long )p1 - (unsigned long )p2) | ((unsigned long )p2 - (unsigned long )p1)) >> 31UL) & 1UL)) {
    return (0);
  }
  tmp = p1;
  p1 ++;
  ...
  state = ((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) | (((unsigned int )(((tmp___1 >> 31) - tmp___1) ^ (tmp___1 >> 31)) >> 31U) & 1)) + ((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) & (((unsigned int )(((tmp___1 >> 31) - tmp___1) ^ (tmp___1 >> 31)) >> 31U) & 1));
  while (1) {
    diff = ((int )c1 ^ (int )c2) - ((~ ((int )c1) & (int )c2) + (~ ((int )c1) & (int )c2));
    if (((unsigned int )(((diff + (1 << 31)) ^ ((diff + (1 << 31)) >> 31)) - ((diff + (1 << 31)) >> 31)) >> 31U) & 1) {
      if (! (((unsigned int )(((int )c1 >> 31) - ((int )c1 ^ ((int )c1 >> 31))) >> 31U) & 1)) {
        break;
      }
    } else {
      break;
    ...
    state = (state & ~ ((((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) | (((unsigned int )(((unsigned int )tmp___4 >> 1U) - tmp___4) >> 31U) & 1)) << 1) - ((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) ^ (((unsigned int )(((unsigned int )tmp___4 >> 1U) - tmp___4) >> 31U) & 1)))) + ((((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) | (((unsigned int )(((unsigned int )tmp___4 >> 1U) - tmp___4) >> 31U) & 1)) << 1) - ((((unsigned int )(~ (((int )c1 - 48) | (48 - (int )c1))) >> 31U) & 1) ^ (((unsigned int )(((unsigned int )tmp___4 >> 1U) - tmp___4) >> 31U) & 1)));
  }
...
{ 
  ...
  if (siflag) {
    _L: 
    if ((int )(((unsigned long long )((size & ~ ((off_t )usize)) | (~ (size ^ (off_t )usize) & (size - (off_t )usize))) >> 63ULL) & 1LL)) {
      idx = 0;
    } else {
      idx = 1;
    }
    while ((int )(((unsigned long long )((~ ((off_t )((usize & usize) * (usize | usize) + (usize & ~ usize) * (~ usize & usize)) ^ size) >> 1LL) + ((off_t )((usize & usize) * (usize | usize) + (usize & ~ usize) * (~ usize & usize)) & ~ size)) >> 63ULL) & 1LL)) {
      idx = ((idx | 1) << 1) - (idx ^ 1);
      size /= (off_t )usize;
    }
    if (! idx) {
      ...
      if ((int )(((unsigned long long )((~ (10LL ^ size / (off_t )usize) >> 1LL) + (10LL & ~ (size / (off_t )usize))) >> 63ULL) & 1LL)) {
        tmp___2 = (char *)" %3.0f%c";
      } else {
        tmp___2 = (char *)" %3.1f%c";
      }
    ...
    if ((int )((((((sizeof(off_t ) - sizeof(long long )) ^ ((long )(sizeof(off_t ) - sizeof(long long )) >> 31L)) - ((long )(sizeof(off_t ) - sizeof(long long )) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
      tmp___4 = (char *)" %11lld";
    } else {
      tmp___4 = (char *)" %9lld";
    }
