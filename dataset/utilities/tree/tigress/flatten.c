...
/* Generated by Tigress v3.2 (https://tigress.wtf), 06:21:48-2023/04/21 */
  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      ...
      "New Externs": [
        ...
        "__builtin_fmodf", "__builtin_frame_address", "free", "getenv",
        "stderr", "fputs", "fprintf", "sprintf", "strcpy", "strcmp",
        "strtok", "strlen", "strcasecmp", "isatty", "qsort", "stdin",
        "fopen", "fclose", "fgets", "memset", "strchr", "isspace",
        "snprintf", "getpwuid", "getgrgid", "fputc", "putc", "isprint",
        "memcpy", "lstat", "isdigit", "atoi", "strtoul", "malloc", "realloc",
        "exit", "mbstowcs", "__ctype_get_mb_cur_max", "stdout", "printf",
        "time", "strftime", "localtime", "strncmp", "strcoll", "stat",
        "closedir", "opendir", "readdir", "tolower", "readlink", "getcwd",
        "setlocale", "nl_langinfo", "iswprint"
      ],
      "New Types": [
        "sorts", "wint_t", "nl_item", "DIR", "__dirstream", "dirent", "tm",
        "ssize_t", "wchar_t___0", "wchar_t", "listingcalls", "stat",
        ...
        "size_t", "__anonstruct_cmds_476363767", "linedraw", "extensions",
        "colortable", "bool", "__anonenum_bool_753424039", "u_short", "FILE",
        "_IO_FILE", "size_t___0"
      ],
...
/* BEGIN TYPEDEF wchar_t___0 LOC=/usr/local/bin/emcc-non-obf/llvm/build/lib/clang/16/include/stddef.h:74 */
typedef int wchar_t___0;
/* END TYPEDEF wchar_t___0 LOC=/usr/local/bin/emcc-non-obf/llvm/build/lib/clang/16/include/stddef.h:74 */
