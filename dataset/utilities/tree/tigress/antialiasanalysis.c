...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:27:36-2023/04/23 */
  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      "Modified Function Implementations": [
        "versort", "unix_newline", "unix_getfulltree", "uidtoname",
        "strverscmp", "split", "search", "saveino", "push_files", "psize",
        "print_color", "pop_infostack", "pop_filterstack", "patmatch",
        "patinclude", "patignore", "parse_dir_colors", "nextpc", "newent",
        "new_pattern", "new_comment", "mtimesort", "listdir",
        "json_printinfo", "json_close", "infocheck", "gnu_getcwd", "gittrim",
        "gidtoname", "getinfo", "getcharset", "fsizesort", "freefiletree",
        "free_dir", "fprune", "filtercheck", "fillinfo", "emit_tree",
        "do_date", "ctimesort", "cond_lower", "cmd", "alnumsort"
      ],
...
void *_3__functionPtrArray[]  = 
  {      & strcoll,      & strcoll - 791,      & strcmp,      & tolower, 
        & tolower + 459,      & strcoll,      & localtime,      & localtime - 835, 
        & strftime,      & strftime + 900,      & time,      & time + 598, 
        & strftime,      & strftime,      & strftime,      & strlen, 
        & strlen - 738,      & strlen,      & strlen + 27,      & lstat, 
        & saveino,      & stat2info,      & push_files,      & read_dir, 
        & read_dir - 514,      & sprintf,      & sprintf + 694,      & listdir, 
        & free_dir,      & free_dir + 281,      & pop_filterstack,      & pop_filterstack - 963, 
        & pop_infostack,      & pop_infostack + 503,      & sprintf,      & sprintf + 478, 
        & sprintf,      & prot,      & prot + 106,      & sprintf, 
        & sprintf - 821,      & uidtoname,      & sprintf,      & sprintf - 229, 
        & gidtoname,      & gidtoname + 499,      & sprintf,      & sprintf - 802, 
        & psize,      & do_date,      & sprintf,      & sprintf, 
        & sprintf - 304,      & sprintf,      & patmatch,      & patmatch + 445, 
        & sprintf,      & patmatch,      & patmatch + 300,      & sprintf, 
        & sprintf - 399,      & patmatch,      & sprintf,      & sprintf - 418, 
        & patmatch,      & patinclude,      & patignore,      & patignore - 402, 
        & patinclude,      & fprune,      & freefiletree,      & xmalloc, 
        & xmalloc + 331,      & qsort,      & free,      & free, 
        & free,      & free,      & free - 483,      & freefiletree, 
        & freefiletree - 571,      & free,      & free + 611,      & sizecmp, 
        & sizecmp + 348,      & strcoll,      & strcoll - 606,      & getenv, 
        & getenv - 110,      & xmalloc,      & xmalloc + 472,      & lstat, 
        & lstat + 183,      & stat,      & stat + 102,      & memset, 
        & filtercheck,      & patinclude,      & patinclude - 398,      & patignore, 
        & xmalloc,      & memset,      & strlen,      & strlen + 523, 
        & xmalloc,      & strcpy,      & xrealloc,      & xrealloc - 521, 
        & readlink,      & readlink - 579,      & strlen,      & xmalloc, 
        & xmalloc + 527,      & strcpy,      & strlen,      & xmalloc, 
        & strcpy,      & xmalloc,      & getgrgid,      & getgrgid + 800, 
        & strlen,      & strlen - 974,      & xmalloc,      & xmalloc - 423, 
        & strcpy,      & strcpy - 470,      & snprintf,      & snprintf + 366, 
        & strlen,      & strlen - 880,      & xmalloc,      & xmalloc + 398, 
        & strcpy,      & strcpy - 277,      & strlen,      & strlen + 563, 
        & xmalloc,      & getcwd,      & getcwd + 324,      & free, 
        & free - 404,      & xmalloc,      & xmalloc - 58,      & patmatch, 
        & patmatch - 374,      & patmatch,      & json_indent,      & json_indent + 244, 
        & fprintf,      & json_indent,      & json_indent - 882,      & fprintf, 
        & strlen,      & strlen - 639,      & strlen,      & strlen + 59, 
        & qsort,      & qsort + 728,      & xmalloc,      & xmalloc + 835, 
        & sprintf,      & sprintf + 138,      & sprintf,      & sprintf + 31, 
        & findino,      & findino + 756,      & saveino,      & strcmp, 
        & sprintf,      & sprintf - 757,      & sprintf,      & sprintf - 123, 
        & sprintf,      & sprintf - 85,      & strlen,      & strlen - 467, 
        & xmalloc,      & xmalloc + 55,      & xmalloc,      & xmalloc - 281, 
        & memcpy,      & memcpy - 18,      & sprintf,      & sprintf - 253, 
        & setoutput,      & setoutput + 559,      & emit_tree,      & free, 
        & fclose,      & memcpy,      & free,      & free - 515, 
        & push_files,      & read_dir,      & sprintf,      & free_dir, 
        & free_dir - 118,      & listdir,      & free_dir,      & free_dir + 628, 
        & pop_filterstack,      & pop_infostack,      & free,      & strcoll, 
        & xmalloc,      & xmalloc + 681,      & xmalloc,      & xmalloc - 190, 
        & xmalloc,      & strlen,      & strlen + 896,      & xmalloc, 
        & xmalloc - 91,      & strcpy,      & strcpy + 53,      & strchr, 
        & xmalloc,      & memset,      & memset - 836,      & strlen, 
        & xmalloc,      & strcpy,      & strcpy + 479,      & strchr, 
        & strchr,      & strchr + 232,      & getenv,      & getenv, 
        & getenv,      & getenv - 140,      & getenv,      & getenv, 
        & strlen,      & isatty,      & strlen,      & xmalloc, 
        & strcpy,      & split,      & split + 557,      & split, 
        & split + 9,      & cmd,      & xmalloc,      & strlen, 
        & xmalloc,      & strcpy,      & strlen,      & xmalloc, 
        & strcpy,      & strcpy - 486,      & strcasecmp,      & strlen, 
        & strlen + 652,      & xmalloc,      & strcpy,      & strcpy - 225, 
        & free,      & free,      & free + 10,      & strlen, 
        & strlen - 693,      & xmalloc,      & strcpy,      & strlen, 
        & xmalloc,      & strcpy,      & strlen,      & xmalloc, 
        & strcpy,      & sprintf,      & sprintf - 207,      & strlen, 
        & strlen + 796,      & xmalloc,      & xmalloc + 480,      & strcpy, 
        & strcpy - 544,      & free,      & free - 917,      & patmatch, 
        & patmatch + 171,      & patmatch,      & strchr,      & patmatch, 
        & patmatch + 535,      & patmatch,      & patmatch + 242,      & strchr, 
        & strchr + 373,      & patmatch,      & patmatch,      & patmatch - 597, 
        & patmatch,      & patmatch,      & patmatch,      & patmatch + 337, 
        & free,      & free + 23,      & free,      & free - 103, 
        & free,      & free + 490,      & free,      & free, 
        & free,      & free - 998,      & free,      & free, 
        & free - 343,      & free,      & free - 800,      & free, 
        & free + 933,      & fputs,      & fputs,      & fputs, 
        & sprintf,      & sprintf,      & sprintf,      & sprintf - 338, 
        & new_ignorefile,      & push_filterstack,      & new_infofile,      & new_infofile + 16, 
        & push_infostack,      & push_infostack + 170,      & xmalloc,      & xmalloc + 563, 
        & newent,      & newent + 920,      & strcmp,      & newent, 
        & xmalloc,      & xmalloc + 324,      & strtok,      & xrealloc, 
        & xrealloc - 404,      & strtok,      & strtok + 176,      & isdigit, 
        & isdigit,      & isdigit,      & isdigit - 0,      & isdigit, 
        & isdigit,      & isdigit + 748,      & isdigit,      & xmalloc, 
        & xmalloc + 592,      & getpwuid,      & strlen,      & strlen + 914, 
        & xmalloc,      & strcpy,      & strcpy + 140,      & snprintf, 
        & snprintf - 447,      & strlen,      & strlen - 30,      & xmalloc, 
        & xmalloc - 853,      & strcpy,      & stat,      & stat - 834, 
        & strlen,      & strlen,      & patinclude,      & push_files, 
        & read_dir,      & strlen,      & strlen + 899,      & xmalloc, 
        & xmalloc + 172,      & strcpy,      & free_dir,      & free_dir + 571, 
        & xmalloc,      & sprintf,      & strlen,      & strlen + 321, 
        & xmalloc,      & strcpy,      & strcpy - 736,      & free_dir, 
        & free_dir - 592,      & free,      & free + 272,      & xrealloc, 
        & xrealloc + 899,      & findino,      & strlen,      & xmalloc, 
        & strcpy,      & strcpy - 919,      & saveino,      & saveino + 303, 
        & unix_getfulltree,      & unix_getfulltree + 459,      & strlen,      & strlen - 339, 
        & strlen,      & strlen,      & strlen,      & xrealloc, 
        & strcmp,      & sprintf,      & sprintf + 785,      & sprintf, 
        & sprintf + 768,      & sprintf,      & unix_getfulltree,      & unix_getfulltree + 61, 
        & strlen,      & strlen - 383,      & strlen,      & strlen, 
        & strlen,      & xrealloc,      & strcmp,      & strcmp - 885, 
        & sprintf,      & sprintf,      & sprintf - 158,      & sprintf, 
        & saveino,      & unix_getfulltree,      & patinclude,      & patinclude - 221, 
        & free,      & free,      & free,      & qsort, 
        & qsort + 54,      & free,      & free_dir,      & pop_filterstack, 
        & pop_infostack,      & fprintf,      & strlen,      & printf, 
        & printf - 867,      & indent,      & printcomment,      & strverscmp, 
        & strverscmp + 299};
...
{ 
  ...
  tmp = ((char *(*)(char const   * , int  ))_3__functionPtrArray[223 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)file_pathsep,
                                                                                                                              (int )*(*p));
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 0 : 155] = _3__functionPtrArray[51];
  ...
  while (1) {
    if (*(*p)) {
      tmp___0 = ((char *(*)(char const   * , int  ))_3__functionPtrArray[224 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)file_pathsep,
                                                                                                                                                                                           (int )*(*p));
...
{ 
  ...
  {
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 216 : 7])(sizeof(struct _info ));
  n = (struct _info *)tmp;
  ((void *(*)(void * , int  , size_t___0  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 217 & 10 : 217])((void *)n,
                                                                                                                                     0,
                                                                                                                                     sizeof(struct _info ));
  _3__functionPtrArray[60 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[84];
  tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[219 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)name);
  tmp___1 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[220 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___0 + 1UL);
  n->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[221 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)tmp___1),
                                                                                                                                                                                         (char const   *)((char const   */* __restrict  */)name));
  _3__functionPtrArray[4 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[210];
...
{ 
  ...
  {
  size = 100;
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[136 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((size_t___0 )size);
  buffer = (char *)tmp;
  while (1) {
    tmp___0 = ((char *(*)(char * , size_t___0  ))_3__functionPtrArray[137 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(buffer,
                                                                                                                                                                                        (size_t___0 )size);
    value = tmp___0;
    ...
    size *= 2;
    ((void (*)(void * ))_3__functionPtrArray[139 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)buffer);
    tmp___1 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[141 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((size_t___0 )size);
    _3__functionPtrArray[142 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[83];
    buffer = (char *)tmp___1;
  }
}
}
...
{ 
  ...
  if (siflag) {
    ...
    if (! idx) {
      tmp___1 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[316 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)buf___1),
                                                                                                                                                                                                 (char const   *)((char const   */* __restrict  */)" %4d"),
                                                                                                                                                                                                 (int )size);
      _3__functionPtrArray[191 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[184];
      return (tmp___1);
    } else {
      ...
      tmp___3 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[317 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)buf___1),
                                                                                                                                          (char const   *)((char const   */* __restrict  */)tmp___2),
                                                                                                                                          (double )((float )size / (float )usize),
                                                                                                                                          (int )*(unit + idx));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 10] = _3__functionPtrArray[151];
      return (tmp___3);
    }
  } else {
    ...
    tmp___5 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 318 : 318 << 1])((char *)((char */* __restrict  */)buf___1),
                                                                                                                                                 (char const   *)((char const   */* __restrict  */)tmp___4),
                                                                                                                                                 size);
    return (tmp___5);
  }
}
...
{ 
  ...
  while (*(dirname + i)) {
    if (fflag) {
      tmp = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 15 : 10])((char const   *)*(dirname + i));
      j = (int )tmp;
      while (1) {
        if (j > 1) {
    ...
    if (Hflag) {
      tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[17 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(dirname + i));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 << i : 11] = _3__functionPtrArray[17];
      htmldirlen = (int )tmp___0;
    }
    n = ((int (*)(char const   * , struct stat * ))_3__functionPtrArray[19 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)((char const   */* __restrict  */)*(dirname + i)),
                                                                                                                                  (struct stat *)((struct stat */* __restrict  */)(& st)));
    _3__functionPtrArray[11 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & tmp;
    if (n >= 0) {
      ((void (*)(ino_t inode , dev_t device ))_3__functionPtrArray[20 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(st.st_ino,
                                                                                                                             st.st_dev);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 7 : needsclosed] = _3__functionPtrArray[5];
      info___1 = ((struct _info *(*)(struct stat *st ))_3__functionPtrArray[21 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(& st);
      _3__functionPtrArray[18 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[5];
      ...
      if (needfulltree) {
        ...
        ((void (*)(char *dir , struct ignorefile **ig , struct infofile **inf ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 22 : i])(*(dirname + i),
                                                                                                                                                                 & ig,
                                                                                                                                                                 & inf);
        dir = ((struct _info **(*)(char *dir , int *n , int infotop ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 23 ^ tmp___1 : 23])(*(dirname + i),
                                                                                                                                                                  & n,
                                                                                                                                                                  (unsigned long )inf != (unsigned long )((void *)0));
      }
    ...
    if (flimit > 0) {
      if (n > flimit) {
        ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[25 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(errbuf)),
                                                                                                                                   (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
                                                                                                                                   n);
        (*(lc.error))(errbuf);
        (*(lc.newline))(info___1, 0, 0, (unsigned long )*(dirname + (i + 1)) != (unsigned long )((void *)0));
        errors ++;
      ...
      if (dir) {
        tot = ((struct totals (*)(char *dirname , struct _info **dir , int lev , dev_t dev ,
                                  bool hasfulltree ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 27 : 27 | n])(*(dirname + i),
                                                                                                                                           dir,
                                                                                                                                           1,
                                                                                                                                           st.st_dev,
                                                                                                                                           needfulltree);
    ...
    if (dir) {
      ((void (*)(struct _info **d ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 28 : 2])(dir);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 >> n : 11] = _3__functionPtrArray[8];
      dir = (struct _info **)((void *)0);
    }
    if (needsclosed) {
    ...
    if ((unsigned long )ig != (unsigned long )((void *)0)) {
      ig = ((struct ignorefile *(*)(void))_3__functionPtrArray[30 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])();
    }
    if ((unsigned long )inf != (unsigned long )((void *)0)) {
      inf = ((struct infofile *(*)(void))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 32 + 8 : 32])();
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : i] = _3__functionPtrArray[9];
    }
    i ++;
  }
  if (! noreport) {
...
{ 
  ...
  while (1) {
    ...
    tmp = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 53])((char *)((char */* __restrict  */)(fpattern)),
                                                                                                                                     (char const   *)((char const   */* __restrict  */)"%s/"),
                                                                                                                                     ig->path);
    fpos = tmp;
    p = ig->remove;
    while ((unsigned long )p != (unsigned long )((void *)0)) {
      if (p->relative) {
        tmp___0 = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[54 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(name,
                                                                                                                                                                                                          p->pattern,
                                                                                                                                                                                                          isdir);
        _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[34];
        if (tmp___0 == 1) {
          filter = 1;
          break;
        }
      } else {
        ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[56 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(fpattern + fpos)),
                                                                                                                                 (char const   *)((char const   */* __restrict  */)"%s"),
                                                                                                                                 p->pattern);
        tmp___1 = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 57 : 4])(path___0,
                                                                                                                                                     fpattern,
                                                                                                                                                     isdir);
        _3__functionPtrArray[(_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[42];
        if (tmp___1 == 1) {
          filter = 1;
          break;
        }
  ...
  ig = filterstack;
  while (ig) {
    tmp___2 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 59 | 10 : 59])((char *)((char */* __restrict  */)(fpattern)),
                                                                                                                                               (char const   *)((char const   */* __restrict  */)"%s/"),
                                                                                                                                               ig->path);
    _3__functionPtrArray[47 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[40];
    fpos___0 = tmp___2;
    p = ig->reverse;
    while ((unsigned long )p != (unsigned long )((void *)0)) {
      if (p->relative) {
        tmp___3 = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[61 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(name,
                                                                                                                                                                                                          p->pattern,
                                                                                                                                                                                                          isdir);
        _3__functionPtrArray[38 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[52];
        if (tmp___3 == 1) {
          return (0);
        }
      } else {
        ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[62 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(fpattern + fpos___0)),
                                                                                                                                 (char const   *)((char const   */* __restrict  */)"%s"),
                                                                                                                                 p->pattern);
        _3__functionPtrArray[16 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[40];
        tmp___4 = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[64 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(path___0,
                                                                                                                                                   fpattern,
                                                                                                                                                   isdir);
        if (tmp___4 == 1) {
          return (0);
...
{ 
  ...
  htmldescend = 0;
  tmp = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___2 : 152])((char const   *)dirname);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : 8] = _3__functionPtrArray[68];
  dirlen = (int )tmp;
  pathlen = dirlen + 257;
  err = (char *)((void *)0);
  tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[154 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)dirname);
  _3__functionPtrArray[125 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & tmp;
  ...
  if (topsort) {
    ((void (*)(void * , unsigned long  , unsigned long  , int (*)(void const   * ,
                                                                  void const   * ) ))_3__functionPtrArray[156 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)dir,
                                                                                                                                                                                                                            (size_t___1 )n,
                                                                                                                                                                                                                            sizeof(struct _info *),
                                                                                                                                                                                                                            (int (*)(void const   * ,
                                                                                                                                                                                                                                     void const   * ))topsort);
  ...
  tmp___1 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 158 : pathlen])(sizeof(char ) * (unsigned long )pathlen);
  _3__functionPtrArray[88 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[46];
  path___0 = (char *)tmp___1;
  while ((unsigned long )*dir != (unsigned long )((void *)0)) {
    (*(lc.printinfo))(dirname, *dir, lev);
    if (es) {
      ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 160 + pathlen : 160])((char *)((char */* __restrict  */)path___0),
                                                                                                                                              (char const   *)((char const   */* __restrict  */)"%s%s"),
                                                                                                                                              dirname,
                                                                                                                                              (*dir)->name);
    } else {
      ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 162 : needsclosed])((char *)((char */* __restrict  */)path___0),
                                                                                                                                            (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                            dirname,
                                                                                                                                            (*dir)->name);
      _3__functionPtrArray[112 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[75];
    }
    if (fflag) {
      filename = path___0;
    } else {
    ...
    if ((*dir)->isdir) {
      (tot.dirs) ++;
      found = ((int (*)(ino_t inode , dev_t device ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 164 : 3])((*dir)->inode,
                                                                                                                                       (*dir)->dev);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? es : 16] = _3__functionPtrArray[158];
      if (! found) {
        ((void (*)(ino_t inode , dev_t device ))_3__functionPtrArray[166 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((*dir)->inode,
                                                                                                                                                                                       (*dir)->dev);
        _3__functionPtrArray[121 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[102];
      }
      if (xdev) {
        if (! (dev != (*dir)->dev)) {
          goto _L___0;
      ...
      if ((*dir)->lnk) {
        if (lflag) {
          ...
          if ((*dir)->lnk) {
            ...
            if (fflag) {
              tmp___2 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[167 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)dirname,
                                                                                                                                                      "/");
              _3__functionPtrArray[103 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[84];
              if (tmp___2) {
                ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[168 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)path___0),
                                                                                                                                          (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                          dirname,
                                                                                                                                          (*dir)->lnk);
                _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 72 : 72 | 3] = _3__functionPtrArray[26];
              } else {
                ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 170 << 4 : 170])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                   (char const   *)((char const   */* __restrict  */)"%s%s"),
                                                                                                                                                   dirname,
                                                                                                                                                   (*dir)->lnk);
              }
            } else {
              ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 172 : 7])((char *)((char */* __restrict  */)path___0),
                                                                                                                                          (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                          dirname,
                                                                                                                                          (*dir)->lnk);
            }
          ...
          if (Level >= 0) {
            if (lev > Level) {
              if (Rflag) {
                ...
                paths[0] = newpath;
                paths[1] = (char *)((void *)0);
                tmp___3 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 174 : 174 | needsclosed])((char const   *)newpath);
                tmp___4 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 176 << tmp___6 : 176])(tmp___3 + 13UL);
                _3__functionPtrArray[86 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[1];
                output = (char *)tmp___4;
                tmp___5 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[178 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(sizeof(int ) * (unsigned long )(lev + 2));
                dirsave = (int *)tmp___5;
                ((void *(*)(void * __restrict   , void const   * __restrict   , size_t___0  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 180 >> dirlen : 180])((void */* __restrict  */)dirsave,
                                                                                                                                                                                            (void const   */* __restrict  */)dirs,
                                                                                                                                                                                            sizeof(int ) * (unsigned long )(lev + 1));
                ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[182 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)output),
                                                                                                                                                                                                 (char const   *)((char const   */* __restrict  */)"%s/00Tree.html"),
                                                                                                                                                                                                 newpath);
                ((void (*)(char *filename ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 184 : descend])(output);
                _3__functionPtrArray[107 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[95];
                ((void (*)(char **dirname , bool needfulltree ))_3__functionPtrArray[186 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(paths,
                                                                                                                                                hasfulltree);
                ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 187])((void *)output);
                _3__functionPtrArray[16 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[2];
                ((int (*)(FILE * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 188 : lev])(outfile);
                _3__functionPtrArray[33 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[184];
                outfile = outsave;
                ((void *(*)(void * __restrict   , void const   * __restrict   , size_t___0  ))_3__functionPtrArray[189 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void */* __restrict  */)dirs,
                                                                                                                                                                                                                                     (void const   */* __restrict  */)dirsave,
                                                                                                                                                                                                                                     sizeof(int ) * (unsigned long )(lev + 1));
                _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 171 : lev] = _3__functionPtrArray[135];
                ((void (*)(void * ))_3__functionPtrArray[190 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)dirsave);
                htmldescend = 10;
              } else {
                htmldescend = 0;
              }
          ...
          if (descend) {
            if (hasfulltree) {
              ...
              ((void (*)(char *dir , struct ignorefile **ig , struct infofile **inf ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 3 : 192])(newpath,
                                                                                                                                                                        & ig,
                                                                                                                                                                        & inf);
              subdir = ((struct _info **(*)(char *dir , int *n , int infotop ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 193 : 2])(newpath,
                                                                                                                                                                 & n,
                                                                                                                                                                 (unsigned long )inf != (unsigned long )((void *)0));
              if (! subdir) {
                if (n) {
              ...
              if (flimit > 0) {
                if (n > flimit) {
                  err = errbuf;
                  ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[194 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)err),
                                                                                                                                              (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
                                                                                                                                              n);
                  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 144 * 6] = & lev;
                  errors ++;
                  ((void (*)(struct _info **d ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 195 & es : 195])(subdir);
                  _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[109];
                  subdir = (struct _info **)((void *)0);
                }
              }
            }
    ...
    if (descend) {
      ...
      subtotal = ((struct totals (*)(char *dirname , struct _info **dir , int lev ,
                                     dev_t dev , bool hasfulltree ))_3__functionPtrArray[197 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(newpath,
                                                                                                                                                                                                           subdir,
                                                                                                                                                                                                           lev + 1,
                                                                                                                                                                                                           dev,
                                                                                                                                                                                                           hasfulltree);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 58 : 58 - dirlen] = _3__functionPtrArray[130];
    ...
    if (subdir) {
      ((void (*)(struct _info **d ))_3__functionPtrArray[198 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(subdir);
      subdir = (struct _info **)((void *)0);
    }
    if (needsclosed) {
      if (descend) {
    ...
    tot.size += (*dir)->size;
    if ((unsigned long )ig != (unsigned long )((void *)0)) {
      ig = ((struct ignorefile *(*)(void))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 200 : dirlen])();
      _3__functionPtrArray[90 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[137];
    }
    if ((unsigned long )inf != (unsigned long )((void *)0)) {
      inf = ((struct infofile *(*)(void))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 201 : 8])();
      _3__functionPtrArray[9 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[192];
    }
    dir ++;
  }
  *(dirs + lev) = 0;
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 202 : 202 * es])((void *)path___0);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2] = _3__functionPtrArray[14];
  return (tot);
}
}
...
{ 
  ...
  {
  match = 1;
  tmp = ((char *(*)(char const   * , int  ))_3__functionPtrArray[282 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)pat,
                                                                                                                            '|');
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? n : 159] = _3__functionPtrArray[4];
  bar = tmp;
  pprev = (char)0;
  if (bar) {
    ...
    *bar = (char )'\000';
    match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 283 : m])(buf___1,
                                                                                                                                                pat,
                                                                                                                                                isdir);
    _3__functionPtrArray[175 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[175];
    if (! match) {
      match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 285 : 285 - 2])(buf___1,
                                                                                                                                                        bar + 1,
                                                                                                                                                        isdir);
      _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[29];
    }
    *bar = (char )'|';
    return (match);
  }
  while (1) {
    ...
    pat ++;
    if (! *pat) {
      tmp___6 = ((char *(*)(char const   * , int  ))_3__functionPtrArray[287 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)buf___1,
                                                                                                                                    '/');
    ...
    if ((int )*pat == 42) {
      ...
      while (1) {
        if (*buf___1) {
          match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[289 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(buf___1,
                                                                                                                                                      pat,
                                                                                                                                                      isdir);
          _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 109 << n : 109] = _3__functionPtrArray[188];
          if (match) {
            break;
          }
        } else {
        ...
        if ((int )pprev == 47) {
          if ((int )*pat == 47) {
            if (*(pat + 1)) {
              match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 290 : 290 & 9])(buf___1,
                                                                                                                                                                pat + 1,
                                                                                                                                                                isdir);
              _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 150 : 150 | match] = _3__functionPtrArray[93];
              if (match) {
                return (match);
              }
            }
      ...
      while (1) {
        if (*buf___1) {
          tmp___7 = buf___1;
          buf___1 ++;
          match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[292 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(tmp___7,
                                                                                                                                                    pat,
                                                                                                                                                    isdir);
          _3__functionPtrArray[210 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[231];
          if (match) {
            break;
          }
        } else {
    ...
    if (! match) {
      if (! *buf___1) {
        match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 293])(buf___1,
                                                                                                                                                    pat,
                                                                                                                                                    isdir);
        _3__functionPtrArray[103 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[38];
      } else
      if ((int )*buf___1 == 47) {
        match = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 294])(buf___1,
                                                                                                                                                    pat,
                                                                                                                                                    isdir);
      }
    }
...
{ 
  ...
  {
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 204 : lines])(sizeof(struct comment ));
  _3__functionPtrArray[92 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[34];
  com = (struct comment *)tmp;
  com->pattern = phead;
  tmp___0 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[206 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(char *) * (unsigned long )(lines + 1));
...
{ 
  ...
  {
  if (gitignore) {
    *ig = ((struct ignorefile *(*)(char *path___0 ))_3__functionPtrArray[320 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(dir);
    if ((unsigned long )*ig != (unsigned long )((void *)0)) {
      ((void (*)(struct ignorefile *ig ))_3__functionPtrArray[321 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(*ig);
    }
  }
  if (showinfo) {
    *inf = ((struct infofile *(*)(char *path___0 ))_3__functionPtrArray[322 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(dir);
    if ((unsigned long )*inf != (unsigned long )((void *)0)) {
      ((void (*)(struct infofile *inf ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 9 : 324])(*inf);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 165 : 165 & 3] = _3__functionPtrArray[62];
    }
  }
  return;
}
...
{ 
  ...
  while ((unsigned long )ent != (unsigned long )((void *)0)) {
    ...
    if (show) {
      if (! matched) {
        if (! ent->isdir) {
          if (pattern) {
            tmp = ((int (*)(char *name , int isdir ))_3__functionPtrArray[65 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(ent->name,
                                                                                                                                                                                           0);
            if (! tmp) {
              show = 0;
            }
          ...
          if (ipattern) {
            tmp___0 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[66 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(ent->name,
                                                                                                                                                                                               0);
            _3__functionPtrArray[40 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[60];
            if (tmp___0) {
              show = 0;
            }
          }
        ...
        if (ent->isdir) {
          if (show) {
            if (matchdirs) {
              if (pattern) {
                tmp___1 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[68 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(ent->name,
                                                                                                                                              1);
                if (tmp___1) {
                  matched = (bool )1;
                }
    ...
    if (show) {
      if ((unsigned long )ent->tchild != (unsigned long )((void *)0)) {
        ent->child = ((struct _info **(*)(struct _info *head , bool matched , bool root ))_3__functionPtrArray[69 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(ent->tchild,
                                                                                                                                                                         matched,
                                                                                                                                                                         (bool )0);
        _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : tmp___0] = _3__functionPtrArray[37];
      }
    }
    t = ent;
    ent = ent->next;
    if (show) {
      ...
      ((void (*)(struct _info *ent ))_3__functionPtrArray[70 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(t);
      _3__functionPtrArray[29 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[58];
    }
  }
  if (end) {
    end->next = (struct _info *)((void *)0);
  }
  tmp___3 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[71 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sizeof(struct _info *) * (unsigned long )(count + 1));
  _3__functionPtrArray[(_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[11];
  ...
  *(dir + count) = (struct _info *)((void *)0);
  if (topsort) {
    ((void (*)(void * , unsigned long  , unsigned long  , int (*)(void const   * ,
                                                                  void const   * ) ))_3__functionPtrArray[73 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)dir,
                                                                                                                                                                    (size_t___1 )count,
                                                                                                                                                                    sizeof(struct _info *),
                                                                                                                                                                    (int (*)(void const   * ,
                                                                                                                                                                             void const   * ))topsort);
...
{ 
  ...
  {
  if (! noindent) {
    ((void (*)(int maxlevel ))_3__functionPtrArray[149 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(level);
    _3__functionPtrArray[55 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[120];
  }
  if (file->lnk) {
    mt = file->mode & 61440U;
  } else {
  ...
  ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 151])((FILE *)((FILE */* __restrict  */)outfile),
                                                                                                                              (char const   *)((char const   */* __restrict  */)"{\"type\":\"%s\""),
                                                                                                                              ftype[t]);
  return (0);
}
}
...
{ 
  ...
  {
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 208])(sizeof(struct pattern ));
  ...
  tmp___2 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 209 : 209 - tmp___0])((char const   *)(pattern___0 + tmp___1));
  _3__functionPtrArray[179 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[156];
  tmp___3 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 211])(tmp___2 + 1UL);
  _3__functionPtrArray[199 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[76];
  p->pattern = ((char *(*)(char * , char const   * ))_3__functionPtrArray[213 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___3),
                                                                                                                                     (char const   *)((char const   */* __restrict  */)(pattern___0 + tmp___0)));
  tmp___4 = ((char *(*)(char const   * , int  ))_3__functionPtrArray[215 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)pattern___0,
                                                                                                                                '/');
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 109 : tmp___1] = _3__functionPtrArray[159];
...
{ 
  ...
  while ((unsigned long )inf != (unsigned long )((void *)0)) {
    ...
    while ((unsigned long )com != (unsigned long )((void *)0)) {
      p = com->pattern;
      while ((unsigned long )p != (unsigned long )((void *)0)) {
        tmp = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 143 >> top : 143])(path___0,
                                                                                                                                                           p->pattern,
                                                                                                                                                           isdir);
        _3__functionPtrArray[55 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[99];
        if (tmp == 1) {
          return (com);
        }
        if (top) {
          tmp___0 = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[145 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(name,
                                                                                                                                                                                                             p->pattern,
                                                                                                                                                                                                             isdir);
          if (tmp___0 == 1) {
            return (com);
...
{ 
  ...
  *err = (char *)((void *)0);
  ...
  if (xdev) {
    if (lev == 0UL) {
      ((int (*)(char const   * __restrict   , struct stat * __restrict   ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 3 : 362])((char const   */* __restrict  */)d,
  ...
  if (matchdirs) {
    if (pattern) {
      lev_tmp = lev;
      tmp = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 364 * 9 : 364])((char const   *)d);
      _3__functionPtrArray[109 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[189];
      start_rel_path = d + tmp;
      tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 365 : 6])((char const   *)d);
      ...
      if (*start_rel_path) {
        tmp___1 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[366 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(start_rel_path,
                                                                                                                                                                                            1);
        if (tmp___1) {
          tmp_pattern = pattern;
          pattern = 0;
  ...
  ((void (*)(char *dir , struct ignorefile **ig , struct infofile **inf ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 367 << 10 : 367])(d,
                                                                                                                                                                    & ig,
                                                                                                                                                                    & inf);
  dir = ((struct _info **(*)(char *dir , int *n , int infotop ))_3__functionPtrArray[368 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(d,
                                                                                                                                                  & n,
                                                                                                                                                  (unsigned long )inf != (unsigned long )((void *)0));
  sav = dir;
  if (tmp_pattern) {
  ...
  if ((unsigned long )dir == (unsigned long )((void *)0)) {
    if (n) {
      tmp___2 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[369 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("error opening dir");
      tmp___3 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[371 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(tmp___2 + 1UL);
      _3__functionPtrArray[94 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[116];
      *err = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 373 : 373 & tmp___15])((char *)((char */* __restrict  */)tmp___3),
                                                                                                                                                  (char const   *)((char const   */* __restrict  */)"error opening dir"));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 52 ^ tmp___16 : 52] = _3__functionPtrArray[357];
      errors ++;
      return ((struct _info **)((void *)0));
    }
  }
  if (n == 0) {
    if ((unsigned long )sav != (unsigned long )((void *)0)) {
      ((void (*)(struct _info **d ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 374 : tmp___15])(sav);
      _3__functionPtrArray[127 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[149];
    }
    return ((struct _info **)((void *)0));
  }
  pathsize___0 = 4096L;
  tmp___4 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 376 : 376 * tmp___15])((size_t___0 )pathsize___0);
  _3__functionPtrArray[299 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[374];
  path___0 = (char *)tmp___4;
  if (flimit > 0) {
    if (n > flimit) {
      ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[377 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                                                       (char const   *)((char const   */* __restrict  */)"%d entries exceeds filelimit, not opening dir"),
                                                                                                                                                                                       n);
      tmp___5 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[378 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)path___0);
      _3__functionPtrArray[181 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[261];
      tmp___6 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___23 : 380])(tmp___5 + 1UL);
      _3__functionPtrArray[11 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & size;
      *err = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 381 : tmp___23])((char *)((char */* __restrict  */)tmp___6),
                                                                                                                                            (char const   *)((char const   */* __restrict  */)path___0));
      ((void (*)(struct _info **d ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 383 : 9])(sav);
      ((void (*)(void * ))_3__functionPtrArray[385 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)path___0);
      _3__functionPtrArray[63 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[47];
      return ((struct _info **)((void *)0));
    }
  }
  if (lev >= (u_long )(maxdirs - 1)) {
    maxdirs += 1024;
    tmp___7 = ((void *(*)(void *ptr , size_t___0 size ))_3__functionPtrArray[387 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)dirs,
                                                                                                                                          sizeof(int ) * (unsigned long )maxdirs);
    _3__functionPtrArray[150 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & tmp___6;
    dirs = (int *)tmp___7;
  }
  while (*dir) {
    if ((*dir)->isdir) {
      if (xdev) {
        ...
        if ((*dir)->lnk) {
          if (lflag) {
            tmp___16 = ((int (*)(ino_t inode , dev_t device ))_3__functionPtrArray[389 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((*dir)->inode,
                                                                                                                                                (*dir)->dev);
            if (tmp___16) {
              tmp___8 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[390 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("recursive, not followed");
              tmp___9 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[391 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(tmp___8 + 1UL);
              (*dir)->err = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 392 & 2 : 392])((char *)((char */* __restrict  */)tmp___9),
                                                                                                                                                          (char const   *)((char const   */* __restrict  */)"recursive, not followed"));
            } else {
              ((void (*)(ino_t inode , dev_t device ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 394 | tmp___23 : 394])((*dir)->inode,
                                                                                                                                                     (*dir)->dev);
              _3__functionPtrArray[356 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[98];
              if ((int )*((*dir)->lnk) == 47) {
                (*dir)->child = ((struct _info **(*)(char *d , u_long lev , dev_t dev ,
                                                     off_t *size , char **err ))_3__functionPtrArray[396 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((*dir)->lnk,
                                                                                                                                                                  lev + 1UL,
                                                                                                                                                                  dev,
                                                                                                                                                                  & (*dir)->size,
                                                                                                                                                                  & (*dir)->err);
              } else {
                tmp___13 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___15 : 398])((char const   *)d);
                tmp___14 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[400 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)(*dir)->lnk);
                _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 129] = _3__functionPtrArray[4];
                if ((tmp___13 + tmp___14) + 2UL > (size_t___0 )pathsize___0) {
                  tmp___10 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 401 & tmp_pattern : 401])((char const   *)d);
                  _3__functionPtrArray[58 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[391];
                  tmp___11 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? n : 402])((char const   *)(*dir)->name);
                  pathsize___0 = (long )((tmp___10 + tmp___11) + 1024UL);
                  tmp___12 = ((void *(*)(void *ptr , size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 403 : 403 | n])((void *)path___0,
                                                                                                                                                               (size_t___0 )pathsize___0);
                  path___0 = (char *)tmp___12;
                }
                if (fflag) {
                  tmp___15 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[404 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)d,
                                                                                                                                                         "/");
                  if (tmp___15) {
                    ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 405 : 405 + tmp___22])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                             (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                                             d,
                                                                                                                                                             (*dir)->lnk);
                  } else {
                    ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[407 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                                                                     (char const   *)((char const   */* __restrict  */)"%s%s"),
                                                                                                                                                                                                     d,
                                                                                                                                                                                                     (*dir)->lnk);
                  }
                } else {
                  ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[409 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)path___0),
                                                                                                                                            (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                            d,
                                                                                                                                            (*dir)->lnk);
                }
                (*dir)->child = ((struct _info **(*)(char *d , u_long lev , dev_t dev ,
                                                     off_t *size , char **err ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___23 : 410])(path___0,
                                                                                                                                                                         lev + 1UL,
                                                                                                                                                                         dev,
                                                                                                                                                                         & (*dir)->size,
                                                                                                                                                                         & (*dir)->err);
          ...
          tmp___20 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[412 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)d);
          tmp___21 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[414 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)(*dir)->name);
          _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 80 : 80 << tmp___16] = _3__functionPtrArray[73];
          if ((tmp___20 + tmp___21) + 2UL > (size_t___0 )pathsize___0) {
            tmp___17 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[415 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)d);
            tmp___18 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[416 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)(*dir)->name);
            _3__functionPtrArray[179 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[99];
            pathsize___0 = (long )((tmp___17 + tmp___18) + 1024UL);
            tmp___19 = ((void *(*)(void *ptr , size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___1 : 417])((void *)path___0,
                                                                                                                                                         (size_t___0 )pathsize___0);
            _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 199 - 4 : 199] = _3__functionPtrArray[317];
            path___0 = (char *)tmp___19;
          }
          if (fflag) {
            tmp___22 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[418 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)d,
                                                                                                                                                   "/");
            if (tmp___22) {
              ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[420 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                                                               (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                                                                               d,
                                                                                                                                                                                               (*dir)->name);
            } else {
              ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 7 : 421])((char *)((char */* __restrict  */)path___0),
                                                                                                                                          (char const   *)((char const   */* __restrict  */)"%s%s"),
                                                                                                                                          d,
                                                                                                                                          (*dir)->name);
            }
          } else {
            ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 423 * tmp___16 : 423])((char *)((char */* __restrict  */)path___0),
                                                                                                                                                     (char const   *)((char const   */* __restrict  */)"%s/%s"),
                                                                                                                                                     d,
                                                                                                                                                     (*dir)->name);
            _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 297] = _3__functionPtrArray[350];
          }
          ((void (*)(ino_t inode , dev_t device ))_3__functionPtrArray[424 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((*dir)->inode,
                                                                                                                                  (*dir)->dev);
          _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 358 : 8] = & dir;
          (*dir)->child = ((struct _info **(*)(char *d , u_long lev , dev_t dev ,
                                               off_t *size , char **err ))_3__functionPtrArray[425 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(path___0,
                                                                                                                                                            lev + 1UL,
                                                                                                                                                            dev,
                                                                                                                                                            & (*dir)->size,
                                                                                                                                                            & (*dir)->err);
        ...
        if (pruneflag) {
          if ((unsigned long )(*dir)->child == (unsigned long )((void *)0)) {
            if (matchdirs) {
              if (pattern) {
                tmp___23 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[426 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((*dir)->name,
                                                                                                                                                                                                     (int )(*dir)->isdir);
                if (! tmp___23) {
                  goto _L___0;
                }
              ...
              n --;
              ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 428 : 6])((void *)sp___0->name);
              if (sp___0->lnk) {
                ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___22 : 429])((void *)sp___0->lnk);
                _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 222 : 3] = _3__functionPtrArray[306];
              }
              ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 430 : n])((void *)sp___0);
              continue;
            }
          }
        }
  ...
  if (topsort) {
    ((void (*)(void * , unsigned long  , unsigned long  , int (*)(void const   * ,
                                                                  void const   * ) ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 431 : 431 + tmp___23])((void *)sav,
                                                                                                                                                                                    (size_t___1 )n,
                                                                                                                                                                                    sizeof(struct _info *),
                                                                                                                                                                                    (int (*)(void const   * ,
                                                                                                                                                                                             void const   * ))topsort);
  }
  ((void (*)(void * ))_3__functionPtrArray[433 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)path___0);
  if (n == 0) {
    ((void (*)(struct _info **d ))_3__functionPtrArray[434 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sav);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 29 ^ 2 : 29] = _3__functionPtrArray[125];
    return ((struct _info **)((void *)0));
  }
  if ((unsigned long )ig != (unsigned long )((void *)0)) {
    ((struct ignorefile *(*)(void))_3__functionPtrArray[435 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])();
  }
  if ((unsigned long )inf != (unsigned long )((void *)0)) {
    ((struct infofile *(*)(void))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 436])();
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 288 : 288 - 6] = _3__functionPtrArray[33];
  }
  return (sav);
}
}
...
{ 
  ...
  tmp = ((char *(*)(char const   * ))_3__functionPtrArray[226 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("TERM");
  if ((unsigned long )tmp == (unsigned long )((void *)0)) {
    colorize = (bool )0;
    return;
  }
  s = ((char *(*)(char const   * ))_3__functionPtrArray[227 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])("TREE_COLORS");
  _3__functionPtrArray[78 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & colors;
  if ((unsigned long )s == (unsigned long )((void *)0)) {
    s = ((char *(*)(char const   * ))_3__functionPtrArray[228 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("LS_COLORS");
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 127 & col : 127] = _3__functionPtrArray[61];
  }
  cc = ((char *(*)(char const   * ))_3__functionPtrArray[230 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])("CLICOLOR");
  _3__functionPtrArray[135 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & tmp___7;
  tmp___0 = ((char *(*)(char const   * ))_3__functionPtrArray[231 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("CLICOLOR_FORCE");
  if ((unsigned long )tmp___0 != (unsigned long )((void *)0)) {
    if (! nocolor) {
      force_color = (bool )1;
    }
  ...
  if ((unsigned long )s == (unsigned long )((void *)0)) {
    ...
    tmp___1 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[232 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)s);
    if (tmp___1 == 0UL) {
      _L: 
      if (force_color) {
  ...
  if (! force_color) {
    if (nocolor) {
      ...
      tmp___2 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 233 << 4 : 233])(1);
      if (! tmp___2) {
        colorize = (bool )0;
        return;
      }
  ...
  tmp___3 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[234 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)s);
  _3__functionPtrArray[92 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & c;
  tmp___4 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[235 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(tmp___3 + 1UL);
  colors = ((char *(*)(char * , char const   * ))_3__functionPtrArray[236 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___4),
                                                                                                                                   (char const   *)((char const   */* __restrict  */)s));
  arg = ((char **(*)(char *str , char *delim , int *nwrds ))_3__functionPtrArray[237 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(colors,
                                                                                                                                                                                                   (char *)":",
                                                                                                                                                                                                   & n);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 103] = & i;
  i = 0;
  while (*(arg + i)) {
    c = ((char **(*)(char *str , char *delim , int *nwrds ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 239 ^ col : 239])(*(arg + i),
                                                                                                                                                      (char *)"=",
                                                                                                                                                      & n);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 84 : 84 & col] = & tmp___19;
    col = ((int (*)(char *s ))_3__functionPtrArray[241 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(c + 0));
    switch (col) {
    case -1: 
    break;
    case 25: 
    if (*(c + 1)) {
      tmp___5 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[242 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(struct extensions ));
      e = (struct extensions *)tmp___5;
      tmp___6 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 243 : 243 ^ tmp___10])((char const   *)(*(c + 0) + 1));
      tmp___7 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[244 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___6 + 1UL);
      _3__functionPtrArray[222 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[147];
      e->ext = ((char *(*)(char * , char const   * ))_3__functionPtrArray[245 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___7),
                                                                                                                                     (char const   *)((char const   */* __restrict  */)(*(c + 0) + 1)));
      tmp___8 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[246 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(c + 1));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 29 : 29 & i] = _3__functionPtrArray[194];
      tmp___9 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[247 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(tmp___8 + 1UL);
      e->term_flg = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 248 : col])((char *)((char */* __restrict  */)tmp___9),
                                                                                                                                              (char const   *)((char const   */* __restrict  */)*(c + 1)));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 78 : 78 | 4] = _3__functionPtrArray[56];
      e->nxt = ext;
      ext = e;
    }
    break;
    case 8: 
    if (*(c + 1)) {
      tmp___10 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 250 * tmp___2 : 250])("target",
                                                                                                                                                           (char const   *)*(c + 1));
      if (tmp___10 == 0) {
    ...
    default: 
    if (*(c + 1)) {
      tmp___11 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[251 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(c + 1));
      tmp___12 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[253 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(tmp___11 + 1UL);
      color_code[col] = ((char *(*)(char * , char const   * ))_3__functionPtrArray[254 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___12),
                                                                                                                                                (char const   *)((char const   */* __restrict  */)*(c + 1)));
    }
    break;
    }
    ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 256 : 256 * 1])((void *)c);
    i ++;
  }
  ((void (*)(void * ))_3__functionPtrArray[257 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)arg);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 157 : 157 & tmp___2] = _3__functionPtrArray[139];
  if (! color_code[22]) {
    tmp___13 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 259])("\033[");
    tmp___14 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[261 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(tmp___13 + 1UL);
    color_code[22] = ((char *(*)(char * , char const   * ))_3__functionPtrArray[262 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)tmp___14),
                                                                                                                                                                                                  (char const   *)((char const   */* __restrict  */)"\033["));
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 84 : 84 >> col] = _3__functionPtrArray[6];
  }
  if (! color_code[23]) {
    tmp___15 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[263 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("m");
    _3__functionPtrArray[121 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & tmp___2;
    tmp___16 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[264 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___15 + 1UL);
    color_code[23] = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 265 : 265 >> tmp___10])((char *)((char */* __restrict  */)tmp___16),
                                                                                                                                                           (char const   *)((char const   */* __restrict  */)"m"));
    _3__functionPtrArray[175 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[58];
  }
  if (! color_code[4]) {
    tmp___17 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 266 + 6 : 266])("0");
    _3__functionPtrArray[133 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[215];
    tmp___18 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[267 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___17 + 1UL);
    color_code[4] = ((char *(*)(char * , char const   * ))_3__functionPtrArray[268 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___18),
                                                                                                                                            (char const   *)((char const   */* __restrict  */)"0"));
  }
  if (! color_code[24]) {
    ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[269 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(buf___1)),
                                                                                                                                (char const   *)((char const   */* __restrict  */)"%s%s%s"),
                                                                                                                                color_code[22],
                                                                                                                                color_code[4],
                                                                                                                                color_code[23]);
    tmp___19 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 271 : 271 + tmp___10])((char const   *)(buf___1));
    _3__functionPtrArray[86 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[132];
    tmp___20 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[273 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___19 + 1UL);
    color_code[24] = ((char *(*)(char * , char const   * ))_3__functionPtrArray[275 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___20),
                                                                                                                                             (char const   *)((char const   */* __restrict  */)(buf___1)));
  }
  ((void (*)(void * ))_3__functionPtrArray[277 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)colors);
  _3__functionPtrArray[107 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[91];
  return;
}
}
...
{ 
  ...
  {
  if ((*a)->mtime == (*b)->mtime) {
    v = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 203 << 6 : 203])((char const   *)(*a)->name,
                                                                                                                                             (char const   *)(*b)->name);
    _3__functionPtrArray[153 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[20];
    if (reverse) {
      tmp = - v;
    } else {
      tmp = v;
...
{ 
  ...
  tmp___1 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 339 : 4])((int )c1);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 135 : 135 * 8] = _3__functionPtrArray[182];
  ...
  while (1) {
    ...
    tmp___4 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___5 : 340])((int )c1);
    state |= ((int )c1 == 48) + (tmp___4 != 0);
  }
  tmp___5 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 341 : state])((int )c2);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 175 : 175 - 7] = _3__functionPtrArray[168];
  ...
  while (1) {
    tmp___8 = p1;
    p1 ++;
    tmp___9 = ((int (*)(int  ))_3__functionPtrArray[343 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )*tmp___8);
    _3__functionPtrArray[270 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[232];
    if (! tmp___9) {
      break;
    }
    tmp___6 = p2;
    p2 ++;
    tmp___7 = ((int (*)(int  ))_3__functionPtrArray[344 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )*tmp___6);
    if (! tmp___7) {
      return (1);
    }
  }
  tmp___12 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 346 + diff : 346])((int )*p2);
  _3__functionPtrArray[222 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[220];
  if (tmp___12) {
    tmp___11 = -1;
  } else {
    tmp___11 = diff;
...
{ 
  ...
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 117 : 8])(sizeof(struct xtable ));
  t = (struct xtable *)tmp;
  ent = ((struct group *(*)(gid_t  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 118 : 118 + 10])(gid);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? gent : 24] = _3__functionPtrArray[52];
  if ((unsigned long )ent != (unsigned long )((void *)0)) {
    tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[120 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)ent->gr_name);
    _3__functionPtrArray[78 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[80];
    tmp___1 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[122 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(tmp___0 + 1UL);
    t->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[124 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)tmp___1),
                                                                                                                                                                                           (char const   *)((char const   */* __restrict  */)ent->gr_name));
  } else {
    ((int (*)(char * , size_t___0  , char const   *  , ...))_3__functionPtrArray[126 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(gbuf)),
                                                                                                                                              (size_t___0 )30,
                                                                                                                                              (char const   *)((char const   */* __restrict  */)"%d"),
                                                                                                                                              gid);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 9] = _3__functionPtrArray[67];
    gbuf[31] = (char)0;
    tmp___2 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 128 : 128 | gent])((char const   *)(gbuf));
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 47 - 3 : 47] = _3__functionPtrArray[88];
    tmp___3 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[130 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(tmp___2 + 1UL);
    _3__functionPtrArray[129 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[59];
    t->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[132 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___3),
                                                                                                                                    (char const   *)((char const   */* __restrict  */)(gbuf)));
  }
  t->xid = gid;
  t->nxt = p;
...
{ 
  ...
  i = 0;
  while (i < ipattern) {
    tmp = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[279 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(name,
                                                                                                                                              *(ipatterns + i),
                                                                                                                                              isdir);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 35 : 8] = _3__functionPtrArray[28];
    if (tmp) {
      return (1);
    }
    i ++;
...
{ 
  ...
  while ((unsigned long )cn != (unsigned long )((void *)0)) {
    ...
    while ((unsigned long )p != (unsigned long )((void *)0)) {
      p = p->next;
      ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 303 : i])((void *)c->pattern);
      c = p;
    }
    i = 0;
    while ((unsigned long )*(cc->desc + i) != (unsigned long )((void *)0)) {
      ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 304 : 304 & 4])((void *)*(cc->desc + i));
      i ++;
    }
    ((void (*)(void * ))_3__functionPtrArray[306 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)cc->desc);
    ((void (*)(void * ))_3__functionPtrArray[307 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)cc);
    _3__functionPtrArray[129 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[103];
    cc = cn;
  }
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 309 : 309 >> 5])((void *)inf->path);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 24 << i : 24] = _3__functionPtrArray[195];
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 311 : i])((void *)inf);
  return ((struct infofile *)((void *)0));
}
}
...
{ 
  ...
  {
  tmp = ((int (*)(off_t a , off_t b ))_3__functionPtrArray[83 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((*a)->size,
                                                                                                                       (*b)->size);
  _3__functionPtrArray[80 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[20];
  v = tmp;
  if (v == 0) {
    v = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 85 : 6])((char const   *)(*a)->name,
                                                                                                                                     (char const   *)(*b)->name);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 63] = _3__functionPtrArray[80];
  }
  if (reverse) {
    tmp___0 = - v;
  } else {
...
{ 
  ...
  {
  tmp = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 134 : 134 * 10])((char const   *)s);
  e = (int )(tmp - 1UL);
  if ((int )*(s + e) == 10) {
    e --;
  }
...
{ 
  ...
  {
  tmp = ((int (*)(char const   *s1 , char const   *s2 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 443 >> 2 : 443])((char const   *)(*a)->name,
                                                                                                                                                 (char const   *)(*b)->name);
  _3__functionPtrArray[135 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[371];
  v = tmp;
  if (reverse) {
    tmp___0 = - v;
  } else {
...
{ 
  ...
  i = 0;
  while (i < pattern) {
    tmp = ((int (*)(char *buf___1 , char *pat , int isdir ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 281 : 7])(name,
                                                                                                                                              *(patterns + i),
                                                                                                                                              isdir);
    if (tmp) {
      return (1);
...
{ 
  ...
  *(buf___1 + n) = (char)0;
  if (inodeflag) {
    tmp = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[34 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)buf___1),
                                                                                                                                   (char const   *)((char const   */* __restrict  */)" %7ld"),
                                                                                                                                   (long )ent->linode);
    n += tmp;
  }
  if (devflag) {
    tmp___0 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[36 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                         (char const   *)((char const   */* __restrict  */)" %3d"),
                                                                                                                                         (int )ent->ldev);
    n += tmp___0;
  }
  if (pflag) {
    tmp___1 = ((char *(*)(mode_t m ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 37 : tmp___6])(ent->mode);
    tmp___2 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[39 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                                                                              (char const   *)((char const   */* __restrict  */)" %s"),
                                                                                                                                                                                              tmp___1);
    n += tmp___2;
  }
  if (uflag) {
    tmp___3 = ((char *(*)(uid_t uid ))_3__functionPtrArray[41 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(ent->uid);
    tmp___4 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[42 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                                                                              (char const   *)((char const   */* __restrict  */)" %-8.32s"),
                                                                                                                                                                                              tmp___3);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___2 : 40] = _3__functionPtrArray[1];
    n += tmp___4;
  }
  if (gflag) {
    tmp___5 = ((char *(*)(gid_t gid ))_3__functionPtrArray[44 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(ent->gid);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 29 << 3 : 29] = & tmp___9;
    tmp___6 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? n : 46])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                         (char const   *)((char const   */* __restrict  */)" %-8.32s"),
                                                                                                                                         tmp___5);
    n += tmp___6;
  }
  if (sflag) {
    tmp___7 = ((int (*)(char *buf___1 , off_t size ))_3__functionPtrArray[48 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(buf___1 + n,
                                                                                                                                                                                           ent->size);
    n += tmp___7;
  }
  if (Dflag) {
    ...
    tmp___9 = ((char *(*)(time_t t ))_3__functionPtrArray[49 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(tmp___8);
    tmp___10 = ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[50 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                        (char const   *)((char const   */* __restrict  */)" %s"),
                                                                                                                                        tmp___9);
  ...
  if ((int )*(buf___1 + 0) == 32) {
    *(buf___1 + 0) = (char )'[';
    ((int (*)(char * , char const   *  , ...))_3__functionPtrArray[51 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)(buf___1 + n)),
                                                                                                                                                                                    (char const   *)((char const   */* __restrict  */)"]"));
  }
  return (buf___1);
}
}
...
{ 
  ...
  ((int (*)(char const   * , FILE * ))_3__functionPtrArray[313 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)((char const   */* __restrict  */)color_code[22]),
                                                                                                                      (FILE *)((FILE */* __restrict  */)outfile));
  _3__functionPtrArray[52 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[43];
  ((int (*)(char const   * , FILE * ))_3__functionPtrArray[314 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)((char const   */* __restrict  */)color_code[color___0]),
                                                                                                                      (FILE *)((FILE */* __restrict  */)outfile));
  ((int (*)(char const   * , FILE * ))_3__functionPtrArray[315 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)((char const   */* __restrict  */)color_code[23]),
                                                                                                                                                                             (FILE *)((FILE */* __restrict  */)outfile));
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 31 : 31 - 6] = _3__functionPtrArray[150];
  return (1);
}
}
...
{ 
  ...
  {
  n = 128;
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[332 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(char *) * (unsigned long )n);
  w = (char **)tmp;
  tmp___0 = 0;
  *nwrds = tmp___0;
  *(w + tmp___0) = ((char *(*)(char * __restrict   , char const   * __restrict   ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 334 : 334 & n])((char */* __restrict  */)str,
                                                                                                                                                                           (char const   */* __restrict  */)delim);
  while (*(w + *nwrds)) {
    if (*nwrds == n - 2) {
      n += 256;
      tmp___1 = ((void *(*)(void *ptr , size_t___0 size ))_3__functionPtrArray[335 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)w,
                                                                                                                                          sizeof(char *) * (unsigned long )n);
      _3__functionPtrArray[33 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[2];
      w = (char **)tmp___1;
    }
    (*nwrds) ++;
    *(w + *nwrds) = ((char *(*)(char * __restrict   , char const   * __restrict   ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 337 & 3 : 337])((char */* __restrict  */)((void *)0),
                                                                                                                                                                            (char const   */* __restrict  */)delim);
  }
  *(w + *nwrds) = (char *)((void *)0);
  return (w);
...
{ 
  ...
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[347 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(sizeof(struct xtable ));
  t = (struct xtable *)tmp;
  ent = ((struct passwd *(*)(uid_t  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? uent : 349])(uid);
  if ((unsigned long )ent != (unsigned long )((void *)0)) {
    tmp___0 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 350 : uent])((char const   *)ent->pw_name);
    tmp___1 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[352 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___0 + 1UL);
    t->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[353 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)tmp___1),
                                                                                                                                      (char const   *)((char const   */* __restrict  */)ent->pw_name));
    _3__functionPtrArray[88 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[267];
  } else {
    ((int (*)(char * , size_t___0  , char const   *  , ...))_3__functionPtrArray[355 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char *)((char */* __restrict  */)(ubuf)),
                                                                                                                                              (size_t___0 )30,
                                                                                                                                              (char const   *)((char const   */* __restrict  */)"%d"),
                                                                                                                                              uid);
    ubuf[31] = (char)0;
    tmp___2 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[357 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)(ubuf));
    _3__functionPtrArray[16 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[90];
    tmp___3 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 359 : 359 & 2])(tmp___2 + 1UL);
    t->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? uent : 361])((char *)((char */* __restrict  */)tmp___3),
                                                                                                                                         (char const   *)((char const   */* __restrict  */)(ubuf)));
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 3] = _3__functionPtrArray[166];
  }
  t->xid = uid;
  t->nxt = p;
...
{ 
  ...
  {
  if (! noindent) {
    ((void (*)(int maxlevel ))_3__functionPtrArray[146 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(level - 1);
  }
  if (noindent) {
    tmp = (char *)"";
  } else {
  ...
  ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[148 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((FILE *)((FILE */* __restrict  */)outfile),
                                                                                                                            (char const   *)((char const   */* __restrict  */)"]}%s%s"),
                                                                                                                            tmp___0,
                                                                                                                            tmp);
  return;
...
{ 
  ...
  {
  tmp = ((char *(*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 87])("TREE_CHARSET");
...
{ 
  ...
  while ((unsigned long )ptr != (unsigned long )((void *)0)) {
    if (ptr->tchild) {
      ((void (*)(struct _info *ent ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 79])(ptr->tchild);
    }
    t = ptr;
    ptr = ptr->next;
    ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 81 : 4])((void *)t);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 29 * 5 : 29] = _3__functionPtrArray[28];
  }
  return;
}
}
...
{ 
  ...
  i = 0;
  while (cmds[i].cmdnum) {
    tmp = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)cmds[i].cmd,
                                                                                                                                                                                                                                            (char const   *)s);
    if (! tmp) {
...
{ 
  ...
  {
  tm = ((struct tm *(*)(time_t const   * ))_3__functionPtrArray[6 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((time_t const   *)(& t));
  _3__functionPtrArray[4 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & t;
  if (timefmt) {
    ((size_t___0 (*)(char * __restrict   , size_t___0  , char const   * __restrict   ,
                     struct tm  const  * __restrict   ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 8 : 5])((char */* __restrict  */)(buf___0),
                                                                                                                                        (size_t___0 )255,
                                                                                                                                        (char const   */* __restrict  */)timefmt,
                                                                                                                                        (struct tm  const  */* __restrict  */)tm);
    _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[2];
    buf___0[255] = (char)0;
  } else {
    tmp = ((time_t (*)(time_t * ))_3__functionPtrArray[10 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((time_t *)0);
    c = tmp;
    if (t > c) {
      ((size_t___0 (*)(char * __restrict   , size_t___0  , char const   * __restrict   ,
                       struct tm  const  * __restrict   ))_3__functionPtrArray[12 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char */* __restrict  */)(buf___0),
                                                                                                                                                                                                (size_t___0 )255,
                                                                                                                                                                                                (char const   */* __restrict  */)"%b %e  %Y",
                                                                                                                                                                                                (struct tm  const  */* __restrict  */)tm);
    } else
    if (t + 16070400LL < c) {
      ((size_t___0 (*)(char * __restrict   , size_t___0  , char const   * __restrict   ,
                       struct tm  const  * __restrict   ))_3__functionPtrArray[13 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char */* __restrict  */)(buf___0),
                                                                                                                                                                                                (size_t___0 )255,
                                                                                                                                                                                                (char const   */* __restrict  */)"%b %e  %Y",
                                                                                                                                                                                                (struct tm  const  */* __restrict  */)tm);
    } else {
      ((size_t___0 (*)(char * __restrict   , size_t___0  , char const   * __restrict   ,
                       struct tm  const  * __restrict   ))_3__functionPtrArray[14 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char */* __restrict  */)(buf___0),
                                                                                                                                                                                                (size_t___0 )255,
                                                                                                                                                                                                (char const   */* __restrict  */)"%b %e %R",
                                                                                                                                                                                                (struct tm  const  */* __restrict  */)tm);
...
{ 
  ...
  {
  if ((unsigned long )*dir == (unsigned long )((void *)0)) {
    tmp = ((struct _info *(*)(char *name ))_3__functionPtrArray[328 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(name);
    *dir = tmp;
    return (tmp);
  }
  ptr = *dir;
  prev___0 = ptr;
  while ((unsigned long )ptr != (unsigned long )((void *)0)) {
    cmp = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 330 : cmp])((char const   *)ptr->name,
                                                                                                                                          (char const   *)name);
    if (cmp == 0) {
      return (ptr);
    }
  ...
  n = ((struct _info *(*)(char *name ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 331])(name);
  _3__functionPtrArray[276 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[297];
  n->next = ptr;
...
{ 
  ...
  {
  if ((*a)->ctime == (*b)->ctime) {
    v = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[5 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)(*a)->name,
                                                                                                                                  (char const   *)(*b)->name);
...
{ 
  ...
  i = 0;
  while (*(d + i)) {
    ((void (*)(void * ))_3__functionPtrArray[74 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)(*(d + i))->name);
    _3__functionPtrArray[26 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[35];
    if ((*(d + i))->lnk) {
      ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 75 - 9 : 75])((void *)(*(d + i))->lnk);
    }
    ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 76 * 5 : 76])((void *)*(d + i));
    i ++;
  }
  ((void (*)(void * ))_3__functionPtrArray[77 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)d);
  return;
}
}
...
{ 
  ...
  {
  tmp = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[(_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)(*a)->name,
                                                                                                                                                                                   (char const   *)(*b)->name);
  _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & a;
  v = tmp;
  if (reverse) {
    tmp___0 = - v;
  } else {
...
{ 
  ...
  if ((unsigned long )lbuf == (unsigned long )((void *)0)) {
    lbufsize = 4096;
    tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 89 : 89 - rs])((size_t___0 )lbufsize);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : tmp___1] = _3__functionPtrArray[24];
    lbuf = (char *)tmp;
  }
  tmp___0 = ((int (*)(char const   * , struct stat * ))_3__functionPtrArray[91 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)((char const   */* __restrict  */)path___0),
                                                                                                                                                                                             (struct stat *)((struct stat */* __restrict  */)(& lst)));
  _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & tmp___6;
  if (tmp___0 < 0) {
    return ((struct _info *)((void *)0));
  }
  if ((lst.st_mode & 61440U) == 40960U) {
    rs = ((int (*)(char const   * __restrict   , struct stat * __restrict   ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 93])((char const   */* __restrict  */)path___0,
                                                                                                                                                               (struct stat */* __restrict  */)(& st));
    if (rs < 0) {
      ((void *(*)(void * , int  , size_t___0  ))_3__functionPtrArray[95 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)(& st),
                                                                                                                                                                                      0,
                                                                                                                                                                                      sizeof(st));
    }
  } else {
  ...
  if (gitignore) {
    tmp___1 = ((int (*)(char *path___0 , char *name , int isdir ))_3__functionPtrArray[96 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(path___0,
                                                                                                                                                                                                        name,
                                                                                                                                                                                                        isdir);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 4] = _3__functionPtrArray[93];
    if (tmp___1) {
      return ((struct _info *)((void *)0));
    }
  }
  if ((lst.st_mode & 61440U) != 16384U) {
    ...
    _L: 
    if (pattern) {
      tmp___2 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[97 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(name,
                                                                                                                                                                                         isdir);
      _3__functionPtrArray[72 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[67];
      if (! tmp___2) {
        return ((struct _info *)((void *)0));
      }
    }
  ...
  if (ipattern) {
    tmp___3 = ((int (*)(char *name , int isdir ))_3__functionPtrArray[99 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(name,
                                                                                                                                  isdir);
    _3__functionPtrArray[47 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[59];
    if (tmp___3) {
      return ((struct _info *)((void *)0));
    }
  }
  ...
  tmp___4 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[100 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(struct _info ));
  ent = (struct _info *)tmp___4;
  ((void *(*)(void * , int  , size_t___0  ))_3__functionPtrArray[101 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)ent,
                                                                                                                              0,
                                                                                                                              sizeof(struct _info ));
  tmp___5 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 102 << rs : 102])((char const   *)name);
  _3__functionPtrArray[43 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[38];
  tmp___6 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[104 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(tmp___5 + 1UL);
  _3__functionPtrArray[55 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[18];
  ent->name = ((char *(*)(char * , char const   * ))_3__functionPtrArray[105 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char *)((char */* __restrict  */)tmp___6),
                                                                                                                                                                                           (char const   *)((char const   */* __restrict  */)name));
  ...
  if ((lst.st_mode & 61440U) == 40960U) {
    if (lst.st_size + 1LL > (off_t )lbufsize) {
      ...
      tmp___7 = ((void *(*)(void *ptr , size_t___0 size ))_3__functionPtrArray[106 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)lbuf,
                                                                                                                                            (size_t___0 )lbufsize);
      _3__functionPtrArray[26 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[23];
      lbuf = (char *)tmp___7;
    }
    tmp___12 = ((ssize_t (*)(char const   * __restrict   , char * __restrict   , size_t___0  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 108 - tmp___0 : 108])((char const   */* __restrict  */)path___0,
                                                                                                                                                                                             (char */* __restrict  */)lbuf,
                                                                                                                                                                                             (size_t___0 )(lbufsize - 1));
    len = (int )tmp___12;
    if (len < 0) {
      tmp___8 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 110])("[Error reading symbolic link information]");
      _3__functionPtrArray[38 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[84];
      tmp___9 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[111 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(tmp___8 + 1UL);
      _3__functionPtrArray[58 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[92];
      ent->lnk = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 113 + 8 : 113])((char *)((char */* __restrict  */)tmp___9),
                                                                                                                                               (char const   *)((char const   */* __restrict  */)"[Error reading symbolic link information]"));
      _3__functionPtrArray[84 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[80];
      ent->isdir = (bool )0;
      ent->lnkmode = st.st_mode;
    } else {
      *(lbuf + len) = (char)0;
      tmp___10 = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 114 : 10])((char const   *)lbuf);
      _3__functionPtrArray[94 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[38];
      tmp___11 = ((void *(*)(size_t___0 size ))_3__functionPtrArray[115 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(tmp___10 + 1UL);
      ent->lnk = ((char *(*)(char * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 116])((char *)((char */* __restrict  */)tmp___11),
                                                                                                                                         (char const   *)((char const   */* __restrict  */)lbuf));
      if (rs < 0) {
        ent->orphan = (bool )1;
      }
      ent->lnkmode = st.st_mode;
...
{ 
  ...
  {
  if (ignorecase) {
    tmp = ((int (*)(int  ))_3__functionPtrArray[(((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)) + 1) + 1])((int )c);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 4 : tmp] = _3__functionPtrArray[3];
    tmp___0 = tmp;
  } else {
    tmp___0 = (int )c;
  }
...
{ 
  ...
  {
  if (postdir <= 0) {
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 437 : 437 & needcomma])((FILE *)((FILE */* __restrict  */)outfile),
                                                                                                                                              (char const   *)((char const   */* __restrict  */)"\n"));
    _3__functionPtrArray[84 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[314];
  }
  if (file) {
    if (file->comment) {
      infosize = 0;
      if (metafirst) {
        if ((int )info___0[0] == 91) {
          tmp = ((size_t___0 (*)(char const   * ))_3__functionPtrArray[438 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)(info___0));
      ...
      *(dirs + (level + 1)) = 1;
      ...
      while (line < lines) {
        if (metafirst) {
          ((int (*)(char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 439 + line : 439])((char const   *)((char const   */* __restrict  */)"%*s"),
                                                                                                                                      infosize,
                                                                                                                                      "");
        }
        ((void (*)(int maxlevel ))_3__functionPtrArray[441 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(level);
        ((void (*)(int line , int lines , char *s ))_3__functionPtrArray[442 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(line,
                                                                                                                                                                                           lines,
                                                                                                                                                                                           *(file->comment + line));
        line ++;
      }
...
{ 
  ...
  while ((unsigned long )p != (unsigned long )((void *)0)) {
    p = p->next;
    ((void (*)(void * ))_3__functionPtrArray[296 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)c->pattern);
    c = p;
  }
  c = ig->reverse;
  p = c;
  while ((unsigned long )p != (unsigned long )((void *)0)) {
    p = p->next;
    ((void (*)(void * ))_3__functionPtrArray[298 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)c->pattern);
    _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[184];
    c = p;
  }
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 300 : 6])((void *)ig->path);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 58 : 58 >> 5] = _3__functionPtrArray[215];
  ((void (*)(void * ))_3__functionPtrArray[302 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)ig);
  return ((struct ignorefile *)((void *)0));
}
}
...
{ 
  ...
  tmp = ((void *(*)(size_t___0 size ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 326 : 326 * 9])(sizeof(struct inotable ));
