...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:48:14-2023/04/23 */
...
{ 
  ...
  while (1) {
    ...
    tmp___4 = isgraph(c);
    if (tmp___4) {
      if ((int )((((~ seq->seq.m | ((seq->seq.l ^ 1UL) + ((seq->seq.l & 1UL) << 1UL))) & ((seq->seq.m ^ ((seq->seq.l ^ 1UL) + ((seq->seq.l & 1UL) << 1UL))) | ~ (((seq->seq.l ^ 1UL) + ((seq->seq.l & 1UL) << 1UL)) - seq->seq.m))) >> 31UL) & 1UL)) {
        seq->seq.m = (seq->seq.l | 2UL) + (seq->seq.l & 2UL);
        seq->seq.m = (seq->seq.m + ~ 1UL) + 1UL;
        seq->seq.m = ((seq->seq.m + (seq->seq.m >> 1)) + 1UL) + ((- seq->seq.m - 1UL) | (- (seq->seq.m >> 1) - 1UL));
        seq->seq.m = (seq->seq.m & ~ (seq->seq.m >> 2)) + (seq->seq.m >> 2);
        ...
        seq->seq.m = ((seq->seq.m + (seq->seq.m >> 16)) + 1UL) + ((- seq->seq.m - 1UL) | (- (seq->seq.m >> 16) - 1UL));
        seq->seq.m = (seq->seq.m | 1UL) + (seq->seq.m & 1UL);
        tmp___2 = realloc((void *)seq->seq.s, seq->seq.m);
        seq->seq.s = (char *)tmp___2;
      }
      tmp___3 = seq->seq.l;
      seq->seq.l = (seq->seq.l - ~ 1UL) - 1UL;
  ...
  *(seq->seq.s + seq->seq.l) = (char)0;
  ...
  while (1) {
    ...
    if (((unsigned int )((~ (33 ^ c) >> 1) + (33 & ~ c)) >> 31U) & 1) {
      if (((unsigned int )((~ (c ^ 127) >> 1) + (c & ~ 127)) >> 31U) & 1) {
        tmp___6 = seq->qual.l;
        seq->qual.l = (seq->qual.l | 1UL) + (seq->qual.l & 1UL);
  ...
  *(seq->qual.s + seq->qual.l) = (char)0;
  seq->last_char = 0;
  if ((int )((((((long )(seq->seq.l - seq->qual.l) >> 31L) - (seq->seq.l - seq->qual.l)) ^ ((long )(seq->seq.l - seq->qual.l) >> 31L)) >> 31UL) & 1UL)) {
    return (-2);
  }
  return ((int )seq->seq.l);
}
  ...
  while (1) {
    if (((unsigned int )((ks->end | ~ ks->begin) & ((ks->end ^ ks->begin) | ~ (ks->begin - ks->end))) >> 31U) & 1) {
      if (! ks->is_eof) {
        ...
        if (((unsigned int )((ks->end & ~ 4096) | (~ (ks->end ^ 4096) & (ks->end - 4096))) >> 31U) & 1) {
          ks->is_eof = 1;
        }
        if (((unsigned int )(~ (ks->end | - ks->end)) >> 31U) & 1) {
          break;
        }
      } else {
        break;
    ...
    if (((unsigned int )((1 & ~ delimiter) | (~ (1 ^ delimiter) & (1 - delimiter))) >> 31U) & 1) {
      i = ks->begin;
    ...
    if (((unsigned int )(~ delimiter & (delimiter - 1)) >> 31U) & 1) {
      i = ks->begin;
    ...
    if ((int )((((~ ((str->m + ~ str->l) + 1UL) & (size_t___1 )((((i ^ ks->begin) - ((~ i & ks->begin) << 1)) - ~ 1) - 1)) | (~ (((str->m + ~ str->l) + 1UL) ^ (size_t___1 )((((i ^ ks->begin) - ((~ i & ks->begin) << 1)) - ~ 1) - 1)) & (((str->m + ~ str->l) + 1UL) - (size_t___1 )((((i ^ ks->begin) - ((~ i & ks->begin) << 1)) - ~ 1) - 1)))) >> 31UL) & 1UL)) {
      str->m = ((((str->l ^ (size_t___1 )((i + ~ ks->begin) + 1)) + ((str->l & (size_t___1 )((i + ~ ks->begin) + 1)) << 1UL)) ^ ~ 1UL) + ((((str->l ^ (size_t___1 )((i + ~ ks->begin) + 1)) + ((str->l & (size_t___1 )((i + ~ ks->begin) + 1)) << 1UL)) | 1UL) + (((str->l ^ (size_t___1 )((i + ~ ks->begin) + 1)) + ((str->l & (size_t___1 )((i + ~ ks->begin) + 1)) << 1UL)) | 1UL))) + 1UL;
      str->m = (str->m + ~ 1UL) + 1UL;
      str->m = ((str->m + (str->m >> 1)) + 1UL) + ((- str->m - 1UL) | (- (str->m >> 1) - 1UL));
      str->m = (str->m & ~ (str->m >> 2)) + (str->m >> 2);
      str->m = (str->m & ~ (str->m >> 4)) + (str->m >> 4);
      str->m = (str->m & ~ (str->m >> 8)) + (str->m >> 8);
      str->m = ((str->m + (str->m >> 16)) + 1UL) + ((- str->m - 1UL) | (- (str->m >> 16) - 1UL));
      str->m = ((str->m ^ ~ 1UL) + ((str->m | 1UL) + (str->m | 1UL))) + 1UL;
      tmp___1 = realloc((void *)str->s, str->m);
      str->s = (char *)tmp___1;
    }
    memcpy((void */* __restrict  */)(str->s + str->l), (void const   */* __restrict  */)(ks->buf + ks->begin),
           (size_t___1 )(((i & ~ ks->begin) << 1) - (i ^ ks->begin)));
    str->l = (str->l ^ (size_t___1 )((i ^ ks->begin) - ((~ i & ks->begin) << 1))) + ((str->l & (size_t___1 )((i ^ ks->begin) - ((~ i & ks->begin) << 1))) + (str->l & (size_t___1 )((i ^ ks->begin) - ((~ i & ks->begin) << 1))));
    ks->begin = (i | 1) + (i & 1);
    if (((unsigned int )((((ks->end - i) & - (ks->end >= i)) >> 31) - (((ks->end - i) & - (ks->end >= i)) ^ (((ks->end - i) & - (ks->end >= i)) >> 31))) >> 31U) & 1) {
      if (dret) {
        *dret = (int )*(ks->buf + i);
      }
      break;
...
{ 
  ...
  {
  if (((unsigned int )(~ (iset | - iset)) >> 31U) & 1) {
    while (1) {
      tmp = drand48();
      v1 = 2.0 * tmp - 1.0;
      tmp___0 = drand48();
...
{ 
  ...
  j = 0;
  i = 0;
  while ((int )((((((long )((size_t___1 )i - (size_t___1 )ks->seq.l) >> 31L) - ((size_t___1 )i - (size_t___1 )ks->seq.l)) ^ ((long )((size_t___1 )i - (size_t___1 )ks->seq.l) >> 31L)) >> 31UL) & 1UL)) {
    c[0] = (int )nst_nt4_table[(int )*(ks->seq.s + i)];
    c[1] = (int )*(hap1->s + i);
    c[2] = (int )*(hap2->s + i);
    if (((unsigned int )((4 | ~ c[0]) & ((4 ^ c[0]) | ~ (c[0] - 4))) >> 31U) & 1) {
      goto __Cont;
    }
    if (((unsigned int )(((unsigned int )(((~ c[1] | (int )mutmsk) + c[1]) + 1) >> 1U) - (((~ c[1] | (int )mutmsk) + c[1]) + 1)) >> 31U) & 1) {
      goto _L___1;
    } else
    if (((unsigned int )(((unsigned int )((~ c[2] | (int )mutmsk) - ~ c[2]) >> 1U) - ((~ c[2] | (int )mutmsk) - ~ c[2])) >> 31U) & 1) {
      _L___1: 
      if (((unsigned int )(~ ((c[1] - c[2]) | (c[2] - c[1]))) >> 31U) & 1) {
        if (((unsigned int )((((((~ c[1] | (int )mutmsk) - ~ c[1]) - 57344) + ((((~ c[1] | (int )mutmsk) - ~ c[1]) - 57344) >> 31)) ^ ((((~ c[1] | (int )mutmsk) - ~ c[1]) - 57344) >> 31)) - 1) >> 31U) & 1) {
          printf((char const   */* __restrict  */)"%s\t%d\t%c\t%c\t-\n", name, (i ^ 1) + ((i & 1) << 1),
                 (int )*("ACGTN" + c[0]), (int )*("ACGTN" + ((~ c[1] | 15) - ~ c[1])));
        } else
        if (((unsigned int )((((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) + (1 << 31)) ^ (((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) + (1 << 31)) >> 31)) - (((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) + (1 << 31)) >> 31)) >> 31U) & 1) {
          if (((unsigned int )((j | ~ i) & ((j ^ i) | ~ (i - j))) >> 31U) & 1) {
            printf((char const   */* __restrict  */)"%s\t%d\t", name, (i - ~ 1) - 1);
            j = i;
            while (1) {
              if ((int )((((~ ((size_t___1 )j) & (size_t___1 )ks->seq.l) | (~ ((size_t___1 )j ^ (size_t___1 )ks->seq.l) & ((size_t___1 )j - (size_t___1 )ks->seq.l))) >> 31UL) & 1UL)) {
                if (((unsigned int )((((int )*(hap1->s + j) - (int )*(hap2->s + j)) + (1 << 31)) - (((((int )*(hap1->s + j) - (int )*(hap2->s + j)) + (1 << 31)) + (((int )*(hap1->s + j) - (int )*(hap2->s + j)) + (1 << 31))) & ((((int )*(hap1->s + j) - (int )*(hap2->s + j)) + (1 << 31)) >> 31))) >> 31U) & 1) {
                  if (! (((unsigned int )(~ ((((~ ((int )*(hap1->s + j)) | (int )mutmsk) - ~ ((int )*(hap1->s + j))) - 61440) | (61440 - ((~ ((int )*(hap1->s + j)) | (int )mutmsk) - ~ ((int )*(hap1->s + j)))))) >> 31U) & 1)) {
                    break;
                  }
                } else {
                  break;
        ...
        if (((unsigned int )((~ ((((~ c[1] | (int )mutmsk) - ~ c[1]) >> 12) ^ 4) >> 1) + ((((~ c[1] | (int )mutmsk) - ~ c[1]) >> 12) & ~ 4)) >> 31U) & 1) {
          printf((char const   */* __restrict  */)"%s\t%d\t-\t", name, (i | 1) + (i & 1));
          n = (((~ c[1] | (int )mutmsk) + c[1]) + 1) >> 12;
          ins = c[1] >> 4;
          while (((unsigned int )((n >> 1) - n) >> 31U) & 1) {
            putchar((int )*("ACGTN" + (((~ ins | 3) + ins) + 1)));
            ins >>= 2;
            n = (n + ~ 1) + 1;
          }
          printf((char const   */* __restrict  */)"\t-\n");
      ...
      if (((unsigned int )(~ ((((~ c[1] | (int )mutmsk) - ~ c[1]) - 57344) | (57344 - ((~ c[1] | (int )mutmsk) - ~ c[1])))) >> 31U) & 1) {
        printf((char const   */* __restrict  */)"%s\t%d\t%c\t%c\t+\n", name, (i - ~ 1) - 1,
               (int )*("ACGTN" + c[0]), (int )*("XACMGRSVTWYHKDBN" + (((1 << ((~ c[1] | 3) - ~ c[1])) & ~ (1 << ((~ c[2] | 3) - ~ c[2]))) + (1 << ((~ c[2] | 3) - ~ c[2])))));
      } else
      if (((unsigned int )(((((((~ c[2] | (int )mutmsk) + c[2]) + 1) - 57344) + (1 << 31)) + ((((((~ c[2] | (int )mutmsk) + c[2]) + 1) - 57344) + (1 << 31)) >> 31)) ^ ((((((~ c[2] | (int )mutmsk) + c[2]) + 1) - 57344) + (1 << 31)) >> 31)) >> 31U) & 1) {
        printf((char const   */* __restrict  */)"%s\t%d\t%c\t%c\t+\n", name, (i ^ 1) + ((i & 1) + (i & 1)),
               (int )*("ACGTN" + c[0]), (int )*("XACMGRSVTWYHKDBN" + ((((1 << (((~ c[1] | 3) + c[1]) + 1)) + (1 << ((~ c[2] | 3) - ~ c[2]))) + 1) + ((- (1 << (((~ c[1] | 3) + c[1]) + 1)) - 1) | (- (1 << ((~ c[2] | 3) - ~ c[2])) - 1)))));
      } else
      if (((unsigned int )((((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) + ((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) >> 31)) ^ ((((~ c[1] | (int )mutmsk) - ~ c[1]) - 61440) >> 31)) - 1) >> 31U) & 1) {
        if (((unsigned int )((j | ~ i) & ((j ^ i) | ~ (i - j))) >> 31U) & 1) {
          printf((char const   */* __restrict  */)"%s\t%d\t", name, (i ^ 1) + ((i & 1) << 1));
          j = i;
          while (1) {
            if ((int )((((~ ((size_t___1 )j) & (size_t___1 )ks->seq.l) | ((~ ((size_t___1 )j) | (size_t___1 )ks->seq.l) & ((size_t___1 )j - (size_t___1 )ks->seq.l))) >> 31UL) & 1UL)) {
              if (((unsigned int )(((int )*(hap1->s + j) - (int )*(hap2->s + j)) | ((int )*(hap2->s + j) - (int )*(hap1->s + j))) >> 31U) & 1) {
                if (! (((unsigned int )((((((~ ((int )*(hap1->s + j)) | (int )mutmsk) + (int )*(hap1->s + j)) + 1) - 61440) - ((((((~ ((int )*(hap1->s + j)) | (int )mutmsk) + (int )*(hap1->s + j)) + 1) - 61440) << 1) & (((((~ ((int )*(hap1->s + j)) | (int )mutmsk) + (int )*(hap1->s + j)) + 1) - 61440) >> 31))) - 1) >> 31U) & 1)) {
                  break;
                }
              } else {
                break;
      ...
      if (((unsigned int )(~ ((((~ c[2] | (int )mutmsk) - ~ c[2]) - 61440) | (61440 - ((~ c[2] | (int )mutmsk) - ~ c[2])))) >> 31U) & 1) {
        if (((unsigned int )((~ (j ^ i) >> 1) + (j & ~ i)) >> 31U) & 1) {
          printf((char const   */* __restrict  */)"%s\t%d\t", name, (i | 1) + (i & 1));
          j = i;
          while (1) {
            if ((int )((((~ ((size_t___1 )j) & (size_t___1 )ks->seq.l) | (~ ((size_t___1 )j ^ (size_t___1 )ks->seq.l) & ((size_t___1 )j - (size_t___1 )ks->seq.l))) >> 31UL) & 1UL)) {
              if (((unsigned int )(((int )*(hap1->s + j) - (int )*(hap2->s + j)) | ((int )*(hap2->s + j) - (int )*(hap1->s + j))) >> 31U) & 1) {
                if (! (((unsigned int )(~ ((((~ ((int )*(hap2->s + j)) | (int )mutmsk) - ~ ((int )*(hap2->s + j))) - 61440) | (61440 - ((~ ((int )*(hap2->s + j)) | (int )mutmsk) - ~ ((int )*(hap2->s + j)))))) >> 31U) & 1)) {
                  break;
                }
              } else {
                break;
      ...
      if (((unsigned int )((~ ((((~ c[1] | (int )mutmsk) - ~ c[1]) >> 12) ^ 4) >> 1) + ((((~ c[1] | (int )mutmsk) - ~ c[1]) >> 12) & ~ 4)) >> 31U) & 1) {
        if (((unsigned int )((((((~ c[1] | (int )mutmsk) + c[1]) + 1) >> 12) >> 1) - ((((~ c[1] | (int )mutmsk) + c[1]) + 1) >> 12)) >> 31U) & 1) {
          printf((char const   */* __restrict  */)"%s\t%d\t-\t", name, (i - ~ 1) - 1);
          n___0 = ((~ c[1] | (int )mutmsk) - ~ c[1]) >> 12;
          ins___0 = c[1] >> 4;
          while (((unsigned int )((n___0 >> 1) - n___0) >> 31U) & 1) {
            putchar((int )*("ACGTN" + (((~ ins___0 | 3) + ins___0) + 1)));
            ins___0 >>= 2;
            n___0 = (n___0 + ~ 1) + 1;
          }
          printf((char const   */* __restrict  */)"\t+\n");
      ...
      _L___0: 
      if (((unsigned int )((~ ((((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12) ^ 4) >> 1) + ((((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12) & ~ 4)) >> 31U) & 1) {
        goto _L;
      } else
      if (((unsigned int )((((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12) ^ ((((((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12) >> 31) - (((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12)) ^ ((((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12) >> 31))) >> 31U) & 1) {
        _L: 
        printf((char const   */* __restrict  */)"%s\t%d\t-\t", name, (i ^ 1) + ((i & 1) << 1));
        n___1 = ((~ c[2] | (int )mutmsk) - ~ c[2]) >> 12;
        ins___1 = c[2] >> 4;
        while (((unsigned int )((n___1 >> 1) - n___1) >> 31U) & 1) {
          putchar((int )*("ACGTN" + ((~ ins___1 | 3) - ~ ins___1)));
          ins___1 >>= 2;
          n___1 = (n___1 ^ 1) - ((~ n___1 & 1) << 1);
        }
        printf((char const   */* __restrict  */)"\t+\n");
      }
    }
...
{ 
  ...
  i = 0;
  while ((int )(((((size_t___1 )i - (size_t___1 )ks->seq.l) | ((size_t___1 )ks->seq.l - (size_t___1 )i)) >> 31UL) & 1UL)) {
    ...
    *((ret[0])->s + i) = tmp___1;
    ...
    if (deleting) {
      ...
      if (tmp___3 < INDEL_EXTEND) {
        if ((~ deleting | 1) - ~ deleting) {
          *((ret[0])->s + i) = (mut_t )((((int )*((ret[0])->s + i) + 61440) + 1) + ((- ((int )*((ret[0])->s + i)) - 1) | (- 61440 - 1)));
        }
        if ((~ deleting | 2) - ~ deleting) {
          *((ret[1])->s + i) = (mut_t )(((int )*((ret[1])->s + i) & ~ 61440) + 61440);
        }
        goto __Cont;
      } else {
        deleting = 0;
    ...
    if (((unsigned int )((c & ~ 4) | (~ (c ^ 4) & (c - 4))) >> 31U) & 1) {
      tmp___23 = drand48();
      if (tmp___23 < MUT_RATE) {
        tmp___22 = drand48();
        if (INDEL_FRAC <= tmp___22) {
          tmp___4 = drand48();
          r = tmp___4;
          c = ((~ (((c ^ ~ ((int )(r * 3.0 + (double )1))) + ((c | (int )(r * 3.0 + (double )1)) + (c | (int )(r * 3.0 + (double )1)))) + 1) | 3) + (((c ^ ~ ((int )(r * 3.0 + (double )1))) + ((c | (int )(r * 3.0 + (double )1)) + (c | (int )(r * 3.0 + (double )1)))) + 1)) + 1;
          if (is_hap) {
            tmp___5 = (mut_t )(((57344 + c) + 1) + ((- 57344 - 1) | (- c - 1)));
            *((ret[1])->s + i) = tmp___5;
            *((ret[0])->s + i) = tmp___5;
          } else {
            tmp___9 = drand48();
            if (tmp___9 < 0.333333) {
              tmp___5 = (mut_t )((57344 & ~ c) + c);
              *((ret[1])->s + i) = tmp___5;
              *((ret[0])->s + i) = tmp___5;
            } else {
              tmp___8 = drand48();
              ...
              *((ret[tmp___7])->s + i) = (mut_t )(((57344 + c) + 1) + ((- 57344 - 1) | (- c - 1)));
            }
          }
        } else {
          tmp___21 = drand48();
          if (tmp___21 < 0.5) {
            ...
            while (1) {
              num_ins = (num_ins - ~ 1) - 1;
              tmp___14 = drand48();
              ins = (((ins << 2) + (int )(tmp___14 * 4.0)) + 1) + ((- (ins << 2) - 1) | (- ((int )(tmp___14 * 4.0)) - 1));
              if (((unsigned int )((num_ins & ~ 4) | (~ (num_ins ^ 4) & (num_ins - 4))) >> 31U) & 1) {
                tmp___15 = drand48();
            ...
            if (is_hap) {
              tmp___16 = (mut_t )((((((num_ins << 12) & ~ (ins << 4)) + (ins << 4)) + c) + 1) + ((- (((num_ins << 12) & ~ (ins << 4)) + (ins << 4)) - 1) | (- c - 1)));
              *((ret[1])->s + i) = tmp___16;
              *((ret[0])->s + i) = tmp___16;
            } else {
              tmp___20 = drand48();
              if (tmp___20 < 0.333333) {
                ...
                *((ret[tmp___18])->s + i) = (mut_t )(((((((num_ins << 12) + (ins << 4)) + 1) + ((- (num_ins << 12) - 1) | (- (ins << 4) - 1))) + c) + 1) + ((- ((((num_ins << 12) + (ins << 4)) + 1) + ((- (num_ins << 12) - 1) | (- (ins << 4) - 1))) - 1) | (- c - 1)));
              }
            }
          }
        }
...
{ 
  ...
  if (((unsigned int )(((((3 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (3 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) >> 31) - ((3 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (3 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind)))) ^ (((3 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (3 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) >> 31)) >> 31U) & 1) {
    tmp___0 = simu_usage();
    return (tmp___0);
  }
  fpout1 = fopen((char const   */* __restrict  */)*(argv + (((optind | 1) + (optind | 1)) - (optind ^ 1))),
                 (char const   */* __restrict  */)"w");
  fpout2 = fopen((char const   */* __restrict  */)*(argv + (((optind ^ ~ 2) + ((optind | 2) << 1)) + 1)),
                 (char const   */* __restrict  */)"w");
  if (! fpout1) {
  ...
  if (((unsigned int )(seed | ~ (- seed)) >> 31U) & 1) {
    tmp___1 = time((time_t *)0);
    seed = (int )((~ tmp___1 | 2147483647LL) - ~ tmp___1);
  }
...
{ 
  ...
  {
  if (((unsigned int )((size_r & ~ size_l) | (~ (size_r ^ size_l) & (size_r - size_l))) >> 31U) & 1) {
    l = size_l;
  } else {
    l = size_r;
  }
  tmp = calloc((size_t___0 )((l - ~ 1) - 1), (size_t___0 )1);
  qstr = (char *)tmp;
  tmp___0 = calloc((size_t___0 )((l ^ 2) + ((l & 2) + (l & 2))), (size_t___0 )1);
  tmp_seq[0] = (uint8_t *)tmp___0;
  tmp___1 = calloc((size_t___0 )(((l ^ ~ 2) + ((l | 2) << 1)) + 1), (size_t___0 )1);
  ...
  if (ERR_RATE == 0.0) {
    ...
    tmp___3 = log(10.0);
    Q = ((int )((- 10.0 * tmp___2) / tmp___3 + 0.499) - ~ 33) - 1;
  }
  fp_fa = gzopen(fn, "r");
  ks = kseq_init(fp_fa);
  n_ref = 0;
  ...
  while (1) {
    ...
    tot_len = (tot_len - ~ ((uint64_t )l)) - 1ULL;
    n_ref = (n_ref - ~ 1) - 1;
  }
  ...
  while (1) {
    ...
    if (((unsigned int )((l - (((dist ^ ~ ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) + ((dist | ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) << 1)) + 1)) ^ ((l ^ (((dist ^ ~ ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) + ((dist | ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) << 1)) + 1)) & ((l - (((dist ^ ~ ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) + ((dist | ((3 & std_dev) * (3 | std_dev) + (3 & ~ std_dev) * (~ 3 & std_dev))) << 1)) + 1)) ^ l))) >> 31U) & 1) {
      continue;
    }
    wgsim_mut_diref((kseq_t const   *)ks, is_hap, rseq, rseq + 1);
    ii = (uint64_t )0;
    while ((int )(((((long long )(ii - n_pairs) >> 63LL) - ((ii - n_pairs) ^ ((long long )(ii - n_pairs) >> 63LL))) >> 63ULL) & 1ULL)) {
      is_flip = 0;
      while (1) {
        ran = ran_normal();
        ran = ran * (double )std_dev + (double )dist;
        d = (int )(ran + 0.5);
        if (((unsigned int )((max_size & ~ d) | (~ (max_size ^ d) & (max_size - d))) >> 31U) & 1) {
          d = d;
        } else {
          d = max_size;
        }
        tmp___4 = drand48();
        pos = (int )((double )((((l ^ d) - ((~ l & d) + (~ l & d))) - ~ 1) - 1) * tmp___4);
        if (! (((unsigned int )pos >> 31U) & 1)) {
          if (! ((int )((((~ ks->seq.l | (size_t___1 )pos) & ((ks->seq.l ^ (size_t___1 )pos) | ~ ((size_t___1 )pos - ks->seq.l))) >> 31UL) & 1UL))) {
            if (! ((int )((((~ ks->seq.l | (size_t___1 )((((pos ^ d) + ((pos & d) << 1)) + ~ 1) + 1)) & ((ks->seq.l ^ (size_t___1 )((((pos ^ d) + ((pos & d) << 1)) + ~ 1) + 1)) | ~ ((size_t___1 )((((pos ^ d) + ((pos & d) << 1)) + ~ 1) + 1) - ks->seq.l))) >> 31UL) & 1UL))) {
              break;
            }
          }
        }
      ...
      while (1) {
        ...
        while (1) {
          if (((unsigned int )(~ i) >> 31U) & 1) {
            if ((int )((((~ ((size_t___1 )i) & ks->seq.l) | (~ ((size_t___1 )i ^ ks->seq.l) & ((size_t___1 )i - ks->seq.l))) >> 31UL) & 1UL)) {
              if (! (((unsigned int )((((s[0] - k) & - (s[0] >= k)) >> 31) - (((s[0] - k) & - (s[0] >= k)) ^ (((s[0] - k) & - (s[0] >= k)) >> 31))) >> 31U) & 1)) {
                break;
              }
            } else {
              break;
          ...
          c = (int )*(target + i);
          mut_type = ((~ c | (int )mutmsk) + c) + 1;
          if (((unsigned int )ext_coor[0] >> 31U) & 1) {
            if (((unsigned int )(((mut_type + mut_type) & (mut_type >> 31)) - mut_type) >> 31U) & 1) {
              if (((unsigned int )((mut_type - 57344) | (57344 - mut_type)) >> 31U) & 1) {
                goto __Cont;
              }
            }
            ext_coor[0] = i;
          }
          if (((unsigned int )(~ ((mut_type - 61440) | (61440 - mut_type))) >> 31U) & 1) {
            n_indel[0] = ((n_indel[0] ^ ~ 1) + ((n_indel[0] | 1) << 1)) + 1;
          } else
          if (((unsigned int )(~ mut_type & (mut_type - 1)) >> 31U) & 1) {
            goto _L;
          } else
          if (((unsigned int )(((mut_type - 57344) - (((mut_type - 57344) + (mut_type - 57344)) & ((mut_type - 57344) >> 31))) - 1) >> 31U) & 1) {
            _L: 
            tmp___9 = k;
            k = ((k ^ ~ 1) + ((k | 1) << 1)) + 1;
            *(tmp_seq[0] + tmp___9) = (uint8_t )(((~ c | 15) + c) + 1);
            if (((unsigned int )((((mut_type - 57344) ^ ((mut_type - 57344) >> 31)) - ((mut_type - 57344) >> 31)) - 1) >> 31U) & 1) {
              n_sub[0] = ((n_sub[0] ^ ~ 1) + ((n_sub[0] | 1) << 1)) + 1;
            }
          } else {
            n_indel[0] = (n_indel[0] - ~ 1) - 1;
            tmp___10 = k;
            k = ((k ^ ~ 1) + ((k | 1) + (k | 1))) + 1;
            *(tmp_seq[0] + tmp___10) = (uint8_t )(((~ c | 15) + c) + 1);
            n = mut_type >> 12;
            ins = c >> 4;
            while (1) {
              if (((unsigned int )(- n & ~ n) >> 31U) & 1) {
                if (! (((unsigned int )(((((s[0] - k) & - (s[0] >= k)) << 1) & (((s[0] - k) & - (s[0] >= k)) >> 31)) - ((s[0] - k) & - (s[0] >= k))) >> 31U) & 1)) {
                  break;
                }
              } else {
                break;
              ...
              tmp___11 = k;
              k = (k - ~ 1) - 1;
              *(tmp_seq[0] + tmp___11) = (uint8_t )((~ ins | 3) - ~ ins);
              n = (n ^ 1) - ((~ n & 1) + (~ n & 1));
              ins >>= 2;
            }
          }
        ...
        if (((unsigned int )((k - s[0]) | (s[0] - k)) >> 31U) & 1) {
          ext_coor[0] = -10;
        }
        break;
      }
      while (1) {
        i = (((((pos ^ ~ d) + ((pos | d) << 1)) + 1) & ~ 1) + ((((pos ^ ~ d) + ((pos | d) << 1)) + 1) & ~ 1)) - ((((pos ^ ~ d) + ((pos | d) << 1)) + 1) ^ 1);
        k = 0;
        ext_coor[1] = -10;
        while (1) {
          if (((unsigned int )(~ i) >> 31U) & 1) {
            if ((int )((((~ ((size_t___1 )i) & ks->seq.l) | (~ ((size_t___1 )i ^ ks->seq.l) & ((size_t___1 )i - ks->seq.l))) >> 31UL) & 1UL)) {
              if (! (((unsigned int )(((((s[1] - k) & - (s[1] >= k)) + ((s[1] - k) & - (s[1] >= k))) & (((s[1] - k) & - (s[1] >= k)) >> 31)) - ((s[1] - k) & - (s[1] >= k))) >> 31U) & 1)) {
                break;
              }
            } else {
              break;
          ...
          c___0 = (int )*(target + i);
          mut_type___0 = ((~ c___0 | (int )mutmsk) + c___0) + 1;
          if (((unsigned int )ext_coor[1] >> 31U) & 1) {
            if (((unsigned int )(mut_type___0 | - mut_type___0) >> 31U) & 1) {
              if (((unsigned int )(((mut_type___0 - 57344) >> 31) - ((mut_type___0 - 57344) ^ ((mut_type___0 - 57344) >> 31))) >> 31U) & 1) {
                goto __Cont___0;
              }
            }
            ext_coor[1] = i;
          }
          if (((unsigned int )(~ ((mut_type___0 - 61440) | (61440 - mut_type___0))) >> 31U) & 1) {
            n_indel[1] = ((n_indel[1] ^ ~ 1) + ((n_indel[1] | 1) << 1)) + 1;
          } else
          if (((unsigned int )(~ (mut_type___0 | - mut_type___0)) >> 31U) & 1) {
            goto _L___0;
          } else
          if (((unsigned int )((((mut_type___0 - 57344) ^ ((mut_type___0 - 57344) >> 31)) - ((mut_type___0 - 57344) >> 31)) - 1) >> 31U) & 1) {
            _L___0: 
            tmp___12 = k;
            k = ((k | 1) + (k | 1)) - (k ^ 1);
            *(tmp_seq[1] + tmp___12) = (uint8_t )(((~ c___0 | 15) + c___0) + 1);
            if (((unsigned int )((((mut_type___0 - 57344) + (1 << 31)) + (((mut_type___0 - 57344) + (1 << 31)) >> 31)) ^ (((mut_type___0 - 57344) + (1 << 31)) >> 31)) >> 31U) & 1) {
              n_sub[1] = (n_sub[1] - ~ 1) - 1;
            }
          } else {
            n_indel[1] = (n_indel[1] ^ 1) + ((n_indel[1] & 1) + (n_indel[1] & 1));
            tmp___13 = k;
            k = ((k | 1) << 1) - (k ^ 1);
            *(tmp_seq[1] + tmp___13) = (uint8_t )(((~ c___0 | 15) + c___0) + 1);
            n___0 = mut_type___0 >> 12;
            ins___0 = c___0 >> 4;
            while (1) {
              if (((unsigned int )((n___0 >> 1) - n___0) >> 31U) & 1) {
                if (! (((unsigned int )((k & ~ s[1]) | (~ (k ^ s[1]) & (k - s[1]))) >> 31U) & 1)) {
                  break;
                }
              } else {
                break;
              ...
              tmp___14 = k;
              k = (k | 1) + (k & 1);
              *(tmp_seq[1] + tmp___14) = (uint8_t )(((~ ins___0 | 3) + ins___0) + 1);
              n___0 = (n___0 + ~ 1) + 1;
              ins___0 >>= 2;
            }
          }
        ...
        if (((unsigned int )((k - s[1]) | (s[1] - k)) >> 31U) & 1) {
          ext_coor[1] = -10;
        }
        break;
      }
      k = 0;
      while (((unsigned int )((k & ~ s[1]) | (~ (k ^ s[1]) & (k - s[1]))) >> 31U) & 1) {
        if (((unsigned int )(((int )*(tmp_seq[1] + k) - 4) ^ (((int )*(tmp_seq[1] + k) ^ 4) & (((int )*(tmp_seq[1] + k) - 4) ^ (int )*(tmp_seq[1] + k)))) >> 31U) & 1) {
          *(tmp_seq[1] + k) = (uint8_t )((3 + ~ ((int )*(tmp_seq[1] + k))) + 1);
        } else {
      ...
      if (((unsigned int )ext_coor[1] >> 31U) & 1) {
        ii = (ii ^ 1ULL) - ((~ ii & 1ULL) << 1ULL);
        goto __Cont___1;
      }
      j = 0;
      while (((unsigned int )((j - 2) ^ ((j ^ 2) & ((j - 2) ^ j))) >> 31U) & 1) {
        n_n = 0;
        i = 0;
        while (((unsigned int )((i & ~ s[j]) | (~ (i ^ s[j]) & (i - s[j]))) >> 31U) & 1) {
          c___1 = (int )*(tmp_seq[j] + i);
          if (((unsigned int )((4 | ~ c___1) & ((4 ^ c___1) | ~ (c___1 - 4))) >> 31U) & 1) {
            c___1 = 4;
            n_n = (n_n | 1) + (n_n & 1);
          } else {
            tmp___15 = drand48();
            if (tmp___15 < ERR_RATE) {
              c___1 = (~ ((c___1 - ~ 1) - 1) | 3) - ~ ((c___1 - ~ 1) - 1);
              n_err[j] = (n_err[j] | 1) + (n_err[j] & 1);
            }
          }
          *(tmp_seq[j] + i) = (uint8_t )c___1;
          i = (i | 1) + (i & 1);
        }
        if (MAX_N_RATIO < (double )n_n / (double )s[j]) {
          break;
        }
        j = (j - ~ 1) - 1;
      }
      if (((unsigned int )((j & ~ 2) | (~ (j ^ 2) & (j - 2))) >> 31U) & 1) {
        ii = (ii + ~ 1ULL) + 1ULL;
        goto __Cont___1;
      }
      j = 0;
      while (((unsigned int )((j - 2) ^ ((j ^ 2) & ((j - 2) ^ j))) >> 31U) & 1) {
        i = 0;
        while (((unsigned int )(((((s[j] - i) & - (s[j] >= i)) << 1) & (((s[j] - i) & - (s[j] >= i)) >> 31)) - ((s[j] - i) & - (s[j] >= i))) >> 31U) & 1) {
          *(qstr + i) = (char )Q;
          i = ((i | 1) + (i | 1)) - (i ^ 1);
        }
        *(qstr + i) = (char)0;
        if (((unsigned int )(~ j & (j - 1)) >> 31U) & 1) {
          tmp___16 = (is_flip | 1) + (is_flip & 1);
        } else {
          tmp___16 = (2 ^ is_flip) - ((~ 2 & is_flip) + (~ 2 & is_flip));
        }
        fprintf((FILE */* __restrict  */)fpo[j], (char const   */* __restrict  */)"@%s_%u_%u_%d:%d:%d_%d:%d:%d_%llx/%d\n",
                ks->name.s, (ext_coor[0] | 1) + (ext_coor[0] & 1), ((ext_coor[1] ^ ~ 1) + ((ext_coor[1] | 1) << 1)) + 1,
                n_err[0], n_sub[0], n_indel[0], n_err[1], n_sub[1], n_indel[1], (long long )ii,
                tmp___16);
        i = 0;
        while (((unsigned int )(((((s[j] - i) & - (s[j] >= i)) << 1) & (((s[j] - i) & - (s[j] >= i)) >> 31)) - ((s[j] - i) & - (s[j] >= i))) >> 31U) & 1) {
      ...
      __Cont___1: 
      ii = ((ii ^ ~ 1ULL) + ((ii | 1ULL) + (ii | 1ULL))) + 1ULL;
    }
    free((void *)rseq[0].s);
    free((void *)rseq[1].s);
  }
...
{ 
  ...
  if (((unsigned int )((ks->end | ~ ks->begin) & ((ks->end ^ ks->begin) | ~ (ks->begin - ks->end))) >> 31U) & 1) {
    ...
    if (((unsigned int )(((ks->end ^ (ks->end >> 31)) - (ks->end >> 31)) - 1) >> 31U) & 1) {
      return (-1);
    }
  }
  tmp = ks->begin;
  ks->begin = (ks->begin | 1) + (ks->begin & 1);
