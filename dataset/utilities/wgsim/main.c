...
#line 42
      memcpy((void *__restrict)(str->s + str->l),
...
#line 105 "wgsim.c"
void wgsim_mut_diref(kseq_t const *ks, int is_hap, mutseq_t *hap1,
                     mutseq_t *hap2) {
  int i;
  int deleting;
  mutseq_t *ret[2];
...
#line 230 "wgsim.c"
void wgsim_core(FILE *fpout1, FILE *fpout2, char const *fn, int is_hap,
...
#line 254
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"[%s] calculating the total length of the "
                                    "reference sequence...\n",
            "wgsim_core");
#line 255
    while (1) {
...
#line 266
      n_pairs =
          (uint64_t)(((long double)l / (long double)tot_len) * (long double)N +
                     (long double)0.5);
#line 267
      if (l < dist + 3 * std_dev) {
#line 268
...
#line 377
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"Program: wgsim (short read simulator)\n");
#line 378
    fprintf((FILE *__restrict)stderr, (char const *__restrict)"Version: %s\n",
            "0.3.1-r13");
#line 379
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"Contact: Heng Li <lh3@sanger.ac.uk>\n\n");
#line 380
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"Usage:   wgsim [options] <in.ref.fa> "
                                    "<out.read1.fq> <out.read2.fq>\n\n");
#line 381
    fprintf((FILE *__restrict)stderr,
            (char const
                 *__restrict)"Options: -e FLOAT      base error rate [%.3f]\n",
            ERR_RATE);
#line 382
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -d INT        outer distance "
                                    "between the two ends [500]\n");
#line 383
    fprintf(
        (FILE *__restrict)stderr,
        (char const
             *__restrict)"         -s INT        standard deviation [50]\n");
#line 384
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -N INT        number of read "
                                    "pairs [1000000]\n");
#line 385
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -1 INT        length of the "
                                    "first read [70]\n");
#line 386
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -2 INT        length of the "
                                    "second read [70]\n");
#line 387
    fprintf(
        (FILE *__restrict)stderr,
        (char const
             *__restrict)"         -r FLOAT      rate of mutations [%.4f]\n",
        MUT_RATE);
#line 388
    fprintf(
        (FILE *__restrict)stderr,
        (char const
             *__restrict)"         -R FLOAT      fraction of indels [%.2f]\n",
        INDEL_FRAC);
#line 389
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -X FLOAT      probability an "
                                    "indel is extended [%.2f]\n",
            INDEL_EXTEND);
#line 390
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -S INT        seed for random "
                                    "generator [-1]\n");
#line 391
    fprintf((FILE *__restrict)stderr,
            (char const
                 *__restrict)"         -A FLOAT      disgard if the fraction "
                             "of ambiguous bases higher than FLOAT [%.2f]\n",
            MAX_N_RATIO);
#line 392
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"         -h            haplotype mode\n");
#line 393
    fprintf((FILE *__restrict)stderr, (char const *__restrict)"\n");
#line 394
    return (1);
...
#line 423
    fpout1 = fopen((char const *__restrict)*(argv + (optind + 1)),
                   (char const *__restrict)"w");
#line 424
    fpout2 = fopen((char const *__restrict)*(argv + (optind + 2)),
                   (char const *__restrict)"w");
#line 425
    if (!fpout1) {
#line 426
      fprintf((FILE *__restrict)stderr,
              (char const *__restrict)"[wgsim] file open error\n");
#line 427
      return (1);
    } else
#line 425
...
#line 430
    fprintf((FILE *__restrict)stderr,
            (char const *__restrict)"[wgsim] seed = %d\n", seed);
#line 431
    srand48((long)seed);
#line 432
    wgsim_core(fpout1, fpout2, (char const *)*(argv + optind), is_hap,
               (uint64_t)N, dist, std_dev, size_l, size_r);
#line 434
    fclose(fpout1);
#line 434
    fclose(fpout2);
