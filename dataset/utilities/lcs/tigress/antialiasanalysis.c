...
/* Generated by Tigress v3.2 (https://tigress.wtf), 07:03:23-2023/04/23 */
  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      "Modified Function Implementations": [
        "scoring_print", "scoring_init", "parse_entire_int", "main",
        "gzreadline_buf", "gzreadline", "cmdline_new", "bitset_alloc",
        "alignment_free", "alignment_fill_matrices", "alignment_create",
        "aligner_destroy", "aligner_align", "align_scoring_load_matrix",
        "_seq_read_unknown_gz", "_seq_read_fastq_gz", "_follow_hit",
...
void *_3__functionPtrArray[]  = 
  {      & realloc,      & realloc - 791,      & fprintf,      & exit, 
        ...
        & alignment_reverse_move - 738,      & gzgetc,      & gzgetc + 27,      & gzgetc, 
        & gzgetc,      & gzgetc,      & gzungetc,      & gzgetc, 
        & gzgetc - 514,      & isspace,      & isspace + 694,      & gzungetc, 
        & strbuf_new,      & strbuf_new + 281,      & strbuf_reset_gzreadline,      & strbuf_reset_gzreadline - 963, 
        & strbuf_chomp,      & strbuf_chomp + 503,      & string_is_all_whitespace,      & string_is_all_whitespace + 478, 
        & _loading_error,      & _loading_error,      & _loading_error + 106,      & _loading_error, 
        & _loading_error - 821,      & _loading_error,      & malloc,      & malloc - 229, 
        & isspace,      & isspace + 499,      & string_next_nonwhitespace,      & string_next_nonwhitespace - 802, 
        & tolower,      & strbuf_reset_gzreadline,      & strbuf_chomp,      & string_next_nonwhitespace, 
        & string_next_nonwhitespace - 304,      & tolower,      & isspace,      & isspace + 445, 
        & _loading_error,      & string_next_nonwhitespace,      & string_next_nonwhitespace + 300,      & strtol, 
        & strtol - 399,      & _loading_error,      & scoring_add_mutation,      & scoring_add_mutation - 418, 
        & string_is_all_whitespace,      & _loading_error,      & _loading_error,      & _loading_error - 402, 
        & tolower,      & strbuf_reset_gzreadline,      & strbuf_chomp,      & tolower, 
        & tolower + 331,      & string_is_all_whitespace,      & _loading_error,      & strtol, 
        & _loading_error,      & _loading_error,      & _loading_error - 483,      & scoring_add_mutation, 
        & scoring_add_mutation - 571,      & free,      & free + 611,      & realloc, 
        & realloc + 348,      & realloc,      & realloc - 606,      & realloc, 
        & realloc - 110,      & alignment_fill_matrices,      & alignment_fill_matrices + 472,      & free, 
        & free + 183,      & free,      & free + 102,      & free, 
        & malloc,      & malloc,      & malloc - 398,      & malloc, 
        & abs,      & scoring_lookup,      & free,      & free + 523, 
        & free,      & free,      & calloc,      & calloc - 521, 
        & calloc,      & calloc - 579,      & malloc,      & malloc, 
        & malloc + 527,      & print_usage,      & strcasecmp,      & print_usage, 
        & strcasecmp,      & print_usage,      & strcasecmp,      & strcasecmp + 800, 
        & print_usage,      & print_usage - 974,      & strcasecmp,      & strcasecmp - 423, 
        & strcasecmp,      & strcasecmp - 470,      & print_usage,      & print_usage + 366, 
        & strcasecmp,      & strcasecmp - 880,      & scoring_system_PAM30,      & scoring_system_PAM30 + 398, 
        & strcasecmp,      & strcasecmp - 277,      & scoring_system_PAM70,      & scoring_system_PAM70 + 563, 
        & strcasecmp,      & scoring_system_BLOSUM80,      & scoring_system_BLOSUM80 + 324,      & strcasecmp, 
        & strcasecmp - 404,      & scoring_system_BLOSUM62,      & scoring_system_BLOSUM62 - 58,      & strcasecmp, 
        & strcasecmp - 374,      & scoring_system_DNA_hybridization,      & print_usage,      & print_usage + 244, 
        & strcasecmp,      & print_usage,      & print_usage - 882,      & strcasecmp, 
        & print_usage,      & print_usage - 639,      & strcasecmp,      & strcasecmp + 59, 
        & strcasecmp,      & strcasecmp + 728,      & strcasecmp,      & strcasecmp + 835, 
        & strcasecmp,      & strcasecmp + 138,      & strcasecmp,      & strcasecmp + 31, 
        & strcasecmp,      & strcasecmp + 756,      & print_usage,      & strcasecmp, 
        & strcasecmp,      & strcasecmp - 757,      & print_usage,      & print_usage - 123, 
        & strcasecmp,      & strcasecmp - 85,      & strcasecmp,      & strcasecmp - 467, 
        & strcasecmp,      & strcasecmp + 55,      & strcasecmp,      & strcasecmp - 281, 
        & print_usage,      & print_usage - 18,      & strcasecmp,      & strcasecmp - 253, 
        & cmdline_add_files,      & cmdline_add_files + 559,      & print_usage,      & strcasecmp, 
        & strcasecmp,      & gzopen,      & print_usage,      & print_usage - 515, 
        & align_scoring_load_matrix,      & gzclose,      & strcasecmp,      & gzopen, 
        & gzopen - 118,      & print_usage,      & align_scoring_load_pairwise,      & align_scoring_load_pairwise + 628, 
        & gzclose,      & strcasecmp,      & print_usage,      & parse_entire_int, 
        & print_usage,      & print_usage + 681,      & strcasecmp,      & strcasecmp - 190, 
        & print_usage,      & parse_entire_uint,      & parse_entire_uint + 896,      & print_usage, 
        & print_usage - 91,      & strcasecmp,      & strcasecmp + 53,      & print_usage, 
        & parse_entire_uint,      & print_usage,      & print_usage - 836,      & strcasecmp, 
        & parse_entire_int,      & print_usage,      & print_usage + 479,      & strcasecmp, 
        & parse_entire_int,      & parse_entire_int + 232,      & print_usage,      & strcasecmp, 
        & parse_entire_int,      & parse_entire_int - 140,      & print_usage,      & strcasecmp, 
        & parse_entire_int,      & print_usage,      & strcasecmp,      & cmdline_add_files, 
        & strcasecmp,      & print_usage,      & print_usage + 557,      & strcmp, 
        & strcmp + 9,      & strcmp,      & cmdline_add_files,      & cmdline_add_files, 
        & cmdline_add_files,      & strcasecmp,      & print_usage,      & strlen, 
        & print_usage,      & print_usage - 486,      & parse_entire_int,      & print_usage, 
        & print_usage + 652,      & scoring_add_wildcard,      & print_usage,      & print_usage - 225, 
        & print_usage,      & print_usage,      & print_usage + 10,      & print_usage, 
        & print_usage - 693,      & print_usage,      & print_usage,      & print_usage, 
        & print_usage,      & print_usage,      & print_usage,      & print_usage, 
        & print_usage,      & gzgets,      & gzgets - 207,      & strlen, 
        & strlen + 796,      & realloc,      & realloc + 480,      & memcpy, 
        & memcpy - 544,      & print_usage___0,      & print_usage___0 - 917,      & strlen, 
        & strlen + 171,      & scoring_init,      & smith_waterman_new,      & alignment_create, 
        & alignment_create + 535,      & smith_waterman_align,      & smith_waterman_align + 242,      & smith_waterman_fetch, 
        & smith_waterman_fetch + 373,      & fputs,      & printf,      & printf - 597, 
        & smith_waterman_free,      & alignment_free,      & strlen,      & strlen + 337, 
        & strtol,      & strtol + 23,      & memset,      & memset - 103, 
        & memset,      & memset + 490,      & printf,      & printf, 
        & printf,      & printf - 998,      & printf,      & printf, 
        & printf - 343};
...
{ 
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 23 ^ c : 23])(sf->gz_file);
      c = tmp___0;
    }
    if (c != -1) {
      tmp___1 = ((int (*)(int  ))_3__functionPtrArray[25 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(c);
      if (! tmp___1) {
        break;
      }
    } else {
  ...
  ((int (*)(int c , gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 27 : 27 | c])(c,
                                                                                                                        sf->gz_file);
...
{ 
  ...
  origlen = *len;
  while (1) {
    tmp___3 = ((char *(*)(gzFile file , char *buf , int len ))_3__functionPtrArray[269 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(file,
                                                                                                                                                *buf + *len,
                                                                                                                                                (int )r);
    if (! ((unsigned long )tmp___3 != (unsigned long )((void *)0))) {
      break;
    }
    tmp___0 = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 271 : 271 + 9])((char const   *)(*buf + *len));
    _3__functionPtrArray[86 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[170];
    *len += tmp___0;
    if ((int )*(*buf + (*len - 1UL)) == 10) {
      return (*len - origlen);
    } else {
      tmp___1 = *size * 2UL;
      *size = tmp___1;
      tmp___2 = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[273 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)*buf,
                                                                                                                                        tmp___1);
      *buf = (char *)tmp___2;
    }
    if (*size - *len > 4294967295UL) {
...
{ 
  ...
  if ((sf->gz_file)->have) {
    ...
    tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[17 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 << tmp___1 : 11] = & tmp;
    tmp___1 = tmp___0;
  }
  c = tmp___1;
  if (c == -1) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___5 = ((int (*)(gzFile file ))_3__functionPtrArray[19 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___7 = ((int (*)(gzFile file ))_3__functionPtrArray[20 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sf->gz_file);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 7 : tmp___1] = _3__functionPtrArray[0];
      c = tmp___7;
    }
    if (c != -1) {
      if (! (c != 10)) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___10 = ((int (*)(gzFile file ))_3__functionPtrArray[21 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
  ...
  ((int (*)(int c , gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 22 : tmp___1])(c,
                                                                                                                         sf->gz_file);
  return (1);
}
}
...
{ 
  ...
  if (argc != 2) {
    ((void (*)(char **argv ))_3__functionPtrArray[277 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(argv);
    _3__functionPtrArray[107 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[114];
  }
  seq = *(argv + 1);
  tmp = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[279 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)seq);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 35 : 8] = _3__functionPtrArray[271];
  seqlen = tmp;
  match = 1;
  mismatch = -1;
  gap_open = -4;
  ...
  ((void (*)(scoring_t *scoring , int match , int mismatch , int gap_open , int gap_extend ,
             _Bool no_start_gap_penalty , _Bool no_end_gap_penalty , _Bool no_gaps_in_a ,
             _Bool no_gaps_in_b , _Bool no_mismatches , _Bool case_sensitive ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 281 : 7])(& scoring,
                                                                                                                                                                 match,
                                                                                                                                                                 mismatch,
                                                                                                                                                                 gap_open,
                                                                                                                                                                 gap_extend,
                                                                                                                                                                 ...
                                                                                                                                                                 no_mismatches,
                                                                                                                                                                 case_sensitive);
  tmp___0 = ((sw_aligner_t *(*)(void))_3__functionPtrArray[282 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])();
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? gap_extend : 159] = _3__functionPtrArray[63];
  sw = tmp___0;
  tmp___1 = ((alignment_t *(*)(size_t___1 capacity ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 283 : r25])(seqlen + 1UL);
  _3__functionPtrArray[175 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[132];
  aln = tmp___1;
  ((void (*)(char const   *a , char const   *b , scoring_t const   *scoring , sw_aligner_t *sw ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 285 : 285 - 2])((char const   *)seq,
                                                                                                                                                                                         (char const   *)seq,
                                                                                                                                                                                         (scoring_t const   *)(& scoring),
                                                                                                                                                                                         sw);
  _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[174];
  while (1) {
    tmp___2 = ((int (*)(sw_aligner_t *sw , alignment_t *result ))_3__functionPtrArray[287 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sw,
                                                                                                                                                 aln);
    if (! tmp___2) {
      break;
    }
    if (aln->pos_a < aln->pos_b) {
      ((int (*)(char const   * , FILE * ))_3__functionPtrArray[289 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)((char const   */* __restrict  */)aln->result_a),
                                                                                                                            (FILE *)((FILE */* __restrict  */)stdout));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 109 << tmp___2 : 109] = _3__functionPtrArray[4];
      ((int (*)(char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 290 : 290 & 9])((char const   *)((char const   */* __restrict  */)" [%zu,%zu]\n"),
                                                                                                                               aln->pos_a,
                                                                                                                               aln->pos_b);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 150 : 150 | tmp___2] = & tmp___1;
    }
  }
  ((void (*)(sw_aligner_t *sw ))_3__functionPtrArray[292 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sw);
  _3__functionPtrArray[210 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[31];
  ((void (*)(alignment_t *result ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 293])(aln);
  _3__functionPtrArray[103 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[132];
  return (0);
}
}
...
{ 
  ...
  {
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 102 << 3 : 102])((void *)result->result_a);
  _3__functionPtrArray[43 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[20];
  ((void (*)(void * ))_3__functionPtrArray[104 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)result->result_b);
  _3__functionPtrArray[55 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[86];
  ((void (*)(void * ))_3__functionPtrArray[105 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)result);
  return;
}
}
...
{ 
  ...
  ((void *(*)(void * , int  , size_t___1  ))_3__functionPtrArray[298 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)(scoring->wildcards),
                                                                                                                                                                                   0,
                                                                                                                                                                                   sizeof(scoring->wildcards));
  _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[234];
  ((void *(*)(void * , int  , size_t___1  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 300 : tmp])((void *)(scoring->swap_set),
                                                                                                                                0,
                                                                                                                                sizeof(scoring->swap_set));
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 58 : 58 >> gap_extend] = _3__functionPtrArray[63];
  if (match <= mismatch) {
...
{ 
  ...
  {
  ((int (*)(char const   *  , ...))_3__functionPtrArray[302 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)((char const   */* __restrict  */)"scoring:\n"));
  ((int (*)(char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 303 : 6])((char const   *)((char const   */* __restrict  */)"  match: %i; mismatch: %i; (use_match_mismatch: %i)\n"),
                                                                                                                     scoring->match,
                                                                                                                     scoring->mismatch,
                                                                                                                     (int )scoring->use_match_mismatch);
  ((int (*)(char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 304 : 304 & 4])((char const   *)((char const   */* __restrict  */)"  gap_open: %i; gap_extend: %i;\n"),
                                                                                                                           scoring->gap_open,
                                                                                                                           scoring->gap_extend);
  ((int (*)(char const   *  , ...))_3__functionPtrArray[306 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)((char const   */* __restrict  */)"  no_gaps_in_a: %i; no_gaps_in_b: %i; no_mismatches: %i;\n"),
                                                                                                                   (int )scoring->no_gaps_in_a,
                                                                                                                   (int )scoring->no_gaps_in_b,
                                                                                                                   (int )scoring->no_mismatches);
  ((int (*)(char const   *  , ...))_3__functionPtrArray[307 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)((char const   */* __restrict  */)"  no_start_gap_penalty: %i; no_end_gap_penalty: %i;\n"),
                                                                                                                                                                          (int )scoring->no_start_gap_penalty,
                                                                                                                                                                          (int )scoring->no_end_gap_penalty);
  _3__functionPtrArray[129 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[291];
  return;
}
}
...
{ 
  ...
  {
  tmp = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 294])((char const   *)str);
  len = tmp;
  strtol_last_char_ptr = str;
  tmp___1 = ((long (*)(char const   * __restrict   , char ** __restrict   , int  ))_3__functionPtrArray[296 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   */* __restrict  */)str,
...
{ 
  ...
  if (aligner->capacity < new_capacity) {
    ...
    tmp = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[83 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)aligner->match_scores,
                                                                                                                                 mem);
    _3__functionPtrArray[80 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & len_b;
    aligner->match_scores = (score_t *)tmp;
    tmp___0 = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 85 : 6])((void *)aligner->gap_a_scores,
                                                                                                                                     mem);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 63] = _3__functionPtrArray[20];
    aligner->gap_a_scores = (score_t *)tmp___0;
    tmp___1 = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 87])((void *)aligner->gap_b_scores,
                                                                                                                                     mem);
    aligner->gap_b_scores = (score_t *)tmp___1;
  }
  ((void (*)(aligner_t *aligner , char is_sw ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 89 : 89 - 5])(aligner,
                                                                                                                                     is_sw);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : 6] = _3__functionPtrArray[22];
  return;
}
}
...
{ 
  ...
  {
  tmp = ((void *(*)(unsigned long  , unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 108 - tmp___5 : 108])((size_t___0 )1,
                                                                                                                                                    sizeof(cmdline_t ));
  cmd = (cmdline_t *)tmp;
  cmd->file_list_length = (size_t___1 )0;
  cmd->file_list_capacity = (size_t___1 )256;
  tmp___0 = ((void *(*)(unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 110])(sizeof(char *) * cmd->file_list_capacity);
  _3__functionPtrArray[38 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & tmp___9;
  cmd->file_paths1 = (char **)tmp___0;
  tmp___1 = ((void *(*)(unsigned long  ))_3__functionPtrArray[111 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sizeof(char *) * cmd->file_list_capacity);
  _3__functionPtrArray[58 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[33];
  ...
  if (argc == 1) {
    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
               char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 113 + 8 : 113])(cmd_type,
                                                                                                                                    defaults,
                                                                                                                                    (char const   *)*(argv + 0),
                                                                                                                                    (char const   *)((void *)0));
    _3__functionPtrArray[84 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & sub_matrix_file;
  }
  scoring_set = (char)0;
  ...
  argi = 1;
  while (argi < argc) {
    tmp___10 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 114 : 10])((char const   *)*(argv + argi),
                                                                                                                                              "--help");
    _3__functionPtrArray[94 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[30];
    if (tmp___10 == 0) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[115 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                defaults,
                                                                                                                                (char const   *)*(argv + 0),
                                                                                                                                (char const   *)((void *)0));
    } else {
      tmp___11 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 116])((char const   *)*(argv + argi),
                                                                                                                                               "-help");
      if (tmp___11 == 0) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 117 : 8])(cmd_type,
                                                                                                                                  defaults,
                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                  (char const   *)((void *)0));
      } else {
        tmp___12 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 118 : 118 + 10])((char const   *)*(argv + argi),
                                                                                                                                                        "-h");
        _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___7 : 24] = & tmp___1;
        if (tmp___12 == 0) {
          ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                     char const   *errfmt  , ...))_3__functionPtrArray[120 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                  defaults,
                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                  (char const   *)((void *)0));
          _3__functionPtrArray[78 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[101];
        } else {
          tmp___9 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[122 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                       "--case_sensitive");
          if (tmp___9 == 0) {
            cmd->case_sensitive = (_Bool)1;
          } else {
            tmp___8 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[124 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                         "--scoring");
            if (tmp___8 == 0) {
              if (scoring_set) {
                ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                           char const   *errfmt  , ...))_3__functionPtrArray[126 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                          defaults,
                                                                                                                                          (char const   *)*(argv + 0),
              ...
              tmp___7 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 128 : 128 | tmp___34])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                   "PAM30");
              _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 47 - 3 : 47] = & tmp___17;
              if (tmp___7 == 0) {
                ((void (*)(scoring_t *scoring ))_3__functionPtrArray[130 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(scoring);
                _3__functionPtrArray[129 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[103];
              } else {
                tmp___6 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[132 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                      "PAM70");
                if (tmp___6 == 0) {
                  ((void (*)(scoring_t *scoring ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 134 : 134 * 10])(scoring);
                } else {
                  tmp___5 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[136 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                               "BLOSUM80");
                  if (tmp___5 == 0) {
                    ((void (*)(scoring_t *scoring ))_3__functionPtrArray[137 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(scoring);
                  } else {
                    tmp___4 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[139 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                            "BLOSUM62");
                    if (tmp___4 == 0) {
                      ((void (*)(scoring_t *scoring ))_3__functionPtrArray[141 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(scoring);
                      _3__functionPtrArray[142 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & tmp___32;
                    } else {
                      tmp___3 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 143 >> tmp___9 : 143])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                           "DNA_HYBRIDIZATION");
                      _3__functionPtrArray[55 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[4];
                      if (tmp___3 == 0) {
                        ((void (*)(scoring_t *scoring ))_3__functionPtrArray[145 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(scoring);
                      } else {
                        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                   char const   *cmdstr , char const   *errfmt  , ...))_3__functionPtrArray[146 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                         defaults,
                                                                                                                                                                         (char const   *)*(argv + 0),
  ...
  while (argi < argc) {
    if ((int )*(*(argv + argi) + 0) == 45) {
      tmp___53 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[148 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                             "--freestartgap");
      if (tmp___53 == 0) {
        if ((unsigned int )cmd_type != 1U) {
          ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                     char const   *errfmt  , ...))_3__functionPtrArray[149 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                  defaults,
                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                  "--freestartgap only valid with Needleman-Wunsch");
          _3__functionPtrArray[55 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[94];
        }
        scoring->no_start_gap_penalty = (_Bool)1;
      } else {
        tmp___52 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 151])((char const   *)*(argv + argi),
                                                                                                                                                 "--freeendgap");
        if (tmp___52 == 0) {
          if ((unsigned int )cmd_type != 1U) {
            ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                       char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___31 : 152])(cmd_type,
                                                                                                                                             defaults,
                                                                                                                                             (char const   *)*(argv + 0),
                                                                                                                                             "--freeendgap only valid with Needleman-Wunsch");
            _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : 8] = _3__functionPtrArray[134];
          }
          scoring->no_end_gap_penalty = (_Bool)1;
        } else {
          tmp___51 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[154 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                        "--nogaps");
          _3__functionPtrArray[125 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[70];
          if (tmp___51 == 0) {
            scoring->no_gaps_in_a = (_Bool)1;
            scoring->no_gaps_in_b = (_Bool)1;
          } else {
            tmp___50 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[156 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                          "--nogapsin1");
            if (tmp___50 == 0) {
              scoring->no_gaps_in_a = (_Bool)1;
            } else {
              tmp___49 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 158 : tmp___7])((char const   *)*(argv + argi),
                                                                                                                                                             "--nogapsin2");
              _3__functionPtrArray[88 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[44];
              if (tmp___49 == 0) {
                scoring->no_gaps_in_b = (_Bool)1;
              } else {
                tmp___48 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 160 + tmp___48 : 160])((char const   *)*(argv + argi),
                                                                                                                                                                      "--nomismatches");
                if (tmp___48 == 0) {
                  scoring->no_mismatches = (_Bool)1;
                } else {
                  tmp___47 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 162 : tmp___38])((char const   *)*(argv + argi),
                                                                                                                                                                  "--case_sensitive");
                  _3__functionPtrArray[112 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[65];
                  if (! (tmp___47 == 0)) {
                    tmp___46 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 164 : 3])((char const   *)*(argv + argi),
                                                                                                                                                             "--printseq");
                    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___27 : 16] = _3__functionPtrArray[134];
                    if (tmp___46 == 0) {
                      if ((unsigned int )cmd_type != 0U) {
                        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                   char const   *cmdstr , char const   *errfmt  , ...))_3__functionPtrArray[166 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                              defaults,
                                                                                                                                                                                                                              (char const   *)*(argv + 0),
                      ...
                      tmp___45 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[167 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                               "--printmatrices");
                      _3__functionPtrArray[103 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & tmp___36;
                      if (tmp___45 == 0) {
                        cmd->print_matrices = (_Bool)1;
                      } else {
                        tmp___44 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[168 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                               "--printscores");
                        ...
                        if (tmp___44 == 0) {
                          if ((unsigned int )cmd_type != 1U) {
                            ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                       ...
                                       , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 170 << 4 : 170])(cmd_type,
                                                                                                                                       defaults,
                                                                                                                                       (char const   *)*(argv + 0),
                          ...
                          tmp___43 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 172 : 7])((char const   *)*(argv + argi),
                                                                                                                                                                   "--printfasta");
                          if (tmp___43 == 0) {
                            cmd->print_fasta = (_Bool)1;
                          } else {
                            tmp___42 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 174 : 174 | tmp___4])((char const   *)*(argv + argi),
                                                                                                                                                                                 "--pretty");
                            if (tmp___42 == 0) {
                              cmd->print_pretty = (_Bool)1;
                            } else {
                              tmp___41 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 176 << tmp___32 : 176])((char const   *)*(argv + argi),
                                                                                                                                                                                     "--colour");
                              _3__functionPtrArray[86 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[163];
                              if (tmp___41 == 0) {
                                cmd->print_colour = (_Bool)1;
                              } else {
                                tmp___40 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[178 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                              "--zam");
                                if (tmp___40 == 0) {
                                  if ((unsigned int )cmd_type != 1U) {
                                    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                               char const   *cmdstr , char const   *errfmt 
                                               , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 180 >> tmp___45 : 180])(cmd_type,
                                                                                                                                                      defaults,
                                                                                                                                                      (char const   *)*(argv + 0),
                                  ...
                                  tmp___39 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[182 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                                "--stdin");
                                  if (tmp___39 == 0) {
                                    ((void (*)(cmdline_t *cmd , char *p1 , char *p2 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 184 : tmp___41])(cmd,
                                                                                                                                                                               (char *)"",
                                                                                                                                                                               (char *)((void *)0));
                                  ...
                                  if (argi == argc - 1) {
                                    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                               char const   *cmdstr , char const   *errfmt 
                                               , ...))_3__functionPtrArray[186 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                      defaults,
                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                      "Unknown argument without parameter: %s",
                                                                                                                                      *(argv + argi));
                                  } else {
                                    tmp___38 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 187])((char const   *)*(argv + argi),
                                                                                                                                                                              "--scoring");
                                    _3__functionPtrArray[16 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[110];
                                    if (tmp___38 == 0) {
                                      argi ++;
                                    } else {
                                      tmp___37 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 188 : tmp___7])((char const   *)*(argv + argi),
                                                                                                                                                                                     "--substitution_matrix");
                                      _3__functionPtrArray[33 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[106];
                                      if (tmp___37 == 0) {
                                        tmp___13 = ((gzFile (*)(char const   * , char const   * ))_3__functionPtrArray[189 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                                                         "r");
                                        ...
                                        if ((unsigned long )sub_matrix_file == (unsigned long )((void *)0)) {
                                          ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                     score_t *defaults , char const   *cmdstr ,
                                                     char const   *errfmt  , ...))_3__functionPtrArray[190 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                         defaults,
                                                                                                                                                                                                                         (char const   *)*(argv + 0),
                                                                                                                                                                                                                         "Couldn\'t read: %s",
                                                                                                                                                                                                                         *(argv + (argi + 1)));
                                        ...
                                        ((void (*)(gzFile file , char const   *file_path ,
                                                   scoring_t *scoring , char case_sensitive ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 3 : 192])(sub_matrix_file,
                                                                                                                                                                                (char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                scoring,
                                                                                                                                                                                (char )cmd->case_sensitive);
                                        ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 193 : 2])(sub_matrix_file);
                                        substitutions_set = (char)1;
                                        argi ++;
                                      } else {
                                        tmp___36 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[194 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                 "--substitution_pairs");
                                        _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 144 * 6] = & tmp___20;
                                        if (tmp___36 == 0) {
                                          tmp___14 = ((gzFile (*)(char const   * ,
                                                                  char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 195 & tmp___41 : 195])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                  "r");
                                          ...
                                          if ((unsigned long )sub_pairs_file == (unsigned long )((void *)0)) {
                                            ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                       score_t *defaults , char const   *cmdstr ,
                                                       char const   *errfmt  , ...))_3__functionPtrArray[197 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                           defaults,
                                                                                                                                                                                                                           (char const   *)*(argv + 0),
                                                                                                                                                                                                                           "Couldn\'t read: %s",
                                                                                                                                                                                                                           *(argv + (argi + 1)));
                                          ...
                                          ((void (*)(gzFile file , char const   *file_path ,
                                                     scoring_t *scoring , char case_sensitive ))_3__functionPtrArray[198 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(sub_pairs_file,
                                                                                                                                                                                                                                       (char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                                                       scoring,
                                                                                                                                                                                                                                       (char )cmd->case_sensitive);
                                          ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 200 : wildscore])(sub_pairs_file);
                                          ...
                                          tmp___35 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 201 : 8])((char const   *)*(argv + argi),
                                                                                                                                                                                   "--minscore");
                                          ...
                                          if (tmp___35 == 0) {
                                            ...
                                            tmp___15 = ((char (*)(char *str , int *result ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 203 << 6 : 203])(*(argv + (argi + 1)),
                                                                                                                                                                                     & cmd->min_score);
                                            ...
                                            if (! tmp___15) {
                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                         score_t *defaults , char const   *cmdstr ,
                                                         char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 204 : tmp___36])(cmd_type,
                                                                                                                                                                               defaults,
                                                                                                                                                                               (char const   *)*(argv + 0),
                                            ...
                                            tmp___34 = ((int (*)(char const   * ,
                                                                 char const   * ))_3__functionPtrArray[206 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                         "--maxhits");
                                            if (tmp___34 == 0) {
                                              if ((unsigned int )cmd_type != 0U) {
                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                           score_t *defaults , char const   *cmdstr ,
                                                           char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 208])(cmd_type,
                                                                                                                                                                          defaults,
                                                                                                                                                                          (char const   *)*(argv + 0),
                                                                                                                                                                          "--maxhits only valid with Smith-Waterman");
                                              }
                                              tmp___16 = ((char (*)(char *str , unsigned int *result ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 209 : 209 - tmp___46])(*(argv + (argi + 1)),
                                              ...
                                              if (! tmp___16) {
                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                           score_t *defaults , char const   *cmdstr ,
                                                           char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 211])(cmd_type,
                                                                                                                                                                          defaults,
                                                                                                                                                                          (char const   *)*(argv + 0),
                                              ...
                                              tmp___33 = ((int (*)(char const   * ,
                                                                   char const   * ))_3__functionPtrArray[213 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                    "--context");
                                              if (tmp___33 == 0) {
                                                if ((unsigned int )cmd_type != 0U) {
                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                             score_t *defaults , char const   *cmdstr ,
                                                             char const   *errfmt 
                                                             , ...))_3__functionPtrArray[215 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                    defaults,
                                                                                                                                                    (char const   *)*(argv + 0),
                                                ...
                                                tmp___17 = ((char (*)(char *str ,
                                                                      unsigned int *result ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 216 : 7])(*(argv + (argi + 1)),
                                                                                                                                                                               & cmd->print_context);
                                                if (! tmp___17) {
                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                             score_t *defaults , char const   *cmdstr ,
                                                ...
                                                tmp___32 = ((int (*)(char const   * ,
                                                                     char const   * ))_3__functionPtrArray[219 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                             "--match");
                                                if (tmp___32 == 0) {
                                                  tmp___18 = ((char (*)(char *str ,
                                                                        int *result ))_3__functionPtrArray[220 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                                                                                                                                      & scoring->match);
                                                  if (! tmp___18) {
                                                    ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                               score_t *defaults ,
                                                               char const   *cmdstr ,
                                                               char const   *errfmt 
                                                               , ...))_3__functionPtrArray[221 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                             defaults,
                                                                                                                                                                                                             (char const   *)*(argv + 0),
                                                  ...
                                                  tmp___31 = ((int (*)(char const   * ,
                                                                       char const   * ))_3__functionPtrArray[223 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                          "--mismatch");
                                                  ...
                                                  if (tmp___31 == 0) {
                                                    tmp___19 = ((char (*)(char *str ,
                                                                          int *result ))_3__functionPtrArray[224 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(*(argv + (argi + 1)),
                                                                                                                                                                                                                               & scoring->mismatch);
                                                    if (! tmp___19) {
                                                      ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                 score_t *defaults ,
                                                                 char const   *cmdstr ,
                                                                 char const   *errfmt 
                                                                 , ...))_3__functionPtrArray[226 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                          defaults,
                                                                                                                                                          (char const   *)*(argv + 0),
                                                    ...
                                                    tmp___30 = ((int (*)(char const   * ,
                                                                         char const   * ))_3__functionPtrArray[227 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                                 "--gapopen");
                                                    _3__functionPtrArray[78 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[54];
                                                    if (tmp___30 == 0) {
                                                      tmp___20 = ((char (*)(char *str ,
                                                                            int *result ))_3__functionPtrArray[228 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                                                                                                                                          & scoring->gap_open);
                                                      ...
                                                      if (! tmp___20) {
                                                        ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                   ...
                                                                   char const   *cmdstr ,
                                                                   char const   *errfmt 
                                                                   , ...))_3__functionPtrArray[230 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                 defaults,
                                                                                                                                                                                                                 (char const   *)*(argv + 0),
                                                      ...
                                                      tmp___29 = ((int (*)(char const   * ,
                                                                           char const   * ))_3__functionPtrArray[231 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                            "--gapextend");
                                                      if (tmp___29 == 0) {
                                                        tmp___21 = ((char (*)(char *str ,
                                                                              int *result ))_3__functionPtrArray[232 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                                                                                                                                            & scoring->gap_extend);
                                                        if (! tmp___21) {
                                                          ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                     score_t *defaults ,
                                                                     char const   *cmdstr ,
                                                                     char const   *errfmt 
                                                                     , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 233 << 4 : 233])(cmd_type,
                                                                                                                                                                     defaults,
                                                                                                                                                                     (char const   *)*(argv + 0),
                                                        ...
                                                        tmp___28 = ((int (*)(char const   * ,
                                                                             char const   * ))_3__functionPtrArray[234 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                              "--file");
                                                        ...
                                                        if (tmp___28 == 0) {
                                                          ((void (*)(cmdline_t *cmd ,
                                                                     char *p1 , char *p2 ))_3__functionPtrArray[235 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd,
                                                                                                                                                                           *(argv + (argi + 1)),
                                                                                                                                                                           (char *)((void *)0));
                                                          argi ++;
                                                        } else {
                                                          tmp___27 = ((int (*)(char const   * ,
                                                                               char const   * ))_3__functionPtrArray[236 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                  "--files");
                                                          if (tmp___27 == 0) {
                                                            if (argi >= argc - 2) {
                                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                         ...
                                                                         char const   *cmdstr ,
                                                                         char const   *errfmt 
                                                                         , ...))_3__functionPtrArray[237 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                       defaults,
                                                                                                                                                                                                                       (char const   *)*(argv + 0),
                                                              ...
                                                              tmp___22 = ((int (*)(char const   * ,
                                                                                   char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 239 ^ tmp___31 : 239])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                   "-");
                                                              ...
                                                              if (tmp___22 == 0) {
                                                                tmp___23 = ((int (*)(char const   * ,
                                                                                     char const   * ))_3__functionPtrArray[241 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 2)),
                                                                                                                                                                                      "-");
                                                                if (tmp___23 == 0) {
                                                                  ((void (*)(cmdline_t *cmd ,
                                                                             char *p1 ,
                                                                             char *p2 ))_3__functionPtrArray[242 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd,
                                                                                                                                                                                                                               *(argv + (argi + 1)),
                                                                                                                                                                                                                               (char *)((void *)0));
                                                                } else {
                                                                  ((void (*)(cmdline_t *cmd ,
                                                                             char *p1 ,
                                                                             char *p2 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 243 : 243 ^ tmp___26])(cmd,
                                                                                                                                                                                       *(argv + (argi + 1)),
                                                                                                                                                                                       *(argv + (argi + 2)));
                                                                }
                                                              } else {
                                                                ((void (*)(cmdline_t *cmd ,
                                                                           char *p1 ,
                                                                           char *p2 ))_3__functionPtrArray[244 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd,
                                                                                                                                                                      *(argv + (argi + 1)),
                                                                                                                                                                      *(argv + (argi + 2)));
                                                            ...
                                                            tmp___26 = ((int (*)(char const   * ,
                                                                                 char const   * ))_3__functionPtrArray[245 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                  "--wildcard");
                                                            if (tmp___26 == 0) {
                                                              wildscore = 0;
                                                              if (argi == argc - 2) {
                                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                           ...
                                                                           char const   *cmdstr ,
                                                                           char const   *errfmt 
                                                                           , ...))_3__functionPtrArray[246 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                    defaults,
                                                                                                                                                                    (char const   *)*(argv + 0),
                                                                ...
                                                                tmp___24 = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[247 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + (argi + 1)));
                                                                if (tmp___24 != 1UL) {
                                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                             score_t *defaults ,
                                                                             char const   *cmdstr ,
                                                                             char const   *errfmt 
                                                                             , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 248 : tmp___12])(cmd_type,
                                                                                                                                                                             defaults,
                                                                                                                                                                             (char const   *)*(argv + 0),
                                                                                                                                                                             "--wildcard <w> <s> takes a single character and a number");
                                                                  ...
                                                                  tmp___25 = ((char (*)(char *str ,
                                                                                        int *result ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 250 * tmp___53 : 250])(*(argv + (argi + 2)),
                                                                                                                                                                                                     & wildscore);
                                                                  if (! tmp___25) {
                                                                    ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                               score_t *defaults ,
                                                                               char const   *cmdstr ,
                                                                               char const   *errfmt 
                                                                               , ...))_3__functionPtrArray[251 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                             defaults,
                                                                                                                                                                                                                             (char const   *)*(argv + 0),
                                                                                                                                                                                                                             "--wildcard <w> <s> takes a single character and a number");
                                                                  }
                                                              ...
                                                              ((void (*)(scoring_t *scoring ,
                                                                         char c ,
                                                                         int score ))_3__functionPtrArray[253 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(scoring,
                                                                                                                                                                                                                            *(*(argv + (argi + 1)) + 0),
                                                                                                                                                                                                                            wildscore);
                                                              argi += 2;
                                                            } else {
      ...
      if (argc - argi != 2) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 256 : 256 * 1])(cmd_type,
                                                                                                                                        defaults,
                                                                                                                                        (char const   *)*(argv + 0),
                                                                                                                                        "Unknown options: \'%s\'",
                                                                                                                                        *(argv + argi));
  ...
  if (match_set) {
    if (! mismatch_set) {
      if (! scoring->no_mismatches) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[257 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                       defaults,
                                                                                                                                                                                       (char const   *)*(argv + 0),
  ...
  if (! match_set) {
    if (mismatch_set) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 259])(cmd_type,
                                                                                                                                defaults,
                                                                                                                                (char const   *)*(argv + 0),
                                                                                                                                "--match --mismatch must both be set or neither set");
    } else {
  ...
  if (scoring->use_match_mismatch) {
    if (scoring->match < scoring->mismatch) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[261 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                     defaults,
                                                                                                                                                                                     (char const   *)*(argv + 0),
  ...
  if ((unsigned int )cmd_type == 1U) {
    if (scoring->no_mismatches) {
      if (scoring->no_gaps_in_a) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[262 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                       defaults,
                                                                                                                                                                                       (char const   *)*(argv + 0),
      ...
      if (scoring->no_gaps_in_b) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[263 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                  defaults,
                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                  "--nogaps.. --nomismatches cannot be used at together");
  ...
  if ((unsigned long )cmd->seq1 == (unsigned long )((void *)0)) {
    if (cmd->file_list_length == 0UL) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[264 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              "No input specified");
    }
  ...
  if (cmd->zam_stle_output) {
    if (cmd->print_pretty) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 265 : 265 >> tmp___39])(cmd_type,
                                                                                                                                              defaults,
                                                                                                                                              (char const   *)*(argv + 0),
    ...
    if (cmd->print_scores) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 266 + 6 : 266])(cmd_type,
                                                                                                                                      defaults,
                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                      "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
    ...
    if (cmd->print_colour) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[267 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                defaults,
                                                                                                                                (char const   *)*(argv + 0),
                                                                                                                                "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
    } else
    if (cmd->print_fasta) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[268 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                defaults,
                                                                                                                                (char const   *)*(argv + 0),
                                                                                                                                "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
    }
...
{ 
  ...
  while (in->end > in->begin) {
    ...
    buffered = offset - in->begin;
    cbuf_capacity(buf, size, *len + buffered);
    ((void *(*)(void * __restrict   , void const   * __restrict   , size_t___1  ))_3__functionPtrArray[275 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void */* __restrict  */)(*buf + *len),
...
{ 
  ...
  bs->s = (l + 31UL) / 32UL;
  bs->l = l;
  tmp = ((void *(*)(unsigned long  , unsigned long  ))_3__functionPtrArray[106 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sizeof(*(bs->b + 0)),
                                                                                                                                        bs->s);
  _3__functionPtrArray[26 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & tmp___0;
  bs->b = (uint32_t *)tmp;
  if (bs->b) {
    tmp___0 = bs;
  } else {
...
{ 
  ...
  ((void (*)(alignment_t *result , size_t___1 strlength ))_3__functionPtrArray[10 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(result,
                                                                                                                                                                                                length);
...
{ 
  ...
  {
  tmp = ((StrBuf *(*)(size_t___1 len ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 28 : 2])((size_t___1 )500);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 >> tmp___14 : 11] = & file_path;
  sbuf = tmp;
  line_num = 0;
  while (1) {
    read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[30 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sbuf,
                                                                                                                                                  file);
    if (! (read_length > 0UL)) {
      break;
    }
    ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 32 + 8 : 32])(sbuf);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : i] = & case_sensitive;
    if (sbuf->end > 0UL) {
      if ((int )*(sbuf->b + 0) != 35) {
        tmp___0 = ((char (*)(char const   *s ))_3__functionPtrArray[34 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)sbuf->b);
        if (! tmp___0) {
          if (sbuf->end < 2UL) {
            ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                       char is_matrix ))_3__functionPtrArray[36 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("Too few column headings",
                                                                                                                         file_path,
                                                                                                                         line_num,
                                                                                                                         (char)1);
          }
  ...
  if (line_num == 0) {
    if (sbuf->end <= 0UL) {
      ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                 char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 37 : tmp___18])("Empty file",
                                                                                                                          file_path,
                                                                                                                          -1,
                                                                                                                          (char)0);
    }
  ...
  if ((int )sep >= 48) {
    if ((int )sep <= 57) {
      ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                 char is_matrix ))_3__functionPtrArray[39 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Numbers (0-9) and dashes (-) do not make good separators",
                                                                                                                                                                        file_path,
                                                                                                                                                                        line_num,
                                                                                                                                                                        (char)0);
    } else {
  ...
  _L: 
  if ((int )sep == 45) {
    ((void (*)(char const   *err_msg , char const   *file_path , int line_num , char is_matrix ))_3__functionPtrArray[41 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("Numbers (0-9) and dashes (-) do not make good separators",
                                                                                                                                                                                  file_path,
                                                                                                                                                                                  line_num,
                                                                                                                                                                                  (char)0);
  }
  tmp___1 = ((void *(*)(unsigned long  ))_3__functionPtrArray[42 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(sbuf->end);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___18 : 40] = _3__functionPtrArray[14];
  characters = (char *)tmp___1;
  num_of_chars = 0;
  tmp___18 = ((int (*)(int  ))_3__functionPtrArray[44 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((int )sep);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 29 << 3 : 29] = _3__functionPtrArray[29];
  if (tmp___18) {
    next = sbuf->b;
    while (1) {
      next = ((char *(*)(char *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? line_num : 46])(next + 1);
      ...
      if (case_sensitive) {
        *(characters + tmp___2) = *next;
        ...
        tmp___3 = ((int (*)(int  ))_3__functionPtrArray[48 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((int )*next);
        *(characters + tmp___2) = (char )tmp___3;
      }
    }
    while (1) {
      read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[49 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf,
                                                                                                                                                    file);
      if (! (read_length > 0UL)) {
        break;
      }
      ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[50 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sbuf);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 24 : 5] = _3__functionPtrArray[38];
      tmp___4 = ((char *(*)(char *s ))_3__functionPtrArray[51 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sbuf->b);
      ...
      if (case_sensitive) {
        ...
        tmp___5 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 53])((int )*from_char_pos);
        tmp___6 = tmp___5;
      }
      ...
      while (i < num_of_chars) {
        ...
        tmp___7 = ((int (*)(int  ))_3__functionPtrArray[54 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )*score_txt);
        _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[9];
        if (! tmp___7) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[56 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("Expected whitespace between elements - found character",
                                                                                                                     file_path,
                                                                                                                     line_num,
                                                                                                                     (char)1);
        }
        score_txt = ((char *(*)(char *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 57 : 4])(score_txt + 1);
        ...
        tmp___8 = ((long (*)(char const   * __restrict   , char ** __restrict   ,
                             int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 59 | 10 : 59])((char const   */* __restrict  */)strtol_last_char_ptr,
                                                                                                                           (char **/* __restrict  */)(& strtol_last_char_ptr),
                                                                                                                           10);
        _3__functionPtrArray[47 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & scoring;
        score = (int )tmp___8;
        if ((unsigned long )strtol_last_char_ptr == (unsigned long )score_txt) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[61 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Missing number value on line",
                                                                                                                                                                            file_path,
                                                                                                                                                                            line_num,
                                                                                                                                                                            (char)1);
          _3__functionPtrArray[38 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & line_num;
        }
        ((void (*)(scoring_t *scoring , char a , char b , int score ))_3__functionPtrArray[62 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(scoring,
                                                                                                                                                     from_char,
                                                                                                                                                     to_char,
                                                                                                                                                     score);
      ...
      if ((int )*score_txt != 0) {
        tmp___9 = ((char (*)(char const   *s ))_3__functionPtrArray[64 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)score_txt);
        if (! tmp___9) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[65 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Too many columns on row",
                                                                                                                                                                            file_path,
                                                                                                                                                                            line_num,
                                                                                                                                                                            (char)1);
        }
    ...
    while (i___0 < sbuf->end) {
      if ((int )*(sbuf->b + i___0) != (int )sep) {
        ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                   char is_matrix ))_3__functionPtrArray[66 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])("Separator missing from line",
                                                                                                                                                                          file_path,
                                                                                                                                                                          line_num,
                                                                                                                                                                          (char)1);
      ...
      if (case_sensitive) {
        ...
        tmp___10 = ((int (*)(int  ))_3__functionPtrArray[68 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((int )*(sbuf->b + (i___0 + 1UL)));
        tmp___11 = tmp___10;
      }
      c = (char )tmp___11;
    ...
    while (1) {
      read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[69 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf,
                                                                                                                                                  file);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : tmp___10] = _3__functionPtrArray[50];
      if (! (read_length > 0UL)) {
        break;
      }
      ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[70 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf);
      ...
      if (case_sensitive) {
        ...
        tmp___13 = ((int (*)(int  ))_3__functionPtrArray[71 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((int )*(sbuf->b + 0));
      ...
      if ((int )from_char___0 == 35) {
        ...
        tmp___15 = ((char (*)(char const   *s ))_3__functionPtrArray[73 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)sbuf->b);
        if (tmp___15) {
          continue;
        }
      }
      ...
      while ((int )*str_pos != 0) {
        ...
        if ((int )*str_pos != (int )sep) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[74 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Separator missing from line",
                                                                                                                                                                            file_path,
                                                                                                                                                                            line_num,
                                                                                                                                                                            (char)1);
        ...
        tmp___17 = ((long (*)(char const   * __restrict   , char ** __restrict   ,
                              int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 75 - 9 : 75])((char const   */* __restrict  */)str_pos,
                                                                                                                           (char **/* __restrict  */)(& after_num_str),
                                                                                                                           10);
        score___0 = (int )tmp___17;
        if ((unsigned long )str_pos == (unsigned long )after_num_str) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 76 * 5 : 76])("Missing number value on line",
                                                                                                                            file_path,
                                                                                                                            line_num,
                                                                                                                            (char)1);
        }
        if (to_char_index >= num_of_chars) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[77 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Too many columns on row",
                                                                                                                                                                            file_path,
                                                                                                                                                                            line_num,
                                                                                                                                                                            (char)1);
        }
        ((void (*)(scoring_t *scoring , char a , char b , int score ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 79])(scoring,
                                                                                                                                                       from_char___0,
                                                                                                                                                       to_char___0,
                                                                                                                                                       score___0);
  ...
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 81 : tmp___11])((void *)characters);
...
{ 
  ...
  if (is_sw) {
    ...
    tmp = ((int (*)(int  ))_3__functionPtrArray[100 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((int )scoring->min_penalty);
  ...
  *(gap_b_scores + 0) = 0;
  ...
  while (seq_j < len_j) {
    seq_i = (size_t___1 )0;
    while (seq_i < len_i) {
      ((void (*)(scoring_t const   *scoring , char a , char b , int *score , _Bool *is_match ))_3__functionPtrArray[101 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(scoring,
                                                                                                                                                                                 (char )*(aligner->seq_a + seq_i),
                                                                                                                                                                                 (char )*(aligner->seq_b + seq_j),
...
{ 
  ...
  {
  capacity = _rndup2pow64((unsigned long long )capacity);
  tmp = ((void *(*)(unsigned long  ))_3__functionPtrArray[96 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(alignment_t ));
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 4] = _3__functionPtrArray[22];
  result = (alignment_t *)tmp;
  tmp___0 = ((void *(*)(unsigned long  ))_3__functionPtrArray[97 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sizeof(char ) * capacity);
  _3__functionPtrArray[72 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[19];
  result->result_a = (char *)tmp___0;
  tmp___1 = ((void *(*)(unsigned long  ))_3__functionPtrArray[99 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sizeof(char ) * capacity);
...
{ 
  ...
  if (aligner->capacity > 0UL) {
    ((void (*)(void * ))_3__functionPtrArray[91 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)aligner->match_scores);
    ...
    ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 93])((void *)aligner->gap_a_scores);
    ((void (*)(void * ))_3__functionPtrArray[95 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((void *)aligner->gap_b_scores);
  }
  return;
}
}
