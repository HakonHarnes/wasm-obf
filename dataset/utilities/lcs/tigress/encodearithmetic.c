...
/* Generated by Tigress v3.2 (https://tigress.wtf), 07:03:20-2023/04/23 */
...
{ 
  ...
  gap_open_penalty = (int )(((scoring->gap_extend ^ ~ scoring->gap_open) + ((scoring->gap_extend | scoring->gap_open) + (scoring->gap_extend | scoring->gap_open))) + 1);
  gap_extend_penalty = (int )scoring->gap_extend;
  if (is_sw) {
    tmp___0 = 0;
  } else {
    tmp = abs((int )scoring->min_penalty);
    tmp___0 = (((-0x7FFFFFFF-1) ^ ~ tmp) + (((-0x7FFFFFFF-1) | tmp) + ((-0x7FFFFFFF-1) | tmp))) + 1;
  }
  min = tmp___0;
  len_i = (score_width + ~ 1UL) + 1UL;
  len_j = ((score_height & ~ 1UL) << 1UL) - (score_height ^ 1UL);
  *(match_scores + 0) = 0;
  *(gap_a_scores + 0) = 0;
  *(gap_b_scores + 0) = 0;
  if (is_sw) {
    ...
    while ((int )((((~ j & score_height) | (~ (j ^ score_height) & (j - score_height))) >> 31UL) & 1UL)) {
      ...
      *(match_scores + index___0) = tmp___3;
      j = ((j | 1UL) + (j | 1UL)) - (j ^ 1UL);
      index___0 = (index___0 | score_width) + (index___0 & score_width);
    }
  } else {
    i = (size_t___1 )1;
    while ((int )((((~ i & score_width) | (~ (i ^ score_width) & (i - score_width))) >> 31UL) & 1UL)) {
      ...
      *(gap_a_scores + i) = min;
      if (scoring->no_start_gap_penalty) {
        ...
        *(gap_b_scores + i) = (score_t )((scoring->gap_open ^ (int const   )(((int )i & (int )scoring->gap_extend) * ((int )i | (int )scoring->gap_extend) + ((int )i & ~ ((int )scoring->gap_extend)) * (~ ((int )i) & (int )scoring->gap_extend))) + ((scoring->gap_open & (int const   )(((int )i & (int )scoring->gap_extend) * ((int )i | (int )scoring->gap_extend) + ((int )i & ~ ((int )scoring->gap_extend)) * (~ ((int )i) & (int )scoring->gap_extend))) + (scoring->gap_open & (int const   )(((int )i & (int )scoring->gap_extend) * ((int )i | (int )scoring->gap_extend) + ((int )i & ~ ((int )scoring->gap_extend)) * (~ ((int )i) & (int )scoring->gap_extend)))));
      }
    ...
    while ((int )((((~ j & score_height) | (~ (j ^ score_height) & (j - score_height))) >> 31UL) & 1UL)) {
      *(match_scores + index___0) = min;
      if (scoring->no_start_gap_penalty) {
        ...
        *(gap_a_scores + index___0) = (score_t )(((scoring->gap_open ^ ~ ((int const   )(((int )j & (int )scoring->gap_extend) * ((int )j | (int )scoring->gap_extend) + ((int )j & ~ ((int )scoring->gap_extend)) * (~ ((int )j) & (int )scoring->gap_extend)))) + ((scoring->gap_open | (int const   )(((int )j & (int )scoring->gap_extend) * ((int )j | (int )scoring->gap_extend) + ((int )j & ~ ((int )scoring->gap_extend)) * (~ ((int )j) & (int )scoring->gap_extend))) << 1)) + 1);
      }
  ...
  index___0 = ((score_width ^ ~ 1UL) + ((score_width | 1UL) << 1UL)) + 1UL;
  seq_j = (size_t___1 )0;
  while ((int )((((~ seq_j & len_j) | ((~ seq_j | len_j) & (seq_j - len_j))) >> 31UL) & 1UL)) {
    ...
    while ((int )((((~ seq_i & len_i) | ((~ seq_i | len_i) & (seq_i - len_i))) >> 31UL) & 1UL)) {
      ...
      if (scoring->no_mismatches) {
        ...
        _L___2: 
        if (((unsigned int )((~ ((((*(gap_a_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_a_scores + index_upleft) | substitution_penalty) << 1)) + 1) ^ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) | substitution_penalty))) + 1)) >> 1) + ((((*(gap_a_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_a_scores + index_upleft) | substitution_penalty) << 1)) + 1) & ~ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) | substitution_penalty))) + 1))) >> 31U) & 1) {
          if (((unsigned int )(((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) | substitution_penalty))) + 1) | ~ ((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1))) & (((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) | substitution_penalty))) + 1) ^ ((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1))) | ~ (((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1)) - (((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) | substitution_penalty))) + 1)))) >> 31U) & 1) {
            tmp___10 = (*(match_scores + index_upleft) - ~ substitution_penalty) - 1;
          } else {
            goto _L___1;
          }
        } else {
          _L___1: 
          if (((unsigned int )(((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) << 1)) + 1) | ~ (((*(gap_a_scores + index_upleft) | substitution_penalty) << 1) - (*(gap_a_scores + index_upleft) ^ substitution_penalty))) & (((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) << 1)) + 1) ^ (((*(gap_a_scores + index_upleft) | substitution_penalty) << 1) - (*(gap_a_scores + index_upleft) ^ substitution_penalty))) | ~ ((((*(gap_a_scores + index_upleft) | substitution_penalty) << 1) - (*(gap_a_scores + index_upleft) ^ substitution_penalty)) - (((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) << 1)) + 1)))) >> 31U) & 1) {
            tmp___9 = (*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1;
          } else {
        ...
        if (((unsigned int )((min | ~ tmp___10) & ((min ^ tmp___10) | ~ (tmp___10 - min))) >> 31U) & 1) {
          if (((unsigned int )((((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) + (*(gap_a_scores + index_upleft) & substitution_penalty))) | ~ ((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1))) & ((((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) + (*(gap_a_scores + index_upleft) & substitution_penalty))) ^ ((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1))) | ~ (((*(match_scores + index_upleft) ^ substitution_penalty) + ((*(match_scores + index_upleft) & substitution_penalty) << 1)) - ((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) + (*(gap_a_scores + index_upleft) & substitution_penalty)))))) >> 31U) & 1) {
            if (((unsigned int )((((*(gap_b_scores + index_upleft) ^ substitution_penalty) + ((*(gap_b_scores + index_upleft) & substitution_penalty) << 1)) | ~ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) & ((((*(gap_b_scores + index_upleft) ^ substitution_penalty) + ((*(gap_b_scores + index_upleft) & substitution_penalty) << 1)) ^ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) | ~ ((((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1) - ((*(gap_b_scores + index_upleft) ^ substitution_penalty) + ((*(gap_b_scores + index_upleft) & substitution_penalty) << 1))))) >> 31U) & 1) {
              tmp___8 = (*(match_scores + index_upleft) - ~ substitution_penalty) - 1;
            } else {
              goto _L___0;
            }
          } else {
            _L___0: 
            if (((unsigned int )((~ ((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) << 1)) + 1) ^ ((*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1)) >> 1) + ((((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) << 1)) + 1) & ~ ((*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1))) >> 31U) & 1) {
              ...
              tmp___7 = (*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1;
            }
            tmp___8 = tmp___7;
          }
      ...
      if ((int )((((((seq_i - ((len_i + ~ 1UL) + 1UL)) + ((long )(seq_i - ((len_i + ~ 1UL) + 1UL)) >> 31L)) ^ ((long )(seq_i - ((len_i + ~ 1UL) + 1UL)) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
        if (scoring->no_end_gap_penalty) {
          if (((unsigned int )((~ (*(gap_a_scores + index_up) ^ *(match_scores + index_up)) >> 1) + (*(gap_a_scores + index_up) & ~ *(match_scores + index_up))) >> 31U) & 1) {
            if (((unsigned int )((~ (*(gap_b_scores + index_up) ^ *(match_scores + index_up)) >> 1) + (*(gap_b_scores + index_up) & ~ *(match_scores + index_up))) >> 31U) & 1) {
            ...
            _L___3: 
            if (((unsigned int )((~ (*(gap_b_scores + index_up) ^ *(gap_a_scores + index_up)) >> 1) + (*(gap_b_scores + index_up) & ~ *(gap_a_scores + index_up))) >> 31U) & 1) {
      ...
      if ((int )((((((seq_i - (((len_i & ~ 1UL) + (len_i & ~ 1UL)) - (len_i ^ 1UL))) + ((long )(seq_i - (((len_i & ~ 1UL) + (len_i & ~ 1UL)) - (len_i ^ 1UL))) >> 31L)) ^ ((long )(seq_i - (((len_i & ~ 1UL) + (len_i & ~ 1UL)) - (len_i ^ 1UL))) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
        _L___7: 
        if (((unsigned int )((((*(gap_a_scores + index_up) - ~ gap_extend_penalty) - 1) | ~ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1)) & ((((*(gap_a_scores + index_up) - ~ gap_extend_penalty) - 1) ^ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1)) | ~ ((((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1) - ((*(gap_a_scores + index_up) - ~ gap_extend_penalty) - 1)))) >> 31U) & 1) {
          if (((unsigned int )(((((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) | gap_open_penalty)) - (*(gap_b_scores + index_up) ^ gap_open_penalty)) | ~ ((*(match_scores + index_up) - ~ gap_open_penalty) - 1)) & (((((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) | gap_open_penalty)) - (*(gap_b_scores + index_up) ^ gap_open_penalty)) ^ ((*(match_scores + index_up) - ~ gap_open_penalty) - 1)) | ~ (((*(match_scores + index_up) - ~ gap_open_penalty) - 1) - (((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) | gap_open_penalty)) - (*(gap_b_scores + index_up) ^ gap_open_penalty))))) >> 31U) & 1) {
            tmp___17 = ((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) << 1)) + 1;
          } else {
            goto _L___6;
          }
        } else {
          _L___6: 
          if (((unsigned int )((~ ((((*(gap_b_scores + index_up) ^ ~ gap_open_penalty) + ((*(gap_b_scores + index_up) | gap_open_penalty) << 1)) + 1) ^ ((*(gap_a_scores + index_up) - ~ gap_extend_penalty) - 1)) >> 1) + ((((*(gap_b_scores + index_up) ^ ~ gap_open_penalty) + ((*(gap_b_scores + index_up) | gap_open_penalty) << 1)) + 1) & ~ ((*(gap_a_scores + index_up) - ~ gap_extend_penalty) - 1))) >> 31U) & 1) {
            tmp___16 = (*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty);
          } else {
        ...
        if (((unsigned int )((min | ~ tmp___17) & ((min ^ tmp___17) | ~ (tmp___17 - min))) >> 31U) & 1) {
          if (((unsigned int )((~ (((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)) ^ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) << 1)) + 1)) >> 1) + (((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)) & ~ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) << 1)) + 1))) >> 31U) & 1) {
            if (((unsigned int )((((*(gap_b_scores + index_up) - ~ gap_open_penalty) - 1) | ~ ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty))) & ((((*(gap_b_scores + index_up) - ~ gap_open_penalty) - 1) ^ ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty))) | ~ (((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty)) - ((*(gap_b_scores + index_up) - ~ gap_open_penalty) - 1)))) >> 31U) & 1) {
              tmp___15 = (*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty);
            } else {
              goto _L___5;
            }
          } else {
            _L___5: 
            if (((unsigned int )((((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) << 1)) | ~ ((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty))) & ((((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) << 1)) ^ ((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty))) | ~ (((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)) - ((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) << 1))))) >> 31U) & 1) {
              tmp___14 = ((*(gap_a_scores + index_up) | gap_extend_penalty) << 1) - (*(gap_a_scores + index_up) ^ gap_extend_penalty);
            } else {
              tmp___14 = (*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty));
            }
            tmp___15 = tmp___14;
          }
      ...
      if ((int )((~ ((seq_j - (((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL))) | ((((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL)) - seq_j)) >> 31UL) & 1UL)) {
        if (scoring->no_end_gap_penalty) {
          if (((unsigned int )((*(gap_a_scores + index_left) | ~ *(match_scores + index_left)) & ((*(gap_a_scores + index_left) ^ *(match_scores + index_left)) | ~ (*(match_scores + index_left) - *(gap_a_scores + index_left)))) >> 31U) & 1) {
            ...
            _L___9: 
            if (((unsigned int )((*(gap_b_scores + index_left) | ~ *(gap_a_scores + index_left)) & ((*(gap_b_scores + index_left) ^ *(gap_a_scores + index_left)) | ~ (*(gap_a_scores + index_left) - *(gap_b_scores + index_left)))) >> 31U) & 1) {
      ...
      if ((int )(((((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) + (1UL << 31)) - ((((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) + (1UL << 31)) + ((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) + (1UL << 31))) & ((long )((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) + (1UL << 31)) >> 31L))) >> 31UL) & 1UL)) {
        _L___13: 
        if (((unsigned int )((~ ((((*(gap_a_scores + index_left) | gap_open_penalty) << 1) - (*(gap_a_scores + index_left) ^ gap_open_penalty)) ^ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) << 1))) >> 1) + ((((*(gap_a_scores + index_left) | gap_open_penalty) << 1) - (*(gap_a_scores + index_left) ^ gap_open_penalty)) & ~ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) << 1)))) >> 31U) & 1) {
          if (((unsigned int )((((*(gap_b_scores + index_left) ^ gap_extend_penalty) + ((*(gap_b_scores + index_left) & gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty))) | ~ ((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty))) & ((((*(gap_b_scores + index_left) ^ gap_extend_penalty) + ((*(gap_b_scores + index_left) & gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty))) ^ ((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty))) | ~ (((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty)) - ((*(gap_b_scores + index_left) ^ gap_extend_penalty) + ((*(gap_b_scores + index_left) & gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty)))))) >> 31U) & 1) {
            tmp___24 = (*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty);
          } else {
            goto _L___12;
          }
        } else {
          _L___12: 
          if (((unsigned int )((~ ((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) ^ ((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty))) >> 1) + ((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) & ~ ((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty)))) >> 31U) & 1) {
            tmp___23 = (*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty);
          } else {
            tmp___23 = (*(gap_b_scores + index_left) | gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty);
          }
          tmp___24 = tmp___23;
        }
        if (((unsigned int )((~ (min ^ tmp___24) >> 1) + (min & ~ tmp___24)) >> 31U) & 1) {
          if (((unsigned int )((~ ((((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) | gap_open_penalty)) - (*(gap_a_scores + index_left) ^ gap_open_penalty)) ^ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty)))) >> 1) + ((((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) | gap_open_penalty)) - (*(gap_a_scores + index_left) ^ gap_open_penalty)) & ~ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty))))) >> 31U) & 1) {
            if (((unsigned int )((~ (((*(gap_b_scores + index_left) ^ gap_extend_penalty) + ((*(gap_b_scores + index_left) & gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty))) ^ (((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) << 1)) + 1)) >> 1) + (((*(gap_b_scores + index_left) ^ gap_extend_penalty) + ((*(gap_b_scores + index_left) & gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty))) & ~ (((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) << 1)) + 1))) >> 31U) & 1) {
              tmp___22 = ((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) << 1)) + 1;
            } else {
              goto _L___11;
            }
          } else {
            _L___11: 
            if (((unsigned int )((~ (((*(gap_b_scores + index_left) - ~ gap_extend_penalty) - 1) ^ ((*(gap_a_scores + index_left) - ~ gap_open_penalty) - 1)) >> 1) + (((*(gap_b_scores + index_left) - ~ gap_extend_penalty) - 1) & ~ ((*(gap_a_scores + index_left) - ~ gap_open_penalty) - 1))) >> 31U) & 1) {
              tmp___21 = (*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty);
            } else {
      ...
      index_up = ((index_up | 1UL) << 1UL) - (index_up ^ 1UL);
      index_upleft = (index_upleft ^ 1UL) + ((index_upleft & 1UL) + (index_upleft & 1UL));
      seq_i = (seq_i | 1UL) + (seq_i & 1UL);
    }
    index___0 = (index___0 ^ 1UL) + ((index___0 & 1UL) << 1UL);
    index_left = ((index_left ^ ~ 1UL) + ((index_left | 1UL) << 1UL)) + 1UL;
    index_up = (index_up - ~ 1UL) - 1UL;
    index_upleft = (index_upleft ^ 1UL) + ((index_upleft & 1UL) + (index_upleft & 1UL));
    seq_j = ((seq_j ^ ~ 1UL) + ((seq_j | 1UL) + (seq_j | 1UL))) + 1UL;
  }
  return;
}
}
...
{ 
  ...
  tmp___0 = malloc((sizeof(char *) & cmd->file_list_capacity) * (sizeof(char *) | cmd->file_list_capacity) + (sizeof(char *) & ~ cmd->file_list_capacity) * (~ sizeof(char *) & cmd->file_list_capacity));
  cmd->file_paths1 = (char **)tmp___0;
  tmp___1 = malloc((sizeof(char *) & cmd->file_list_capacity) * (sizeof(char *) | cmd->file_list_capacity) + (sizeof(char *) & ~ cmd->file_list_capacity) * (~ sizeof(char *) & cmd->file_list_capacity));
  ...
  mismatch_set = (char)0;
  argi = 1;
  while (((unsigned int )(((((argc - argi) & - (argc >= argi)) << 1) & (((argc - argi) & - (argc >= argi)) >> 31)) - ((argc - argi) & - (argc >= argi))) >> 31U) & 1) {
    tmp___10 = strcasecmp((char const   *)*(argv + argi), "--help");
    if (((unsigned int )(~ tmp___10 & (tmp___10 - 1)) >> 31U) & 1) {
      print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
    } else {
      ...
      if (((unsigned int )(~ tmp___11 & (tmp___11 - 1)) >> 31U) & 1) {
        ...
        if (((unsigned int )(~ tmp___12 & (tmp___12 - 1)) >> 31U) & 1) {
          print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
        } else {
          ...
          if (((unsigned int )(~ (tmp___9 | - tmp___9)) >> 31U) & 1) {
            ...
            if (((unsigned int )((tmp___8 - ((tmp___8 << 1) & (tmp___8 >> 31))) - 1) >> 31U) & 1) {
              if (scoring_set) {
                print_usage(cmd_type, defaults, (char const   *)*(argv + 0), "More than one scoring system specified - not permitted");
              }
              tmp___7 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                   "PAM30");
              if (((unsigned int )((tmp___7 + (1 << 31)) - (((tmp___7 + (1 << 31)) + (tmp___7 + (1 << 31))) & ((tmp___7 + (1 << 31)) >> 31))) >> 31U) & 1) {
                scoring_system_PAM30(scoring);
              } else {
                tmp___6 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)),
                                     "PAM70");
                if (((unsigned int )(((tmp___6 ^ (tmp___6 >> 31)) - (tmp___6 >> 31)) - 1) >> 31U) & 1) {
                  ...
                  tmp___5 = strcasecmp((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                       "BLOSUM80");
                  if (((unsigned int )((tmp___5 + (1 << 31)) - (((tmp___5 + (1 << 31)) << 1) & ((tmp___5 + (1 << 31)) >> 31))) >> 31U) & 1) {
                    scoring_system_BLOSUM80(scoring);
                  } else {
                    tmp___4 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                         "BLOSUM62");
                    if (((unsigned int )((tmp___4 - ((tmp___4 << 1) & (tmp___4 >> 31))) - 1) >> 31U) & 1) {
                      scoring_system_BLOSUM62(scoring);
                    } else {
                      tmp___3 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                           "DNA_HYBRIDIZATION");
                      if (((unsigned int )(((tmp___3 + (1 << 31)) + ((tmp___3 + (1 << 31)) >> 31)) ^ ((tmp___3 + (1 << 31)) >> 31)) >> 31U) & 1) {
  ...
  argi = 1;
  while (((unsigned int )((argi - argc) ^ ((argi ^ argc) & ((argi - argc) ^ argi))) >> 31U) & 1) {
    if (((unsigned int )(((((int )*(*(argv + argi) + 0) - 45) + (1 << 31)) ^ ((((int )*(*(argv + argi) + 0) - 45) + (1 << 31)) >> 31)) - ((((int )*(*(argv + argi) + 0) - 45) + (1 << 31)) >> 31)) >> 31U) & 1) {
      tmp___53 = strcasecmp((char const   *)*(argv + argi), "--freestartgap");
      if (((unsigned int )(((tmp___53 + (1 << 31)) ^ ((tmp___53 + (1 << 31)) >> 31)) - ((tmp___53 + (1 << 31)) >> 31)) >> 31U) & 1) {
        ...
        if (((unsigned int )((tmp___52 + (1 << 31)) - (((tmp___52 + (1 << 31)) << 1) & ((tmp___52 + (1 << 31)) >> 31))) >> 31U) & 1) {
          if ((int )(((((int )((unsigned int )cmd_type - 1U) >> 31) - (((unsigned int )cmd_type - 1U) ^ ((int )((unsigned int )cmd_type - 1U) >> 31))) >> 31U) & 1U)) {
                ...
                if (((unsigned int )(~ tmp___48 & (tmp___48 - 1)) >> 31U) & 1) {
                  ...
                  if (! (((unsigned int )(((tmp___47 + (1 << 31)) + ((tmp___47 + (1 << 31)) >> 31)) ^ ((tmp___47 + (1 << 31)) >> 31)) >> 31U) & 1)) {
                    ...
                    if (((unsigned int )(~ (tmp___46 | - tmp___46)) >> 31U) & 1) {
                      ...
                      if (((unsigned int )(~ tmp___45 & (tmp___45 - 1)) >> 31U) & 1) {
                        cmd->print_matrices = (_Bool)1;
                      } else {
                        tmp___44 = strcasecmp((char const   *)*(argv + argi), "--printscores");
                        if (((unsigned int )(~ tmp___44 & (tmp___44 - 1)) >> 31U) & 1) {
                          ...
                          if (((unsigned int )(~ (tmp___43 | - tmp___43)) >> 31U) & 1) {
                            ...
                            if (((unsigned int )(~ tmp___42 & (tmp___42 - 1)) >> 31U) & 1) {
                              ...
                              tmp___41 = strcasecmp((char const   *)*(argv + argi),
                                                    "--colour");
                              if (((unsigned int )(((tmp___41 ^ (tmp___41 >> 31)) - (tmp___41 >> 31)) - 1) >> 31U) & 1) {
                                cmd->print_colour = (_Bool)1;
                              } else {
                                tmp___40 = strcasecmp((char const   *)*(argv + argi),
                                                      "--zam");
                                if (((unsigned int )(~ (tmp___40 | - tmp___40)) >> 31U) & 1) {
                                  if ((int )(((((((unsigned int )cmd_type - 1U) + ((unsigned int )cmd_type - 1U)) & ((int )((unsigned int )cmd_type - 1U) >> 31)) - ((unsigned int )cmd_type - 1U)) >> 31U) & 1U)) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                  ...
                                  tmp___39 = strcasecmp((char const   *)*(argv + argi),
                                                        "--stdin");
                                  if (((unsigned int )((tmp___39 + (1 << 31)) - (((tmp___39 + (1 << 31)) << 1) & ((tmp___39 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                    cmdline_add_files(cmd, (char *)"", (char *)((void *)0));
                                    cmd->interactive = (_Bool)1;
                                  } else
                                  if (((unsigned int )((((argi - ((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)))) + ((argi - ((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)))) >> 31)) ^ ((argi - ((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)))) >> 31)) - 1) >> 31U) & 1) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                    ...
                                    if (((unsigned int )((tmp___38 + (1 << 31)) - (((tmp___38 + (1 << 31)) + (tmp___38 + (1 << 31))) & ((tmp___38 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                      ...
                                      if (((unsigned int )(~ (tmp___37 | - tmp___37)) >> 31U) & 1) {
                                        tmp___13 = gzopen((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                                          "r");
                                        sub_matrix_file = tmp___13;
                                        if ((unsigned long )sub_matrix_file == (unsigned long )((void *)0)) {
                                          print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                      "Couldn\'t read: %s", *(argv + ((argi ^ 1) + ((argi & 1) + (argi & 1)))));
                                        }
                                        align_scoring_load_matrix(sub_matrix_file,
                                                                  (char const   *)*(argv + ((argi | 1) + (argi & 1))),
                                        ...
                                        tmp___36 = strcasecmp((char const   *)*(argv + argi),
                                                              "--substitution_pairs");
                                        if (((unsigned int )(((tmp___36 + (1 << 31)) ^ ((tmp___36 + (1 << 31)) >> 31)) - ((tmp___36 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                          tmp___14 = gzopen((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                                            "r");
                                          sub_pairs_file = tmp___14;
                                          if ((unsigned long )sub_pairs_file == (unsigned long )((void *)0)) {
                                            print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                        "Couldn\'t read: %s", *(argv + ((argi ^ 1) + ((argi & 1) << 1))));
                                          }
                                          ...
                                          tmp___35 = strcasecmp((char const   *)*(argv + argi),
                                                                "--minscore");
                                          if (((unsigned int )(~ (tmp___35 | - tmp___35)) >> 31U) & 1) {
                                            if ((unsigned int )cmd_type != 0U) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                          "--minscore only valid with Smith-Waterman");
                                            }
                                            tmp___15 = parse_entire_int(*(argv + ((argi - ~ 1) - 1)),
                                                                        & cmd->min_score);
                                            if (! tmp___15) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                            ...
                                            if (((unsigned int )(~ tmp___34 & (tmp___34 - 1)) >> 31U) & 1) {
                                              ...
                                              tmp___16 = parse_entire_uint(*(argv + ((argi - ~ 1) - 1)),
                                              ...
                                              tmp___33 = strcasecmp((char const   *)*(argv + argi),
                                                                    "--context");
                                              if (((unsigned int )(~ (tmp___33 | - tmp___33)) >> 31U) & 1) {
                                                if ((unsigned int )cmd_type != 0U) {
                                                  print_usage(cmd_type, defaults,
                                                              (char const   *)*(argv + 0),
                                                              "--context only valid with Smith-Waterman");
                                                }
                                                tmp___17 = parse_entire_uint(*(argv + (((argi | 1) << 1) - (argi ^ 1))),
                                                                             & cmd->print_context);
                                                if (! tmp___17) {
                                                  print_usage(cmd_type, defaults,
                                                              (char const   *)*(argv + 0),
                                                ...
                                                if (((unsigned int )(~ tmp___32 & (tmp___32 - 1)) >> 31U) & 1) {
                                                  ...
                                                  tmp___31 = strcasecmp((char const   *)*(argv + argi),
                                                                        "--mismatch");
                                                  if (((unsigned int )(~ tmp___31 & (tmp___31 - 1)) >> 31U) & 1) {
                                                    tmp___19 = parse_entire_int(*(argv + ((argi ^ 1) + ((argi & 1) + (argi & 1)))),
                                                                                & scoring->mismatch);
                                                    if (! tmp___19) {
                                                      print_usage(cmd_type, defaults,
                                                                  (char const   *)*(argv + 0),
                                                    ...
                                                    tmp___30 = strcasecmp((char const   *)*(argv + argi),
                                                                          "--gapopen");
                                                    if (((unsigned int )(~ (tmp___30 | - tmp___30)) >> 31U) & 1) {
                                                      tmp___20 = parse_entire_int(*(argv + ((argi | 1) + (argi & 1))),
                                                                                  & scoring->gap_open);
                                                      if (! tmp___20) {
                                                        print_usage(cmd_type, defaults,
                                                                    (char const   *)*(argv + 0),
                                                      ...
                                                      tmp___29 = strcasecmp((char const   *)*(argv + argi),
                                                                            "--gapextend");
                                                      if (((unsigned int )(((tmp___29 + (1 << 31)) + ((tmp___29 + (1 << 31)) >> 31)) ^ ((tmp___29 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                                        tmp___21 = parse_entire_int(*(argv + ((argi - ~ 1) - 1)),
                                                                                    & scoring->gap_extend);
                                                        if (! tmp___21) {
                                                          print_usage(cmd_type, defaults,
                                                                      (char const   *)*(argv + 0),
                                                        ...
                                                        if (((unsigned int )(~ (tmp___28 | - tmp___28)) >> 31U) & 1) {
                                                          cmdline_add_files(cmd, *(argv + (((argi | 1) << 1) - (argi ^ 1))),
                                                                            (char *)((void *)0));
                                                          argi = (argi ^ 1) + ((argi & 1) << 1);
                                                        } else {
                                                          tmp___27 = strcasecmp((char const   *)*(argv + argi),
                                                                                "--files");
                                                          if (((unsigned int )(~ tmp___27 & (tmp___27 - 1)) >> 31U) & 1) {
                                                            if (((unsigned int )((((argc + ~ 2) + 1) | ~ argi) & ((((argc + ~ 2) + 1) ^ argi) | ~ (argi - ((argc + ~ 2) + 1)))) >> 31U) & 1) {
                                                              print_usage(cmd_type,
                                                                          defaults,
                                                                          (char const   *)*(argv + 0),
                                                                          "--files option takes 2 arguments");
                                                            } else {
                                                              tmp___22 = strcmp((char const   *)*(argv + ((argi | 1) + (argi & 1))),
                                                                                "-");
                                                              if (((unsigned int )(~ (tmp___22 | - tmp___22)) >> 31U) & 1) {
                                                                tmp___23 = strcmp((char const   *)*(argv + (((argi | 2) + (argi | 2)) - (argi ^ 2))),
                                                                                  "-");
                                                                if (((unsigned int )(((tmp___23 + (1 << 31)) ^ ((tmp___23 + (1 << 31)) >> 31)) - ((tmp___23 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                                            ...
                                                            argi = (argi ^ 2) + ((argi & 2) << 1);
                                                          } else {
                                                            tmp___26 = strcasecmp((char const   *)*(argv + argi),
                                                                                  "--wildcard");
                                                            if (((unsigned int )(~ (tmp___26 | - tmp___26)) >> 31U) & 1) {
                                                              wildscore = 0;
                                                              if (((unsigned int )((((argi - ((argc ^ 2) - ((~ argc & 2) + (~ argc & 2)))) + (1 << 31)) ^ (((argi - ((argc ^ 2) - ((~ argc & 2) + (~ argc & 2)))) + (1 << 31)) >> 31)) - (((argi - ((argc ^ 2) - ((~ argc & 2) + (~ argc & 2)))) + (1 << 31)) >> 31)) >> 31U) & 1) {
                                                                print_usage(cmd_type,
                                                                            defaults,
                                                                            (char const   *)*(argv + 0),
                                                                            "--wildcard <w> <s> takes a single character and a number");
                                                              } else {
                                                                tmp___24 = strlen((char const   *)*(argv + ((argi | 1) + (argi & 1))));
                                                                if ((int )((((((long )(tmp___24 - 1UL) >> 31L) - (tmp___24 - 1UL)) ^ ((long )(tmp___24 - 1UL) >> 31L)) >> 31UL) & 1UL)) {
                                                                  print_usage(cmd_type,
                                                                              defaults,
                                                                              (char const   *)*(argv + 0),
                                                                              "--wildcard <w> <s> takes a single character and a number");
                                                                } else {
                                                                  tmp___25 = parse_entire_int(*(argv + (((argi | 2) << 1) - (argi ^ 2))),
                                                                                              & wildscore);
                                                                  if (! tmp___25) {
                                                                    print_usage(cmd_type,
                                                                                defaults,
      ...
      if (((unsigned int )(((((argc & ~ argi) - (~ argc & argi)) - 2) >> 31) - ((((argc & ~ argi) - (~ argc & argi)) - 2) ^ ((((argc & ~ argi) - (~ argc & argi)) - 2) >> 31))) >> 31U) & 1) {
  ...
  if (scoring->use_match_mismatch) {
    if (((unsigned int )(((((scoring->mismatch - scoring->match) & - (scoring->mismatch >= scoring->match)) >> 31) - ((scoring->mismatch - scoring->match) & - (scoring->mismatch >= scoring->match))) ^ (((scoring->mismatch - scoring->match) & - (scoring->mismatch >= scoring->match)) >> 31)) >> 31U) & 1) {
      print_usage(cmd_type, defaults, (char const   *)*(argv + 0), "Match value should not be less than mismatch penalty");
    }
  }
  if ((int )((((((unsigned int )cmd_type - 1U) + (1U << 31)) - (((((unsigned int )cmd_type - 1U) + (1U << 31)) << 1U) & ((int )(((unsigned int )cmd_type - 1U) + (1U << 31)) >> 31))) >> 31U) & 1U)) {
    if (scoring->no_mismatches) {
      if (scoring->no_gaps_in_a) {
  ...
  if (((unsigned int )(((((argc - argi) & - (argc >= argi)) << 1) & (((argc - argi) & - (argc >= argi)) >> 31)) - ((argc - argi) & - (argc >= argi))) >> 31U) & 1) {
    cmd->seq1 = (char const   *)*(argv + argi);
    cmd->seq2 = (char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1));
  }
...
{ 
  ...
  *is_match = (_Bool )(((unsigned int )(((((int )a - (int )b) + (((int )a - (int )b) >> 31)) ^ (((int )a - (int )b) >> 31)) - 1) >> 31U) & 1);
  ...
  if (((~ (scoring->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b))) | 1U) + (scoring->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b)))) + 1U) {
...
{ 
  ...
  while ((int )(((unsigned int const   )((int const   )*(alignment_a + i) | - ((int const   )*(alignment_a + i))) >> (unsigned int const   )31) & 1)) {
    ...
    if ((int )(((unsigned int const   )(((((int const   )*(alignment_b + i) - 45) + (1 << 31)) + ((((int const   )*(alignment_b + i) - 45) + (1 << 31)) >> (int const   )31)) ^ ((((int const   )*(alignment_b + i) - 45) + (1 << 31)) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
      putc(' ', stdout);
    } else
    ...
    if (! scoring->case_sensitive) {
      ...
      if (((unsigned int )((((tmp - tmp___0) + (1 << 31)) ^ (((tmp - tmp___0) + (1 << 31)) >> 31)) - (((tmp - tmp___0) + (1 << 31)) >> 31)) >> 31U) & 1) {
        putc('|', stdout);
      } else {
        putc('*', stdout);
      }
...
{ 
  ...
  tmp___2 = strcmp(p, "-");
  if (((unsigned int )(((tmp___2 ^ (tmp___2 >> 31)) - (tmp___2 >> 31)) - 1) >> 31U) & 1) {
  ...
  fmt = tmp___3;
  if ((int )(((((((unsigned int )fmt - 8U) + (1U << 31)) ^ ((int )(((unsigned int )fmt - 8U) + (1U << 31)) >> 31)) - ((int )(((unsigned int )fmt - 8U) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
  if ((int )(((((((unsigned int )fmt - 16U) + (1U << 31)) ^ ((int )(((unsigned int )fmt - 16U) + (1U << 31)) >> 31)) - ((int )(((unsigned int )fmt - 16U) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
...
{ 
  ...
  while (1) {
    ...
    (*align)(& read1, & read2);
    alignments = ((alignments | 1UL) + (alignments | 1UL)) - (alignments ^ 1UL);
  }
  if (alignments == 0UL) {
        ...
        if (! tmp___7) {
          ...
          if (tmp___4) {
            ...
            while (1) {
              ...
              char2_pos = (char2_pos ^ 1UL) + ((char2_pos & 1UL) + (char2_pos & 1UL));
            }
            if ((int )((((~ sbuf->end | ((char2_pos ^ 2UL) + ((char2_pos & 2UL) << 1UL))) & ((sbuf->end ^ ((char2_pos ^ 2UL) + ((char2_pos & 2UL) << 1UL))) | ~ (((char2_pos ^ 2UL) + ((char2_pos & 2UL) << 1UL)) - sbuf->end))) >> 31UL) & 1UL)) {
              _loading_error("Line too short", file_path, line_num, (char)0);
            } else {
              tmp___1 = isspace((int )*(sbuf->b + ((char2_pos | 1UL) + (char2_pos & 1UL))));
              if (! tmp___1) {
                _loading_error("Line too short", file_path, line_num, (char)0);
              }
            }
          ...
          num_pairs_added = ((num_pairs_added | 1) << 1) - (num_pairs_added ^ 1);
        }
      }
    }
    line_num = (line_num | 1) + (line_num & 1);
  }
  strbuf_free(sbuf);
  if (((unsigned int )((num_pairs_added - ((num_pairs_added + num_pairs_added) & (num_pairs_added >> 31))) - 1) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )((((argc - 2) >> 31) - (argc - 2)) ^ ((argc - 2) >> 31)) >> 31U) & 1) {
  ...
  sw = tmp___0;
  tmp___1 = alignment_create((seqlen | 1UL) + (seqlen & 1UL));
  aln = tmp___1;
  ...
  while (1) {
    ...
    if ((int )((((~ aln->pos_a & aln->pos_b) | (~ (aln->pos_a ^ aln->pos_b) & (aln->pos_a - aln->pos_b))) >> 31UL) & 1UL)) {
...
{ 
  ...
  gap_b_open_penalty = (int )((scoring->gap_extend ^ scoring->gap_open) + ((scoring->gap_extend & scoring->gap_open) + (scoring->gap_extend & scoring->gap_open)));
  ...
  *score_x = ((*score_x & ~ 1UL) + (*score_x & ~ 1UL)) - (*score_x ^ 1UL);
  *score_y = (*score_y & ~ 1UL) - (~ *score_y & 1UL);
  *arr_index = ((*arr_index & ~ ((size_t___1 )(((aligner->score_width ^ ~ 1UL) + ((aligner->score_width | 1UL) + (aligner->score_width | 1UL))) + 1UL))) << 1UL) - (*arr_index ^ (size_t___1 )(((aligner->score_width ^ ~ 1UL) + ((aligner->score_width | 1UL) + (aligner->score_width | 1UL))) + 1UL));
  break;
  case 1U: 
  ...
  *score_y = (*score_y & ~ 1UL) - (~ *score_y & 1UL);
  *arr_index = (*arr_index ^ (size_t___1 )aligner->score_width) - ((~ *arr_index & (size_t___1 )aligner->score_width) << 1UL);
  break;
  case 2U: 
  ...
  *arr_index = (*arr_index + ~ 1UL) + 1UL;
  ...
  if ((int )(((((*score_x - len_i) - (((*score_x - len_i) << 1UL) & ((long )(*score_x - len_i) >> 31L))) - 1UL) >> 31UL) & 1UL)) {
    _L___2: 
    if (((unsigned int )(~ ((((*(aligner->gap_a_scores + *arr_index) ^ prev_gap_a_penalty) + ((*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty) << 1)) - *curr_score) | (*curr_score - ((*(aligner->gap_a_scores + *arr_index) ^ prev_gap_a_penalty) + ((*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty) << 1))))) >> 31U) & 1) {
  ...
  if ((int )((((((*score_y - len_j) + (1UL << 31)) ^ ((long )((*score_y - len_j) + (1UL << 31)) >> 31L)) - ((long )((*score_y - len_j) + (1UL << 31)) >> 31L)) >> 31UL) & 1UL)) {
    _L___0: 
    if (((unsigned int )(~ (((((*(aligner->gap_b_scores + *arr_index) | prev_gap_b_penalty) + (*(aligner->gap_b_scores + *arr_index) | prev_gap_b_penalty)) - (*(aligner->gap_b_scores + *arr_index) ^ prev_gap_b_penalty)) - *curr_score) | (*curr_score - (((*(aligner->gap_b_scores + *arr_index) | prev_gap_b_penalty) + (*(aligner->gap_b_scores + *arr_index) | prev_gap_b_penalty)) - (*(aligner->gap_b_scores + *arr_index) ^ prev_gap_b_penalty))))) >> 31U) & 1) {
  ...
  _L: 
  if (((unsigned int )(~ (((((*(aligner->match_scores + *arr_index) ^ ~ prev_match_penalty) + ((*(aligner->match_scores + *arr_index) | prev_match_penalty) + (*(aligner->match_scores + *arr_index) | prev_match_penalty))) + 1) - *curr_score) | (*curr_score - (((*(aligner->match_scores + *arr_index) ^ ~ prev_match_penalty) + ((*(aligner->match_scores + *arr_index) | prev_match_penalty) + (*(aligner->match_scores + *arr_index) | prev_match_penalty))) + 1)))) >> 31U) & 1) {
    ...
    *curr_score = *(aligner->match_scores + *arr_index);
    ...
    if ((unsigned int )*curr_matrix == 0U) {
      ...
      if ((int )((~ (((unsigned int )*curr_matrix - 1U) | (1U - (unsigned int )*curr_matrix)) >> 31U) & 1U)) {
        tmp = (char *)"GAP_A";
      } else {
        tmp = (char *)"GAP_B";
      }
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )((((c - 10) + (1 << 31)) + (((c - 10) + (1 << 31)) >> 31)) ^ (((c - 10) + (1 << 31)) >> 31)) >> 31U) & 1) {
      break;
    }
  }
...
{ 
  ...
  while (1) {
    if (file->have) {
      file->have = ((file->have & ~ 1U) + (file->have & ~ 1U)) - (file->have ^ 1U);
    ...
    skipped_bytes = ((skipped_bytes ^ ~ 1UL) + ((skipped_bytes | 1UL) << 1UL)) + 1UL;
...
{ 
  ...
  if ((int )(((unsigned long )(((diff ^ (diff >> 31L)) - (diff >> 31L)) - 1L) >> 31UL) & 1L)) {
    return ((int )((*a % (unsigned long const   )score_width + ~ (*b % (unsigned long const   )score_width)) + 1UL));
  } else {
...
{ 
  ...
  scoring->swap_set[(size_t___1 )a][(int )b >> 5] = (scoring->swap_set[(size_t___1 )a][(int )b >> 5] & ~ ((unsigned int )(1 << ((~ ((int )b) | 31) - ~ ((int )b))))) + (unsigned int )(1 << ((~ ((int )b) | 31) - ~ ((int )b)));
  if (((unsigned int )((scoring->min_penalty | ~ score) & ((scoring->min_penalty ^ score) | ~ (score - scoring->min_penalty))) >> 31U) & 1) {
    scoring->min_penalty = scoring->min_penalty;
  } else {
    scoring->min_penalty = score;
  }
  if (((unsigned int )((score | ~ scoring->max_penalty) & ((score ^ scoring->max_penalty) | ~ (scoring->max_penalty - score))) >> 31U) & 1) {
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      ...
      in->end = ((1UL ^ ~ tmp) + ((1UL | tmp) + (1UL | tmp))) + 1UL;
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    buffered = (offset + ~ in->begin) + 1UL;
    cbuf_capacity(buf, size, ((*len ^ ~ buffered) + ((*len | buffered) + (*len | buffered))) + 1UL);
    memcpy((void */* __restrict  */)(*buf + *len), (void const   */* __restrict  */)(in->b + in->begin),
           buffered);
    *len = (*len ^ buffered) + ((*len & buffered) << 1UL);
    in->begin = offset;
    total_read = ((total_read | buffered) + (total_read | buffered)) - (total_read ^ buffered);
    if (((unsigned int )(((((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) ^ (((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) >> 31)) - (((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) >> 31)) - 1) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size + ~ 1UL) + 1UL);
      in->end = ((1UL | tmp___1) << 1UL) - (1UL ^ tmp___1);
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  {
  if ((int )((~ ((cmd->file_list_length - cmd->file_list_capacity) | (cmd->file_list_capacity - cmd->file_list_length)) >> 31UL) & 1UL)) {
    cmd->file_list_capacity = (cmd->file_list_capacity & 2UL) * (cmd->file_list_capacity | 2UL) + (cmd->file_list_capacity & ~ 2UL) * (~ cmd->file_list_capacity & 2UL);
    mem = (sizeof(char *) & cmd->file_list_capacity) * (sizeof(char *) | cmd->file_list_capacity) + (sizeof(char *) & ~ cmd->file_list_capacity) * (~ sizeof(char *) & cmd->file_list_capacity);
  ...
  *(cmd->file_paths2 + cmd->file_list_length) = p2;
  cmd->file_list_length = (cmd->file_list_length | 1UL) + (cmd->file_list_length & 1UL);
  return;
}
}
...
{ 
  ...
  if ((int )((((((long )((unsigned long )strtol_last_char_ptr - (unsigned long )(str + len)) >> 31L) - ((unsigned long )strtol_last_char_ptr - (unsigned long )(str + len))) ^ ((long )((unsigned long )strtol_last_char_ptr - (unsigned long )(str + len)) >> 31L)) >> 31UL) & 1UL)) {
    return ((char)0);
  } else {
...
{ 
  ...
  {
  capacity = (strlength | 1UL) + (strlength & 1UL);
  if ((int )((((~ result->capacity & capacity) | (~ (result->capacity ^ capacity) & (result->capacity - capacity))) >> 31UL) & 1UL)) {
    capacity = _rndup2pow64((unsigned long long )capacity);
    tmp = realloc((void *)result->result_a, (sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
    result->result_a = (char *)tmp;
    tmp___0 = realloc((void *)result->result_b, (sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size + ~ 1UL) + 1UL,
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      ...
      skipped_bytes = (skipped_bytes | ((offset ^ in->begin) - ((~ offset & in->begin) << 1UL))) + (skipped_bytes & ((offset ^ in->begin) - ((~ offset & in->begin) << 1UL)));
    }
    in->begin = offset;
    if (((unsigned int )((((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) + (1 << 31)) - (((((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) + (1 << 31)) << 1) & ((((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
      break;
    }
    while (1) {
...
{ 
  ...
  if ((~ (scoring->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a))) | 1U) - ~ (scoring->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a)))) {
    tmp_score = scoring->wildscores[(size_t___1 )a];
  }
  if ((~ (scoring->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1)) | 1U) - ~ (scoring->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1))) {
    if ((int )(((unsigned int const   )((~ (scoring->wildscores[(size_t___1 )b] ^ tmp_score) >> (int const   )1) + (scoring->wildscores[(size_t___1 )b] & ~ tmp_score)) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  if ((int )(((unsigned long )((tmp___0 & ~ (-0x7FFFFFFF-1)) | (~ (tmp___0 ^ (-0x7FFFFFFF-1)) & (tmp___0 - (-0x7FFFFFFF-1)))) >> 31UL) & 1L)) {
    return ((char)0);
  } else
...
{ 
  ...
  if ((unsigned long )errfmt != (unsigned long )((void *)0)) {
    ...
    tmp = strlen(errfmt);
    if ((int )(((unsigned int const   )(((int const   )*(errfmt + ((tmp & ~ 1UL) - (~ tmp & 1UL))) - 10) | (10 - (int const   )*(errfmt + ((tmp & ~ 1UL) - (~ tmp & 1UL))))) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  if (((unsigned int )((match | ~ mismatch) & ((match ^ mismatch) | ~ (mismatch - match))) >> 31U) & 1) {
  ...
  if (! no_gaps_in_b) {
    _L___1: 
    if (((unsigned int )((scoring->min_penalty | ~ ((gap_open | gap_extend) + (gap_open & gap_extend))) & ((scoring->min_penalty ^ ((gap_open | gap_extend) + (gap_open & gap_extend))) | ~ (((gap_open | gap_extend) + (gap_open & gap_extend)) - scoring->min_penalty))) >> 31U) & 1) {
      if (((unsigned int )((~ (scoring->min_penalty ^ gap_extend) >> 1) + (scoring->min_penalty & ~ gap_extend)) >> 31U) & 1) {
        scoring->min_penalty = scoring->min_penalty;
      } else {
        goto _L;
      }
      ...
      _L: 
      if (((unsigned int )((~ ((((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1) ^ gap_extend) >> 1) + ((((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1) & ~ gap_extend)) >> 31U) & 1) {
        tmp = (gap_open - ~ gap_extend) - 1;
      } else {
        tmp = gap_extend;
      }
      scoring->min_penalty = tmp;
    }
    if (((unsigned int )((~ (((gap_open | gap_extend) + (gap_open & gap_extend)) ^ scoring->max_penalty) >> 1) + (((gap_open | gap_extend) + (gap_open & gap_extend)) & ~ scoring->max_penalty)) >> 31U) & 1) {
      if (((unsigned int )((gap_extend | ~ scoring->max_penalty) & ((gap_extend ^ scoring->max_penalty) | ~ (scoring->max_penalty - gap_extend))) >> 31U) & 1) {
        scoring->max_penalty = scoring->max_penalty;
      } else {
        goto _L___0;
      }
      ...
      _L___0: 
      if (((unsigned int )((gap_extend | ~ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) + (gap_open | gap_extend))) + 1)) & ((gap_extend ^ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) + (gap_open | gap_extend))) + 1)) | ~ ((((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) + (gap_open | gap_extend))) + 1) - gap_extend))) >> 31U) & 1) {
        tmp___0 = (gap_open ^ gap_extend) + ((gap_open & gap_extend) + (gap_open & gap_extend));
      } else {
        tmp___0 = gap_extend;
      }
...
{ 
  ...
  while ((int )((((~ nread & len) | (~ (nread ^ len) & (nread - len))) >> 31UL) & 1UL)) {
    n = ((len & ~ nread) + (len & ~ nread)) - (len ^ nread);
...
{ 
  ...
  {
  if ((int )((((~ *size | (((*len | 1UL) + (*len | 1UL)) - (*len ^ 1UL))) & ((*size ^ (((*len | 1UL) + (*len | 1UL)) - (*len ^ 1UL))) | ~ ((((*len | 1UL) + (*len | 1UL)) - (*len ^ 1UL)) - *size))) >> 31UL) & 1UL)) {
    cbuf_capacity(buf, size, (*len | 1UL) + (*len & 1UL));
  }
  ...
  while (1) {
    ...
    *len = (*len - ~ tmp___0) - 1UL;
    if (((unsigned int )(~ (((int )*(*buf + ((*len + ~ 1UL) + 1UL)) - 10) | (10 - (int )*(*buf + ((*len + ~ 1UL) + 1UL))))) >> 31U) & 1) {
    ...
    if ((int )((((~ 4294967295UL & (((*size & ~ *len) << 1UL) - (*size ^ *len))) | ((~ 4294967295UL | (((*size & ~ *len) << 1UL) - (*size ^ *len))) & (4294967295UL - (((*size & ~ *len) << 1UL) - (*size ^ *len))))) >> 31UL) & 1UL)) {
      r = (size_t___1 )4294967295U;
    } else {
      r = (*size + ~ *len) + 1UL;
    }
  }
  return ((*len & ~ origlen) - (~ *len & origlen));
}
}
...
{ 
  ...
  while ((int )((((~ hist->next_hit & hist->num_of_hits) | ((~ hist->next_hit | hist->num_of_hits) & (hist->next_hit - hist->num_of_hits))) >> 31UL) & 1UL)) {
    tmp = hist->next_hit;
    hist->next_hit = (hist->next_hit ^ 1UL) + ((hist->next_hit & 1UL) << 1UL);
...
{ 
  ...
  while ((int )((((~ i & len) | (~ (i ^ len) & (i - len))) >> 31UL) & 1UL)) {
    ...
    while ((int )((((~ j & len) | (~ (j ^ len) & (j - len))) >> 31UL) & 1UL)) {
      ...
      score = (int )*(scores + ((((j & len) * (j | len) + (j & ~ len) * (~ j & len)) | i) + (((j & len) * (j | len) + (j & ~ len) * (~ j & len)) & i)));
      scoring_add_mutation(scoring, a, b, score);
      j = ((j | 1UL) << 1UL) - (j ^ 1UL);
    }
    i = ((i | 1UL) + (i | 1UL)) - (i ^ 1UL);
...
{ 
  ...
  longest_alignment = (((((nw->score_width & ~ 1UL) - (~ nw->score_width & 1UL)) | nw->score_height) + (((nw->score_width & ~ 1UL) - (~ nw->score_width & 1UL)) & nw->score_height)) + ~ 1UL) + 1UL;
  alignment_ensure_capacity(result, longest_alignment);
  next_char = (longest_alignment ^ 1UL) - ((~ longest_alignment & 1UL) + (~ longest_alignment & 1UL));
  ...
  if (((unsigned int )((curr_score | ~ *(nw->gap_b_scores + ((arr_size + ~ 1UL) + 1UL))) & ((curr_score ^ *(nw->gap_b_scores + ((arr_size + ~ 1UL) + 1UL))) | ~ (*(nw->gap_b_scores + ((arr_size + ~ 1UL) + 1UL)) - curr_score))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )2;
    curr_score = *(nw->gap_b_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) + (~ arr_size & 1UL))));
  }
  if (((unsigned int )((curr_score | ~ *(nw->gap_a_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) << 1UL)))) & ((curr_score ^ *(nw->gap_a_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) << 1UL)))) | ~ (*(nw->gap_a_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) << 1UL))) - curr_score))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )1;
    curr_score = *(nw->gap_a_scores + (((arr_size & ~ 1UL) + (arr_size & ~ 1UL)) - (arr_size ^ 1UL)));
  }
  result->score = curr_score;
  alignment_a = result->result_a;
  alignment_b = result->result_b;
  score_x = (nw->score_width + ~ 1UL) + 1UL;
  score_y = (nw->score_height ^ 1UL) - ((~ nw->score_height & 1UL) << 1UL);
  arr_index = (arr_size + ~ 1UL) + 1UL;
  while (1) {
    if (score_x > 0UL) {
      if (! (score_y > 0UL)) {
        break;
    ...
    switch ((unsigned int )curr_matrix) {
    case 0U: 
    *(alignment_a + next_char) = (char )*(nw->seq_a + ((score_x ^ 1UL) - ((~ score_x & 1UL) << 1UL)));
    *(alignment_b + next_char) = (char )*(nw->seq_b + (((score_y & ~ 1UL) << 1UL) - (score_y ^ 1UL)));
    break;
    case 1U: 
  ...
  while (score_y > 0UL) {
    *(alignment_a + next_char) = (char )'-';
    *(alignment_b + next_char) = (char )*(nw->seq_b + ((score_y ^ 1UL) - ((~ score_y & 1UL) << 1UL)));
    next_char = (next_char & ~ 1UL) - (~ next_char & 1UL);
    score_y = ((score_y & ~ 1UL) << 1UL) - (score_y ^ 1UL);
  }
  while (score_x > 0UL) {
    *(alignment_a + next_char) = (char )*(nw->seq_a + ((score_x + ~ 1UL) + 1UL));
    *(alignment_b + next_char) = (char )'-';
    next_char = (next_char ^ 1UL) - ((~ next_char & 1UL) << 1UL);
    score_x = (score_x & ~ 1UL) - (~ score_x & 1UL);
  }
  first_char = (int )((next_char ^ 1UL) + ((next_char & 1UL) + (next_char & 1UL)));
  alignment_len = (int )(((longest_alignment & ~ ((size_t___1 )first_char)) + (longest_alignment & ~ ((size_t___1 )first_char))) - (longest_alignment ^ (size_t___1 )first_char));
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = gzread2(file, (void *)(in->b + 1), ((in->size & ~ 1UL) << 1UL) - (in->size ^ 1UL));
      in->end = ((1UL | tmp) << 1UL) - (1UL ^ tmp);
      in->begin = (size_t___1 )1;
      break;
    }
    if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
...
{ 
  ...
  b->size = ((tmp | 1UL) + (tmp | 1UL)) - (tmp ^ 1UL);
  ...
  b->begin = tmp___2;
  tmp___3 = (char)0;
  *(b->b + (((b->size & ~ 1UL) + (b->size & ~ 1UL)) - (b->size ^ 1UL))) = tmp___3;
  *(b->b + b->end) = tmp___3;
  return (b);
}
}
...
{ 
  ...
  while ((int )((((~ in->begin & in->end) | ((~ in->begin | in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      ...
      skipped_bytes = ((skipped_bytes | ((offset + ~ in->begin) + 1UL)) + (skipped_bytes | ((offset + ~ in->begin) + 1UL))) - (skipped_bytes ^ ((offset + ~ in->begin) + 1UL));
    }
    in->begin = offset;
    if (((unsigned int )(((((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) + (((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) >> 31)) ^ (((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) >> 31)) - 1) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size + ~ 1UL) + 1UL);
      in->end = ((1UL ^ ~ tmp___1) + ((1UL | tmp___1) + (1UL | tmp___1))) + 1UL;
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  green = (char)0;
  i = 0;
  while ((int )(((unsigned int const   )(((unsigned int const   )((int const   )*(alignment_a + i)) >> (unsigned int const   )1) - (int const   )*(alignment_a + i)) >> (unsigned int const   )31) & 1)) {
    if ((int )(((unsigned int const   )(((((int const   )*(alignment_b + i) - 45) + (1 << 31)) ^ ((((int const   )*(alignment_b + i) - 45) + (1 << 31)) >> (int const   )31)) - ((((int const   )*(alignment_b + i) - 45) + (1 << 31)) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
      if (! red) {
    ...
    if (! case_sensitive) {
      tmp = tolower((int )*(alignment_a + i));
      tmp___0 = tolower((int )*(alignment_b + i));
      if (((unsigned int )((((tmp - tmp___0) << 1) & ((tmp - tmp___0) >> 31)) - (tmp - tmp___0)) >> 31U) & 1) {
        _L___1: 
...
{ 
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    memcpy((void */* __restrict  */)(*buf + *len), (void const   */* __restrict  */)(in->b + in->begin),
           buffered);
    *len = ((*len | buffered) + (*len | buffered)) - (*len ^ buffered);
    in->begin = offset;
    total_read = (total_read - ~ buffered) - 1UL;
...
{ 
  ...
  if ((unsigned long )sf->gz_file != (unsigned long )((void *)0)) {
    ...
    if (((unsigned int )(((unsigned int )e >> 1U) - e) >> 31U) & 1) {
...
{ 
  ...
  if ((int )((((~ *sizeptr & len) | ((~ *sizeptr | len) & (*sizeptr - len))) >> 31UL) & 1UL)) {
    ...
    *sizeptr = 1UL << ((64 ^ tmp) - ((~ 64 & tmp) + (~ 64 & tmp)));
...
{ 
  ...
  printf((char const   *)((char const   */* __restrict  */)"seq_a: %.*s\nseq_b: %.*s\n"),
         ((int )aligner->score_width ^ 1) - ((~ ((int )aligner->score_width) & 1) << 1),
         aligner->seq_a, (((int )aligner->score_height & ~ 1) + ((int )aligner->score_height & ~ 1)) - ((int )aligner->score_height ^ 1),
         aligner->seq_b);
  ...
  while ((int )((((~ j & (size_t___1 )aligner->score_height) | ((~ j | (size_t___1 )aligner->score_height) & (j - (size_t___1 )aligner->score_height))) >> 31UL) & 1UL)) {
    ...
    while ((int )((((~ i & (size_t___1 )aligner->score_width) | ((~ i | (size_t___1 )aligner->score_width) & (i - (size_t___1 )aligner->score_width))) >> 31UL) & 1UL)) {
      printf((char const   *)((char const   */* __restrict  */)"\t%3i"), (int )*(match_scores + ((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i) + (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) & i))));
      i = (i | 1UL) + (i & 1UL);
    }
    putc('\n', stdout);
    j = ((j ^ ~ 1UL) + ((j | 1UL) + (j | 1UL))) + 1UL;
  }
  ...
  while ((int )((((~ j & (size_t___1 )aligner->score_height) | (~ (j ^ (size_t___1 )aligner->score_height) & (j - (size_t___1 )aligner->score_height))) >> 31UL) & 1UL)) {
    ...
    i = (size_t___1 )0;
    while ((int )((((~ i & (size_t___1 )aligner->score_width) | (~ (i ^ (size_t___1 )aligner->score_width) & (i - (size_t___1 )aligner->score_width))) >> 31UL) & 1UL)) {
      printf((char const   *)((char const   */* __restrict  */)"\t%3i"), (int )*(gap_b_scores + (((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i) + (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i)) - (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) ^ i))));
      i = ((i ^ ~ 1UL) + ((i | 1UL) + (i | 1UL))) + 1UL;
    }
    putc('\n', stdout);
    j = (j | 1UL) + (j & 1UL);
...
{ 
  ...
  aligner->seq_a = seq_a;
  aligner->seq_b = seq_b;
  aligner->score_width = (len_a | 1UL) + (len_a & 1UL);
  aligner->score_height = (len_b | 1UL) + (len_b & 1UL);
...
{ 
  ...
  if (((unsigned int )(((line_num + (1 << 31)) ^ ((line_num + (1 << 31)) >> 31)) - ((line_num + (1 << 31)) >> 31)) >> 31U) & 1) {
    if (sbuf->end <= 0UL) {
  ...
  _L: 
  if (((unsigned int )(~ (((int )sep - 45) | (45 - (int )sep))) >> 31U) & 1) {
    _loading_error("Numbers (0-9) and dashes (-) do not make good separators", file_path,
                   line_num, (char)0);
  }
  ...
  if (tmp___18) {
    ...
    while (1) {
      ...
      num_of_chars = (num_of_chars ^ 1) + ((num_of_chars & 1) + (num_of_chars & 1));
      if (case_sensitive) {
    ...
    while (1) {
      ...
      score_txt = sbuf->b + 1;
      i = 0;
      while (((unsigned int )((i & ~ num_of_chars) | (~ (i ^ num_of_chars) & (i - num_of_chars))) >> 31U) & 1) {
      ...
      line_num = ((line_num | 1) << 1) - (line_num ^ 1);
    }
  } else {
    i___0 = (size_t___1 )0;
    while ((int )((((~ i___0 & sbuf->end) | ((~ i___0 | sbuf->end) & (i___0 - sbuf->end))) >> 31UL) & 1UL)) {
      ...
      if (case_sensitive) {
        tmp___11 = (int )*(sbuf->b + ((i___0 ^ 1UL) + ((i___0 & 1UL) + (i___0 & 1UL))));
      } else {
        tmp___10 = tolower((int )*(sbuf->b + ((i___0 ^ 1UL) + ((i___0 & 1UL) + (i___0 & 1UL)))));
        tmp___11 = tmp___10;
      }
      c = (char )tmp___11;
      tmp___12 = num_of_chars;
      num_of_chars = (num_of_chars - ~ 1) - 1;
    ...
    while (1) {
      ...
      if (((unsigned int )(((((int )from_char___0 - 35) + (((int )from_char___0 - 35) >> 31)) ^ (((int )from_char___0 - 35) >> 31)) - 1) >> 31U) & 1) {
        continue;
      } else {
      ...
      str_pos = sbuf->b;
      to_char_index = 0;
      while (((unsigned int )(((unsigned int )((int )*str_pos) >> 1U) - (int )*str_pos) >> 31U) & 1) {
        tmp___16 = to_char_index;
        to_char_index = (to_char_index | 1) + (to_char_index & 1);
        to_char___0 = *(characters + tmp___16);
        if (((unsigned int )(((int )*str_pos - (int )sep) | ((int )sep - (int )*str_pos)) >> 31U) & 1) {
          _loading_error("Separator missing from line", file_path, line_num, (char)1);
        }
        str_pos ++;
        ...
        if ((int )((~ (((unsigned long )str_pos - (unsigned long )after_num_str) | ((unsigned long )after_num_str - (unsigned long )str_pos)) >> 31UL) & 1UL)) {
          _loading_error("Missing number value on line", file_path, line_num, (char)1);
        }
      ...
      line_num = (line_num ^ 1) + ((line_num & 1) << 1);
    }
  }
...
{ 
  ...
  scoring->wildcards[(int )c >> 5] = ((scoring->wildcards[(int )c >> 5] + (unsigned int )(1 << (((~ ((int )c) | 31) + (int )c) + 1))) + 1U) + ((- scoring->wildcards[(int )c >> 5] - 1U) | (- ((unsigned int )(1 << (((~ ((int )c) | 31) + (int )c) + 1))) - 1U));
  scoring->wildscores[(size_t___1 )c] = score;
  if (((unsigned int )((~ (scoring->min_penalty ^ score) >> 1) + (scoring->min_penalty & ~ score)) >> 31U) & 1) {
    scoring->min_penalty = scoring->min_penalty;
  } else {
    scoring->min_penalty = score;
  }
  if (((unsigned int )((~ (score ^ scoring->max_penalty) >> 1) + (score & ~ scoring->max_penalty)) >> 31U) & 1) {
    scoring->max_penalty = scoring->max_penalty;
  } else {
    scoring->max_penalty = score;
  }
...
{ 
  ...
  memset((void *)hist->match_scores_mask.b, 0, ((hist->match_scores_mask.l - ~ 31UL) - 1UL) / 32UL);
  tmp = (size_t___1 )0;
  hist->next_hit = tmp;
  ...
  while ((int )((((~ pos & arr_size) | (~ (pos ^ arr_size) & (pos - arr_size))) >> 31UL) & 1UL)) {
    if (((unsigned int )((*(aligner->match_scores + pos) >> 1) - *(aligner->match_scores + pos)) >> 31U) & 1) {
      ...
      hist->num_of_hits = (hist->num_of_hits ^ 1UL) + ((hist->num_of_hits & 1UL) + (hist->num_of_hits & 1UL));
      *(hist->sorted_match_indices + tmp___0) = pos;
    }
    pos = ((pos ^ ~ 1UL) + ((pos | 1UL) << 1UL)) + 1UL;
  }
...
{ 
  ...
  while (((unsigned int )(curr_score ^ ((curr_score >> 31) - (curr_score ^ (curr_score >> 31)))) >> 31U) & 1) {
    switch ((unsigned int )curr_matrix) {
    case 0U: 
    *(result->result_a + i) = (char )*(aligner->seq_a + ((score_x & ~ 1UL) - (~ score_x & 1UL)));
    *(result->result_b + i) = (char )*(aligner->seq_b + ((score_y + ~ 1UL) + 1UL));
    break;
    case 1U: 
    *(result->result_a + i) = (char )'-';
    *(result->result_b + i) = (char )*(aligner->seq_b + ((score_y & ~ 1UL) - (~ score_y & 1UL)));
    break;
    case 2U: 
    *(result->result_a + i) = (char )*(aligner->seq_a + ((score_x & ~ 1UL) - (~ score_x & 1UL)));
  ...
  *(result->result_b + length) = (char )'\000';
  ...
  result->len_a = (end_score_x + ~ score_x) + 1UL;
  result->len_b = (end_score_y ^ score_y) - ((~ end_score_y & score_y) << 1UL);
  return ((char)1);
}
}
...
{ 
  ...
  if ((int )((((~ nel & 7UL) | ((~ nel | 7UL) & (nel - 7UL))) >> 31UL) & 1UL)) {
    ...
    last = b + ((w & ((nel & ~ 1UL) - (~ nel & 1UL))) * (w | ((nel & ~ 1UL) - (~ nel & 1UL))) + (w & ~ ((nel & ~ 1UL) - (~ nel & 1UL))) * (~ w & ((nel & ~ 1UL) - (~ nel & 1UL))));
    l[0] = b;
    l[1] = b + ((w & nel / 2UL) * (w | nel / 2UL) + (w & ~ (nel / 2UL)) * (~ w & nel / 2UL));
    l[2] = last;
    tmp___1 = (*compar)((void const   *)l[0], (void const   *)l[1], arg);
    if (((unsigned int )((tmp___1 >> 1) - tmp___1) >> 31U) & 1) {
      tmp___0 = l[0];
      l[0] = l[1];
      l[1] = tmp___0;
    }
    tmp___3 = (*compar)((void const   *)l[1], (void const   *)l[2], arg);
    if (((unsigned int )((tmp___3 >> 1) - tmp___3) >> 31U) & 1) {
      tmp___0 = l[1];
      l[1] = l[2];
      l[2] = tmp___0;
      tmp___2 = (*compar)((void const   *)l[0], (void const   *)l[1], arg);
      if (((unsigned int )(tmp___2 ^ (((tmp___2 << 1) & (tmp___2 >> 31)) - tmp___2)) >> 31U) & 1) {
        tmp___0 = l[0];
        l[0] = l[1];
        l[1] = tmp___0;
      }
...
{ 
  ...
  while ((int )((((~ i & 29UL) | (~ (i ^ 29UL) & (i - 29UL))) >> 31UL) & 1UL)) {
    if ((int )((((~ extlens[i] | plen) & ((extlens[i] ^ plen) | ~ (plen - extlens[i]))) >> 31UL) & 1UL)) {
      ...
      if (((unsigned int )(((tmp___0 + (tmp___0 >> 31)) ^ (tmp___0 >> 31)) - 1) >> 31U) & 1) {
        return (types[i]);
      }
    }
    i = ((i | 1UL) << 1UL) - (i ^ 1UL);
...
{ 
  ...
  {
  cbuf_capacity(buf, sizeptr, (*lenptr ^ 1UL) + ((*lenptr & 1UL) + (*lenptr & 1UL)));
  tmp = *lenptr;
  *lenptr = ((*lenptr ^ ~ 1UL) + ((*lenptr | 1UL) << 1UL)) + 1UL;
  *(*buf + tmp) = c;
  *(*buf + *lenptr) = (char )'\000';
  return;
}
...
{ 
  ...
  if ((int )((((~ *size | (((*len | 1UL) << 1UL) - (*len ^ 1UL))) & ((*size ^ (((*len | 1UL) << 1UL) - (*len ^ 1UL))) | ~ ((((*len | 1UL) << 1UL) - (*len ^ 1UL)) - *size))) >> 31UL) & 1UL)) {
    cbuf_capacity(buf, size, ((*len | 1UL) + (*len | 1UL)) - (*len ^ 1UL));
  }
  if ((int )((((~ 4294967295UL & ((*size & ~ *len) - (~ *size & *len))) | ((~ 4294967295UL | ((*size & ~ *len) - (~ *size & *len))) & (4294967295UL - ((*size & ~ *len) - (~ *size & *len))))) >> 31UL) & 1UL)) {
    tmp = (size_t___1 )4294967295U;
  } else {
  ...
  while (1) {
    ...
    tmp___0 = strlen((char const   *)(*buf + *len));
    *len = ((*len ^ ~ tmp___0) + ((*len | tmp___0) << 1UL)) + 1UL;
    if (((unsigned int )(((((int )*(*buf + ((*len & ~ 1UL) - (~ *len & 1UL))) - 10) + (((int )*(*buf + ((*len & ~ 1UL) - (~ *len & 1UL))) - 10) >> 31)) ^ (((int )*(*buf + ((*len & ~ 1UL) - (~ *len & 1UL))) - 10) >> 31)) - 1) >> 31U) & 1) {
      return ((*len ^ origlen) - ((~ *len & origlen) << 1UL));
    } else {
      tmp___1 = (*size & 2UL) * (*size | 2UL) + (*size & ~ 2UL) * (~ *size & 2UL);
      *size = tmp___1;
      tmp___2 = realloc((void *)*buf, tmp___1);
...
{ 
  ...
  if ((int )((((~ bs->s & ss) | (~ (bs->s ^ ss) & (bs->s - ss))) >> 31UL) & 1UL)) {
    ...
    bs->b = (uint32_t *)tmp;
    memset((void *)(bs->b + bs->s), 0, ((((ss & ~ bs->s) + (ss & ~ bs->s)) - (ss ^ bs->s)) & sizeof(*(bs->b + 0))) * ((((ss & ~ bs->s) + (ss & ~ bs->s)) - (ss ^ bs->s)) | sizeof(*(bs->b + 0))) + ((((ss & ~ bs->s) + (ss & ~ bs->s)) - (ss ^ bs->s)) & ~ sizeof(*(bs->b + 0))) * (~ (((ss & ~ bs->s) + (ss & ~ bs->s)) - (ss ^ bs->s)) & sizeof(*(bs->b + 0))));
    bs->s = ss;
  }
  bs->l = l;
  if (bs->b) {
