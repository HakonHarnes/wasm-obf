...
/* Generated by Tigress v3.2 (https://tigress.wtf), 07:03:16-2023/04/23 */
...
{ 
  ...
  while (1) {
    ...
    b = (char )*(str + j);
    {
    _1_scoring_add_mutations_next = 3U;
    }
    break;
    case 8: ;
...
{ 
  ...
  {
  {
  _1_alignment_reverse_move_next = 19U;
  }
  while (1) {
    ...
    *arr_index -= (size_t___1 )aligner->score_width;
    {
    _1_alignment_reverse_move_next = 21U;
    }
    break;
    case 15: 
    tmp = (char *)"GAP_A";
    ...
    {
    _1_alignment_reverse_move_next = 32U;
    }
    break;
    case 8: 
    ...
    *curr_score = *(aligner->match_scores + *arr_index);
    ...
    if (! scoring->no_gaps_in_b) {
      ...
      {
      _1_alignment_reverse_move_next = 20U;
      }
    }
    break;
    case 21: ;
    ...
    if (*(aligner->match_scores + *arr_index) + prev_match_penalty == *curr_score) {
      {
      _1_alignment_reverse_move_next = 3U;
      }
    } else {
      {
    ...
    *curr_score = *(aligner->gap_a_scores + *arr_index);
    ...
    if (scoring->no_start_gap_penalty) {
      ...
      {
      _1_alignment_reverse_move_next = 43U;
      }
    }
    break;
    case 22: 
    ...
    if (*score_y == len_j) {
      {
      _1_alignment_reverse_move_next = 0U;
      }
    } else {
      {
      _1_alignment_reverse_move_next = 27U;
    ...
    if ((unsigned int )*curr_matrix == 1U) {
      {
      _1_alignment_reverse_move_next = 15U;
      }
    } else {
      {
...
{ 
  ...
  while (1) {
    ...
    if ((int const   )*(alignment_a + i) == 45) {
      {
      _1_alignment_print_spacer_next = 12U;
      }
    } else {
      {
      _1_alignment_print_spacer_next = 7U;
      }
    }
    break;
    case 7: ;
  ...
  while (1) {
    ...
    *(gap_b_scores + index___0) = tmp___18;
    ...
    if (*(match_scores + index_up) + gap_open_penalty >= *(gap_a_scores + index_up) + gap_extend_penalty) {
      ...
      {
      _1_alignment_fill_matrices_next = 20U;
      }
    }
    break;
    case 104: 
    ...
    *(gap_a_scores + i) = min;
    {
    _1_alignment_fill_matrices_next = 45U;
    }
    break;
    case 130: ;
    if (is_sw) {
      {
      _1_alignment_fill_matrices_next = 107U;
      }
    } else {
      {
    ...
    {
    _1_alignment_fill_matrices_next = 121U;
    }
    break;
    case 52: ;
    if (! is_match) {
    ...
    if (seq_j == len_j - 1UL) {
      {
      _1_alignment_fill_matrices_next = 78U;
      }
    } else {
      {
    ...
    if (j < score_height) {
      {
      _1_alignment_fill_matrices_next = 82U;
      }
    } else {
      {
    ...
    *(gap_b_scores + index___0) = min;
    ...
    if (seq_j < len_j) {
      ...
      {
      _1_alignment_fill_matrices_next = 19U;
      }
    }
    break;
    case 82: 
    ...
    *(gap_a_scores + index___0) = tmp___15;
    ...
    if (*(gap_a_scores + index_left) + gap_open_penalty >= *(gap_b_scores + index_left) + gap_extend_penalty) {
      {
      _1_alignment_fill_matrices_next = 2U;
      }
    } else {
      {
    ...
    if (*(match_scores + index_left) + gap_open_penalty >= *(gap_a_scores + index_left) + gap_open_penalty) {
      {
      _1_alignment_fill_matrices_next = 36U;
      }
    } else {
      {
      _1_alignment_fill_matrices_next = 8U;
      }
    }
    break;
    case 118: 
    tmp___15 = tmp___14;
    {
    _1_alignment_fill_matrices_next = 69U;
    }
    break;
    case 23: 
    *(gap_b_scores + index___0) = tmp___22;
    ...
    if (*(match_scores + index_left) >= *(gap_a_scores + index_left)) {
      ...
      {
      _1_alignment_fill_matrices_next = 86U;
      }
    }
    break;
    case 16: 
    ...
    *(match_scores + index___0) = tmp___8;
    ...
    {
    _1_alignment_fill_matrices_next = 118U;
    }
    break;
    case 36: ;
    ...
    *(match_scores + index___0) = tmp___3;
    ...
    index___0 += score_width;
    {
    _1_alignment_fill_matrices_next = 84U;
    }
    break;
    case 100: 
    *(gap_b_scores + i) = 0;
    ...
    if (seq_i == len_i - 1UL) {
      {
      _1_alignment_fill_matrices_next = 58U;
      }
    } else {
      {
    ...
    *(gap_a_scores + index___0) = min;
    ...
    if (*(match_scores + index_upleft) + substitution_penalty >= *(gap_b_scores + index_upleft) + substitution_penalty) {
      {
      _1_alignment_fill_matrices_next = 73U;
      }
    } else {
      {
      _1_alignment_fill_matrices_next = 97U;
    ...
    if (*(match_scores + index_up) + gap_open_penalty >= *(gap_a_scores + index_up) + gap_extend_penalty) {
      {
      _1_alignment_fill_matrices_next = 53U;
      }
    } else {
      {
    ...
    if (tmp___17 >= min) {
      {
      _1_alignment_fill_matrices_next = 129U;
      }
    } else {
      {
    ...
    *(gap_a_scores + index___0) = (score_t )(scoring->gap_open + (int const   )((int )j * (int )scoring->gap_extend));
    ...
    if (*(gap_a_scores + index_upleft) + substitution_penalty >= *(gap_b_scores + index_upleft) + substitution_penalty) {
      ...
      {
      _1_alignment_fill_matrices_next = 48U;
      }
    }
    break;
    case 72: 
    *(match_scores + index___0) = min;
    ...
    if (tmp___10 >= min) {
      ...
      {
      _1_alignment_fill_matrices_next = 9U;
      }
    }
    break;
    case 119: ;
    ...
    *(gap_a_scores + index___0) = 0;
    ...
    if (scoring->no_end_gap_penalty) {
      {
      _1_alignment_fill_matrices_next = 46U;
      }
    } else {
      {
      _1_alignment_fill_matrices_next = 28U;
    ...
    if (*(gap_a_scores + index_left) >= *(gap_b_scores + index_left)) {
      {
      _1_alignment_fill_matrices_next = 67U;
      }
    } else {
      {
...
{ 
  ...
  while (1) {
    ...
    break;
    case 0: 
    scoring_init(scoring, 1, -17, -9, -1, (_Bool)0, (_Bool)0, (_Bool)0, (_Bool)0,
                 (_Bool)0, (_Bool)0);
...
static void print_usage___0(char **argv ) 
{ 
  unsigned int _1_print_usage___0_next ;

  {
  {
  _1_print_usage___0_next = 1U;
  }
  while (1) {
    switch (_1_print_usage___0_next) {
    case 1: 
...
{ 
  ...
  {
  {
  _1_alignment_print_matrices_next = 1U;
  }
  while (1) {
    ...
    j ++;
    {
    _1_alignment_print_matrices_next = 23U;
    }
    break;
    case 31: 
    putc('\n', stdout);
    j ++;
    {
    _1_alignment_print_matrices_next = 19U;
    }
    break;
    case 12: ;
    if (i < (size_t___1 )aligner->score_width) {
      {
      _1_alignment_print_matrices_next = 6U;
      }
    } else {
      {
      _1_alignment_print_matrices_next = 31U;
      }
    }
    break;
    case 8: 
    ...
    i = (size_t___1 )0;
    {
    _1_alignment_print_matrices_next = 24U;
    }
    break;
    case 1: 
    ...
    j = (size_t___1 )0;
    {
    _1_alignment_print_matrices_next = 0U;
    }
    break;
    case 23: ;
    if (j < (size_t___1 )aligner->score_height) {
      {
    ...
    if (i < (size_t___1 )aligner->score_width) {
      {
      _1_alignment_print_matrices_next = 27U;
      }
    } else {
      {
      _1_alignment_print_matrices_next = 15U;
      }
    }
    break;
    case 11: 
    ...
    if (j < (size_t___1 )aligner->score_height) {
      {
      _1_alignment_print_matrices_next = 7U;
      }
    } else {
      {
    ...
    i ++;
    {
    _1_alignment_print_matrices_next = 12U;
    }
    break;
    case 27: 
...
{ 
  ...
  {
  {
  _1_alignment_colour_print_against_next = 12U;
  }
  while (1) {
    ...
    i = 0;
    {
    _1_alignment_colour_print_against_next = 21U;
    }
    break;
    case 1: 
    fputs((char const   *)((char const   */* __restrict  */)(align_col_stop)), (FILE *)((FILE */* __restrict  */)stdout));
    ...
    if (green) {
      {
      _1_alignment_colour_print_against_next = 20U;
      }
    } else {
      {
      _1_alignment_colour_print_against_next = 17U;
      }
    }
    break;
    case 24: 
    ...
    if ((int const   )*(alignment_b + i) == 45) {
      ...
      {
      _1_alignment_colour_print_against_next = 7U;
      }
    }
    break;
    case 11: ;
    ...
    if (! red) {
      {
      _1_alignment_colour_print_against_next = 15U;
      }
    } else {
      {
      _1_alignment_colour_print_against_next = 6U;
...
{ 
  ...
  while (1) {
    ...
    case 1: 
    scoring_init(scoring, 0, 0, -10, -10, (_Bool)0, (_Bool)0, (_Bool)0, (_Bool)0,
                 (_Bool)0, (_Bool)0);
...
{ 
  ...
  while (1) {
    ...
    break;
    case 0: 
    scoring_init(scoring, 1, -4, -10, -1, (_Bool)0, (_Bool)0, (_Bool)0, (_Bool)0,
                 (_Bool)0, (_Bool)0);
...
{ 
  ...
  while (1) {
    ...
    *(alignment_b + next_char) = (char )'-';
    ...
    {
    _1_needleman_wunsch_align2_next = 10U;
    }
    break;
    case 8: 
    curr_matrix = (enum Matrix )1;
...
{ 
  ...
  while (1) {
    ...
    break;
    case 219: 
    tmp___15 = parse_entire_int(*(argv + (argi + 1)), & cmd->min_score);
    {
    ...
    break;
    case 62: 
    tmp___18 = parse_entire_int(*(argv + (argi + 1)), & scoring->match);
    {
    ...
    break;
    case 82: 
    tmp___17 = parse_entire_uint(*(argv + (argi + 1)), & cmd->print_context);
    {
    ...
    break;
    case 220: 
    cmdline_add_files(cmd, *(argv + (argi + 1)), (char *)((void *)0));
    {
    ...
    break;
    case 187: 
    tmp___19 = parse_entire_int(*(argv + (argi + 1)), & scoring->mismatch);
    {
    _1_cmdline_new_next = 0U;
    }
    break;
    case 161: 
    tmp___16 = parse_entire_uint(*(argv + (argi + 1)), & cmd->max_hits_per_alignment);
    {
    ...
    break;
    case 120: 
    tmp___21 = parse_entire_int(*(argv + (argi + 1)), & scoring->gap_extend);
    {
    ...
    break;
    case 114: 
    tmp___20 = parse_entire_int(*(argv + (argi + 1)), & scoring->gap_open);
    {
...
{ 
  ...
  while (1) {
    ...
    case 1: 
    scoring_init(scoring, 1, -8, -10, -1, (_Bool)0, (_Bool)0, (_Bool)0, (_Bool)0,
                 (_Bool)0, (_Bool)0);
...
{ 
  ...
  while (1) {
    ...
    *(characters + tmp___2) = *next;
    ...
    if (i < num_of_chars) {
      {
      _1_align_scoring_load_matrix_next = 37U;
      }
    } else {
      {
    ...
    if (! tmp___9) {
      {
      _1_align_scoring_load_matrix_next = 35U;
      }
    } else {
      {
    ...
    *(characters + tmp___2) = (char )tmp___3;
    ...
    if ((int )*str_pos != (int )sep) {
      {
      _1_align_scoring_load_matrix_next = 43U;
      }
    } else {
      {
    ...
    *(characters + tmp___12) = c;
    ...
    i = 0;
    {
    _1_align_scoring_load_matrix_next = 45U;
    }
    break;
    case 41: 
    ...
    if (case_sensitive) {
      ...
      {
      _1_align_scoring_load_matrix_next = 55U;
      }
    }
    break;
    case 88: ;
