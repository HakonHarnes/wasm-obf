...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:47:53-2023/04/23 */
...
{ 
  ...
  while (((unsigned int )((((argc - argi) & - (argc >= argi)) >> 31) - (((argc - argi) & - (argc >= argi)) ^ (((argc - argi) & - (argc >= argi)) >> 31))) >> 31U) & 1) {
    ...
    if (((unsigned int )((tmp___10 + (1 << 31)) - (((tmp___10 + (1 << 31)) + (tmp___10 + (1 << 31))) & ((tmp___10 + (1 << 31)) >> 31))) >> 31U) & 1) {
      print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
    } else {
      tmp___11 = strcasecmp((char const   *)*(argv + argi), "-help");
      if (((unsigned int )((tmp___11 - ((tmp___11 << 1) & (tmp___11 >> 31))) - 1) >> 31U) & 1) {
        print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
      } else {
        tmp___12 = strcasecmp((char const   *)*(argv + argi), "-h");
        if (((unsigned int )((tmp___12 - ((tmp___12 << 1) & (tmp___12 >> 31))) - 1) >> 31U) & 1) {
          print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
        } else {
          ...
          if (((unsigned int )(~ tmp___9 & (tmp___9 - 1)) >> 31U) & 1) {
            ...
            if (((unsigned int )(~ (tmp___8 | - tmp___8)) >> 31U) & 1) {
              if (scoring_set) {
                print_usage(cmd_type, defaults, (char const   *)*(argv + 0), "More than one scoring system specified - not permitted");
              }
              tmp___7 = strcasecmp((char const   *)*(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                   "PAM30");
              if (((unsigned int )(((tmp___7 ^ (tmp___7 >> 31)) - (tmp___7 >> 31)) - 1) >> 31U) & 1) {
                scoring_system_PAM30(scoring___0);
              } else {
                tmp___6 = strcasecmp((char const   *)*(argv + ((argi ^ 1) + ((argi & 1) << 1))),
                                     "PAM70");
                if (((unsigned int )(((tmp___6 ^ (tmp___6 >> 31)) - (tmp___6 >> 31)) - 1) >> 31U) & 1) {
                  scoring_system_PAM70(scoring___0);
                } else {
                  tmp___5 = strcasecmp((char const   *)*(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                       "BLOSUM80");
                  if (((unsigned int )(~ (tmp___5 | - tmp___5)) >> 31U) & 1) {
                    scoring_system_BLOSUM80(scoring___0);
                  } else {
                    tmp___4 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)),
                                         "BLOSUM62");
                    if (((unsigned int )(((tmp___4 + (1 << 31)) + ((tmp___4 + (1 << 31)) >> 31)) ^ ((tmp___4 + (1 << 31)) >> 31)) >> 31U) & 1) {
                      scoring_system_BLOSUM62(scoring___0);
                    } else {
                      tmp___3 = strcasecmp((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                           "DNA_HYBRIDIZATION");
  ...
  while (((unsigned int )((((argc - argi) & - (argc >= argi)) >> 31) - (((argc - argi) & - (argc >= argi)) ^ (((argc - argi) & - (argc >= argi)) >> 31))) >> 31U) & 1) {
    if (((unsigned int )(~ (((int )*(*(argv + argi) + 0) - 45) | (45 - (int )*(*(argv + argi) + 0)))) >> 31U) & 1) {
      ...
      if (((unsigned int )((tmp___53 - ((tmp___53 + tmp___53) & (tmp___53 >> 31))) - 1) >> 31U) & 1) {
        ...
        if (((unsigned int )(~ tmp___52 & (tmp___52 - 1)) >> 31U) & 1) {
          if ((int )(((((unsigned int )cmd_type - 1U) | (1U - (unsigned int )cmd_type)) >> 31U) & 1U)) {
          ...
          if (((unsigned int )((tmp___51 + (1 << 31)) - (((tmp___51 + (1 << 31)) << 1) & ((tmp___51 + (1 << 31)) >> 31))) >> 31U) & 1) {
            scoring___0->no_gaps_in_a = (_Bool)1;
            scoring___0->no_gaps_in_b = (_Bool)1;
          } else {
            tmp___50 = strcasecmp((char const   *)*(argv + argi), "--nogapsin1");
            if (((unsigned int )(((tmp___50 + (tmp___50 >> 31)) ^ (tmp___50 >> 31)) - 1) >> 31U) & 1) {
              scoring___0->no_gaps_in_a = (_Bool)1;
            } else {
              tmp___49 = strcasecmp((char const   *)*(argv + argi), "--nogapsin2");
              if (((unsigned int )(((tmp___49 + (1 << 31)) + ((tmp___49 + (1 << 31)) >> 31)) ^ ((tmp___49 + (1 << 31)) >> 31)) >> 31U) & 1) {
                scoring___0->no_gaps_in_b = (_Bool)1;
              } else {
                ...
                if (((unsigned int )(~ tmp___48 & (tmp___48 - 1)) >> 31U) & 1) {
                  ...
                  if (! (((unsigned int )((tmp___47 + (1 << 31)) - (((tmp___47 + (1 << 31)) << 1) & ((tmp___47 + (1 << 31)) >> 31))) >> 31U) & 1)) {
                    tmp___46 = strcasecmp((char const   *)*(argv + argi), "--printseq");
                    if (((unsigned int )(~ tmp___46 & (tmp___46 - 1)) >> 31U) & 1) {
                        ...
                        if (((unsigned int )(~ (tmp___44 | - tmp___44)) >> 31U) & 1) {
                          ...
                          if (((unsigned int )(~ (tmp___43 | - tmp___43)) >> 31U) & 1) {
                            ...
                            tmp___42 = strcasecmp((char const   *)*(argv + argi),
                                                  "--pretty");
                            if (((unsigned int )(((tmp___42 + (tmp___42 >> 31)) ^ (tmp___42 >> 31)) - 1) >> 31U) & 1) {
                              ...
                              if (((unsigned int )(~ tmp___41 & (tmp___41 - 1)) >> 31U) & 1) {
                                ...
                                tmp___40 = strcasecmp((char const   *)*(argv + argi),
                                                      "--zam");
                                if (((unsigned int )(~ tmp___40 & (tmp___40 - 1)) >> 31U) & 1) {
                                  if ((int )(((((int )((unsigned int )cmd_type - 1U) >> 31) - (((unsigned int )cmd_type - 1U) ^ ((int )((unsigned int )cmd_type - 1U) >> 31))) >> 31U) & 1U)) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                  ...
                                  tmp___39 = strcasecmp((char const   *)*(argv + argi),
                                                        "--stdin");
                                  if (((unsigned int )((tmp___39 - ((tmp___39 << 1) & (tmp___39 >> 31))) - 1) >> 31U) & 1) {
                                    cmdline_add_files(cmd___0, (char *)"", (char *)((void *)0));
                                    cmd___0->interactive = (_Bool)1;
                                  } else
                                  if (((unsigned int )(((argi - ((argc ^ 1) - ((~ argc & 1) << 1))) + (1 << 31)) - ((((argi - ((argc ^ 1) - ((~ argc & 1) << 1))) + (1 << 31)) << 1) & (((argi - ((argc ^ 1) - ((~ argc & 1) << 1))) + (1 << 31)) >> 31))) >> 31U) & 1) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                    ...
                                    if (((unsigned int )((tmp___38 + (1 << 31)) - (((tmp___38 + (1 << 31)) + (tmp___38 + (1 << 31))) & ((tmp___38 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                      ...
                                      tmp___37 = strcasecmp((char const   *)*(argv + argi),
                                                            "--substitution_matrix");
                                      if (((unsigned int )(~ tmp___37 & (tmp___37 - 1)) >> 31U) & 1) {
                                        tmp___13 = gzopen((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                                          "r");
                                        sub_matrix_file = tmp___13;
                                        if ((unsigned long )sub_matrix_file == (unsigned long )((void *)0)) {
                                          print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                      "Couldn\'t read: %s", *(argv + ((argi | 1) + (argi & 1))));
                                        }
                                        align_scoring_load_matrix(sub_matrix_file,
                                                                  (char const   *)*(argv + (((argi | 1) << 1) - (argi ^ 1))),
                                        ...
                                        if (((unsigned int )(~ tmp___36 & (tmp___36 - 1)) >> 31U) & 1) {
                                          tmp___14 = gzopen((char const   *)*(argv + (((argi | 1) << 1) - (argi ^ 1))),
                                                            "r");
                                          ...
                                          tmp___35 = strcasecmp((char const   *)*(argv + argi),
                                                                "--minscore");
                                          if (((unsigned int )((tmp___35 - ((tmp___35 << 1) & (tmp___35 >> 31))) - 1) >> 31U) & 1) {
                                            if ((unsigned int )cmd_type != 0U) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                          "--minscore only valid with Smith-Waterman");
                                            }
                                            tmp___15 = parse_entire_int(*(argv + ((argi | 1) + (argi & 1))),
                                                                        & cmd___0->min_score);
                                            if (! tmp___15) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                            ...
                                            tmp___34 = strcasecmp((char const   *)*(argv + argi),
                                                                  "--maxhits");
                                            if (((unsigned int )(~ (tmp___34 | - tmp___34)) >> 31U) & 1) {
                                              if ((unsigned int )cmd_type != 0U) {
                                                print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                            "--maxhits only valid with Smith-Waterman");
                                              }
                                              tmp___16 = parse_entire_uint(*(argv + ((argi | 1) + (argi & 1))),
                                              ...
                                              if (((unsigned int )(~ (tmp___33 | - tmp___33)) >> 31U) & 1) {
                                                ...
                                                tmp___32 = strcasecmp((char const   *)*(argv + argi),
                                                                      "--match");
                                                if (((unsigned int )(~ (tmp___32 | - tmp___32)) >> 31U) & 1) {
                                                  tmp___18 = parse_entire_int(*(argv + ((argi ^ 1) + ((argi & 1) << 1))),
                                                                              & scoring___0->match);
                                                  if (! tmp___18) {
                                                    print_usage(cmd_type, defaults,
                                                                (char const   *)*(argv + 0),
                                                  ...
                                                  if (((unsigned int )(((tmp___31 ^ (tmp___31 >> 31)) - (tmp___31 >> 31)) - 1) >> 31U) & 1) {
                                                    ...
                                                    if (((unsigned int )(((tmp___30 + (tmp___30 >> 31)) ^ (tmp___30 >> 31)) - 1) >> 31U) & 1) {
                                                      ...
                                                      tmp___29 = strcasecmp((char const   *)*(argv + argi),
                                                                            "--gapextend");
                                                      if (((unsigned int )(~ tmp___29 & (tmp___29 - 1)) >> 31U) & 1) {
                                                        ...
                                                        tmp___28 = strcasecmp((char const   *)*(argv + argi),
                                                                              "--file");
                                                        if (((unsigned int )((tmp___28 - ((tmp___28 + tmp___28) & (tmp___28 >> 31))) - 1) >> 31U) & 1) {
                                                          ...
                                                          tmp___27 = strcasecmp((char const   *)*(argv + argi),
                                                                                "--files");
                                                          if (((unsigned int )(((tmp___27 + (1 << 31)) + ((tmp___27 + (1 << 31)) >> 31)) ^ ((tmp___27 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                                            if (((unsigned int )((~ (((argc ^ 2) - ((~ argc & 2) + (~ argc & 2))) ^ argi) >> 1) + (((argc ^ 2) - ((~ argc & 2) + (~ argc & 2))) & ~ argi)) >> 31U) & 1) {
                                                              print_usage(cmd_type,
                                                                          defaults,
                                                                          (char const   *)*(argv + 0),
                                                                          "--files option takes 2 arguments");
                                                            } else {
                                                              tmp___22 = strcmp((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                                                                "-");
                                                              if (((unsigned int )(~ tmp___22 & (tmp___22 - 1)) >> 31U) & 1) {
                                                                tmp___23 = strcmp((char const   *)*(argv + ((argi - ~ 2) - 1)),
                                                                                  "-");
                                                                if (((unsigned int )((tmp___23 - ((tmp___23 << 1) & (tmp___23 >> 31))) - 1) >> 31U) & 1) {
                                                                  cmdline_add_files(cmd___0,
                                                                                    *(argv + ((argi - ~ 1) - 1)),
                                                                                    (char *)((void *)0));
                                                                } else {
                                                                  cmdline_add_files(cmd___0,
                                                                                    *(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                                                    *(argv + (((argi | 2) << 1) - (argi ^ 2))));
                                                                }
                                                              } else {
                                                                cmdline_add_files(cmd___0,
                                                                                  *(argv + ((argi ^ 1) + ((argi & 1) + (argi & 1)))),
                                                                                  *(argv + (((argi ^ ~ 2) + ((argi | 2) + (argi | 2))) + 1)));
                                                              }
                                                            }
                                                            argi = ((argi | 2) << 1) - (argi ^ 2);
                                                          } else {
                                                            ...
                                                            if (((unsigned int )(~ (tmp___26 | - tmp___26)) >> 31U) & 1) {
                                                              ...
                                                              if (((unsigned int )((((argi - ((argc + ~ 2) + 1)) ^ ((argi - ((argc + ~ 2) + 1)) >> 31)) - ((argi - ((argc + ~ 2) + 1)) >> 31)) - 1) >> 31U) & 1) {
                                                                ...
                                                                if ((int )((((((tmp___24 - 1UL) + (tmp___24 - 1UL)) & ((long )(tmp___24 - 1UL) >> 31L)) - (tmp___24 - 1UL)) >> 31UL) & 1UL)) {
                                                                  ...
                                                                  tmp___25 = parse_entire_int(*(argv + (((argi | 2) + (argi | 2)) - (argi ^ 2))),
                                                                                              & wildscore);
                                                                  if (! tmp___25) {
                                                                    print_usage(cmd_type,
                                                                                defaults,
      ...
      if (((unsigned int )((((((argc + ~ argi) + 1) - 2) << 1) & ((((argc + ~ argi) + 1) - 2) >> 31)) - (((argc + ~ argi) + 1) - 2)) >> 31U) & 1) {
  ...
  if ((int )((((((unsigned int )cmd_type - 1U) - ((((unsigned int )cmd_type - 1U) + ((unsigned int )cmd_type - 1U)) & ((int )((unsigned int )cmd_type - 1U) >> 31))) - 1U) >> 31U) & 1U)) {
    if (scoring___0->no_mismatches) {
  ...
  if (((unsigned int )((argi & ~ argc) | (~ (argi ^ argc) & (argi - argc))) >> 31U) & 1) {
    cmd___0->seq1 = (char const   *)*(argv + argi);
    cmd___0->seq2 = (char const   *)*(argv + ((argi | 1) + (argi & 1)));
  }
...
{ 
  ...
  memset((void *)hist->match_scores_mask.b, 0, ((hist->match_scores_mask.l | 31UL) + (hist->match_scores_mask.l & 31UL)) / 32UL);
  tmp = (size_t___1 )0;
  hist->next_hit = tmp;
  ...
  while ((int )((((~ pos & arr_size) | ((~ pos | arr_size) & (pos - arr_size))) >> 31UL) & 1UL)) {
    if (((unsigned int )((*(aligner->match_scores + pos) >> 1) - *(aligner->match_scores + pos)) >> 31U) & 1) {
      ...
      hist->num_of_hits = (hist->num_of_hits | 1UL) + (hist->num_of_hits & 1UL);
      *(hist->sorted_match_indices + tmp___0) = pos;
    }
    pos = (pos ^ 1UL) + ((pos & 1UL) << 1UL);
  }
...
{ 
  ...
  *is_match = (_Bool )(((unsigned int )(~ (((int )a - (int )b) | ((int )b - (int )a))) >> 31U) & 1);
  if (scoring___0->no_mismatches) {
    if (! *is_match) {
  ...
  if ((~ (scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b))) | 1U) - ~ (scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b)))) {
...
{ 
  ...
  while (1) {
    if (*lenptr) {
      if (! (((unsigned int )((((int )*(buf + ((*lenptr + ~ 1UL) + 1UL)) - 10) + (1 << 31)) - (((((int )*(buf + ((*lenptr + ~ 1UL) + 1UL)) - 10) + (1 << 31)) + (((int )*(buf + ((*lenptr + ~ 1UL) + 1UL)) - 10) + (1 << 31))) & ((((int )*(buf + ((*lenptr + ~ 1UL) + 1UL)) - 10) + (1 << 31)) >> 31))) >> 31U) & 1)) {
        if (! (((unsigned int )((((int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL))) - 13) + (1 << 31)) - (((((int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL))) - 13) + (1 << 31)) + (((int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL))) - 13) + (1 << 31))) & ((((int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL))) - 13) + (1 << 31)) >> 31))) >> 31U) & 1)) {
          break;
        }
      }
    } else {
    ...
    *lenptr = (*lenptr ^ 1UL) - ((~ *lenptr & 1UL) << 1UL);
  }
  *(buf + *lenptr) = (char )'\000';
  return;
}
...
{ 
  ...
  if (! no_gaps_in_b) {
    _L___1: 
    if (((unsigned int )((scoring___0->min_penalty | ~ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1)) & ((scoring___0->min_penalty ^ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1)) | ~ ((((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1) - scoring___0->min_penalty))) >> 31U) & 1) {
      if (((unsigned int )((~ (scoring___0->min_penalty ^ gap_extend) >> 1) + (scoring___0->min_penalty & ~ gap_extend)) >> 31U) & 1) {
      ...
      _L: 
      if (((unsigned int )((~ (((gap_open ^ gap_extend) + ((gap_open & gap_extend) << 1)) ^ gap_extend) >> 1) + (((gap_open ^ gap_extend) + ((gap_open & gap_extend) << 1)) & ~ gap_extend)) >> 31U) & 1) {
        tmp = (gap_open | gap_extend) + (gap_open & gap_extend);
      } else {
        tmp = gap_extend;
      }
      scoring___0->min_penalty = tmp;
    }
    if (((unsigned int )((~ (((gap_open | gap_extend) + (gap_open & gap_extend)) ^ scoring___0->max_penalty) >> 1) + (((gap_open | gap_extend) + (gap_open & gap_extend)) & ~ scoring___0->max_penalty)) >> 31U) & 1) {
      ...
      _L___0: 
      if (((unsigned int )((gap_extend | ~ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1)) & ((gap_extend ^ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1)) | ~ ((((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1) - gap_extend))) >> 31U) & 1) {
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = gzread2(file, (void *)(in->b + 1), (in->size ^ 1UL) - ((~ in->size & 1UL) + (~ in->size & 1UL)));
...
{ 
  ...
  while (1) {
    c = gzgetc_buf(sf->gz_file, & sf->in);
    if (! (((unsigned int )((((c - 43) + (c - 43)) & ((c - 43) >> 31)) - (c - 43)) >> 31U) & 1)) {
      break;
    }
...
{ 
  ...
  if (((unsigned int )(tmp___0 ^ (((tmp___0 + tmp___0) & (tmp___0 >> 31)) - tmp___0)) >> 31U) & 1) {
...
{ 
      ...
      if (((unsigned int )((((int )*(sbuf->b + 0) - 35) >> 31) - (((int )*(sbuf->b + 0) - 35) ^ (((int )*(sbuf->b + 0) - 35) >> 31))) >> 31U) & 1) {
        ...
        if (! tmp___7) {
          ...
          if (tmp___4) {
            ...
            while (1) {
              if (((unsigned int )((((int )*(sbuf->b + char2_pos) >> 31) - (int )*(sbuf->b + char2_pos)) ^ ((int )*(sbuf->b + char2_pos) >> 31)) >> 31U) & 1) {
            ...
            if (((unsigned int )(((int )*(sbuf->b + 1) - (int )*(sbuf->b + 3)) | ((int )*(sbuf->b + 3) - (int )*(sbuf->b + 1))) >> 31U) & 1) {
          ...
          num_pairs_added = (num_pairs_added | 1) + (num_pairs_added & 1);
        }
      }
    }
  ...
  strbuf_free(sbuf);
  if (((unsigned int )(((num_pairs_added + (1 << 31)) + ((num_pairs_added + (1 << 31)) >> 31)) ^ ((num_pairs_added + (1 << 31)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )((line_num + (1 << 31)) - (((line_num + (1 << 31)) << 1) & ((line_num + (1 << 31)) >> 31))) >> 31U) & 1) {
    if (sbuf->end <= 0UL) {
      _loading_error("Empty file", file_path, -1, (char)0);
    }
  }
  sep = *(sbuf->b + 0);
  if (((unsigned int )((48 | ~ ((int )sep)) & ((48 ^ (int )sep) | ~ ((int )sep - 48))) >> 31U) & 1) {
  ...
  if (tmp___18) {
    ...
    while (1) {
      ...
      num_of_chars = (num_of_chars | 1) + (num_of_chars & 1);
      if (case_sensitive) {
    ...
    while (1) {
      ...
      if (((unsigned int )((((int )*(sbuf->b + 0) - 35) + (1 << 31)) - (((((int )*(sbuf->b + 0) - 35) + (1 << 31)) + (((int )*(sbuf->b + 0) - 35) + (1 << 31))) & ((((int )*(sbuf->b + 0) - 35) + (1 << 31)) >> 31))) >> 31U) & 1) {
        continue;
      }
      if (case_sensitive) {
      ...
      if (((unsigned int )(((unsigned int )((int )*score_txt) >> 1U) - (int )*score_txt) >> 31U) & 1) {
    ...
    while ((int )((((~ i___0 & sbuf->end) | ((~ i___0 | sbuf->end) & (i___0 - sbuf->end))) >> 31UL) & 1UL)) {
      if (((unsigned int )(((((int )*(sbuf->b + i___0) - (int )sep) >> 31) - ((int )*(sbuf->b + i___0) - (int )sep)) ^ (((int )*(sbuf->b + i___0) - (int )sep) >> 31)) >> 31U) & 1) {
        _loading_error("Separator missing from line", file_path, line_num, (char)1);
      }
      if (case_sensitive) {
        tmp___11 = (int )*(sbuf->b + (((i___0 ^ ~ 1UL) + ((i___0 | 1UL) << 1UL)) + 1UL));
      } else {
      ...
      num_of_chars = (num_of_chars ^ 1) + ((num_of_chars & 1) << 1);
      *(characters + tmp___12) = c;
      i___0 = (i___0 | 2UL) + (i___0 & 2UL);
    }
    while (1) {
      read_length = strbuf_reset_gzreadline(sbuf, file);
      if (! (read_length > 0UL)) {
      ...
      if (((unsigned int )((((int )from_char___0 - 35) - ((((int )from_char___0 - 35) << 1) & (((int )from_char___0 - 35) >> 31))) - 1) >> 31U) & 1) {
        continue;
      } else {
      ...
      while (((unsigned int )(((unsigned int )((int )*str_pos) >> 1U) - (int )*str_pos) >> 31U) & 1) {
        ...
        to_char_index = (to_char_index ^ 1) + ((to_char_index & 1) << 1);
        ...
        if ((int )((((((unsigned long )str_pos - (unsigned long )after_num_str) + (1UL << 31)) - (((((unsigned long )str_pos - (unsigned long )after_num_str) + (1UL << 31)) << 1UL) & ((long )(((unsigned long )str_pos - (unsigned long )after_num_str) + (1UL << 31)) >> 31L))) >> 31UL) & 1UL)) {
          _loading_error("Missing number value on line", file_path, line_num, (char)1);
        }
        if (((unsigned int )((~ (num_of_chars ^ to_char_index) >> 1) + (num_of_chars & ~ to_char_index)) >> 31U) & 1) {
          _loading_error("Too many columns on row", file_path, line_num, (char)1);
        }
...
{ 
  ...
  if (((~ (scoring___0->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a))) | 1U) + (scoring___0->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a)))) + 1U) {
    tmp_score = scoring___0->wildscores[(size_t___1 )a];
  }
  if (((~ (scoring___0->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1)) | 1U) + (scoring___0->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1))) + 1U) {
    if ((int )(((unsigned int const   )((scoring___0->wildscores[(size_t___1 )b] | ~ tmp_score) & ((scoring___0->wildscores[(size_t___1 )b] ^ tmp_score) | ~ (tmp_score - scoring___0->wildscores[(size_t___1 )b]))) >> (unsigned int const   )31) & 1)) {
      tmp_score = scoring___0->wildscores[(size_t___1 )b];
    } else {
      tmp_score = tmp_score;
    }
  }
  if (((unsigned int )((((tmp_score - 2147483647) >> 31) - (tmp_score - 2147483647)) ^ ((tmp_score - 2147483647) >> 31)) >> 31U) & 1) {
    *score = tmp_score;
    return ((char)1);
  }
  *score = 0;
...
{ 
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = ((sf->gz_file)->have ^ 1U) - ((~ (sf->gz_file)->have & 1U) + (~ (sf->gz_file)->have & 1U));
      (sf->gz_file)->pos = ((sf->gz_file)->pos - ~ 1LL) - 1LL;
      tmp = (sf->gz_file)->next;
      ((sf->gz_file)->next) ++;
      c = (int )*tmp;
    } else {
  ...
  if (((unsigned int )(((c - 64) + (1 << 31)) - ((((c - 64) + (1 << 31)) + ((c - 64) + (1 << 31))) & (((c - 64) + (1 << 31)) >> 31))) >> 31U) & 1) {
    sf->format = (seq_format )4;
...
{ 
  ...
  {
  cbuf_capacity(buf, sizeptr, (*lenptr ^ 1UL) + ((*lenptr & 1UL) << 1UL));
  tmp = *lenptr;
  *lenptr = (*lenptr | 1UL) + (*lenptr & 1UL);
  *(*buf + tmp) = c;
  *(*buf + *lenptr) = (char )'\000';
  return;
}
...
{ 
  ...
  {
  if ((int )((((~ *size | ((*len ^ 1UL) + ((*len & 1UL) << 1UL))) & ((*size ^ ((*len ^ 1UL) + ((*len & 1UL) << 1UL))) | ~ (((*len ^ 1UL) + ((*len & 1UL) << 1UL)) - *size))) >> 31UL) & 1UL)) {
  ...
  while (1) {
    ...
    *len = (*len ^ tmp___0) + ((*len & tmp___0) << 1UL);
...
{ 
  ...
  if (((unsigned int )((((c - 62) + (c - 62)) & ((c - 62) >> 31)) - (c - 62)) >> 31U) & 1) {
    return (-1);
  } else {
...
{ 
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    buffered = (offset ^ in->begin) - ((~ offset & in->begin) << 1UL);
    ...
    *len = (*len ^ buffered) + ((*len & buffered) << 1UL);
    ...
    if (((unsigned int )((((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) + (1 << 31)) - (((((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) + (1 << 31)) + (((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) + (1 << 31))) & ((((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size ^ 1UL) - ((~ in->size & 1UL) + (~ in->size & 1UL)));
      in->end = ((1UL | tmp___1) + (1UL | tmp___1)) - (1UL ^ tmp___1);
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  if ((unsigned long )errfmt != (unsigned long )((void *)0)) {
    ...
    tmp = strlen(errfmt);
    if ((int )(((unsigned int const   )((((int const   )*(errfmt + (((tmp & ~ 1UL) + (tmp & ~ 1UL)) - (tmp ^ 1UL))) - 10) >> (int const   )31) - (((int const   )*(errfmt + (((tmp & ~ 1UL) + (tmp & ~ 1UL)) - (tmp ^ 1UL))) - 10) ^ (((int const   )*(errfmt + (((tmp & ~ 1UL) + (tmp & ~ 1UL)) - (tmp ^ 1UL))) - 10) >> (int const   )31))) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  while ((int )((((~ i & num_of_file_pairs) | ((~ i | num_of_file_pairs) & (i - num_of_file_pairs))) >> 31UL) & 1UL)) {
    ...
    if ((unsigned long )file1 != (unsigned long )((void *)0)) {
      if ((int )(((unsigned int const   )(~ ((int const   )*file1) & ((int const   )*file1 - 1)) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  tmp___2 = strcmp(p, "-");
  if (((unsigned int )(~ tmp___2 & (tmp___2 - 1)) >> 31U) & 1) {
  ...
  fmt = tmp___3;
  if ((int )((~ (((unsigned int )fmt - 8U) | (8U - (unsigned int )fmt)) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
  if ((int )((~ (((unsigned int )fmt - 16U) | (16U - (unsigned int )fmt)) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
  if ((int )((((((unsigned int )fmt - 16U) + (1U << 31)) - (((((unsigned int )fmt - 16U) + (1U << 31)) << 1U) & ((int )(((unsigned int )fmt - 16U) + (1U << 31)) >> 31))) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else {
    tmp___4 = 0;
  }
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size ^ 1UL) - ((~ in->size & 1UL) << 1UL),
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      ...
      skipped_bytes = (skipped_bytes - ~ (((offset & ~ in->begin) + (offset & ~ in->begin)) - (offset ^ in->begin))) - 1UL;
    }
    in->begin = offset;
    if (((unsigned int )(~ (((int )*(in->b + ((offset & ~ 1UL) - (~ offset & 1UL))) - 10) | (10 - (int )*(in->b + ((offset & ~ 1UL) - (~ offset & 1UL)))))) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size ^ 1UL) - ((~ in->size & 1UL) + (~ in->size & 1UL)),
                      (FILE */* __restrict  */)file);
      in->end = ((1UL | tmp___1) + (1UL | tmp___1)) - (1UL ^ tmp___1);
      in->begin = (size_t___1 )1;
      break;
...
{ 
  ...
  if ((int )((((~ nel & 7UL) | ((~ nel | 7UL) & (nel - 7UL))) >> 31UL) & 1UL)) {
    ...
    last = b + ((w & ((nel + ~ 1UL) + 1UL)) * (w | ((nel + ~ 1UL) + 1UL)) + (w & ~ ((nel + ~ 1UL) + 1UL)) * (~ w & ((nel + ~ 1UL) + 1UL)));
    l[0] = b;
    l[1] = b + ((w & nel / 2UL) * (w | nel / 2UL) + (w & ~ (nel / 2UL)) * (~ w & nel / 2UL));
    l[2] = last;
    tmp___1 = (*compar)((void const   *)l[0], (void const   *)l[1], arg);
    if (((unsigned int )(- tmp___1 & ~ tmp___1) >> 31U) & 1) {
      tmp___0 = l[0];
      l[0] = l[1];
      l[1] = tmp___0;
    }
    ...
    if (((unsigned int )(tmp___3 ^ ((tmp___3 >> 31) - (tmp___3 ^ (tmp___3 >> 31)))) >> 31U) & 1) {
      ...
      if (((unsigned int )(tmp___2 ^ ((tmp___2 >> 31) - (tmp___2 ^ (tmp___2 >> 31)))) >> 31U) & 1) {
        tmp___0 = l[0];
        l[0] = l[1];
        l[1] = tmp___0;
      }
...
{ 
  ...
  tmp___1 = strtol((char const   */* __restrict  */)str, (char **/* __restrict  */)(& strtol_last_char_ptr),
                   10);
  tmp___0 = tmp___1;
  if ((int )(((unsigned long )(((((tmp___0 - 2147483647L) & - (tmp___0 >= 2147483647L)) + ((tmp___0 - 2147483647L) & - (tmp___0 >= 2147483647L))) & (((tmp___0 - 2147483647L) & - (tmp___0 >= 2147483647L)) >> 31L)) - ((tmp___0 - 2147483647L) & - (tmp___0 >= 2147483647L))) >> 31UL) & 1L)) {
    return ((char)0);
  } else
...
{ 
  ...
  while ((int )((((~ i & len) | (~ (i ^ len) & (i - len))) >> 31UL) & 1UL)) {
    ...
    while ((int )((((~ j & len) | (~ (j ^ len) & (j - len))) >> 31UL) & 1UL)) {
      ...
      score = (int )*(scores + ((((j & len) * (j | len) + (j & ~ len) * (~ j & len)) ^ i) + ((((j & len) * (j | len) + (j & ~ len) * (~ j & len)) & i) + (((j & len) * (j | len) + (j & ~ len) * (~ j & len)) & i))));
      scoring_add_mutation(scoring___0, a, b, score);
      j = (j - ~ 1UL) - 1UL;
    }
    i = (i ^ 1UL) + ((i & 1UL) << 1UL);
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )((c - 13) | (13 - c)) >> 31U) & 1) {
      if (((unsigned int )((((c - 10) + (c - 10)) & ((c - 10) >> 31)) - (c - 10)) >> 31U) & 1) {
        cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
        tmp___1 = freadline_buf(sf->f_file, & sf->in, & r->seq.b, & r->seq.end, & r->seq.size);
        if (tmp___1 == 0UL) {
          return (-1);
...
{ 
  ...
  scoring___0->wildcards[(int )c >> 5] = ((scoring___0->wildcards[(int )c >> 5] + (unsigned int )(1 << (((~ ((int )c) | 31) + (int )c) + 1))) + 1U) + ((- scoring___0->wildcards[(int )c >> 5] - 1U) | (- ((unsigned int )(1 << (((~ ((int )c) | 31) + (int )c) + 1))) - 1U));
...
{ 
  ...
  while (1) {
    ...
    if (! (((unsigned int )((((c - 62) << 1) & ((c - 62) >> 31)) - (c - 62)) >> 31U) & 1)) {
      break;
    }
    if (((unsigned int )((((c - -1) + ((c - -1) >> 31)) ^ ((c - -1) >> 31)) - 1) >> 31U) & 1) {
      return (1);
...
{ 
  ...
  while ((int )((((~ nread & len) | (~ (nread ^ len) & (nread - len))) >> 31UL) & 1UL)) {
    ...
    nread = ((nread ^ ~ ((size_t___1 )s)) + ((nread | (size_t___1 )s) + (nread | (size_t___1 )s))) + 1UL;
  }
  return (nread);
}
}
...
{ 
  ...
  while (1) {
    if (file->have) {
      file->have = ((file->have & ~ 1U) << 1U) - (file->have ^ 1U);
      file->pos = (file->pos - ~ 1LL) - 1LL;
      tmp = file->next;
      (file->next) ++;
      c = (int )*tmp;
    } else {
    ...
    if (((unsigned int )(((c - 10) + (1 << 31)) - ((((c - 10) + (1 << 31)) + ((c - 10) + (1 << 31))) & (((c - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
      break;
    }
  }
  return (skipped_bytes);
...
{ 
  ...
  {
  if ((int )((((((cmd___0->file_list_length - cmd___0->file_list_capacity) + ((long )(cmd___0->file_list_length - cmd___0->file_list_capacity) >> 31L)) ^ ((long )(cmd___0->file_list_length - cmd___0->file_list_capacity) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
  ...
  *(cmd___0->file_paths2 + cmd___0->file_list_length) = p2;
  cmd___0->file_list_length = ((cmd___0->file_list_length ^ ~ 1UL) + ((cmd___0->file_list_length | 1UL) + (cmd___0->file_list_length | 1UL))) + 1UL;
  return;
}
}
...
{ 
  ...
  scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] = ((scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] + (unsigned int )(1 << ((~ ((int )b) | 31) - ~ ((int )b)))) + 1U) + ((- scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] - 1U) | (- ((unsigned int )(1 << ((~ ((int )b) | 31) - ~ ((int )b)))) - 1U));
...
{ 
  ...
  longest_alignment = ((((((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) ^ ~ nw___0->score_height) + ((((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) | nw___0->score_height) + (((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) | nw___0->score_height))) + 1UL) ^ 1UL) - ((~ (((((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) ^ ~ nw___0->score_height) + ((((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) | nw___0->score_height) + (((nw___0->score_width & ~ 1UL) - (~ nw___0->score_width & 1UL)) | nw___0->score_height))) + 1UL) & 1UL) << 1UL);
  alignment_ensure_capacity(result___0, longest_alignment);
  next_char = (longest_alignment ^ 1UL) - ((~ longest_alignment & 1UL) << 1UL);
  arr_size = (nw___0->score_width & nw___0->score_height) * (nw___0->score_width | nw___0->score_height) + (nw___0->score_width & ~ nw___0->score_height) * (~ nw___0->score_width & nw___0->score_height);
  curr_matrix = (enum Matrix )0;
  curr_score = *(nw___0->match_scores + (((arr_size & ~ 1UL) << 1UL) - (arr_size ^ 1UL)));
  if (((unsigned int )((curr_score | ~ *(nw___0->gap_b_scores + (((arr_size & ~ 1UL) + (arr_size & ~ 1UL)) - (arr_size ^ 1UL)))) & ((curr_score ^ *(nw___0->gap_b_scores + (((arr_size & ~ 1UL) + (arr_size & ~ 1UL)) - (arr_size ^ 1UL)))) | ~ (*(nw___0->gap_b_scores + (((arr_size & ~ 1UL) + (arr_size & ~ 1UL)) - (arr_size ^ 1UL))) - curr_score))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )2;
    curr_score = *(nw___0->gap_b_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) << 1UL)));
  }
  if (((unsigned int )((curr_score | ~ *(nw___0->gap_a_scores + ((arr_size & ~ 1UL) - (~ arr_size & 1UL)))) & ((curr_score ^ *(nw___0->gap_a_scores + ((arr_size & ~ 1UL) - (~ arr_size & 1UL)))) | ~ (*(nw___0->gap_a_scores + ((arr_size & ~ 1UL) - (~ arr_size & 1UL))) - curr_score))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )1;
    curr_score = *(nw___0->gap_a_scores + (((arr_size & ~ 1UL) << 1UL) - (arr_size ^ 1UL)));
  }
  result___0->score = curr_score;
  alignment_a = result___0->result_a;
  alignment_b = result___0->result_b;
  score_x = (nw___0->score_width ^ 1UL) - ((~ nw___0->score_width & 1UL) << 1UL);
  score_y = (nw___0->score_height & ~ 1UL) - (~ nw___0->score_height & 1UL);
  ...
  while (1) {
    ...
    switch ((unsigned int )curr_matrix) {
    case 0U: 
    *(alignment_a + next_char) = (char )*(nw___0->seq_a + (((score_x & ~ 1UL) + (score_x & ~ 1UL)) - (score_x ^ 1UL)));
    *(alignment_b + next_char) = (char )*(nw___0->seq_b + ((score_y + ~ 1UL) + 1UL));
    break;
    case 1U: 
    *(alignment_a + next_char) = (char )'-';
    *(alignment_b + next_char) = (char )*(nw___0->seq_b + (((score_y & ~ 1UL) + (score_y & ~ 1UL)) - (score_y ^ 1UL)));
    break;
    case 2U: 
    *(alignment_a + next_char) = (char )*(nw___0->seq_a + ((score_x + ~ 1UL) + 1UL));
  ...
  while (score_y > 0UL) {
    *(alignment_a + next_char) = (char )'-';
    *(alignment_b + next_char) = (char )*(nw___0->seq_b + ((score_y & ~ 1UL) - (~ score_y & 1UL)));
    next_char = ((next_char & ~ 1UL) + (next_char & ~ 1UL)) - (next_char ^ 1UL);
  ...
  first_char = (int )((next_char ^ 1UL) + ((next_char & 1UL) << 1UL));
  alignment_len = (int )((longest_alignment & ~ ((size_t___1 )first_char)) - (~ longest_alignment & (size_t___1 )first_char));
...
{ 
  ...
  while ((int )((((~ in->begin & in->end) | ((~ in->begin | in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    memcpy((void */* __restrict  */)(*buf + *len), (void const   */* __restrict  */)(in->b + in->begin),
           buffered);
    *len = (*len | buffered) + (*len & buffered);
    in->begin = offset;
    total_read = (total_read | buffered) + (total_read & buffered);
    if (((unsigned int )(~ (((int )*(*buf + ((*len & ~ 1UL) - (~ *len & 1UL))) - 10) | (10 - (int )*(*buf + ((*len & ~ 1UL) - (~ *len & 1UL)))))) >> 31U) & 1) {
      break;
    }
    while (1) {
...
{ 
  ...
  if (((unsigned int )(((c - 64) - (((c - 64) + (c - 64)) & ((c - 64) >> 31))) - 1) >> 31U) & 1) {
    sf->format = (seq_format )4;
...
{ 
  ...
  if ((sf->gz_file)->have) {
    (sf->gz_file)->have = ((sf->gz_file)->have ^ 1U) - ((~ (sf->gz_file)->have & 1U) + (~ (sf->gz_file)->have & 1U));
    (sf->gz_file)->pos = (((sf->gz_file)->pos | 1LL) << 1LL) - ((sf->gz_file)->pos ^ 1LL);
    tmp = (sf->gz_file)->next;
    ((sf->gz_file)->next) ++;
    tmp___1 = (int )*tmp;
  } else {
...
{ 
  ...
  if ((int )(((unsigned long )(((diff + (1L << 31)) ^ ((diff + (1L << 31)) >> 31L)) - ((diff + (1L << 31)) >> 31L)) >> 31UL) & 1L)) {
    return ((int )((*a % (unsigned long const   )score_width ^ *b % (unsigned long const   )score_width) - ((~ (*a % (unsigned long const   )score_width) & *b % (unsigned long const   )score_width) + (~ (*a % (unsigned long const   )score_width) & *b % (unsigned long const   )score_width))));
  } else {
    if ((int )(((unsigned long )((diff >> 1L) - diff) >> 31UL) & 1L)) {
      tmp___0 = 1;
    } else {
      tmp___0 = -1;
    }
...
{ 
  ...
  needleman_wunsch_align(seq_a, seq_b, (scoring_t const   *)(& scoring), nw, result);
  i = 0;
  while (((unsigned int )(((unsigned int )((int )*(result->result_a + i)) >> 1U) - (int )*(result->result_a + i)) >> 31U) & 1) {
    if (((unsigned int )(((((int )*(result->result_a + i) - 45) + (((int )*(result->result_a + i) - 45) >> 31)) ^ (((int )*(result->result_a + i) - 45) >> 31)) - 1) >> 31U) & 1) {
      *(result->result_a + i) = (char )'_';
    }
    if (((unsigned int )(~ (((int )*(result->result_b + i) - 45) | (45 - (int )*(result->result_b + i)))) >> 31U) & 1) {
  ...
  i = 0;
  while (((unsigned int )(((int )*(result->result_a + i) >> 31) - ((int )*(result->result_a + i) ^ ((int )*(result->result_a + i) >> 31))) >> 31U) & 1) {
    if (((unsigned int )(((((int )*(result->result_a + i) - 95) + (1 << 31)) ^ ((((int )*(result->result_a + i) - 95) + (1 << 31)) >> 31)) - ((((int )*(result->result_a + i) - 95) + (1 << 31)) >> 31)) >> 31U) & 1) {
      putc(' ', stdout);
      num_of_indels = ((num_of_indels | 1) + (num_of_indels | 1)) - (num_of_indels ^ 1);
    } else
    if (((unsigned int )(~ (((int )*(result->result_b + i) - 95) | (95 - (int )*(result->result_b + i)))) >> 31U) & 1) {
      putc(' ', stdout);
      num_of_indels = ((num_of_indels | 1) << 1) - (num_of_indels ^ 1);
    } else
    if (scoring.case_sensitive) {
      if (((unsigned int )(((int )*(result->result_a + i) - (int )*(result->result_b + i)) | ((int )*(result->result_b + i) - (int )*(result->result_a + i))) >> 31U) & 1) {
        putc('*', stdout);
        num_of_mismatches = ((num_of_mismatches ^ ~ 1) + ((num_of_mismatches | 1) + (num_of_mismatches | 1))) + 1;
      } else {
        goto _L;
      }
    } else {
      ...
      if (((unsigned int )((((tmp - tmp___0) << 1) & ((tmp - tmp___0) >> 31)) - (tmp - tmp___0)) >> 31U) & 1) {
        putc('*', stdout);
        num_of_mismatches = (num_of_mismatches | 1) + (num_of_mismatches & 1);
      } else {
        putc('|', stdout);
      }
    }
...
{ 
  ...
  while ((int )((((~ in->begin & in->end) | ((~ in->begin | in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      if ((int )((((~ offset & in->end) | ((~ offset | in->end) & (offset - in->end))) >> 31UL) & 1UL)) {
        tmp___0 = offset;
        offset = ((offset | 1UL) << 1UL) - (offset ^ 1UL);
        if (! (((unsigned int )(((((int )*(in->b + tmp___0) - 10) >> 31) - ((int )*(in->b + tmp___0) - 10)) ^ (((int )*(in->b + tmp___0) - 10) >> 31)) >> 31U) & 1)) {
          break;
        }
      } else {
      ...
      skipped_bytes = ((skipped_bytes | (((offset & ~ in->begin) + (offset & ~ in->begin)) - (offset ^ in->begin))) << 1UL) - (skipped_bytes ^ (((offset & ~ in->begin) + (offset & ~ in->begin)) - (offset ^ in->begin)));
    }
    in->begin = offset;
    if (((unsigned int )(~ (((int )*(in->b + ((offset + ~ 1UL) + 1UL)) - 10) | (10 - (int )*(in->b + ((offset + ~ 1UL) + 1UL))))) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size ^ 1UL) - ((~ in->size & 1UL) + (~ in->size & 1UL)));
...
{ 
  ...
  if ((unsigned long )sf->gz_file != (unsigned long )((void *)0)) {
    ...
    if (((unsigned int )(((e + e) & (e >> 31)) - e) >> 31U) & 1) {
...
{ 
  ...
  b->begin = tmp___2;
  tmp___3 = (char)0;
  *(b->b + ((b->size ^ 1UL) - ((~ b->size & 1UL) << 1UL))) = tmp___3;
  *(b->b + b->end) = tmp___3;
  return (b);
}
}
...
{ 
  ...
  while (1) {
    ...
    *len = ((*len ^ ~ tmp___0) + ((*len | tmp___0) << 1UL)) + 1UL;
    if (((unsigned int )(((((int )*(*buf + ((*len ^ 1UL) - ((~ *len & 1UL) << 1UL))) - 10) + (((int )*(*buf + ((*len ^ 1UL) - ((~ *len & 1UL) << 1UL))) - 10) >> 31)) ^ (((int )*(*buf + ((*len ^ 1UL) - ((~ *len & 1UL) << 1UL))) - 10) >> 31)) - 1) >> 31U) & 1) {
...
{ 
  ...
  while ((int )((((~ hist->next_hit & hist->num_of_hits) | ((~ hist->next_hit | hist->num_of_hits) & (hist->next_hit - hist->num_of_hits))) >> 31UL) & 1UL)) {
    tmp = hist->next_hit;
    hist->next_hit = (hist->next_hit | 1UL) + (hist->next_hit & 1UL);
