...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:47:55-2023/04/23 */
  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      "Modified Function Implementations": [
        "nw_set_default_scoring", "needleman_wunsch_new",
        "needleman_wunsch_free", "needleman_wunsch_align", "main",
        "gzskipline", "gzreadline_buf", "gzreadline", "gzread2",
        "cmdline_new", "cmdline_free", "cbuf_capacity", "bitset_set_length",
        "bitset_dealloc", "bitset_alloc", "align_scoring_load_pairwise",
        "align_scoring_load_matrix", "align_pair_from_file", "_seq_setup",
        "_seq_read_unknown_gz_buf", "_seq_read_unknown_gz",
        "_seq_read_unknown_f_buf", "_seq_read_plain_gz_buf",
        "_seq_read_plain_gz", "_seq_read_plain_f_buf", "_seq_read_fastq_gz",
        "_seq_read_fasta_gz", "_loading_error", "_init_history",
        "_follow_hit", "_ensure_history_capacity"
      ],
...
void *_3__functionPtrArray[]  = 
  {      & realloc,      & realloc - 791,      & fprintf,      & exit, 
        & exit + 459,      & fprintf,      & exit,      & exit - 835, 
        & alignment_reverse_move,      & alignment_reverse_move + 900,      & alignment_ensure_capacity,      & alignment_ensure_capacity + 598, 
        & fprintf,      & fprintf,      & exit,      & alignment_reverse_move, 
        & alignment_reverse_move - 738,      & malloc,      & malloc + 27,      & fprintf, 
        & fprintf,      & fprintf,      & fprintf,      & exit, 
        & exit - 514,      & gzgetc,      & gzgetc + 694,      & gzgetc, 
        & gzungetc,      & gzungetc + 281,      & gzgetc,      & gzgetc - 963, 
        & gzgetc,      & gzgetc + 503,      & gzgetc,      & gzgetc + 478, 
        & gzgetc,      & gzungetc,      & gzungetc + 106,      & isspace, 
        & isspace - 821,      & gzgetc,      & isspace,      & isspace - 229, 
        & isspace,      & isspace + 499,      & isspace,      & isspace - 802, 
        & gzgetc,      & isspace,      & gzungetc,      & isspace, 
        & isspace - 304,      & free,      & align,      & align + 445, 
        & strbuf_new,      & strbuf_reset_gzreadline,      & strbuf_reset_gzreadline + 300,      & strbuf_chomp, 
        & strbuf_chomp - 399,      & string_is_all_whitespace,      & _loading_error,      & _loading_error - 418, 
        & _loading_error,      & _loading_error,      & _loading_error,      & _loading_error - 402, 
        & malloc,      & isspace,      & string_next_nonwhitespace,      & tolower, 
        & tolower + 331,      & strbuf_reset_gzreadline,      & strbuf_chomp,      & string_next_nonwhitespace, 
        & tolower,      & isspace,      & isspace - 483,      & _loading_error, 
        & _loading_error - 571,      & string_next_nonwhitespace,      & string_next_nonwhitespace + 611,      & strtol, 
        & strtol + 348,      & _loading_error,      & _loading_error - 606,      & scoring_add_mutation, 
        & scoring_add_mutation - 110,      & string_is_all_whitespace,      & string_is_all_whitespace + 472,      & _loading_error, 
        & _loading_error + 183,      & _loading_error,      & _loading_error + 102,      & tolower, 
        & strbuf_reset_gzreadline,      & strbuf_chomp,      & strbuf_chomp - 398,      & tolower, 
        & string_is_all_whitespace,      & _loading_error,      & strtol,      & strtol + 523, 
        & _loading_error,      & _loading_error,      & scoring_add_mutation,      & scoring_add_mutation - 521, 
        & free,      & free - 579,      & strbuf_new,      & strbuf_reset_gzreadline, 
        & strbuf_reset_gzreadline + 527,      & strbuf_chomp,      & string_is_all_whitespace,      & _loading_error, 
        & isspace,      & isspace,      & _loading_error,      & _loading_error + 800, 
        & isspace,      & isspace - 974,      & _loading_error,      & _loading_error - 423, 
        & parse_entire_int,      & parse_entire_int - 470,      & _loading_error,      & _loading_error + 366, 
        & _loading_error,      & _loading_error - 880,      & parse_entire_int,      & parse_entire_int + 398, 
        & _loading_error,      & _loading_error - 277,      & tolower,      & tolower + 563, 
        & tolower,      & scoring_add_mutation,      & scoring_add_mutation + 324,      & _loading_error, 
        & _loading_error - 404,      & calloc,      & calloc - 58,      & free, 
        & free - 374,      & memset,      & realloc,      & realloc + 244, 
        & memset,      & realloc,      & realloc - 882,      & fprintf, 
        & exit,      & exit - 639,      & free,      & free + 59, 
        & free,      & free + 728,      & free,      & free + 835, 
        & calloc,      & calloc + 138,      & malloc,      & malloc + 31, 
        & malloc,      & malloc + 756,      & print_usage,      & strcasecmp, 
        & print_usage,      & print_usage - 757,      & strcasecmp,      & strcasecmp - 123, 
        & print_usage,      & print_usage - 85,      & strcasecmp,      & strcasecmp - 467, 
        & print_usage,      & print_usage + 55,      & strcasecmp,      & strcasecmp - 281, 
        & strcasecmp,      & strcasecmp - 18,      & print_usage,      & print_usage - 253, 
        & strcasecmp,      & strcasecmp + 559,      & scoring_system_PAM30,      & strcasecmp, 
        & scoring_system_PAM70,      & strcasecmp,      & scoring_system_BLOSUM80,      & scoring_system_BLOSUM80 - 515, 
        & strcasecmp,      & scoring_system_BLOSUM62,      & strcasecmp,      & scoring_system_DNA_hybridization, 
        & scoring_system_DNA_hybridization - 118,      & print_usage,      & strcasecmp,      & strcasecmp + 628, 
        & print_usage,      & strcasecmp,      & print_usage,      & strcasecmp, 
        & strcasecmp,      & strcasecmp + 681,      & strcasecmp,      & strcasecmp - 190, 
        & strcasecmp,      & strcasecmp,      & strcasecmp + 896,      & strcasecmp, 
        & strcasecmp - 91,      & print_usage,      & print_usage + 53,      & strcasecmp, 
        & strcasecmp,      & print_usage,      & print_usage - 836,      & strcasecmp, 
        & strcasecmp,      & strcasecmp,      & strcasecmp + 479,      & strcasecmp, 
        & print_usage,      & print_usage + 232,      & strcasecmp,      & cmdline_add_files, 
        & print_usage,      & print_usage - 140,      & strcasecmp,      & strcasecmp, 
        & gzopen,      & print_usage,      & align_scoring_load_matrix,      & gzclose, 
        & strcasecmp,      & gzopen,      & gzopen + 557,      & print_usage, 
        & print_usage + 9,      & align_scoring_load_pairwise,      & gzclose,      & strcasecmp, 
        & print_usage,      & parse_entire_int,      & print_usage,      & strcasecmp, 
        & print_usage,      & print_usage - 486,      & parse_entire_uint,      & print_usage, 
        & print_usage + 652,      & strcasecmp,      & print_usage,      & print_usage - 225, 
        & parse_entire_uint,      & print_usage,      & print_usage + 10,      & strcasecmp, 
        & strcasecmp - 693,      & parse_entire_int,      & print_usage,      & strcasecmp, 
        & parse_entire_int,      & print_usage,      & strcasecmp,      & parse_entire_int, 
        & print_usage,      & strcasecmp,      & strcasecmp - 207,      & parse_entire_int, 
        & parse_entire_int + 796,      & print_usage,      & print_usage + 480,      & strcasecmp, 
        & strcasecmp - 544,      & cmdline_add_files,      & cmdline_add_files - 917,      & strcasecmp, 
        & strcasecmp + 171,      & print_usage,      & strcmp,      & strcmp, 
        & strcmp + 535,      & cmdline_add_files,      & cmdline_add_files + 242,      & cmdline_add_files, 
        & cmdline_add_files + 373,      & cmdline_add_files,      & strcasecmp,      & strcasecmp - 597, 
        & print_usage,      & strlen,      & print_usage,      & print_usage + 337, 
        & parse_entire_int,      & parse_entire_int + 23,      & print_usage,      & print_usage - 103, 
        & scoring_add_wildcard,      & scoring_add_wildcard + 490,      & print_usage,      & print_usage, 
        & print_usage,      & print_usage - 998,      & print_usage,      & print_usage, 
        & print_usage - 343,      & print_usage,      & print_usage - 800,      & print_usage, 
        & print_usage + 933,      & print_usage,      & print_usage,      & print_usage, 
        & print_usage,      & print_usage,      & gzread,      & gzread - 338, 
        & gzgets,      & strlen,      & realloc,      & realloc + 16, 
        & memcpy,      & memcpy + 170,      & gzgetc,      & gzgetc + 563, 
        & nw_set_default_scoring,      & nw_set_default_scoring + 920,      & cmdline_new,      & needleman_wunsch_new, 
        & alignment_create,      & alignment_create + 324,      & align,      & cmdline_get_num_of_file_pairs, 
        & cmdline_get_num_of_file_pairs - 404,      & cmdline_get_file1,      & cmdline_get_file1 + 176,      & cmdline_get_file2, 
        & align_from_file,      & needleman_wunsch_free,      & needleman_wunsch_free - 0,      & alignment_free, 
        & cmdline_free,      & cmdline_free + 748,      & strlen,      & strlen, 
        & strlen + 592,      & needleman_wunsch_align2,      & aligner_destroy,      & aligner_destroy + 914, 
        & free,      & calloc,      & calloc + 140,      & scoring_system_default, 
        & scoring_system_default - 447};
...
{ 
  ...
  {
  ((void (*)(aligner_t *aligner ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 350 : 2])(nw___0);
  ((void (*)(void * ))_3__functionPtrArray[352 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)nw___0);
  return;
}
}
...
{ 
  ...
  {
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 143 >> 4 : 143])((void *)bs->b);
  _3__functionPtrArray[55 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[15];
  ((void *(*)(void * , int  , size_t___1  ))_3__functionPtrArray[145 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)bs,
                                                                                                                                                                                   0,
                                                                                                                                                                                   sizeof(*bs));
  return;
}
...
{ 
  ...
  while (1) {
    ...
    *(hist->match_scores_mask.b + (arr_index >> 5)) |= (unsigned int )(1 << (arr_index & 31UL));
    ...
    ((void (*)(enum Matrix *curr_matrix , score_t *curr_score , size_t___1 *score_x ,
               size_t___1 *score_y , size_t___1 *arr_index , aligner_t const   *aligner ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 8 : end_score])(& curr_matrix,
                                                                                                                                                                                  & curr_score,
                                                                                                                                                                                  & score_x,
                                                                                                                                                                                  & score_y,
                                                                                                                                                                                  & arr_index,
                                                                                                                                                                                  aligner);
    _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & aligner;
    length ++;
  }
  result___0->length = length;
  ((void (*)(alignment_t *result , size_t___1 strlength ))_3__functionPtrArray[10 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(result___0,
                                                                                                                                                                                                length);
  ...
  while (curr_score > 0) {
    ...
    *(result___0->result_b + i) = (char )'-';
    break;
    default: 
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[12 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                                                                                    (char const   *)((char const   */* __restrict  */)"Program error: invalid matrix in _follow_hit()\n"));
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[13 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                                                                                    (char const   *)((char const   */* __restrict  */)"Please submit a bug report to: turner.isaac@gmail.com\n"));
    ((void (*)(int  ))_3__functionPtrArray[14 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(1);
    _3__functionPtrArray[7 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & length;
    }
    ((void (*)(enum Matrix *curr_matrix , score_t *curr_score , size_t___1 *score_x ,
               size_t___1 *score_y , size_t___1 *arr_index , aligner_t const   *aligner ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 15 : 10])(& curr_matrix,
                                                                                                                                                                            & curr_score,
                                                                                                                                                                            & score_x,
                                                                                                                                                                            & score_y,
                                                                                                                                                                            & arr_index,
...
{ 
  ...
  ((void (*)(char const   *seq_a , char const   *seq_b , char const   *seq_a_name ,
             char const   *seq_b_name ))_3__functionPtrArray[54 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)read1->seq.b,
                                                                                                                                                                              (char const   *)read2->seq.b,
                                                                                                                                                                              (char const   *)tmp___0,
                                                                                                                                                                              (char const   *)tmp);
  _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[49];
  return;
}
}
...
{ 
  ...
  while (nread < len) {
    ...
    s = ((int (*)(gzFile file , voidp buf , unsigned int len ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 318 : 318 << 1])(gz,
                                                                                                                                                        (voidp )((char *)ptr + nread),
                                                                                                                                                        (unsigned int )n);
    if (s <= 0) {
      break;
    }
...
{ 
  ...
  {
  tmp = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 346 + 7 : 346])(b);
  _3__functionPtrArray[222 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[268];
  tmp___0 = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[347 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(a);
  ((void (*)(char const   *a , char const   *b , size_t___1 len_a , size_t___1 len_b ,
             scoring_t const   *scoring___0 , nw_aligner_t *nw___0 , alignment_t *result___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 0 : 349])(a,
                                                                                                                                                                                 b,
                                                                                                                                                                                 tmp___0,
                                                                                                                                                                                 tmp,
                                                                                                                                                                                 scoring___0,
...
{ 
  ...
  {
  tmp = ((StrBuf *(*)(size_t___1 len ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 110])((size_t___1 )200);
  _3__functionPtrArray[38 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[0];
  sbuf = tmp;
  line_num = 0;
  num_pairs_added = 0;
  while (1) {
    read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[111 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf,
                                                                                                                                                 file);
    _3__functionPtrArray[58 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[81];
    if (! (read_length > 0UL)) {
      break;
    }
    ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 113 + 8 : 113])(sbuf);
    _3__functionPtrArray[84 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[36];
    if (sbuf->end > 0UL) {
      if ((int )*(sbuf->b + 0) != 35) {
        tmp___7 = ((char (*)(char const   *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 114 : 10])((char const   *)sbuf->b);
        _3__functionPtrArray[94 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[10];
        if (! tmp___7) {
          if (read_length < 5UL) {
            ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                       char is_matrix ))_3__functionPtrArray[115 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("Too few column headings",
                                                                                                                          file_path,
                                                                                                                          line_num,
                                                                                                                          (char)0);
          }
          tmp___4 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 116])((int )*(sbuf->b + 1));
          if (tmp___4) {
            a = *(sbuf->b + 0);
            char2_pos = (size_t___1 )1;
            while (1) {
              if ((int )*(sbuf->b + char2_pos) != 0) {
                tmp___0 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 117 : 8])((int )*(sbuf->b + char2_pos));
                if (! tmp___0) {
                  break;
                }
              } else {
            ...
            if (char2_pos + 2UL >= sbuf->end) {
              ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                         char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 118 : 118 + 10])("Line too short",
                                                                                                                                   file_path,
                                                                                                                                   line_num,
                                                                                                                                   (char)0);
              _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___6 : 24] = (void *)1277205;
            } else {
              tmp___1 = ((int (*)(int  ))_3__functionPtrArray[120 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((int )*(sbuf->b + (char2_pos + 1UL)));
              _3__functionPtrArray[78 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[53];
              if (! tmp___1) {
                ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                           char is_matrix ))_3__functionPtrArray[122 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])("Line too short",
                                                                                                                                                                                   file_path,
                                                                                                                                                                                   line_num,
                                                                                                                                                                                   (char)0);
              }
            ...
            b = *(sbuf->b + char2_pos);
            tmp___2 = ((char (*)(char *str , int *result___0 ))_3__functionPtrArray[124 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((sbuf->b + char2_pos) + 2,
                                                                                                                                                                                                      & score);
            if (! tmp___2) {
              ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                         char is_matrix ))_3__functionPtrArray[126 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("Invalid number",
                                                                                                                            file_path,
                                                                                                                            line_num,
                                                                                                                            (char)0);
            ...
            if ((int )*(sbuf->b + 1) != (int )*(sbuf->b + 3)) {
              ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                         char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 128 : 128 | num_pairs_added])("Inconsistent separators used",
                                                                                                                                                file_path,
                                                                                                                                                line_num,
                                                                                                                                                (char)0);
              _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 47 - 3 : 47] = & tmp___2;
            }
            a = *(sbuf->b + 0);
            b = *(sbuf->b + 2);
            tmp___3 = ((char (*)(char *str , int *result___0 ))_3__functionPtrArray[130 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sbuf->b + 4,
                                                                                                                                                                                                      & score);
            _3__functionPtrArray[129 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[45];
            if (! tmp___3) {
              ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                         char is_matrix ))_3__functionPtrArray[132 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("Invalid number",
                                                                                                                          file_path,
                                                                                                                          line_num,
                                                                                                                          (char)0);
            }
          ...
          if (! case_sensitive) {
            tmp___5 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 134 : 134 * 10])((int )a);
            a = (char )tmp___5;
            tmp___6 = ((int (*)(int  ))_3__functionPtrArray[136 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )b);
            b = (char )tmp___6;
          }
          ((void (*)(scoring_t *scoring___0 , char a , char b , int score ))_3__functionPtrArray[137 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(scoring___0,
                                                                                                                                                                                                                   a,
                                                                                                                                                                                                                   b,
                                                                                                                                                                                                                   score);
          num_pairs_added ++;
  ...
  if (num_pairs_added == 0) {
    ((void (*)(char const   *err_msg , char const   *file_path , int line_num , char is_matrix ))_3__functionPtrArray[139 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("No pairs added from file (file empty?)",
                                                                                                                                                                                   file_path,
                                                                                                                                                                                   line_num,
                                                                                                                                                                                   (char)0);
  }
...
{ 
  ...
  {
  ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[355 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(& scoring);
  return;
}
}
...
{ 
  ...
  {
  tmp = ((void *(*)(unsigned long  , unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 160 + tmp___48 : 160])((size_t___0 )1,
                                                                                                                                                     sizeof(cmdline_t ));
  cmd___0 = (cmdline_t *)tmp;
  cmd___0->file_list_length = (size_t___1 )0;
  cmd___0->file_list_capacity = (size_t___1 )256;
  tmp___0 = ((void *(*)(unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 162 : tmp___38])(sizeof(char *) * cmd___0->file_list_capacity);
  _3__functionPtrArray[112 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[65];
  cmd___0->file_paths1 = (char **)tmp___0;
  tmp___1 = ((void *(*)(unsigned long  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 164 : 3])(sizeof(char *) * cmd___0->file_list_capacity);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___27 : 16] = _3__functionPtrArray[134];
  ...
  if (argc == 1) {
    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
               char const   *errfmt  , ...))_3__functionPtrArray[166 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                   defaults,
                                                                                                                                                                                   (char const   *)*(argv + 0),
                                                                                                                                                                                   (char const   *)((void *)0));
    _3__functionPtrArray[121 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[10];
  }
  scoring_set = (char)0;
  ...
  argi = 1;
  while (argi < argc) {
    tmp___10 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[167 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                             "--help");
    _3__functionPtrArray[103 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & tmp___36;
    if (tmp___10 == 0) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[168 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              (char const   *)((void *)0));
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 72 : 72 | 3] = & tmp___32;
    } else {
      tmp___11 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 170 << 4 : 170])((char const   *)*(argv + argi),
                                                                                                                                                      "-help");
      if (tmp___11 == 0) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 172 : 7])(cmd_type,
                                                                                                                                  defaults,
                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                  (char const   *)((void *)0));
      } else {
        tmp___12 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 174 : 174 | tmp___4])((char const   *)*(argv + argi),
                                                                                                                                                             "-h");
        if (tmp___12 == 0) {
          ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                     char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 176 << tmp___32 : 176])(cmd_type,
                                                                                                                                                  defaults,
                                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                                  (char const   *)((void *)0));
          _3__functionPtrArray[86 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[163];
        } else {
          tmp___9 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[178 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                       "--case_sensitive");
          if (tmp___9 == 0) {
            cmd___0->case_sensitive = (_Bool)1;
          } else {
            tmp___8 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 180 >> tmp___45 : 180])((char const   *)*(argv + argi),
                                                                                                                                                                  "--scoring");
            if (tmp___8 == 0) {
              if (scoring_set) {
                ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                           char const   *errfmt  , ...))_3__functionPtrArray[182 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                               defaults,
                                                                                                                                                                                               (char const   *)*(argv + 0),
                                                                                                                                                                                               "More than one scoring system specified - not permitted");
              }
              tmp___7 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 184 : tmp___41])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                             "PAM30");
              _3__functionPtrArray[107 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & match_set;
              if (tmp___7 == 0) {
                ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[186 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(scoring___0);
              } else {
                tmp___6 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 187])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                         "PAM70");
                _3__functionPtrArray[16 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[110];
                if (tmp___6 == 0) {
                  ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 188 : tmp___7])(scoring___0);
                  _3__functionPtrArray[33 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[106];
                } else {
                  tmp___5 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[189 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                               "BLOSUM80");
                  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 171 : tmp___27] = & tmp___39;
                  if (tmp___5 == 0) {
                    ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[190 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(scoring___0);
                  } else {
                    tmp___4 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 3 : 192])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                            "BLOSUM62");
                    if (tmp___4 == 0) {
                      ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 193 : 2])(scoring___0);
                    } else {
                      tmp___3 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[194 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                              "DNA_HYBRIDIZATION");
                      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 144 * 6] = & tmp___20;
                      if (tmp___3 == 0) {
                        ((void (*)(scoring_t *scoring___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 195 & tmp___41 : 195])(scoring___0);
                        _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & tmp___14;
                      } else {
                        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                   char const   *cmdstr , char const   *errfmt  , ...))_3__functionPtrArray[197 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                              defaults,
                                                                                                                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                                                                                                                              "Unknown --scoring choice, not one of PAM30|PAM70|BLOSUM80|BLOSUM62");
                        _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 58 : 58 - tmp___11] = & tmp___42;
                      }
                    }
                  }
                }
  ...
  while (argi < argc) {
    if ((int )*(*(argv + argi) + 0) == 45) {
      tmp___53 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[198 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                    "--freestartgap");
      if (tmp___53 == 0) {
        if ((unsigned int )cmd_type != 1U) {
          ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                     char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 200 : wildscore])(cmd_type,
                                                                                                                                            defaults,
                                                                                                                                            (char const   *)*(argv + 0),
                                                                                                                                            "--freestartgap only valid with Needleman-Wunsch");
          _3__functionPtrArray[90 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[101];
        }
        scoring___0->no_start_gap_penalty = (_Bool)1;
      } else {
        tmp___52 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 201 : 8])((char const   *)*(argv + argi),
                                                                                                                                                 "--freeendgap");
        _3__functionPtrArray[9 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[90];
        if (tmp___52 == 0) {
          if ((unsigned int )cmd_type != 1U) {
            ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                       char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 202 : 202 * tmp___33])(cmd_type,
                                                                                                                                                   defaults,
                                                                                                                                                   (char const   *)*(argv + 0),
                                                                                                                                                   "--freeendgap only valid with Needleman-Wunsch");
            _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2] = _3__functionPtrArray[20];
          }
          scoring___0->no_end_gap_penalty = (_Bool)1;
        } else {
          tmp___51 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 203 << 6 : 203])((char const   *)*(argv + argi),
                                                                                                                                                          "--nogaps");
          _3__functionPtrArray[153 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[166];
          if (tmp___51 == 0) {
            scoring___0->no_gaps_in_a = (_Bool)1;
            scoring___0->no_gaps_in_b = (_Bool)1;
          } else {
            tmp___50 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 204 : tmp___36])((char const   *)*(argv + argi),
                                                                                                                                                            "--nogapsin1");
            _3__functionPtrArray[92 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[4];
            if (tmp___50 == 0) {
              scoring___0->no_gaps_in_a = (_Bool)1;
            } else {
              tmp___49 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[206 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                            "--nogapsin2");
              if (tmp___49 == 0) {
                scoring___0->no_gaps_in_b = (_Bool)1;
              } else {
                tmp___48 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 208])((char const   *)*(argv + argi),
                                                                                                                                                         "--nomismatches");
                if (tmp___48 == 0) {
                  scoring___0->no_mismatches = (_Bool)1;
                } else {
                  tmp___47 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 209 : 209 - tmp___46])((char const   *)*(argv + argi),
                                                                                                                                                                        "--case_sensitive");
                  _3__functionPtrArray[179 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[99];
                  if (! (tmp___47 == 0)) {
                    tmp___46 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 211])((char const   *)*(argv + argi),
                                                                                                                                                             "--printseq");
                    _3__functionPtrArray[199 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[113];
                    if (tmp___46 == 0) {
                      if ((unsigned int )cmd_type != 0U) {
                        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                   char const   *cmdstr , char const   *errfmt  , ...))_3__functionPtrArray[213 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                       defaults,
                                                                                                                                                                       (char const   *)*(argv + 0),
                      ...
                      tmp___45 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[215 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                             "--printmatrices");
                      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 109 : tmp___12] = _3__functionPtrArray[155];
                      if (tmp___45 == 0) {
                        cmd___0->print_matrices = (_Bool)1;
                      } else {
                        tmp___44 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 216 : 7])((char const   *)*(argv + argi),
                                                                                                                                                                 "--printscores");
                        if (tmp___44 == 0) {
                          if ((unsigned int )cmd_type != 1U) {
                            ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                       char const   *cmdstr , char const   *errfmt 
                                       , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 217 & 10 : 217])(cmd_type,
                                                                                                                                       defaults,
                                                                                                                                       (char const   *)*(argv + 0),
                                                                                                                                       "--printscores only valid with Needleman-Wunsch");
                            _3__functionPtrArray[60 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[173];
                          }
                          cmd___0->print_scores = (_Bool)1;
                        } else {
                          tmp___43 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[219 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                        "--printfasta");
                          if (tmp___43 == 0) {
                            cmd___0->print_fasta = (_Bool)1;
                          } else {
                            tmp___42 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[220 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                   "--pretty");
                            if (tmp___42 == 0) {
                              cmd___0->print_pretty = (_Bool)1;
                            } else {
                              tmp___41 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[221 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                            "--colour");
                              _3__functionPtrArray[4 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[173];
                              if (tmp___41 == 0) {
                                cmd___0->print_colour = (_Bool)1;
                              } else {
                                tmp___40 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[223 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                         "--zam");
                                _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___44 : 155] = _3__functionPtrArray[93];
                                if (tmp___40 == 0) {
                                  if ((unsigned int )cmd_type != 1U) {
                                    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                               char const   *cmdstr , char const   *errfmt 
                                               , ...))_3__functionPtrArray[224 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                             defaults,
                                                                                                                                                                                             (char const   *)*(argv + 0),
                                  ...
                                  tmp___39 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[226 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                           "--stdin");
                                  if (tmp___39 == 0) {
                                    ((void (*)(cmdline_t *cmd___0 , char *p1 , char *p2 ))_3__functionPtrArray[227 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd___0,
                                                                                                                                                                                                                                 (char *)"",
                                                                                                                                                                                                                                 (char *)((void *)0));
                                    _3__functionPtrArray[78 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[54];
                                    cmd___0->interactive = (_Bool)1;
                                  } else
                                  if (argi == argc - 1) {
                                    ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults ,
                                               char const   *cmdstr , char const   *errfmt 
                                               , ...))_3__functionPtrArray[228 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                      defaults,
                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                      "Unknown argument without parameter: %s",
                                                                                                                                      *(argv + argi));
                                    _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 127 & tmp___47 : 127] = & tmp___20;
                                  } else {
                                    tmp___38 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[230 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                                  "--scoring");
                                    _3__functionPtrArray[135 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[52];
                                    if (tmp___38 == 0) {
                                      argi ++;
                                    } else {
                                      tmp___37 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[231 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                             "--substitution_matrix");
                                      if (tmp___37 == 0) {
                                        tmp___13 = ((gzFile (*)(char const   * , char const   * ))_3__functionPtrArray[232 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                  "r");
                                        sub_matrix_file = tmp___13;
                                        if ((unsigned long )sub_matrix_file == (unsigned long )((void *)0)) {
                                          ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                     score_t *defaults , char const   *cmdstr ,
                                                     char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 233 << 4 : 233])(cmd_type,
                                                                                                                                                                           defaults,
                                                                                                                                                                           (char const   *)*(argv + 0),
                                                                                                                                                                           "Couldn\'t read: %s",
                                                                                                                                                                           *(argv + (argi + 1)));
                                        }
                                        ((void (*)(gzFile file , char const   *file_path ,
                                                   scoring_t *scoring___0 , char case_sensitive ))_3__functionPtrArray[234 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sub_matrix_file,
                                                                                                                                                                                  (char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                  scoring___0,
                                                                                                                                                                                  (char )cmd___0->case_sensitive);
                                        _3__functionPtrArray[92 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[133];
                                        ((int (*)(gzFile file ))_3__functionPtrArray[235 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sub_matrix_file);
                                        substitutions_set = (char)1;
                                        argi ++;
                                      } else {
                                        tmp___36 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[236 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                 "--substitution_pairs");
                                        if (tmp___36 == 0) {
                                          tmp___14 = ((gzFile (*)(char const   * ,
                                                                  char const   * ))_3__functionPtrArray[237 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                                                          "r");
                                          _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 103] = _3__functionPtrArray[156];
                                          sub_pairs_file = tmp___14;
                                          if ((unsigned long )sub_pairs_file == (unsigned long )((void *)0)) {
                                            ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                       score_t *defaults , char const   *cmdstr ,
                                                       char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 239 ^ tmp___31 : 239])(cmd_type,
                                                                                                                                                                                   defaults,
                                                                                                                                                                                   (char const   *)*(argv + 0),
                                                                                                                                                                                   "Couldn\'t read: %s",
                                                                                                                                                                                   *(argv + (argi + 1)));
                                            _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 84 : 84 & argi] = _3__functionPtrArray[163];
                                          }
                                          ((void (*)(gzFile file , char const   *file_path ,
                                                     scoring_t *scoring___0 , char case_sensitive ))_3__functionPtrArray[241 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sub_pairs_file,
                                                                                                                                                                                    (char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                    scoring___0,
                                                                                                                                                                                    (char )cmd___0->case_sensitive);
                                          ((int (*)(gzFile file ))_3__functionPtrArray[242 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sub_pairs_file);
                                          substitutions_set = (char)1;
                                          argi ++;
                                        } else {
                                          tmp___35 = ((int (*)(char const   * , char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 243 : 243 ^ tmp___26])((char const   *)*(argv + argi),
                                                                                                                                                                                                "--minscore");
                                          if (tmp___35 == 0) {
                                            if ((unsigned int )cmd_type != 0U) {
                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                         score_t *defaults , char const   *cmdstr ,
                                                         char const   *errfmt  , ...))_3__functionPtrArray[244 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                      defaults,
                                                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                                                      "--minscore only valid with Smith-Waterman");
                                              _3__functionPtrArray[222 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & tmp___22;
                                            }
                                            tmp___15 = ((char (*)(char *str , int *result___0 ))_3__functionPtrArray[245 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                                                                                                                                                & cmd___0->min_score);
                                            if (! tmp___15) {
                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                         score_t *defaults , char const   *cmdstr ,
                                                         char const   *errfmt  , ...))_3__functionPtrArray[246 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                        defaults,
                                                                                                                                                                        (char const   *)*(argv + 0),
                                                                                                                                                                        "Invalid --minscore <score> argument (must be a +ve int)");
                                              _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 29 : 29 & tmp___34] = _3__functionPtrArray[67];
                                            }
                                            cmd___0->min_score_set = (_Bool)1;
                                            argi ++;
                                          } else {
                                            tmp___34 = ((int (*)(char const   * ,
                                                                 char const   * ))_3__functionPtrArray[247 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                         "--maxhits");
                                            if (tmp___34 == 0) {
                                              if ((unsigned int )cmd_type != 0U) {
                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                           score_t *defaults , char const   *cmdstr ,
                                                           char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 248 : tmp___12])(cmd_type,
                                                                                                                                                                                 defaults,
                                                                                                                                                                                 (char const   *)*(argv + 0),
                                                                                                                                                                                 "--maxhits only valid with Smith-Waterman");
                                                _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 78 : 78 | 4] = _3__functionPtrArray[176];
                                              }
                                              tmp___16 = ((char (*)(char *str , unsigned int *result___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 250 * tmp___53 : 250])(*(argv + (argi + 1)),
                                                                                                                                                                                                          & cmd___0->max_hits_per_alignment);
                                              if (! tmp___16) {
                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                           score_t *defaults , char const   *cmdstr ,
                                                           char const   *errfmt  , ...))_3__functionPtrArray[251 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                               defaults,
                                                                                                                                                                                                                               (char const   *)*(argv + 0),
                                              ...
                                              tmp___33 = ((int (*)(char const   * ,
                                                                   char const   * ))_3__functionPtrArray[253 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)*(argv + argi),
                                                                                                                                                                                                                           "--context");
                                              if (tmp___33 == 0) {
                                                if ((unsigned int )cmd_type != 0U) {
                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                             score_t *defaults , char const   *cmdstr ,
                                                             char const   *errfmt 
                                                             , ...))_3__functionPtrArray[254 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                      defaults,
                                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                                      "--context only valid with Smith-Waterman");
                                                }
                                                tmp___17 = ((char (*)(char *str ,
                                                                      unsigned int *result___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 256 : 256 * 1])(*(argv + (argi + 1)),
                                                                                                                                                                                         & cmd___0->print_context);
                                                if (! tmp___17) {
                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                             score_t *defaults , char const   *cmdstr ,
                                                             char const   *errfmt 
                                                             , ...))_3__functionPtrArray[257 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                           defaults,
                                                                                                                                                                                                           (char const   *)*(argv + 0),
                                                                                                                                                                                                           "Invalid --context <c> argument (must be >= 0)");
                                                  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 157 : 157 & tmp___49] = _3__functionPtrArray[94];
                                                }
                                                argi ++;
                                              } else {
                                                tmp___32 = ((int (*)(char const   * ,
                                                                     char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 259])((char const   *)*(argv + argi),
                                                                                                                                                                        "--match");
                                                if (tmp___32 == 0) {
                                                  tmp___18 = ((char (*)(char *str ,
                                                                        int *result___0 ))_3__functionPtrArray[261 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(*(argv + (argi + 1)),
                                                                                                                                                                                                                                 & scoring___0->match);
                                                  if (! tmp___18) {
                                                    ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                               score_t *defaults ,
                                                               char const   *cmdstr ,
                                                               char const   *errfmt 
                                                               , ...))_3__functionPtrArray[262 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                             defaults,
                                                                                                                                                                                                             (char const   *)*(argv + 0),
                                                                                                                                                                                                             "Invalid --match argument (\'%s\') must be an int",
                                                                                                                                                                                                             *(argv + (argi + 1)));
                                                    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 84 : 84 >> tmp___27] = & cmd_type;
                                                  }
                                                  match_set = (char)1;
                                                  argi ++;
                                                } else {
                                                  tmp___31 = ((int (*)(char const   * ,
                                                                       char const   * ))_3__functionPtrArray[263 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                          "--mismatch");
                                                  _3__functionPtrArray[121 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[126];
                                                  if (tmp___31 == 0) {
                                                    tmp___19 = ((char (*)(char *str ,
                                                                          int *result___0 ))_3__functionPtrArray[264 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                    ...
                                                    if (! tmp___19) {
                                                      ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                 ...
                                                                 char const   *cmdstr ,
                                                                 char const   *errfmt 
                                                                 , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 265 : 265 >> tmp___39])(cmd_type,
                                                                                                                                                                        defaults,
                                                                                                                                                                        (char const   *)*(argv + 0),
                                                                                                                                                                        "Invalid --mismatch argument (\'%s\') must be an int",
                                                                                                                                                                        *(argv + (argi + 1)));
                                                      _3__functionPtrArray[175 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[226];
                                                    }
                                                    mismatch_set = (char)1;
                                                    argi ++;
                                                  } else {
                                                    tmp___30 = ((int (*)(char const   * ,
                                                                         char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 266 + 6 : 266])((char const   *)*(argv + argi),
                                                                                                                                                                                  "--gapopen");
                                                    _3__functionPtrArray[133 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[139];
                                                    if (tmp___30 == 0) {
                                                      tmp___20 = ((char (*)(char *str ,
                                                                            int *result___0 ))_3__functionPtrArray[267 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(argv + (argi + 1)),
                                                      ...
                                                      if (! tmp___20) {
                                                        ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                   ...
                                                                   char const   *cmdstr ,
                                                                   char const   *errfmt 
                                                                   , ...))_3__functionPtrArray[268 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                            defaults,
                                                                                                                                                            (char const   *)*(argv + 0),
                                                      ...
                                                      tmp___29 = ((int (*)(char const   * ,
                                                                           char const   * ))_3__functionPtrArray[269 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                              "--gapextend");
                                                      if (tmp___29 == 0) {
                                                        tmp___21 = ((char (*)(char *str ,
                                                                              int *result___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 271 : 271 + argc])(*(argv + (argi + 1)),
                                                                                                                                                                                           & scoring___0->gap_extend);
                                                        _3__functionPtrArray[86 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[92];
                                                        if (! tmp___21) {
                                                          ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                     score_t *defaults ,
                                                                     char const   *cmdstr ,
                                                                     char const   *errfmt 
                                                                     , ...))_3__functionPtrArray[273 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                              defaults,
                                                                                                                                                              (char const   *)*(argv + 0),
                                                        ...
                                                        tmp___28 = ((int (*)(char const   * ,
                                                                             char const   * ))_3__functionPtrArray[275 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                "--file");
                                                        if (tmp___28 == 0) {
                                                          ((void (*)(cmdline_t *cmd___0 ,
                                                                     char *p1 , char *p2 ))_3__functionPtrArray[277 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd___0,
                                                                                                                                                                                                                                  *(argv + (argi + 1)),
                                                                                                                                                                                                                                  (char *)((void *)0));
                                                          _3__functionPtrArray[107 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[187];
                                                          argi ++;
                                                        } else {
                                                          tmp___27 = ((int (*)(char const   * ,
                                                                               char const   * ))_3__functionPtrArray[279 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((char const   *)*(argv + argi),
                                                                                                                                                                                  "--files");
                                                          _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 35 : 8] = _3__functionPtrArray[210];
                                                          if (tmp___27 == 0) {
                                                            if (argi >= argc - 2) {
                                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                         score_t *defaults ,
                                                                         char const   *cmdstr ,
                                                                         char const   *errfmt 
                                                                         , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 281 : 7])(cmd_type,
                                                                                                                                                                  defaults,
                                                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                                                  "--files option takes 2 arguments");
                                                            } else {
                                                              tmp___22 = ((int (*)(char const   * ,
                                                                                   char const   * ))_3__functionPtrArray[282 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   *)*(argv + (argi + 1)),
                                                                                                                                                                                    "-");
                                                              _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___32 : 159] = _3__functionPtrArray[14];
                                                              if (tmp___22 == 0) {
                                                                tmp___23 = ((int (*)(char const   * ,
                                                                                     char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 283 : tmp___47])((char const   *)*(argv + (argi + 2)),
                                                                                                                                                                                               "-");
                                                                _3__functionPtrArray[175 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[205];
                                                                if (tmp___23 == 0) {
                                                                  ((void (*)(cmdline_t *cmd___0 ,
                                                                             char *p1 ,
                                                                             char *p2 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 285 : 285 - 2])(cmd___0,
                                                                                                                                                                                *(argv + (argi + 1)),
                                                                                                                                                                                (char *)((void *)0));
                                                                  _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & tmp___45;
                                                                } else {
                                                                  ((void (*)(cmdline_t *cmd___0 ,
                                                                             char *p1 ,
                                                                             char *p2 ))_3__functionPtrArray[287 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd___0,
                                                                                                                                                                        *(argv + (argi + 1)),
                                                                                                                                                                        *(argv + (argi + 2)));
                                                                }
                                                              } else {
                                                                ((void (*)(cmdline_t *cmd___0 ,
                                                                           char *p1 ,
                                                                           char *p2 ))_3__functionPtrArray[289 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd___0,
                                                                                                                                                                        *(argv + (argi + 1)),
                                                                                                                                                                        *(argv + (argi + 2)));
                                                                _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 109 << tmp___32 : 109] = _3__functionPtrArray[56];
                                                              }
                                                            }
                                                            argi += 2;
                                                          } else {
                                                            tmp___26 = ((int (*)(char const   * ,
                                                                                 char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 290 : 290 & 9])((char const   *)*(argv + argi),
                                                                                                                                                                                          "--wildcard");
                                                            _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 150 : 150 | tmp___31] = _3__functionPtrArray[81];
                                                            if (tmp___26 == 0) {
                                                              wildscore = 0;
                                                              if (argi == argc - 2) {
                                                                ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                           ...
                                                                           char const   *cmdstr ,
                                                                           char const   *errfmt 
                                                                           , ...))_3__functionPtrArray[292 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                                                                  defaults,
                                                                                                                                                                  (char const   *)*(argv + 0),
                                                                                                                                                                  "--wildcard <w> <s> takes a single character and a number");
                                                                _3__functionPtrArray[210 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[45];
                                                              } else {
                                                                tmp___24 = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 293])((char const   *)*(argv + (argi + 1)));
                                                                _3__functionPtrArray[103 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[64];
                                                                if (tmp___24 != 1UL) {
                                                                  ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                             score_t *defaults ,
                                                                             char const   *cmdstr ,
                                                                             char const   *errfmt 
                                                                             , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 2 : 294])(cmd_type,
                                                                                                                                                                      defaults,
                                                                                                                                                                      (char const   *)*(argv + 0),
                                                                                                                                                                      "--wildcard <w> <s> takes a single character and a number");
                                                                } else {
                                                                  tmp___25 = ((char (*)(char *str ,
                                                                                        int *result___0 ))_3__functionPtrArray[296 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(*(argv + (argi + 2)),
                                                                                                                                                                                          & wildscore);
                                                                  if (! tmp___25) {
                                                                    ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                               score_t *defaults ,
                                                                               char const   *cmdstr ,
                                                                               char const   *errfmt 
                                                                               , ...))_3__functionPtrArray[298 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                             defaults,
                                                                                                                                                                                                                             (char const   *)*(argv + 0),
                                                                                                                                                                                                                             "--wildcard <w> <s> takes a single character and a number");
                                                                    _3__functionPtrArray[155 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[72];
                                                                  }
                                                                }
                                                              }
                                                              ((void (*)(scoring_t *scoring___0 ,
                                                                         char c ,
                                                                         int score ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 300 : tmp___41])(scoring___0,
                                                                                                                                                                              *(*(argv + (argi + 1)) + 0),
                                                                                                                                                                              wildscore);
                                                              _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 58 : 58 >> tmp___6] = _3__functionPtrArray[119];
                                                              argi += 2;
                                                            } else {
                                                              ((void (*)(enum SeqAlignCmdType cmd_type ,
                                                                         score_t *defaults ,
                                                                         char const   *cmdstr ,
                                                                         char const   *errfmt 
                                                                         , ...))_3__functionPtrArray[302 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                                                       defaults,
                                                                                                                                                                                                                       (char const   *)*(argv + 0),
                                                                                                                                                                                                                       "Unknown argument \'%s\'",
                                                                                                                                                                                                                       *(argv + argi));
      ...
      if (argc - argi != 2) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 303 : tmp___4])(cmd_type,
                                                                                                                                        defaults,
                                                                                                                                        (char const   *)*(argv + 0),
                                                                                                                                        "Unknown options: \'%s\'",
                                                                                                                                        *(argv + argi));
  ...
  if (match_set) {
    if (! mismatch_set) {
      if (! scoring___0->no_mismatches) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 304 : 304 & 4])(cmd_type,
                                                                                                                                        defaults,
                                                                                                                                        (char const   *)*(argv + 0),
                                                                                                                                        "--match --mismatch must both be set or neither set");
      } else {
        goto _L___1;
      }
    } else {
  ...
  if (! match_set) {
    if (mismatch_set) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[306 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              "--match --mismatch must both be set or neither set");
    } else {
  ...
  if (scoring___0->use_match_mismatch) {
    if (scoring___0->match < scoring___0->mismatch) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[307 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                     defaults,
                                                                                                                                                                                     (char const   *)*(argv + 0),
                                                                                                                                                                                     "Match value should not be less than mismatch penalty");
      _3__functionPtrArray[129 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[108];
    }
  }
  if ((unsigned int )cmd_type == 1U) {
    if (scoring___0->no_mismatches) {
      if (scoring___0->no_gaps_in_a) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 309 : 309 >> 5])(cmd_type,
                                                                                                                                         defaults,
                                                                                                                                         (char const   *)*(argv + 0),
                                                                                                                                         "--nogaps.. --nomismatches cannot be used at together");
        _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 24 << tmp___30 : 24] = & tmp___19;
      } else
      if (scoring___0->no_gaps_in_b) {
        ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                   char const   *errfmt  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 311 : tmp___23])(cmd_type,
                                                                                                                                         defaults,
                                                                                                                                         (char const   *)*(argv + 0),
                                                                                                                                         "--nogaps.. --nomismatches cannot be used at together");
      }
  ...
  if ((unsigned long )cmd___0->seq1 == (unsigned long )((void *)0)) {
    if (cmd___0->file_list_length == 0UL) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[313 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              "No input specified");
      _3__functionPtrArray[52 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[67];
    }
  }
  if (cmd___0->zam_stle_output) {
    if (cmd___0->print_pretty) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[314 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
    } else
    if (cmd___0->print_scores) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[315 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                     defaults,
                                                                                                                                                                                     (char const   *)*(argv + 0),
                                                                                                                                                                                     "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 31 : 31 - 6] = _3__functionPtrArray[276];
    } else
    if (cmd___0->print_colour) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[316 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(cmd_type,
                                                                                                                                                                                     defaults,
                                                                                                                                                                                     (char const   *)*(argv + 0),
                                                                                                                                                                                     "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
      _3__functionPtrArray[191 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[295];
    } else
    if (cmd___0->print_fasta) {
      ((void (*)(enum SeqAlignCmdType cmd_type , score_t *defaults , char const   *cmdstr ,
                 char const   *errfmt  , ...))_3__functionPtrArray[317 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd_type,
                                                                                                                              defaults,
                                                                                                                              (char const   *)*(argv + 0),
                                                                                                                              "Cannot use --printscore, --printfasta, --pretty or --colour with --zam");
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 144 : 10] = & tmp___10;
    }
  }
  return (cmd___0);
}
...
{ 
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[41 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sf->gz_file);
      c = tmp___0;
    }
    if (c != -1) {
      tmp___1 = ((int (*)(int  ))_3__functionPtrArray[42 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(c);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___1 : 40] = & tmp___0;
      if (! tmp___1) {
        break;
      }
    } else {
...
{ 
  ...
  if (arr_size > hist->hits_capacity) {
    ...
    tmp = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[(_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)hist->sorted_match_indices,
                                                                                                                                                                               mem);
    _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & hist;
    hist->sorted_match_indices = (size_t___1 *)tmp;
    if (! hist->match_scores_mask.b) {
      ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                                                                                                                                      (char const   *)((char const   */* __restrict  */)"%s:%i: Out of memory\n"),
                                                                                                                                                                                                                                      "src/smith_waterman.c",
                                                                                                                                                                                                                                      105);
      ((void (*)(int  ))_3__functionPtrArray[(((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)) + 1) + 1])(1);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 4 : 2] = (void *)1346990;
    } else
    if (! hist->sorted_match_indices) {
      ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[5 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                              (char const   *)((char const   */* __restrict  */)"%s:%i: Out of memory\n"),
                                                                                                                              "src/smith_waterman.c",
                                                                                                                              105);
      _3__functionPtrArray[! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[5];
      ((void (*)(int  ))_3__functionPtrArray[6 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(1);
      _3__functionPtrArray[4 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & hist;
    }
  }
  return;
}
...
{ 
  ...
  {
  tmp = ((void *(*)(unsigned long  , unsigned long  ))_3__functionPtrArray[353 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((size_t___0 )1,
                                                                                                                                        sizeof(nw_aligner_t ));
  _3__functionPtrArray[88 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[285];
...
{ 
  ...
  {
  tmp = ((StrBuf *(*)(size_t___1 len ))_3__functionPtrArray[56 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((size_t___1 )500);
  sbuf = tmp;
  line_num = 0;
  while (1) {
    read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 57 : 4])(sbuf,
                                                                                                                                                  file);
    ...
    ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 59 | 10 : 59])(sbuf);
    _3__functionPtrArray[47 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & scoring___0;
    if (sbuf->end > 0UL) {
      if ((int )*(sbuf->b + 0) != 35) {
        tmp___0 = ((char (*)(char const   *s ))_3__functionPtrArray[61 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((char const   *)sbuf->b);
        _3__functionPtrArray[38 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & line_num;
        if (! tmp___0) {
          if (sbuf->end < 2UL) {
            ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                       char is_matrix ))_3__functionPtrArray[62 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("Too few column headings",
                                                                                                                       file_path,
                                                                                                                       line_num,
                                                                                                                       (char)1);
            _3__functionPtrArray[16 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & tmp___17;
          }
          break;
        }
      }
  ...
  if (line_num == 0) {
    if (sbuf->end <= 0UL) {
      ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                 char is_matrix ))_3__functionPtrArray[64 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])("Empty file",
                                                                                                                 file_path,
                                                                                                                 -1,
                                                                                                                 (char)0);
    }
  ...
  if ((int )sep >= 48) {
    if ((int )sep <= 57) {
      ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                 char is_matrix ))_3__functionPtrArray[65 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Numbers (0-9) and dashes (-) do not make good separators",
                                                                                                                                                                        file_path,
                                                                                                                                                                        line_num,
                                                                                                                                                                        (char)0);
    } else {
  ...
  _L: 
  if ((int )sep == 45) {
    ((void (*)(char const   *err_msg , char const   *file_path , int line_num , char is_matrix ))_3__functionPtrArray[66 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])("Numbers (0-9) and dashes (-) do not make good separators",
                                                                                                                                                                                                                                       file_path,
                                                                                                                                                                                                                                       line_num,
                                                                                                                                                                                                                                       (char)0);
    _3__functionPtrArray[40 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = & characters;
  }
  tmp___1 = ((void *(*)(unsigned long  ))_3__functionPtrArray[68 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf->end);
  characters = (char *)tmp___1;
  num_of_chars = 0;
  tmp___18 = ((int (*)(int  ))_3__functionPtrArray[69 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((int )sep);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : tmp___10] = _3__functionPtrArray[50];
  if (tmp___18) {
    next = sbuf->b;
    while (1) {
      next = ((char *(*)(char *s ))_3__functionPtrArray[70 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(next + 1);
      _3__functionPtrArray[29 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & file_path;
      ...
      if (case_sensitive) {
        *(characters + tmp___2) = *next;
        ...
        tmp___3 = ((int (*)(int  ))_3__functionPtrArray[71 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((int )*next);
    ...
    while (1) {
      read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[73 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sbuf,
                                                                                                                                                  file);
      if (! (read_length > 0UL)) {
        break;
      }
      ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[74 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(sbuf);
      _3__functionPtrArray[26 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[1];
      tmp___4 = ((char *(*)(char *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 75 - 9 : 75])(sbuf->b);
      ...
      if (case_sensitive) {
        ...
        tmp___5 = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 76 * 5 : 76])((int )*from_char_pos);
        tmp___6 = tmp___5;
      }
      ...
      while (i < num_of_chars) {
        ...
        tmp___7 = ((int (*)(int  ))_3__functionPtrArray[77 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )*score_txt);
        if (! tmp___7) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 1 : 79])("Expected whitespace between elements - found character",
                                                                                                                       file_path,
                                                                                                                       line_num,
                                                                                                                       (char)1);
        }
        score_txt = ((char *(*)(char *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 81 : tmp___11])(score_txt + 1);
        _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 29 * 5 : 29] = & tmp___16;
        strtol_last_char_ptr = score_txt;
        tmp___8 = ((long (*)(char const   * __restrict   , char ** __restrict   ,
                             int  ))_3__functionPtrArray[83 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((char const   */* __restrict  */)strtol_last_char_ptr,
                                                                                                                     (char **/* __restrict  */)(& strtol_last_char_ptr),
                                                                                                                     10);
        _3__functionPtrArray[80 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[6];
        score = (int )tmp___8;
        if ((unsigned long )strtol_last_char_ptr == (unsigned long )score_txt) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 85 : 6])("Missing number value on line",
                                                                                                                       file_path,
                                                                                                                       line_num,
                                                                                                                       (char)1);
          _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 63] = & read_length;
        }
        ((void (*)(scoring_t *scoring___0 , char a , char b , int score ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp___18 : 87])(scoring___0,
                                                                                                                                                                  from_char,
                                                                                                                                                                  to_char,
                                                                                                                                                                  score);
      ...
      if ((int )*score_txt != 0) {
        tmp___9 = ((char (*)(char const   *s ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 89 : 89 - tmp___18])((char const   *)score_txt);
        _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : score] = _3__functionPtrArray[78];
        if (! tmp___9) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[91 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Too many columns on row",
                                                                                                                                                                            file_path,
                                                                                                                                                                            line_num,
                                                                                                                                                                            (char)1);
          _3__functionPtrArray[(_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[21];
    ...
    while (i___0 < sbuf->end) {
      if ((int )*(sbuf->b + i___0) != (int )sep) {
        ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                   char is_matrix ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 93])("Separator missing from line",
                                                                                                                     file_path,
                                                                                                                     line_num,
                                                                                                                     (char)1);
      }
      if (case_sensitive) {
        ...
        tmp___10 = ((int (*)(int  ))_3__functionPtrArray[95 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])((int )*(sbuf->b + (i___0 + 1UL)));
        tmp___11 = tmp___10;
      }
      c = (char )tmp___11;
    ...
    while (1) {
      read_length = ((size_t___1 (*)(StrBuf *sb , gzFile gz_file ))_3__functionPtrArray[96 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sbuf,
                                                                                                                                                                                                         file);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 8 : 4] = & tmp___5;
      if (! (read_length > 0UL)) {
        break;
      }
      ((size_t___1 (*)(StrBuf *sb ))_3__functionPtrArray[97 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sbuf);
      _3__functionPtrArray[72 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[43];
      if (case_sensitive) {
        tmp___14 = (int )*(sbuf->b + 0);
      } else {
        tmp___13 = ((int (*)(int  ))_3__functionPtrArray[99 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((int )*(sbuf->b + 0));
        _3__functionPtrArray[47 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = & tmp___16;
        tmp___14 = tmp___13;
      }
      ...
      if ((int )from_char___0 == 35) {
        ...
        tmp___15 = ((char (*)(char const   *s ))_3__functionPtrArray[100 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)sbuf->b);
        if (tmp___15) {
          continue;
        }
      }
      ...
      while ((int )*str_pos != 0) {
        ...
        if ((int )*str_pos != (int )sep) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[101 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])("Separator missing from line",
                                                                                                                        file_path,
                                                                                                                        line_num,
                                                                                                                        (char)1);
        }
        ...
        tmp___17 = ((long (*)(char const   * __restrict   , char ** __restrict   ,
                              int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 102 << tmp___12 : 102])((char const   */* __restrict  */)str_pos,
                                                                                                                                     (char **/* __restrict  */)(& after_num_str),
                                                                                                                                     10);
        _3__functionPtrArray[43 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[24];
        score___0 = (int )tmp___17;
        if ((unsigned long )str_pos == (unsigned long )after_num_str) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[104 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Missing number value on line",
                                                                                                                                                                             file_path,
                                                                                                                                                                             line_num,
                                                                                                                                                                             (char)1);
          _3__functionPtrArray[55 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))] = & from_char_pos;
        }
        if (to_char_index >= num_of_chars) {
          ((void (*)(char const   *err_msg , char const   *file_path , int line_num ,
                     char is_matrix ))_3__functionPtrArray[105 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])("Too many columns on row",
                                                                                                                                                                             file_path,
                                                                                                                                                                             line_num,
                                                                                                                                                                             (char)1);
        }
        ((void (*)(scoring_t *scoring___0 , char a , char b , int score ))_3__functionPtrArray[106 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(scoring___0,
                                                                                                                                                            from_char___0,
                                                                                                                                                            to_char___0,
                                                                                                                                                            score___0);
        _3__functionPtrArray[26 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = & score___0;
        str_pos = after_num_str;
      }
      line_num ++;
    }
  }
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 108 - tmp___13 : 108])((void *)characters);
  strbuf_free(sbuf);
  return;
}
}
...
{ 
  ...
  {
  if (is_matrix) {
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[19 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                             (char const   *)((char const   */* __restrict  */)"Error: substitution matrix : %s\n"),
                                                                                                                             err_msg);
    _3__functionPtrArray[11 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[9];
  } else {
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[20 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                             (char const   *)((char const   */* __restrict  */)"Error: substitution pairs : %s\n"),
                                                                                                                             err_msg);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 7 : line_num] = _3__functionPtrArray[18];
  }
  if ((unsigned long )file_path != (unsigned long )((void *)0)) {
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[21 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                             (char const   *)((char const   */* __restrict  */)"File: %s\n"),
                                                                                                                             file_path);
    _3__functionPtrArray[18 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[19];
  }
  if (line_num != -1) {
    ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 22 : line_num])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                                      (char const   *)((char const   */* __restrict  */)"Line: %s\n"),
                                                                                                                                      file_path);
  }
  ((void (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 23 ^ line_num : 23])(1);
}
}
...
{ 
  ...
  while (1) {
    ...
    if (c != -1) {
      tmp = ((int (*)(int  ))_3__functionPtrArray[51 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(c);
      if (! tmp) {
        break;
      }
    } else {
...
{ 
  ...
  while (1) {
    c = gzgetc_buf(sf->gz_file, & sf->in);
    if (c != -1) {
      tmp = ((int (*)(int  ))_3__functionPtrArray[44 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(c);
...
{ 
  ...
  ss = (l + 31UL) / 32UL;
  if (ss > bs->s) {
    tmp = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[146 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)bs->b,
                                                                                                                                  ss * sizeof(*(bs->b + 0)));
    bs->b = (uint32_t *)tmp;
    ((void *(*)(void * , int  , size_t___1  ))_3__functionPtrArray[148 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])((void *)(bs->b + bs->s),
                                                                                                                              0,
                                                                                                                              (ss - bs->s) * sizeof(*(bs->b + 0)));
    bs->s = ss;
  }
  bs->l = l;
  if (bs->b) {
...
{ 
  ...
  if ((sf->gz_file)->have) {
    ...
    tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[30 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(sf->gz_file);
    tmp___1 = tmp___0;
  }
  c = tmp___1;
  if (c == -1) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___5 = ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 32 + 8 : 32])(sf->gz_file);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 16 : tmp___0] = & tmp___6;
      c = tmp___5;
    }
    if (! (c != 43)) {
      break;
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___7 = ((int (*)(gzFile file ))_3__functionPtrArray[34 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
      c = tmp___7;
    }
    if (c != -1) {
      if (! (c != 10)) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___10 = ((int (*)(gzFile file ))_3__functionPtrArray[36 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
      c = tmp___10;
    }
    if (c != -1) {
      if (! (c != 64)) {
  ...
  ((int (*)(int c , gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 37 : tmp___10])(c,
                                                                                                                          sf->gz_file);
  return (1);
}
}
...
{ 
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[48 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])(sf->gz_file);
      c = tmp___0;
    }
    if (c != -1) {
      tmp___1 = ((int (*)(int  ))_3__functionPtrArray[49 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(c);
      if (! tmp___1) {
        break;
      }
    } else {
  ...
  ((int (*)(int c , gzFile file ))_3__functionPtrArray[50 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(c,
                                                                                                                 sf->gz_file);
...
{ 
  ...
  if (*sizeptr < len) {
    ...
    *sizeptr = 1UL << (64 - tmp);
    tmp___1 = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[149 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])((void *)*buf,
                                                                                                                                    *sizeptr);
    _3__functionPtrArray[55 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[46];
    tmp___0 = (char *)tmp___1;
    *buf = tmp___0;
    if ((unsigned long )tmp___0 == (unsigned long )((void *)0)) {
      ((int (*)(FILE * , char const   *  , ...))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 5 : 151])((FILE *)((FILE */* __restrict  */)stderr),
                                                                                                                                  (char const   *)((char const   */* __restrict  */)"Out of memory\n"));
      ((void (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? tmp : 152])(1);
      _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 9 : 8] = _3__functionPtrArray[43];
    }
  }
  return;
}
...
{ 
  ...
  {
  ((void (*)(void * ))_3__functionPtrArray[154 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)cmd___0->file_paths1);
  _3__functionPtrArray[125 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[144];
  ((void (*)(void * ))_3__functionPtrArray[156 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)cmd___0->file_paths2);
  ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 158 : 9])((void *)cmd___0);
  _3__functionPtrArray[88 + ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[50];
  return;
}
}
...
{ 
  ...
  if ((sf->gz_file)->have) {
    ...
    tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[25 * ! (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sf->gz_file);
    tmp___1 = tmp___0;
  }
  c = tmp___1;
  if (c == -1) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      ...
      tmp___5 = ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 27 : 27 | c])(sf->gz_file);
      c = tmp___5;
    }
    if (! (c != 62)) {
      break;
  ...
  ((int (*)(int c , gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 28 : 2])(c,
                                                                                                                   sf->gz_file);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 >> c : 11] = & r;
  return (1);
}
}
...
{ 
  ...
  while (1) {
    if (file->have) {
      ...
      tmp___0 = ((int (*)(gzFile file ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 326 : 326 * 9])(file);
      c = tmp___0;
    }
    if (! (c != -1)) {
      break;
...
{ 
  ...
  bs->s = (l + 31UL) / 32UL;
  bs->l = l;
  tmp = ((void *(*)(unsigned long  , unsigned long  ))_3__functionPtrArray[141 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(sizeof(*(bs->b + 0)),
                                                                                                                                      bs->s);
  _3__functionPtrArray[142 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[105];
  bs->b = (uint32_t *)tmp;
  if (bs->b) {
    tmp___0 = bs;
  } else {
...
{ 
  ...
  ((void (*)(void))_3__functionPtrArray[328 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])();
  cmd = ((cmdline_t *(*)(int argc , char **argv , scoring_t *scoring___0 , enum SeqAlignCmdType cmd_type ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 330 : r13])(argc,
                                                                                                                                                                                               argv,
                                                                                                                                                                                               & scoring,
                                                                                                                                                                                               (enum SeqAlignCmdType )1);
  nw = ((nw_aligner_t *(*)(void))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 10 : 331])();
  _3__functionPtrArray[276 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[17];
  result = ((alignment_t *(*)(size_t___1 capacity ))_3__functionPtrArray[332 - ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((size_t___1 )256);
  if ((unsigned long )cmd->seq1 != (unsigned long )((void *)0)) {
    ((void (*)(char const   *seq_a , char const   *seq_b , char const   *seq_a_name ,
               char const   *seq_b_name ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 334 : 334 & r13])(cmd->seq1,
                                                                                                                                    cmd->seq2,
                                                                                                                                    (char const   *)((void *)0),
                                                                                                                                    (char const   *)((void *)0));
  }
  tmp = ((size_t___1 (*)(cmdline_t *cmd___0 ))_3__functionPtrArray[335 * (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(cmd);
  _3__functionPtrArray[33 - ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))] = _3__functionPtrArray[135];
  num_of_file_pairs = tmp;
  i = (size_t___1 )0;
  while (i < num_of_file_pairs) {
    tmp___0 = ((char *(*)(cmdline_t *cmd___0 , size_t___1 i ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 337 & 3 : 337])(cmd,
                                                                                                                                                      i);
    file1 = (char const   *)tmp___0;
    tmp___1 = ((char *(*)(cmdline_t *cmd___0 , size_t___1 i ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 339 : 4])(cmd,
                                                                                                                                                i);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 135 : 135 * 8] = _3__functionPtrArray[146];
    ...
    ((void (*)(char const   *path1 , char const   *path2 , void (*align___0)(read_t *r1 ,
                                                                             read_t *r2 ) ,
               _Bool use_zlib ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? r15 : 340])(file1,
                                                                                                                    file2,
                                                                                                                    & align_pair_from_file,
                                                                                                                    (_Bool )(! cmd->interactive));
    i ++;
  }
  ((void (*)(nw_aligner_t *nw___0 ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 341 : r13])(nw);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 175 : 175 - 7] = _3__functionPtrArray[187];
  ((void (*)(alignment_t *result ))_3__functionPtrArray[343 * ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(result);
  _3__functionPtrArray[270 - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)] = _3__functionPtrArray[158];
  ((void (*)(cmdline_t *cmd___0 ))_3__functionPtrArray[344 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(cmd);
  return (0);
}
}
...
{ 
  ...
  while (1) {
    c = fgetc_buf(sf->f_file, & sf->in);
    if (c != -1) {
      tmp = ((int (*)(int  ))_3__functionPtrArray[39 + ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2))])(c);
      if (! tmp) {
        break;
      }
    } else {
...
{ 
  ...
  while (1) {
    c = fgetc_buf(sf->f_file, & sf->in);
    if (c != -1) {
      tmp = ((int (*)(int  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? c : 46])(c);
      if (! tmp) {
        break;
      }
    } else {
...
{ 
  ...
  while (in->end > in->begin) {
    ...
    buffered = offset - in->begin;
    cbuf_capacity(buf, size, *len + buffered);
    ((void *(*)(void * __restrict   , void const   * __restrict   , size_t___1  ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 9 : 324])((void */* __restrict  */)(*buf + *len),
                                                                                                                                                                    (void const   */* __restrict  */)(in->b + in->begin),
                                                                                                                                                                    buffered);
    _3__functionPtrArray[_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2 ? 165 : 165 & 3] = _3__functionPtrArray[108];
    *len += buffered;
    in->begin = offset;
    total_read += buffered;
    if ((int )*(*buf + (*len - 1UL)) == 10) {
...
{ 
  ...
  origlen = *len;
  while (1) {
    tmp___3 = ((char *(*)(gzFile file , char *buf , int len ))_3__functionPtrArray[320 - ! (_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2)])(file,
                                                                                                                                                *buf + *len,
                                                                                                                                                (int )r);
    if (! ((unsigned long )tmp___3 != (unsigned long )((void *)0))) {
      break;
    }
    tmp___0 = ((size_t___1 (*)(char const   * ))_3__functionPtrArray[321 * ((_1_main_1_opaque_ptr_1 == _1_main_1_opaque_ptr_2) - (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((char const   *)(*buf + *len));
    *len += tmp___0;
    if ((int )*(*buf + (*len - 1UL)) == 10) {
      return (*len - origlen);
    } else {
      tmp___1 = *size * 2UL;
      *size = tmp___1;
      tmp___2 = ((void *(*)(void * , unsigned long  ))_3__functionPtrArray[322 + ((_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2) + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2))])((void *)*buf,
                                                                                                                                                                                             tmp___1);
      *buf = (char *)tmp___2;
    }
    if (*size - *len > 4294967295UL) {
...
{ 
  ...
  mem = hist->hits_capacity * sizeof(*(hist->sorted_match_indices));
  tmp = ((void *(*)(unsigned long  ))_3__functionPtrArray[17 + (_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2)])(mem);
  _3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 11 << 0 : 11] = _3__functionPtrArray[6];
  hist->sorted_match_indices = (size_t___1 *)tmp;
  return;
}
}
...
{ 
  ...
  if (buf_size) {
    ...
    if (! tmp) {
      ((void (*)(void * ))_3__functionPtrArray[_1_main_1_opaque_ptr_1 != _1_main_1_opaque_ptr_2 ? 4 : 53])((void *)sf);
      return ((char)0);
    }
    if (use_zlib) {
