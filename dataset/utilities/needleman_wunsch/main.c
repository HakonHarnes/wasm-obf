...
#line 325
                                  if (tmp___39 == 0) {
#line 328
                                    cmdline_add_files(cmd___0, "", (char *)((void *)0));
#line 329
...
extern void alignment_print_spacer(char const   *alignment_a , char const   *alignment_b ,
                                   scoring_t const   *scoring ) ;
#line 24 "src/tools/nw_cmdline.c"
cmdline_t *cmd  ;
#line 25 "src/tools/nw_cmdline.c"
scoring_t scoring  ;
#line 28 "src/tools/nw_cmdline.c"
nw_aligner_t *nw  ;
#line 29 "src/tools/nw_cmdline.c"
alignment_t *result  ;
#line 31 "src/tools/nw_cmdline.c"
...
#line 36 "src/tools/nw_cmdline.c"
...
#line 49
  num_of_indels = 0;
#line 52
  printf((char const   * __restrict  )"Br1:%s\n    ", result->result_a);
#line 54
  i = 0;
#line 54
  while ((int )*(result->result_a + i) != 0) {
...
#line 74
  printf((char const   * __restrict  )"\nBr2:%s\n%i %i\n\n", result->result_b, num_of_mismatches,
         num_of_indels);
#line 76
  return;
}
}
#line 78 "src/tools/nw_cmdline.c"
...
#line 143
  if (cmd->print_scores) {
#line 144
    printf((char const   * __restrict  )"score: %i\n", result->score);
  }
#line 147
  putc('\n', (FILE *)stdout);
#line 148
...
#line 151 "src/tools/nw_cmdline.c"
...
#line 158 "src/tools/nw_cmdline.c"
