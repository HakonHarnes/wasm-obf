...
/* Generated by Tigress v3.2 (https://tigress.wtf), 07:50:44-2023/04/23 */
...
{ 
  ...
  if (((unsigned int )(~ tmp___3 & (tmp___3 - 1)) >> 31U) & 1) {
  ...
  while (1) {
    l = kseq_read(seq);
    if (! (((unsigned int )(~ l) >> 31U) & 1)) {
      break;
    }
    printf((char const   */* __restrict  */)">%s", seq->name.s);
    i = 0;
    while (((unsigned int )((i - l) ^ ((i ^ l) & ((i - l) ^ i))) >> 31U) & 1) {
      b = (int )*(seq->seq.s + i);
      c = (int )seq_nt16_table[b];
      a = bitcnt_table[c];
      if (((unsigned int )((((a - 2) ^ ((a - 2) >> 31)) - ((a - 2) >> 31)) - 1) >> 31U) & 1) {
        tmp___4 = drand48();
        m = tmp___4 < 0.5;
        k = 0;
        j = k;
        while (((unsigned int )((((4 - j) & - (4 >= j)) >> 31) - (((4 - j) & - (4 >= j)) ^ (((4 - j) & - (4 >= j)) >> 31))) >> 31U) & 1) {
          if (((unsigned int )((((((~ (1 << j) | c) + (1 << j)) + 1) + (1 << 31)) ^ (((((~ (1 << j) | c) + (1 << j)) + 1) + (1 << 31)) >> 31)) - (((((~ (1 << j) | c) + (1 << j)) + 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
            goto __Cont;
          }
          if (((unsigned int )((((k - m) + ((k - m) >> 31)) ^ ((k - m) >> 31)) - 1) >> 31U) & 1) {
            break;
          }
          k = (k - ~ 1) - 1;
          __Cont: 
      ...
      if (((unsigned int )(~ (i % 60 | - (i % 60))) >> 31U) & 1) {
        putchar('\n');
      }
...
{ 
  ...
  tmp = kh_init_reg();
  h = tmp;
  if (((unsigned int )((((3 - argc) & - (3 >= argc)) >> 31) - (((3 - argc) & - (3 >= argc)) ^ (((3 - argc) & - (3 >= argc)) >> 31))) >> 31U) & 1) {
  ...
  while (1) {
    ...
    if (! (((unsigned int )(~ tmp___12) >> 31U) & 1)) {
      break;
    }
    ...
    if ((int )((((((k - h->n_buckets) + (1U << 31)) ^ ((int )((k - h->n_buckets) + (1U << 31)) >> 31)) - ((int )((k - h->n_buckets) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
      k = kh_put_reg(h, (kh_cstr_t )s, & ret);
      memset((void *)(h->vals + k), 0, sizeof(reglist_t ));
    }
    p = h->vals + k;
    tmp___8 = ks_getuntil(ks, 0, str, & dret);
    if (((unsigned int )(tmp___8 ^ (((tmp___8 << 1) & (tmp___8 >> 31)) - tmp___8)) >> 31U) & 1) {
      tmp___7 = atol((char const   *)str->s);
      beg = (int )((tmp___7 ^ 1L) - ((~ tmp___7 & 1L) + (~ tmp___7 & 1L)));
    }
    ks_getuntil(ks, 0, str, & dret);
    ks_getuntil(ks, 0, str, & dret);
    if (((unsigned int )((dret - 10) | (10 - dret)) >> 31U) & 1) {
      while (1) {
        dret = ks_getc(ks);
        if (((unsigned int )(dret ^ (((dret + dret) & (dret >> 31)) - dret)) >> 31U) & 1) {
          if (! (((unsigned int )((dret - 10) | (10 - dret)) >> 31U) & 1)) {
            break;
          }
        } else {
    ...
    if (tmp___11) {
      if ((int )((((((str->l - 1UL) + (1UL << 31)) ^ ((long )((str->l - 1UL) + (1UL << 31)) >> 31L)) - ((long )((str->l - 1UL) + (1UL << 31)) >> 31L)) >> 31UL) & 1UL)) {
        if (((unsigned int )((((p->n - p->m) + (1 << 31)) + (((p->n - p->m) + (1 << 31)) >> 31)) ^ (((p->n - p->m) + (1 << 31)) >> 31)) >> 31U) & 1) {
          if (p->m) {
            p->m <<= 1;
          } else {
            p->m = 4;
          }
          tmp___9 = realloc((void *)p->a, (size_t___0 )((p->m & 8) * (p->m | 8) + (p->m & ~ 8) * (~ p->m & 8)));
          p->a = (uint64_t *)tmp___9;
        }
        tmp___10 = p->n;
        p->n = (p->n - ~ 1) - 1;
        *(p->a + tmp___10) = ((((uint64_t )beg << 32) + (unsigned long long )*(str->s + 0)) + 1ULL) + ((- ((uint64_t )beg << 32) - 1ULL) | (- ((unsigned long long )*(str->s + 0)) - 1ULL));
      }
    }
  }
  ks_destroy(ks);
  ...
  while (1) {
    ...
    if ((int )((((((k - h->n_buckets) << 1U) & ((int )(k - h->n_buckets) >> 31)) - (k - h->n_buckets)) >> 31U) & 1U)) {
      p___0 = h->vals + k;
      i = 0;
      while (((unsigned int )((i & ~ p___0->n) | (~ (i ^ p___0->n) & (i - p___0->n))) >> 31U) & 1) {
        beg___0 = (int )(*(p___0->a + i) >> 32);
        if ((int )((((~ ((size_t___0 )beg___0) & seq->seq.l) | (~ ((size_t___0 )beg___0 ^ seq->seq.l) & ((size_t___0 )beg___0 - seq->seq.l))) >> 31UL) & 1UL)) {
    ...
    i = 0;
    while (((unsigned int )((i - l) ^ ((i ^ l) & ((i - l) ^ i))) >> 31U) & 1) {
      if (((unsigned int )(~ (i % 60) & (i % 60 - 1)) >> 31U) & 1) {
        putchar('\n');
      }
      putchar((int )*(seq->seq.s + i));
      i = (i ^ 1) + ((i & 1) + (i & 1));
  ...
  gzclose(fp);
  k = (khint_t )0;
  while ((int )((((~ k & h->n_buckets) | ((~ k | h->n_buckets) & (k - h->n_buckets))) >> 31U) & 1U)) {
    if (! ((~ (*(h->flags + (k >> 4)) >> ((((~ k | 15U) + k) + 1U) << 1)) | 3U) - ~ (*(h->flags + (k >> 4)) >> ((((~ k | 15U) + k) + 1U) << 1)))) {
...
{ 
  ...
  kr->mt[0] = seed;
  kr->mti = 1;
  while (((unsigned int )((kr->mti - 312) ^ ((kr->mti ^ 312) & ((kr->mti - 312) ^ kr->mti))) >> 31U) & 1) {
    kr->mt[kr->mti] = ((((6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (6364136223846793005ULL | ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) + (6364136223846793005ULL & ~ ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (~ 6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62))))) ^ ~ ((unsigned long long )kr->mti)) + ((((6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (6364136223846793005ULL | ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) + (6364136223846793005ULL & ~ ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (~ 6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62))))) | (unsigned long long )kr->mti) + (((6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (6364136223846793005ULL | ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) + (6364136223846793005ULL & ~ ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62)))) * (~ 6364136223846793005ULL & ((kr->mt[kr->mti - 1] | (kr->mt[kr->mti - 1] >> 62)) - (kr->mt[kr->mti - 1] & (kr->mt[kr->mti - 1] >> 62))))) | (unsigned long long )kr->mti))) + 1ULL;
    kr->mti = (kr->mti ^ 1) + ((kr->mti & 1) + (kr->mti & 1));
  }
  return;
}
}
...
{ 
  ...
  {
  if (((unsigned int )((((argc - 1) + (1 << 31)) + (((argc - 1) + (1 << 31)) >> 31)) ^ (((argc - 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
  ...
  while (1) {
    ...
    while (((unsigned int )((i - l) ^ ((i ^ l) & ((i - l) ^ i))) >> 31U) & 1) {
      b = (int )*(seq->seq.s + i);
      if (((unsigned int )(((bitcnt_table[seq_nt16_table[b]] - 2) + (1 << 31)) - ((((bitcnt_table[seq_nt16_table[b]] - 2) + (1 << 31)) << 1) & (((bitcnt_table[seq_nt16_table[b]] - 2) + (1 << 31)) >> 31))) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )(((tmp___37 ^ (tmp___37 >> 31)) - (tmp___37 >> 31)) - 1) >> 31U) & 1) {
    tmp___0 = stk_comp(((argc & ~ 1) + (argc & ~ 1)) - (argc ^ 1), argv + 1);
    return (tmp___0);
  } else {
    tmp___36 = strcmp((char const   *)*(argv + 1), "fqchk");
    if (((unsigned int )(((tmp___36 + (1 << 31)) + ((tmp___36 + (1 << 31)) >> 31)) ^ ((tmp___36 + (1 << 31)) >> 31)) >> 31U) & 1) {
      tmp___1 = stk_fqchk(((argc & ~ 1) + (argc & ~ 1)) - (argc ^ 1), argv + 1);
      return (tmp___1);
    } else {
      tmp___35 = strcmp((char const   *)*(argv + 1), "hety");
      if (((unsigned int )(((tmp___35 + (1 << 31)) + ((tmp___35 + (1 << 31)) >> 31)) ^ ((tmp___35 + (1 << 31)) >> 31)) >> 31U) & 1) {
        tmp___2 = stk_hety((argc & ~ 1) - (~ argc & 1), argv + 1);
        return (tmp___2);
      } else {
        tmp___34 = strcmp((char const   *)*(argv + 1), "gc");
        if (((unsigned int )(~ tmp___34 & (tmp___34 - 1)) >> 31U) & 1) {
          tmp___3 = stk_gc((argc + ~ 1) + 1, argv + 1);
          return (tmp___3);
        } else {
          tmp___33 = strcmp((char const   *)*(argv + 1), "subseq");
          if (((unsigned int )(((tmp___33 ^ (tmp___33 >> 31)) - (tmp___33 >> 31)) - 1) >> 31U) & 1) {
            tmp___4 = stk_subseq(((argc & ~ 1) << 1) - (argc ^ 1), argv + 1);
            return (tmp___4);
          } else {
            tmp___32 = strcmp((char const   *)*(argv + 1), "mutfa");
            if (((unsigned int )(((tmp___32 ^ (tmp___32 >> 31)) - (tmp___32 >> 31)) - 1) >> 31U) & 1) {
              tmp___5 = stk_mutfa((argc & ~ 1) - (~ argc & 1), argv + 1);
              return (tmp___5);
            } else {
              tmp___31 = strcmp((char const   *)*(argv + 1), "mergefa");
              if (((unsigned int )(((tmp___31 + (tmp___31 >> 31)) ^ (tmp___31 >> 31)) - 1) >> 31U) & 1) {
                tmp___6 = stk_mergefa((argc + ~ 1) + 1, argv + 1);
                return (tmp___6);
              } else {
                tmp___30 = strcmp((char const   *)*(argv + 1), "mergepe");
                if (((unsigned int )(((tmp___30 + (1 << 31)) + ((tmp___30 + (1 << 31)) >> 31)) ^ ((tmp___30 + (1 << 31)) >> 31)) >> 31U) & 1) {
                  tmp___7 = stk_mergepe((argc & ~ 1) - (~ argc & 1), argv + 1);
                  return (tmp___7);
                } else {
                  tmp___29 = strcmp((char const   *)*(argv + 1), "dropse");
                  if (((unsigned int )(((tmp___29 + (1 << 31)) + ((tmp___29 + (1 << 31)) >> 31)) ^ ((tmp___29 + (1 << 31)) >> 31)) >> 31U) & 1) {
                    tmp___8 = stk_dropse(((argc & ~ 1) << 1) - (argc ^ 1), argv + 1);
                    return (tmp___8);
                  } else {
                    tmp___28 = strcmp((char const   *)*(argv + 1), "randbase");
                    if (((unsigned int )(~ (tmp___28 | - tmp___28)) >> 31U) & 1) {
                      tmp___9 = stk_randbase(((argc & ~ 1) + (argc & ~ 1)) - (argc ^ 1),
                                             argv + 1);
                      return (tmp___9);
                    } else {
                      tmp___27 = strcmp((char const   *)*(argv + 1), "cutN");
                      if (((unsigned int )(~ (tmp___27 | - tmp___27)) >> 31U) & 1) {
                        tmp___10 = stk_cutN((argc & ~ 1) - (~ argc & 1), argv + 1);
                        return (tmp___10);
                      } else {
                        tmp___26 = strcmp((char const   *)*(argv + 1), "listhet");
                        if (((unsigned int )(~ tmp___26 & (tmp___26 - 1)) >> 31U) & 1) {
                          tmp___11 = stk_listhet((argc & ~ 1) - (~ argc & 1), argv + 1);
                          return (tmp___11);
                        } else {
                          tmp___25 = strcmp((char const   *)*(argv + 1), "famask");
                          if (((unsigned int )(~ tmp___25 & (tmp___25 - 1)) >> 31U) & 1) {
                            tmp___12 = stk_famask((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)),
                                                  argv + 1);
                            return (tmp___12);
                          } else {
                            tmp___24 = strcmp((char const   *)*(argv + 1), "trimfq");
                            if (((unsigned int )(~ tmp___24 & (tmp___24 - 1)) >> 31U) & 1) {
                              tmp___13 = stk_trimfq((argc + ~ 1) + 1, argv + 1);
                              return (tmp___13);
                            } else {
                              tmp___23 = strcmp((char const   *)*(argv + 1), "hrun");
                              if (((unsigned int )(~ (tmp___23 | - tmp___23)) >> 31U) & 1) {
                                tmp___14 = stk_hrun((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)),
                                                    argv + 1);
                                return (tmp___14);
                              } else {
                                tmp___22 = strcmp((char const   *)*(argv + 1), "sample");
                                if (((unsigned int )((tmp___22 - ((tmp___22 + tmp___22) & (tmp___22 >> 31))) - 1) >> 31U) & 1) {
                                  tmp___15 = stk_sample((argc + ~ 1) + 1, argv + 1);
                                  return (tmp___15);
                                } else {
                                  tmp___21 = strcmp((char const   *)*(argv + 1), "seq");
                                  if (((unsigned int )(((tmp___21 + (1 << 31)) + ((tmp___21 + (1 << 31)) >> 31)) ^ ((tmp___21 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                    tmp___16 = stk_seq((argc ^ 1) - ((~ argc & 1) + (~ argc & 1)),
                                                       argv + 1);
                                    return (tmp___16);
                                  } else {
                                    tmp___20 = strcmp((char const   *)*(argv + 1),
                                                      "kfreq");
                                    if (((unsigned int )((tmp___20 + (1 << 31)) - (((tmp___20 + (1 << 31)) + (tmp___20 + (1 << 31))) & ((tmp___20 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                      tmp___17 = stk_kfreq(((argc & ~ 1) << 1) - (argc ^ 1),
                                                           argv + 1);
                                      return (tmp___17);
                                    } else {
                                      tmp___19 = strcmp((char const   *)*(argv + 1),
                                                        "rename");
                                      if (((unsigned int )(((tmp___19 + (1 << 31)) ^ ((tmp___19 + (1 << 31)) >> 31)) - ((tmp___19 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                        tmp___18 = stk_rename((argc & ~ 1) - (~ argc & 1),
                                                              argv + 1);
                                        return (tmp___18);
                                      } else {
...
{ 
  ...
  if (((unsigned int )(((optind - argc) + (1 << 31)) - ((((optind - argc) + (1 << 31)) + ((optind - argc) + (1 << 31))) & (((optind - argc) + (1 << 31)) >> 31))) >> 31U) & 1) {
  ...
  seq = kseq_init(fp);
  i = 0;
  while (((unsigned int )((i - 128) ^ ((i ^ 128) & ((i - 128) ^ i))) >> 31U) & 1) {
    q_int2real[i] = pow(10., (double )(~ (((i & ~ 33) << 1) - (i ^ 33)) + 1) / 10.);
    i = ((i ^ ~ 1) + ((i | 1) << 1)) + 1;
  }
  while (1) {
    tmp___6 = kseq_read(seq);
    if (! (((unsigned int )(~ tmp___6) >> 31U) & 1)) {
      break;
    }
    if (left) {
      goto _L;
    ...
    if (((unsigned int )(fixed_len ^ ((fixed_len >> 31) - (fixed_len ^ (fixed_len >> 31)))) >> 31U) & 1) {
      _L: 
      beg = left;
      end = (int )(((seq->seq.l & ~ ((size_t___0 )right)) << 1UL) - (seq->seq.l ^ (size_t___0 )right));
      if (((unsigned int )((~ (end ^ beg) >> 1) + (end & ~ beg)) >> 31U) & 1) {
        end = 0;
        beg = end;
      }
      if (((unsigned int )((fixed_len >> 1) - fixed_len) >> 31U) & 1) {
        if (((unsigned int )((fixed_len & ~ ((end & ~ beg) - (~ end & beg))) | (~ (fixed_len ^ ((end & ~ beg) - (~ end & beg))) & (fixed_len - ((end & ~ beg) - (~ end & beg))))) >> 31U) & 1) {
          end = ((beg ^ ~ fixed_len) + ((beg | fixed_len) << 1)) + 1;
        }
      }
    } else
    if ((int )((((~ ((size_t___0 )min_len) & seq->qual.l) | ((~ ((size_t___0 )min_len) | seq->qual.l) & ((size_t___0 )min_len - seq->qual.l))) >> 31UL) & 1UL)) {
      i = 0;
      tmp___4 = 0;
      beg = tmp___4;
      end = (int )seq->qual.l;
      max = 0.;
      s = max;
      while ((int )((((~ ((size_t___0 )i) & seq->qual.l) | (~ ((size_t___0 )i ^ seq->qual.l) & ((size_t___0 )i - seq->qual.l))) >> 31UL) & 1UL)) {
        q = (int )*(seq->qual.s + i);
        if (((unsigned int )((q & ~ 36) | (~ (q ^ 36) & (q - 36))) >> 31U) & 1) {
          q = 36;
        }
        if (((unsigned int )((127 - q) ^ ((127 ^ q) & ((127 - q) ^ 127))) >> 31U) & 1) {
          q = 127;
        }
      ...
      if (((unsigned int )((((end & ~ beg) - (~ end & beg)) & ~ min_len) | (~ (((end & ~ beg) - (~ end & beg)) ^ min_len) & (((end & ~ beg) - (~ end & beg)) - min_len))) >> 31U) & 1) {
        i = 0;
        is = 0;
        while (((unsigned int )((i - min_len) ^ ((i ^ min_len) & ((i - min_len) ^ i))) >> 31U) & 1) {
          is = (is - ~ ((((int )*(seq->qual.s + i) & ~ 33) + ((int )*(seq->qual.s + i) & ~ 33)) - ((int )*(seq->qual.s + i) ^ 33))) - 1;
          i = (i | 1) + (i & 1);
        }
        imax = is;
        beg = 0;
        while ((int )((((~ ((size_t___0 )i) & seq->qual.l) | (~ ((size_t___0 )i ^ seq->qual.l) & ((size_t___0 )i - seq->qual.l))) >> 31UL) & 1UL)) {
          is = ((is ^ ~ (((int )*(seq->qual.s + i) & ~ ((int )*(seq->qual.s + ((i & ~ min_len) - (~ i & min_len))))) - (~ ((int )*(seq->qual.s + i)) & (int )*(seq->qual.s + ((i & ~ min_len) - (~ i & min_len)))))) + ((is | (((int )*(seq->qual.s + i) & ~ ((int )*(seq->qual.s + ((i & ~ min_len) - (~ i & min_len))))) - (~ ((int )*(seq->qual.s + i)) & (int )*(seq->qual.s + ((i & ~ min_len) - (~ i & min_len)))))) << 1)) + 1;
          if (((unsigned int )((imax - is) ^ ((imax ^ is) & ((imax - is) ^ imax))) >> 31U) & 1) {
            imax = is;
            beg = (((i ^ min_len) - ((~ i & min_len) << 1)) | 1) + (((i ^ min_len) - ((~ i & min_len) << 1)) & 1);
          }
          i = (i - ~ 1) - 1;
        }
        end = (beg ^ min_len) + ((beg & min_len) + (beg & min_len));
      }
    } else {
      beg = 0;
      end = (int )seq->seq.l;
    ...
    fwrite((void const   */* __restrict  */)(seq->seq.s + beg), (size_t___0 )1, (size_t___0 )(((end & ~ beg) << 1) - (end ^ beg)),
           (FILE */* __restrict  */)stdout);
    putchar('\n');
    if (seq->is_fastq) {
      puts("+");
      fwrite((void const   */* __restrict  */)(seq->qual.s + beg), (size_t___0 )1,
             (size_t___0 )((end ^ beg) - ((~ end & beg) << 1)), (FILE */* __restrict  */)stdout);
      putchar('\n');
    }
  }
  kseq_destroy(seq);
...
{ 
  ...
  {
  ks = seq->f;
  if (((unsigned int )(~ seq->last_char & (seq->last_char - 1)) >> 31U) & 1) {
    while (1) {
      c = ks_getc(ks);
      if (((unsigned int )(~ c) >> 31U) & 1) {
  ...
  while (1) {
    ...
    tmp___2 = seq->seq.l;
    seq->seq.l = (seq->seq.l | 1UL) + (seq->seq.l & 1UL);
  ...
  if ((int )((((~ seq->seq.m | ((seq->seq.l | 1UL) + (seq->seq.l & 1UL))) & ((seq->seq.m ^ ((seq->seq.l | 1UL) + (seq->seq.l & 1UL))) | ~ (((seq->seq.l | 1UL) + (seq->seq.l & 1UL)) - seq->seq.m))) >> 31UL) & 1UL)) {
    seq->seq.m = ((seq->seq.l | 2UL) + (seq->seq.l | 2UL)) - (seq->seq.l ^ 2UL);
    seq->seq.m = ((seq->seq.m & ~ 1UL) << 1UL) - (seq->seq.m ^ 1UL);
    seq->seq.m = (seq->seq.m & ~ (seq->seq.m >> 1)) + (seq->seq.m >> 1);
    seq->seq.m = ((seq->seq.m + (seq->seq.m >> 2)) + 1UL) + ((- seq->seq.m - 1UL) | (- (seq->seq.m >> 2) - 1UL));
    seq->seq.m = ((seq->seq.m + (seq->seq.m >> 4)) + 1UL) + ((- seq->seq.m - 1UL) | (- (seq->seq.m >> 4) - 1UL));
    seq->seq.m = ((seq->seq.m + (seq->seq.m >> 8)) + 1UL) + ((- seq->seq.m - 1UL) | (- (seq->seq.m >> 8) - 1UL));
    seq->seq.m = (seq->seq.m & ~ (seq->seq.m >> 16)) + (seq->seq.m >> 16);
    seq->seq.m = ((seq->seq.m | 1UL) + (seq->seq.m | 1UL)) - (seq->seq.m ^ 1UL);
    tmp___3 = realloc((void *)seq->seq.s, seq->seq.m);
    seq->seq.s = (char *)tmp___3;
  }
  *(seq->seq.s + seq->seq.l) = (char)0;
  seq->is_fastq = ((unsigned int )(~ ((c - 43) | (43 - c))) >> 31U) & 1;
  if (! seq->is_fastq) {
    return ((int )seq->seq.l);
  }
  if ((int )((((~ seq->qual.m & seq->seq.m) | ((~ seq->qual.m | seq->seq.m) & (seq->qual.m - seq->seq.m))) >> 31UL) & 1UL)) {
  ...
  while (1) {
    ...
    if (((unsigned int )(~ tmp___5) >> 31U) & 1) {
      if ((int )((((~ seq->qual.l & seq->seq.l) | ((~ seq->qual.l | seq->seq.l) & (seq->qual.l - seq->seq.l))) >> 31UL) & 1UL)) {
        tmp___6 = 1;
      } else {
        tmp___6 = 0;
      }
  ...
  if (((unsigned int )(~ ((c - -3) | (-3 - c))) >> 31U) & 1) {
    return (-3);
  }
  seq->last_char = 0;
  if ((int )((((seq->seq.l - seq->qual.l) | (seq->qual.l - seq->seq.l)) >> 31UL) & 1UL)) {
    return (-2);
  }
  return ((int )seq->seq.l);
}
...
{ 
  ...
  {
  if (((unsigned int )((312 | ~ kr->mti) & ((312 ^ kr->mti) | ~ (kr->mti - 312))) >> 31U) & 1) {
    if (((unsigned int )((((kr->mti - 313) + ((kr->mti - 313) >> 31)) ^ ((kr->mti - 313) >> 31)) - 1) >> 31U) & 1) {
      kr_srand0(5489ULL, kr);
    }
    i = 0;
    while (((unsigned int )((i - 156) ^ ((i ^ 156) & ((i - 156) ^ i))) >> 31U) & 1) {
      x = (((((~ kr->mt[i] | 0xffffffff80000000ULL) + kr->mt[i]) + 1ULL) + ((~ kr->mt[i + 1] | 2147483647ULL) - ~ kr->mt[i + 1])) + 1ULL) + ((- (((~ kr->mt[i] | 0xffffffff80000000ULL) + kr->mt[i]) + 1ULL) - 1ULL) | (- ((~ kr->mt[i + 1] | 2147483647ULL) - ~ kr->mt[i + 1]) - 1ULL));
      kr->mt[i] = (((((kr->mt[i + 156] - (x >> 1)) - ((kr->mt[i + 156] | ~ (x >> 1)) << 1ULL)) - 2ULL) - (unsigned long long )mag01[(int )(x & 1ULL)]) - (((((kr->mt[i + 156] - (x >> 1)) - ((kr->mt[i + 156] | ~ (x >> 1)) << 1ULL)) - 2ULL) | ~ ((unsigned long long )mag01[(int )(x & 1ULL)])) + ((((kr->mt[i + 156] - (x >> 1)) - ((kr->mt[i + 156] | ~ (x >> 1)) << 1ULL)) - 2ULL) | ~ ((unsigned long long )mag01[(int )(x & 1ULL)])))) - 2ULL;
      i = (i | 1) + (i & 1);
    }
    while (((unsigned int )((i & ~ 311) | (~ (i ^ 311) & (i - 311))) >> 31U) & 1) {
      x = (((((~ kr->mt[i] | 0xffffffff80000000ULL) + kr->mt[i]) + 1ULL) + (((~ kr->mt[i + 1] | 2147483647ULL) + kr->mt[i + 1]) + 1ULL)) + 1ULL) + ((- (((~ kr->mt[i] | 0xffffffff80000000ULL) + kr->mt[i]) + 1ULL) - 1ULL) | (- (((~ kr->mt[i + 1] | 2147483647ULL) + kr->mt[i + 1]) + 1ULL) - 1ULL));
      kr->mt[i] = (((kr->mt[i + -156] | (x >> 1)) - (kr->mt[i + -156] & (x >> 1))) | (unsigned long long )mag01[(int )(x & 1ULL)]) - (((kr->mt[i + -156] | (x >> 1)) - (kr->mt[i + -156] & (x >> 1))) & (unsigned long long )mag01[(int )(x & 1ULL)]);
      i = (i - ~ 1) - 1;
    }
    x = ((((~ kr->mt[311] | 0xffffffff80000000ULL) - ~ kr->mt[311]) + (((~ kr->mt[0] | 2147483647ULL) + kr->mt[0]) + 1ULL)) + 1ULL) + ((- ((~ kr->mt[311] | 0xffffffff80000000ULL) - ~ kr->mt[311]) - 1ULL) | (- (((~ kr->mt[0] | 2147483647ULL) + kr->mt[0]) + 1ULL) - 1ULL));
    kr->mt[311] = ((((kr->mt[155] - (x >> 1)) - ((kr->mt[155] | ~ (x >> 1)) + (kr->mt[155] | ~ (x >> 1)))) - 2ULL) | (unsigned long long )mag01[(int )(x & 1ULL)]) - ((((kr->mt[155] - (x >> 1)) - ((kr->mt[155] | ~ (x >> 1)) + (kr->mt[155] | ~ (x >> 1)))) - 2ULL) & (unsigned long long )mag01[(int )(x & 1ULL)]);
    kr->mti = 0;
  }
  tmp = kr->mti;
  kr->mti = ((kr->mti ^ ~ 1) + ((kr->mti | 1) + (kr->mti | 1))) + 1;
  x = kr->mt[tmp];
  x = (x | ((~ (x >> 29) | 6148914691236517205ULL) - ~ (x >> 29))) - (x & ((~ (x >> 29) | 6148914691236517205ULL) - ~ (x >> 29)));
  x = ((x - ((~ (x << 17) | 8202884508482404352ULL) - ~ (x << 17))) - ((x | ~ ((~ (x << 17) | 8202884508482404352ULL) - ~ (x << 17))) + (x | ~ ((~ (x << 17) | 8202884508482404352ULL) - ~ (x << 17))))) - 2ULL;
  x = (x | (((~ (x << 37) | 0xfff7eee000000000ULL) + (x << 37)) + 1ULL)) - (x & (((~ (x << 37) | 0xfff7eee000000000ULL) + (x << 37)) + 1ULL));
  x = ((x - (x >> 43)) - ((x | ~ (x >> 43)) << 1ULL)) - 2ULL;
  return (x);
}
}
...
{ 
  ...
  putchar(tmp);
  if ((int )(((unsigned long long )(~ n) >> 63ULL) & 1LL)) {
    if (prefix) {
...
{ 
  ...
  if (h) {
    s ++;
    while (*s) {
      h = (((((h << 5) + ~ h) + 1U) | (khint_t )*s) << 1U) - ((((h << 5) + ~ h) + 1U) ^ (khint_t )*s);
      s ++;
    }
  }
  return (h);
...
{ 
  ...
  {
  if ((int )((((~ h->upper_bound | h->n_occupied) & ((h->upper_bound ^ h->n_occupied) | ~ (h->n_occupied - h->upper_bound))) >> 31U) & 1U)) {
    if ((int )((((~ (h->size << 1) & h->n_buckets) | ((~ (h->size << 1) | h->n_buckets) & ((h->size << 1) - h->n_buckets))) >> 31U) & 1U)) {
      kh_resize_reg(h, ((h->n_buckets & ~ 1U) + (h->n_buckets & ~ 1U)) - (h->n_buckets ^ 1U));
    } else {
      kh_resize_reg(h, (h->n_buckets | 1U) + (h->n_buckets & 1U));
    }
  }
  mask = (h->n_buckets ^ 1U) - ((~ h->n_buckets & 1U) + (~ h->n_buckets & 1U));
  site = h->n_buckets;
  x = site;
  k = __ac_X31_hash_string(key);
  i = ((~ k | mask) + k) + 1U;
  if (((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) + (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) + 1U) {
    x = i;
  } else {
    inc = (~ (((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) + 1U) + 1U) + ((- ((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) - 1U) | (- 1U - 1U))) | mask) - ~ (((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) + 1U) + 1U) + ((- ((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) - 1U) | (- 1U - 1U)));
    last = i;
    while (1) {
      if (! (((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) + (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) + 1U)) {
        if (! ((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 1U) - ~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)))) {
          tmp = strcmp(*(h->keys + i), key);
          if (((unsigned int )((tmp + (1 << 31)) - (((tmp + (1 << 31)) + (tmp + (1 << 31))) & ((tmp + (1 << 31)) >> 31))) >> 31U) & 1) {
            break;
          }
        }
      } else {
      ...
      if (((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 1U) + (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U) {
        site = i;
      }
      i = (~ (((i ^ ~ inc) + ((i | inc) << 1U)) + 1U) | mask) - ~ (((i ^ ~ inc) + ((i | inc) << 1U)) + 1U);
      if ((int )((~ ((i - last) | (last - i)) >> 31U) & 1U)) {
        x = site;
        break;
      }
    }
    if ((int )((((((x - h->n_buckets) ^ ((int )(x - h->n_buckets) >> 31)) - ((int )(x - h->n_buckets) >> 31)) - 1U) >> 31U) & 1U)) {
      if ((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 2U) - ~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) {
        if ((int )(((((int )(site - h->n_buckets) >> 31) - ((site - h->n_buckets) ^ ((int )(site - h->n_buckets) >> 31))) >> 31U) & 1U)) {
          x = site;
        } else {
          x = i;
        }
  ...
  if (((~ (*(h->flags + (x >> 4)) >> ((((~ x | 15U) + x) + 1U) << 1)) | 2U) + (*(h->flags + (x >> 4)) >> ((((~ x | 15U) + x) + 1U) << 1))) + 1U) {
    *(h->keys + x) = key;
    *(h->flags + (x >> 4)) = (khint32_t )((unsigned long )*(h->flags + (x >> 4)) - ((unsigned long )*(h->flags + (x >> 4)) & (3UL << (((~ x | 15U) - ~ x) << 1))));
    h->size = (h->size ^ 1U) + ((h->size & 1U) + (h->size & 1U));
    h->n_occupied = (h->n_occupied - ~ 1U) - 1U;
    *ret = 1;
  } else
  if ((~ (*(h->flags + (x >> 4)) >> (((~ x | 15U) - ~ x) << 1)) | 1U) - ~ (*(h->flags + (x >> 4)) >> (((~ x | 15U) - ~ x) << 1))) {
    *(h->keys + x) = key;
    *(h->flags + (x >> 4)) = (khint32_t )((unsigned long )*(h->flags + (x >> 4)) - ((unsigned long )*(h->flags + (x >> 4)) & (3UL << (((~ x | 15U) - ~ x) << 1))));
    h->size = (h->size ^ 1U) + ((h->size & 1U) + (h->size & 1U));
    *ret = 2;
...
{ 
  ...
  if (((unsigned int )(((((2 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (2 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) << 1) & (((2 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (2 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) >> 31)) - ((2 - (((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind))) & - (2 >= ((argc & ~ optind) + (argc & ~ optind)) - (argc ^ optind)))) >> 31U) & 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"Usage: seqtk famask <src.fa> <mask.fa>\n");
    return (1);
  }
  i = 0;
  while (((unsigned int )((i - 2) ^ ((i ^ 2) & ((i - 2) ^ i))) >> 31U) & 1) {
    tmp___3 = strcmp((char const   *)*(argv + ((optind ^ i) + ((optind & i) + (optind & i)))),
                     "-");
    if (tmp___3) {
      tmp___0 = gzopen((char const   *)*(argv + (((optind ^ ~ i) + ((optind | i) + (optind | i))) + 1)),
                       "r");
      fp[i] = tmp___0;
    } else {
      tmp___1 = fileno(stdin);
  ...
  while (1) {
    ...
    if ((int )(((((seq[0])->seq.l - (seq[1])->seq.l) | ((seq[1])->seq.l - (seq[0])->seq.l)) >> 31UL) & 1UL)) {
      fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[%s] Unequal sequence length: %ld != %ld\n",
              "stk_famask", (seq[0])->seq.l, (seq[1])->seq.l);
    }
    if ((int )((((~ (seq[0])->seq.l & (seq[1])->seq.l) | ((~ (seq[0])->seq.l | (seq[1])->seq.l) & ((seq[0])->seq.l - (seq[1])->seq.l))) >> 31UL) & 1UL)) {
    ...
    l = 0;
    while (((unsigned int )((l & ~ min_l) | (~ (l ^ min_l) & (l - min_l))) >> 31U) & 1) {
      c___0[0] = (int )*((seq[0])->seq.s + l);
      c___0[1] = (int )*((seq[1])->seq.s + l);
      if (((unsigned int )(~ ((c___0[1] - 120) | (120 - c___0[1]))) >> 31U) & 1) {
        c___0[0] = tolower(c___0[0]);
      } else
      if (((unsigned int )((c___0[1] - 88) | (88 - c___0[1])) >> 31U) & 1) {
        c___0[0] = c___0[1];
      }
      if (((unsigned int )((l % 60 - ((l % 60 << 1) & (l % 60 >> 31))) - 1) >> 31U) & 1) {
        putchar('\n');
      }
      putchar(c___0[0]);
      l = (l | 1) + (l & 1);
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )(((c - 120) + (1 << 31)) - ((((c - 120) + (1 << 31)) << 1) & (((c - 120) + (1 << 31)) >> 31))) >> 31U) & 1) {
      xdropoff = atof((char const   *)optarg);
    } else
    if (((unsigned int )(((c - 119) + (1 << 31)) - ((((c - 119) + (1 << 31)) + ((c - 119) + (1 << 31))) & (((c - 119) + (1 << 31)) >> 31))) >> 31U) & 1) {
      is_at = 1;
    } else
    if (((unsigned int )(~ ((c - 102) | (102 - c))) >> 31U) & 1) {
      frac = atof((char const   *)optarg);
    } else
    if (((unsigned int )(~ ((c - 108) | (108 - c))) >> 31U) & 1) {
      min_l = atoi((char const   *)optarg);
    }
  }
  if (((unsigned int )((((((optind - ~ 1) - 1) - argc) & - ((optind - ~ 1) - 1 >= argc)) >> 31) - (((((optind - ~ 1) - 1) - argc) & - ((optind - ~ 1) - 1 >= argc)) ^ (((((optind - ~ 1) - 1) - argc) & - ((optind - ~ 1) - 1 >= argc)) >> 31))) >> 31U) & 1) {
  ...
  while (1) {
    ...
    max = 0.;
    i = 0;
    while ((int )((((~ ((size_t___0 )i) & seq->seq.l) | ((~ ((size_t___0 )i) | seq->seq.l) & ((size_t___0 )i - seq->seq.l))) >> 31UL) & 1UL)) {
      c = (int )seq_nt16_table[(int )*(seq->seq.s + i)];
      if (is_at) {
        if (((unsigned int )(((c - 1) - (((c - 1) << 1) & ((c - 1) >> 31))) - 1) >> 31U) & 1) {
          tmp___4 = 1;
        } else
        if (((unsigned int )(~ ((c - 8) | (8 - c))) >> 31U) & 1) {
          tmp___4 = 1;
        } else
        if (((unsigned int )(((c - 9) - (((c - 9) << 1) & ((c - 9) >> 31))) - 1) >> 31U) & 1) {
          tmp___4 = 1;
        } else {
          tmp___4 = 0;
        }
        ...
        if (((unsigned int )((((c - 2) ^ ((c - 2) >> 31)) - ((c - 2) >> 31)) - 1) >> 31U) & 1) {
          tmp___5 = 1;
        } else
        if (((unsigned int )((((c - 4) ^ ((c - 4) >> 31)) - ((c - 4) >> 31)) - 1) >> 31U) & 1) {
          tmp___5 = 1;
        } else
        if (((unsigned int )((((c - 6) + (1 << 31)) + (((c - 6) + (1 << 31)) >> 31)) ^ (((c - 6) + (1 << 31)) >> 31)) >> 31U) & 1) {
          tmp___5 = 1;
        } else {
          tmp___5 = 0;
        }
      ...
      if (sc > (double )0) {
        ...
        if (xdropoff < max - sc) {
          _L: 
          if (((unsigned int )((min_l | ~ ((((max_i ^ 1) + ((max_i & 1) << 1)) + ~ start) + 1)) & ((min_l ^ ((((max_i ^ 1) + ((max_i & 1) << 1)) + ~ start) + 1)) | ~ (((((max_i ^ 1) + ((max_i & 1) << 1)) + ~ start) + 1) - min_l))) >> 31U) & 1) {
            printf((char const   */* __restrict  */)"%s\t%d\t%d\t%d\n", seq->name.s,
                   start, (max_i - ~ 1) - 1, ((((max_hits & ~ start_hits) << 1) - (max_hits ^ start_hits)) | 1) + ((((max_hits & ~ start_hits) << 1) - (max_hits ^ start_hits)) & 1));
          }
          max = (double )0;
          sc = max;
          i = max_i;
    ...
    if (0. < max) {
      if (((unsigned int )((~ (min_l ^ (((((max_i ^ ~ 1) + ((max_i | 1) << 1)) + 1) + ~ start) + 1)) >> 1) + (min_l & ~ (((((max_i ^ ~ 1) + ((max_i | 1) << 1)) + 1) + ~ start) + 1))) >> 31U) & 1) {
        printf((char const   */* __restrict  */)"%s\t%d\t%d\t%d\n", seq->name.s, start,
               ((max_i | 1) + (max_i | 1)) - (max_i ^ 1), (((((max_hits & ~ start_hits) << 1) - (max_hits ^ start_hits)) ^ ~ 1) + (((((max_hits & ~ start_hits) << 1) - (max_hits ^ start_hits)) | 1) + ((((max_hits & ~ start_hits) << 1) - (max_hits ^ start_hits)) | 1))) + 1);
      }
    }
  }
  kseq_destroy(seq);
...
{ 
  ...
  if (((unsigned int )((((argc - optind) + (1 << 31)) + (((argc - optind) + (1 << 31)) >> 31)) ^ (((argc - optind) + (1 << 31)) >> 31)) >> 31U) & 1) {
    tmp = fileno(stdin);
    tmp___0 = isatty(tmp);
    if (tmp___0) {
  ...
  if (((unsigned int )((optind & ~ argc) | (~ (optind ^ argc) & (optind - argc))) >> 31U) & 1) {
  ...
  while (1) {
    ...
    if (h) {
      ...
      k___0 = tmp___7;
      if ((int )((((((int )(k___0 - h->n_buckets) >> 31) - (k___0 - h->n_buckets)) ^ ((int )(k___0 - h->n_buckets) >> 31)) >> 31U) & 1U)) {
        p = h->vals + k___0;
      }
    } else {
      p = & dummy;
    ...
    while (1) {
      if (p) {
        if (! (((unsigned int )((k - p->n) ^ ((k ^ p->n) & ((k - p->n) ^ k))) >> 31U) & 1)) {
          break;
        }
      } else {
        break;
      ...
      beg = (int )(*(p->a + k) >> 32);
      end = (int )(((~ *(p->a + k) | 4294967295ULL) + *(p->a + k)) + 1ULL);
      if (((unsigned int )(- beg & ~ beg) >> 31U) & 1) {
        la = (int )*(seq->seq.s + ((beg + ~ 1) + 1));
      ...
      nc = bitcnt_table[nb];
      memset((void *)(cnt), 0, (11UL & sizeof(int )) * (11UL | sizeof(int )) + (11UL & ~ sizeof(int )) * (~ 11UL & sizeof(int )));
      i = beg;
      while (((unsigned int )((i - end) ^ ((i ^ end) & ((i - end) ^ i))) >> 31U) & 1) {
        is_CpG = 0;
        a = na;
        b = nb;
        c___0 = nc;
        na = (int )*(seq->seq.s + (((i ^ ~ 1) + ((i | 1) << 1)) + 1));
        nb = (int )seq_nt16_table[na];
        nc = bitcnt_table[nb];
        if (((unsigned int )(~ ((b - 2) | (2 - b))) >> 31U) & 1) {
          goto _L___0;
        } else
        if (((unsigned int )(((b - 10) + (1 << 31)) - ((((b - 10) + (1 << 31)) + ((b - 10) + (1 << 31))) & (((b - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
          _L___0: 
          if (((unsigned int )(((nb - 4) + (1 << 31)) - ((((nb - 4) + (1 << 31)) << 1) & (((nb - 4) + (1 << 31)) >> 31))) >> 31U) & 1) {
            is_CpG = 1;
          } else
          if (((unsigned int )(~ ((nb - 5) | (5 - nb))) >> 31U) & 1) {
            is_CpG = 1;
          }
        } else
        if (((unsigned int )(((b - 4) + (1 << 31)) - ((((b - 4) + (1 << 31)) << 1) & (((b - 4) + (1 << 31)) >> 31))) >> 31U) & 1) {
          goto _L;
        } else
        if (((unsigned int )((((b - 5) + ((b - 5) >> 31)) ^ ((b - 5) >> 31)) - 1) >> 31U) & 1) {
          _L: 
          if (((unsigned int )(((lb - 2) + (1 << 31)) - ((((lb - 2) + (1 << 31)) + ((lb - 2) + (1 << 31))) & (((lb - 2) + (1 << 31)) >> 31))) >> 31U) & 1) {
            is_CpG = 1;
          } else
          if (((unsigned int )((((lb - 10) ^ ((lb - 10) >> 31)) - ((lb - 10) >> 31)) - 1) >> 31U) & 1) {
            is_CpG = 1;
          }
        }
        if (((unsigned int )((upper_only + (1 << 31)) - (((upper_only + (1 << 31)) + (upper_only + (1 << 31))) & ((upper_only + (1 << 31)) >> 31))) >> 31U) & 1) {
          goto _L___1;
        } else {
          tmp___8 = isupper(a);
          if (tmp___8) {
            _L___1: 
            if (((unsigned int )((1 & ~ c___0) | (~ (1 ^ c___0) & (1 - c___0))) >> 31U) & 1) {
              cnt[c___0 + 2] = ((cnt[c___0 + 2] | 1) + (cnt[c___0 + 2] | 1)) - (cnt[c___0 + 2] ^ 1);
            }
            if (((unsigned int )(~ ((c___0 - 1) | (1 - c___0))) >> 31U) & 1) {
              cnt[seq_nt16to4_table[b]] = ((cnt[seq_nt16to4_table[b]] ^ ~ 1) + ((cnt[seq_nt16to4_table[b]] | 1) + (cnt[seq_nt16to4_table[b]] | 1))) + 1;
            }
            if (((unsigned int )((((b - 10) + (1 << 31)) + (((b - 10) + (1 << 31)) >> 31)) ^ (((b - 10) + (1 << 31)) >> 31)) >> 31U) & 1) {
              cnt[9] = ((cnt[9] ^ ~ 1) + ((cnt[9] | 1) + (cnt[9] | 1))) + 1;
            } else
            if (((unsigned int )((((b - 5) + ((b - 5) >> 31)) ^ ((b - 5) >> 31)) - 1) >> 31U) & 1) {
              cnt[9] = (cnt[9] ^ 1) + ((cnt[9] & 1) << 1);
            } else
            if (((unsigned int )(~ ((c___0 - 2) | (2 - c___0))) >> 31U) & 1) {
              cnt[8] = (cnt[8] - ~ 1) - 1;
            }
            if (is_CpG) {
              cnt[7] = ((cnt[7] ^ ~ 1) + ((cnt[7] | 1) << 1)) + 1;
              if (((unsigned int )(((b - 10) + (1 << 31)) - ((((b - 10) + (1 << 31)) << 1) & (((b - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
                cnt[10] = ((cnt[10] | 1) << 1) - (cnt[10] ^ 1);
              } else
              if (((unsigned int )(((b - 5) + (1 << 31)) - ((((b - 5) + (1 << 31)) + ((b - 5) + (1 << 31))) & (((b - 5) + (1 << 31)) >> 31))) >> 31U) & 1) {
                cnt[10] = ((cnt[10] | 1) + (cnt[10] | 1)) - (cnt[10] ^ 1);
              }
            }
          }
        }
      ...
      i = 0;
      while (((unsigned int )((i - 11) ^ ((i ^ 11) & ((i - 11) ^ i))) >> 31U) & 1) {
...
{ 
  ...
  while (1) {
    ...
    if (! (((unsigned int )(~ tmp___10) >> 31U) & 1)) {
      break;
    }
    tmp___9 = kseq_read(seq[1]);
    if (((unsigned int )tmp___9 >> 31U) & 1) {
  ...
  if (((unsigned int )(~ tmp___11) >> 31U) & 1) {
...
{ 
  ...
  sum_low = (int64_t )0;
  psum = (double )0;
  if (((unsigned int )(pos | ~ (- pos)) >> 31U) & 1) {
    printf((char const   */* __restrict  */)"ALL");
  } else {
    printf((char const   */* __restrict  */)"%d", pos);
  }
  k = 0;
  while (((unsigned int )((k | ~ 4) & ((k ^ 4) | ~ (4 - k))) >> 31U) & 1) {
    sum = ((sum ^ ~ p->b[k]) + ((sum | p->b[k]) << 1LL)) + 1LL;
    k = (k | 1) + (k & 1);
  }
  ...
  k = 0;
  while (((unsigned int )((~ (k ^ 93) >> 1) + (k & ~ 93)) >> 31U) & 1) {
    qsum = (qsum | ((p->q[k] & (int64_t )k) * (p->q[k] | (int64_t )k) + (p->q[k] & ~ ((int64_t )k)) * (~ p->q[k] & (int64_t )k))) + (qsum & ((p->q[k] & (int64_t )k) * (p->q[k] | (int64_t )k) + (p->q[k] & ~ ((int64_t )k)) * (~ p->q[k] & (int64_t )k)));
    psum += (double )p->q[k] * *(perr + k);
    if (((unsigned int )((k & ~ qthres) | (~ (k ^ qthres) & (k - qthres))) >> 31U) & 1) {
      sum_low = (sum_low | p->q[k]) + (sum_low & p->q[k]);
    }
    k = ((k | 1) << 1) - (k ^ 1);
  }
  ...
  printf((char const   */* __restrict  */)"\t%.1f\t%.1f", (double )qsum / (double )sum,
         - 4.343 * tmp);
  if (((unsigned int )(qthres | (qthres - 1)) >> 31U) & 1) {
    k = 0;
    while (((unsigned int )((k | ~ 93) & ((k ^ 93) | ~ (93 - k))) >> 31U) & 1) {
      if ((int )(((unsigned long long )(- *(allq + k) & ~ *(allq + k)) >> 63ULL) & 1LL)) {
    ...
    printf((char const   */* __restrict  */)"\t%.1f\t%.1f", (100. * (double )sum_low) / (double )sum,
           (100. * (double )((sum ^ sum_low) - ((~ sum & sum_low) << 1LL))) / (double )sum);
  }
  putchar('\n');
  return;
}
...
{ 
  ...
  {
  if (((unsigned int )((argc & ~ 2) | (~ (argc ^ 2) & (argc - 2))) >> 31U) & 1) {
  ...
  kmer = 0;
  i = kmer;
  while (((unsigned int )((i & ~ l) | (~ (i ^ l) & (i - l))) >> 31U) & 1) {
    c = (int )seq_nt6_table[(int )*(*(argv + 1) + i)];
    if (((unsigned int )((~ (1 ^ c) >> 1) + (1 & ~ c)) >> 31U) & 1) {
      if (((unsigned int )((c | ~ 4) & ((c ^ 4) | ~ (4 - c))) >> 31U) & 1) {
        tmp___0 = 1;
      } else {
    ...
    kmer = (((kmer << 2) + ((c ^ 1) - ((~ c & 1) << 1))) + 1) + ((- (kmer << 2) - 1) | (- ((c ^ 1) - ((~ c & 1) << 1)) - 1));
    i = ((i ^ ~ 1) + ((i | 1) << 1)) + 1;
  }
  mask = ((1 << ((2 & l) * (2 | l) + (2 & ~ l) * (~ 2 & l))) & ~ 1) - (~ (1 << ((2 & l) * (2 | l) + (2 & ~ l) * (~ 2 & l))) & 1);
  tmp___1 = calloc((size_t___0 )1, (size_t___0 )(1 << ((2 & l) * (2 | l) + (2 & ~ l) * (~ 2 & l))));
  nei = (char *)tmp___1;
  i = 0;
  while (((unsigned int )((i - l) ^ ((i ^ l) & ((i - l) ^ i))) >> 31U) & 1) {
    x = kmer - (kmer & (3 << ((2 & i) * (2 | i) + (2 & ~ i) * (~ 2 & i))));
    j = 0;
    while (((unsigned int )((j - 4) ^ ((j ^ 4) & ((j - 4) ^ j))) >> 31U) & 1) {
      *(nei + ((x & ~ (j << ((2 & i) * (2 | i) + (2 & ~ i) * (~ 2 & i)))) + (j << ((2 & i) * (2 | i) + (2 & ~ i) * (~ 2 & i))))) = (char)1;
      j = (j ^ 1) + ((j & 1) << 1);
    }
    i = (i ^ 1) + ((i & 1) << 1);
  }
  if (((unsigned int )((((argc - 2) ^ ((argc - 2) >> 31)) - ((argc - 2) >> 31)) - 1) >> 31U) & 1) {
    tmp___3 = fileno(stdin);
    tmp___4 = gzdopen(tmp___3, "r");
    fp = tmp___4;
  } else {
    tmp___6 = strcmp((char const   *)*(argv + 2), "-");
    if (((unsigned int )(~ tmp___6 & (tmp___6 - 1)) >> 31U) & 1) {
      tmp___3 = fileno(stdin);
      tmp___4 = gzdopen(tmp___3, "r");
      fp = tmp___4;
    } else {
  ...
  while (1) {
    ...
    x___0[0] = x___0[1];
    i = 0;
    while ((int )((((~ ((size_t___0 )i) & ks->seq.l) | ((~ ((size_t___0 )i) | ks->seq.l) & ((size_t___0 )i - ks->seq.l))) >> 31UL) & 1UL)) {
      c___0 = (int )seq_nt6_table[(int )*(ks->seq.s + i)];
      if (((unsigned int )((~ (1 ^ c___0) >> 1) + (1 & ~ c___0)) >> 31U) & 1) {
        if (((unsigned int )((c___0 | ~ 4) & ((c___0 ^ 4) | ~ (4 - c___0))) >> 31U) & 1) {
          x___0[0] = (~ (((x___0[0] << 2) & ~ (((c___0 & ~ 1) + (c___0 & ~ 1)) - (c___0 ^ 1))) + (((c___0 & ~ 1) + (c___0 & ~ 1)) - (c___0 ^ 1))) | mask) - ~ (((x___0[0] << 2) & ~ (((c___0 & ~ 1) + (c___0 & ~ 1)) - (c___0 ^ 1))) + (((c___0 & ~ 1) + (c___0 & ~ 1)) - (c___0 ^ 1)));
          x___0[1] = ((x___0[1] >> 2) & ~ (((4 + ~ c___0) + 1) << ((2 & ((l & ~ 1) - (~ l & 1))) * (2 | ((l & ~ 1) - (~ l & 1))) + (2 & ~ ((l & ~ 1) - (~ l & 1))) * (~ 2 & ((l & ~ 1) - (~ l & 1)))))) + (((4 + ~ c___0) + 1) << ((2 & ((l & ~ 1) - (~ l & 1))) * (2 | ((l & ~ 1) - (~ l & 1))) + (2 & ~ ((l & ~ 1) - (~ l & 1))) * (~ 2 & ((l & ~ 1) - (~ l & 1)))));
          if (((unsigned int )(((((l - k) & - (l >= k)) >> 31) - ((l - k) & - (l >= k))) ^ (((l - k) & - (l >= k)) >> 31)) >> 31U) & 1) {
            k = (k - ~ 1) - 1;
          }
          if (((unsigned int )(((k - l) - (((k - l) + (k - l)) & ((k - l) >> 31))) - 1) >> 31U) & 1) {
            if (((unsigned int )(~ ((x___0[0] - kmer) | (kmer - x___0[0]))) >> 31U) & 1) {
              cnt[0] = (cnt[0] | 1) + (cnt[0] & 1);
            } else
            if (((unsigned int )(~ ((x___0[1] - kmer) | (kmer - x___0[1]))) >> 31U) & 1) {
              cnt[1] = (cnt[1] | 1) + (cnt[1] & 1);
            }
            if (*(nei + x___0[0])) {
              cnt_nei[0] = ((cnt_nei[0] | 1) + (cnt_nei[0] | 1)) - (cnt_nei[0] ^ 1);
            } else
            if (*(nei + x___0[1])) {
              cnt_nei[1] = ((cnt_nei[1] ^ ~ 1) + ((cnt_nei[1] | 1) + (cnt_nei[1] | 1))) + 1;
            }
          }
        } else {
          k = 0;
    ...
    if (((unsigned int )((cnt_nei[1] - cnt_nei[0]) ^ ((cnt_nei[1] ^ cnt_nei[0]) & ((cnt_nei[1] - cnt_nei[0]) ^ cnt_nei[1]))) >> 31U) & 1) {
      which = 0;
    } else {
      which = 1;
    }
...
{ 
  ...
  j = (khint_t )1;
  new_n_buckets = (new_n_buckets ^ 1U) - ((~ new_n_buckets & 1U) << 1U);
  new_n_buckets = ((new_n_buckets + (new_n_buckets >> 1)) + 1U) + ((- new_n_buckets - 1U) | (- (new_n_buckets >> 1) - 1U));
  new_n_buckets = (new_n_buckets & ~ (new_n_buckets >> 2)) + (new_n_buckets >> 2);
  new_n_buckets = ((new_n_buckets + (new_n_buckets >> 4)) + 1U) + ((- new_n_buckets - 1U) | (- (new_n_buckets >> 4) - 1U));
  new_n_buckets = ((new_n_buckets + (new_n_buckets >> 8)) + 1U) + ((- new_n_buckets - 1U) | (- (new_n_buckets >> 8) - 1U));
  new_n_buckets = ((new_n_buckets + (new_n_buckets >> 16)) + 1U) + ((- new_n_buckets - 1U) | (- (new_n_buckets >> 16) - 1U));
  new_n_buckets = ((new_n_buckets ^ ~ 1U) + ((new_n_buckets | 1U) + (new_n_buckets | 1U))) + 1U;
  if ((int )((((~ new_n_buckets & 4U) | (~ (new_n_buckets ^ 4U) & (new_n_buckets - 4U))) >> 31U) & 1U)) {
    new_n_buckets = (khint_t )4;
  }
  if ((int )((((~ ((khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5)) | h->size) & (((khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5) ^ h->size) | ~ (h->size - (khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5)))) >> 31U) & 1U)) {
    j = (khint_t )0;
  } else {
    if ((int )((((~ new_n_buckets & 16U) | ((~ new_n_buckets | 16U) & (new_n_buckets - 16U))) >> 31U) & 1U)) {
      tmp = (khint_t )1;
    } else {
      tmp = new_n_buckets >> 4;
    }
    tmp___0 = malloc(((unsigned long )tmp & sizeof(khint32_t )) * ((unsigned long )tmp | sizeof(khint32_t )) + ((unsigned long )tmp & ~ sizeof(khint32_t )) * (~ ((unsigned long )tmp) & sizeof(khint32_t )));
    ...
    memset((void *)new_flags, 170, ((unsigned long )tmp___1 & sizeof(khint32_t )) * ((unsigned long )tmp___1 | sizeof(khint32_t )) + ((unsigned long )tmp___1 & ~ sizeof(khint32_t )) * (~ ((unsigned long )tmp___1) & sizeof(khint32_t )));
    if ((int )((((~ h->n_buckets & new_n_buckets) | ((~ h->n_buckets | new_n_buckets) & (h->n_buckets - new_n_buckets))) >> 31U) & 1U)) {
      tmp___2 = realloc((void *)h->keys, ((unsigned long )new_n_buckets & sizeof(khint64_t )) * ((unsigned long )new_n_buckets | sizeof(khint64_t )) + ((unsigned long )new_n_buckets & ~ sizeof(khint64_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(khint64_t )));
      h->keys = (khint64_t *)tmp___2;
    }
  }
  if (j) {
    j = (khint_t )0;
    while ((int )(((((int )(j - h->n_buckets) >> 31) - ((j - h->n_buckets) ^ ((int )(j - h->n_buckets) >> 31))) >> 31U) & 1U)) {
      if ((~ (*(h->flags + (j >> 4)) >> (((~ j | 15U) - ~ j) << 1)) | 3U) - ~ (*(h->flags + (j >> 4)) >> (((~ j | 15U) - ~ j) << 1)) == 0U) {
        key = *(h->keys + j);
        new_mask = (new_n_buckets & ~ 1U) - (~ new_n_buckets & 1U);
        *(h->flags + (j >> 4)) = (khint32_t )((((unsigned long )*(h->flags + (j >> 4)) + (1UL << ((((~ j | 15U) + j) + 1U) << 1))) + 1UL) + ((- ((unsigned long )*(h->flags + (j >> 4))) - 1UL) | (- (1UL << ((((~ j | 15U) + j) + 1U) << 1)) - 1UL)));
        while (1) {
          k = (khint32_t )((((((key >> 33) | key) - ((key >> 33) & key)) - (key << 11)) - (((((key >> 33) | key) - ((key >> 33) & key)) | ~ (key << 11)) + ((((key >> 33) | key) - ((key >> 33) & key)) | ~ (key << 11)))) - 2ULL);
          i = (~ k | new_mask) - ~ k;
          inc = (~ ((((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) + 1U) + 1U) + ((- (((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) - 1U) | (- 1U - 1U))) | new_mask) - ~ ((((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) + 1U) + 1U) + ((- (((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) - 1U) | (- 1U - 1U)));
          while (! ((~ (*(new_flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) - ~ (*(new_flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)))) {
            i = ((~ (((i | inc) + (i | inc)) - (i ^ inc)) | new_mask) + (((i | inc) + (i | inc)) - (i ^ inc))) + 1U;
          }
          *(new_flags + (i >> 4)) = (khint32_t )(((unsigned long )*(new_flags + (i >> 4)) | (2UL << (((~ i | 15U) - ~ i) << 1))) - (2UL << (((~ i | 15U) - ~ i) << 1)));
          if ((int )((((~ i & h->n_buckets) | ((~ i | h->n_buckets) & (i - h->n_buckets))) >> 31U) & 1U)) {
            if ((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 3U) - ~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) == 0U) {
              tmp___4 = *(h->keys + i);
              *(h->keys + i) = key;
              key = tmp___4;
              *(h->flags + (i >> 4)) = (khint32_t )(((unsigned long )*(h->flags + (i >> 4)) & ~ (1UL << (((~ i | 15U) - ~ i) << 1))) + (1UL << (((~ i | 15U) - ~ i) << 1)));
            } else {
              *(h->keys + i) = key;
              break;
            }
    ...
    if ((int )((((~ new_n_buckets & h->n_buckets) | ((~ new_n_buckets | h->n_buckets) & (new_n_buckets - h->n_buckets))) >> 31U) & 1U)) {
      tmp___6 = realloc((void *)h->keys, ((unsigned long )new_n_buckets & sizeof(khint64_t )) * ((unsigned long )new_n_buckets | sizeof(khint64_t )) + ((unsigned long )new_n_buckets & ~ sizeof(khint64_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(khint64_t )));
...
{ 
  ...
  if (((unsigned int )(~ ((argc - optind) | (optind - argc))) >> 31U) & 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  while (1) {
    ...
    while (1) {
      ...
      if (! (((unsigned int )(~ tmp___4) >> 31U) & 1)) {
        break;
      }
      if (((unsigned int )(((unsigned int )begin >> 1U) - begin) >> 31U) & 1) {
        if (gap_only) {
...
{ 
  ...
  if (((unsigned int )(((argc - (((optind | 2) + (optind | 2)) - (optind ^ 2))) - (((argc - (((optind | 2) + (optind | 2)) - (optind ^ 2))) << 1) & ((argc - (((optind | 2) + (optind | 2)) - (optind ^ 2))) >> 31))) - 1) >> 31U) & 1) {
    min_len = atoi((char const   *)*(argv + (((optind ^ ~ 1) + ((optind | 1) << 1)) + 1)));
  }
  tmp___3 = strcmp((char const   *)*(argv + optind), "-");
  ...
  while (1) {
    ...
    i = 1;
    while ((int )((((~ ((size_t___0 )i) & ks->seq.l) | (~ ((size_t___0 )i ^ ks->seq.l) & ((size_t___0 )i - ks->seq.l))) >> 31UL) & 1UL)) {
      if (((unsigned int )((((int )*(ks->seq.s + i) - c) >> 31) - (((int )*(ks->seq.s + i) - c) ^ (((int )*(ks->seq.s + i) - c) >> 31))) >> 31U) & 1) {
        if (((unsigned int )((~ (min_len ^ l) >> 1) + (min_len & ~ l)) >> 31U) & 1) {
  ...
  if (((unsigned int )((min_len | ~ l) & ((min_len ^ l) | ~ (l - min_len))) >> 31U) & 1) {
    printf((char const   */* __restrict  */)"%s\t%d\t%d\t%c\n", ks->name.s, beg, (beg ^ l) + ((beg & l) + (beg & l)),
           c);
  }
  kseq_destroy(ks);
  gzclose(fp);
...
{ 
  ...
  while (1) {
    if (((unsigned int )ks->end >> 31U) & 1) {
      return (-3);
    }
    if (((unsigned int )((ks->end | ~ ks->begin) & ((ks->end ^ ks->begin) | ~ (ks->begin - ks->end))) >> 31U) & 1) {
      if (! ks->is_eof) {
        ks->begin = 0;
        ks->end = gzread(ks->f, (voidp )ks->buf, 16384U);
        if (((unsigned int )(((ks->end + (1 << 31)) ^ ((ks->end + (1 << 31)) >> 31)) - ((ks->end + (1 << 31)) >> 31)) >> 31U) & 1) {
          ks->is_eof = 1;
          break;
        }
        if (((unsigned int )(((ks->end - -1) - (((ks->end - -1) << 1) & ((ks->end - -1) >> 31))) - 1) >> 31U) & 1) {
          ks->is_eof = 1;
          return (-3);
        }
      } else {
    ...
    if (((unsigned int )((((delimiter - 2) + (1 << 31)) ^ (((delimiter - 2) + (1 << 31)) >> 31)) - (((delimiter - 2) + (1 << 31)) >> 31)) >> 31U) & 1) {
      i = ks->begin;
      while (((unsigned int )((i & ~ ks->end) | (~ (i ^ ks->end) & (i - ks->end))) >> 31U) & 1) {
        if (((unsigned int )((((int )*(ks->buf + i) - 10) + (1 << 31)) - (((((int )*(ks->buf + i) - 10) + (1 << 31)) << 1) & ((((int )*(ks->buf + i) - 10) + (1 << 31)) >> 31))) >> 31U) & 1) {
          break;
        }
        i = (i | 1) + (i & 1);
      }
    } else
    if (((unsigned int )(((((delimiter - 2) & - (delimiter >= 2)) + ((delimiter - 2) & - (delimiter >= 2))) & (((delimiter - 2) & - (delimiter >= 2)) >> 31)) - ((delimiter - 2) & - (delimiter >= 2))) >> 31U) & 1) {
      i = ks->begin;
      while (((unsigned int )((i - ks->end) ^ ((i ^ ks->end) & ((i - ks->end) ^ i))) >> 31U) & 1) {
        if (((unsigned int )(((((int )*(ks->buf + i) - delimiter) ^ (((int )*(ks->buf + i) - delimiter) >> 31)) - (((int )*(ks->buf + i) - delimiter) >> 31)) - 1) >> 31U) & 1) {
          break;
        }
        i = ((i ^ ~ 1) + ((i | 1) + (i | 1))) + 1;
      }
    } else
    if (((unsigned int )(((delimiter + (1 << 31)) + ((delimiter + (1 << 31)) >> 31)) ^ ((delimiter + (1 << 31)) >> 31)) >> 31U) & 1) {
      i = ks->begin;
      while (((unsigned int )((((ks->end - i) & - (ks->end >= i)) >> 31) - (((ks->end - i) & - (ks->end >= i)) ^ (((ks->end - i) & - (ks->end >= i)) >> 31))) >> 31U) & 1) {
    ...
    if (((unsigned int )(((delimiter - 1) + (1 << 31)) - ((((delimiter - 1) + (1 << 31)) << 1) & (((delimiter - 1) + (1 << 31)) >> 31))) >> 31U) & 1) {
      i = ks->begin;
      while (((unsigned int )(((((ks->end - i) & - (ks->end >= i)) >> 31) - ((ks->end - i) & - (ks->end >= i))) ^ (((ks->end - i) & - (ks->end >= i)) >> 31)) >> 31U) & 1) {
        tmp___0 = isspace((int )*(ks->buf + i));
        if (tmp___0) {
          if (((unsigned int )(((((int )*(ks->buf + i) - 32) >> 31) - ((int )*(ks->buf + i) - 32)) ^ (((int )*(ks->buf + i) - 32) >> 31)) >> 31U) & 1) {
            break;
          }
        }
        i = (i ^ 1) + ((i & 1) << 1);
    ...
    if ((int )((((~ ((str->m ^ str->l) - ((~ str->m & str->l) + (~ str->m & str->l))) & (size_t___0 )((((i + ~ ks->begin) + 1) - ~ 1) - 1)) | ((~ ((str->m ^ str->l) - ((~ str->m & str->l) + (~ str->m & str->l))) | (size_t___0 )((((i + ~ ks->begin) + 1) - ~ 1) - 1)) & (((str->m ^ str->l) - ((~ str->m & str->l) + (~ str->m & str->l))) - (size_t___0 )((((i + ~ ks->begin) + 1) - ~ 1) - 1)))) >> 31UL) & 1UL)) {
      str->m = ((((str->l ^ (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + ((str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + (str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))))) | 1UL) + (((str->l ^ (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + ((str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + (str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))))) | 1UL)) - (((str->l ^ (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + ((str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + (str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))))) ^ 1UL);
      str->m = (str->m + ~ 1UL) + 1UL;
      str->m = (str->m & ~ (str->m >> 1)) + (str->m >> 1);
      str->m = ((str->m + (str->m >> 2)) + 1UL) + ((- str->m - 1UL) | (- (str->m >> 2) - 1UL));
      str->m = ((str->m + (str->m >> 4)) + 1UL) + ((- str->m - 1UL) | (- (str->m >> 4) - 1UL));
      str->m = (str->m & ~ (str->m >> 8)) + (str->m >> 8);
      str->m = (str->m & ~ (str->m >> 16)) + (str->m >> 16);
      str->m = ((str->m | 1UL) << 1UL) - (str->m ^ 1UL);
      tmp___1 = realloc((void *)str->s, str->m);
      str->s = (char *)tmp___1;
    }
    gotany = 1;
    memcpy((void */* __restrict  */)(str->s + str->l), (void const   */* __restrict  */)(ks->buf + ks->begin),
           (size_t___0 )(((i & ~ ks->begin) << 1) - (i ^ ks->begin)));
    str->l = (str->l | (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin))) + (str->l & (size_t___0 )((i & ~ ks->begin) - (~ i & ks->begin)));
    ks->begin = ((i ^ ~ 1) + ((i | 1) + (i | 1))) + 1;
    if (((unsigned int )((i & ~ ks->end) | (~ (i ^ ks->end) & (i - ks->end))) >> 31U) & 1) {
      if (dret) {
        *dret = (int )*(ks->buf + i);
      }
      break;
  ...
  if (! gotany) {
    if (ks->is_eof) {
      if (((unsigned int )((~ (ks->end ^ ks->begin) >> 1) + (ks->end & ~ ks->begin)) >> 31U) & 1) {
        return (-1);
      }
    }
  }
  ...
  if (((unsigned int )((((delimiter - 2) + ((delimiter - 2) >> 31)) ^ ((delimiter - 2) >> 31)) - 1) >> 31U) & 1) {
    if ((int )((((~ 1UL & str->l) | (~ (1UL ^ str->l) & (1UL - str->l))) >> 31UL) & 1UL)) {
      if (((unsigned int )(~ (((int )*(str->s + ((str->l ^ 1UL) - ((~ str->l & 1UL) + (~ str->l & 1UL)))) - 13) | (13 - (int )*(str->s + ((str->l ^ 1UL) - ((~ str->l & 1UL) + (~ str->l & 1UL))))))) >> 31U) & 1) {
        str->l = (str->l ^ 1UL) - ((~ str->l & 1UL) + (~ str->l & 1UL));
      }
    }
  }
...
{ 
  ...
  {
  if (h->n_buckets) {
    mask = (khint_t )(((h->n_buckets & ~ 1U) << 1U) - (h->n_buckets ^ 1U));
    k = (khint32_t )((((((key >> 33) | key) - ((key >> 33) & key)) - (key << 11)) - (((((key >> 33) | key) - ((key >> 33) & key)) | ~ (key << 11)) << 1ULL)) - 2ULL);
    i = ((~ k | mask) + k) + 1U;
    inc = (~ ((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) + ((k >> 3) | ~ (k << 3)))) - 2U) & ~ 1U) + 1U) | mask) - ~ ((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) + ((k >> 3) | ~ (k << 3)))) - 2U) & ~ 1U) + 1U);
    last = i;
    while (1) {
      if (! ((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) - ~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)))) {
        if (! (((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 1U) + (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U)) {
          if (! (! ((int )((((((*(h->keys + i) - key) ^ ((long long )(*(h->keys + i) - key) >> 63LL)) - ((long long )(*(h->keys + i) - key) >> 63LL)) - 1ULL) >> 63ULL) & 1ULL)))) {
            break;
          }
        }
      } else {
      ...
      i = ((~ (((i ^ ~ inc) + ((i | inc) + (i | inc))) + 1U) | mask) + (((i ^ ~ inc) + ((i | inc) + (i | inc))) + 1U)) + 1U;
      if ((int )(((((i - last) - (((i - last) << 1U) & ((int )(i - last) >> 31))) - 1U) >> 31U) & 1U)) {
        return ((khint_t )h->n_buckets);
      }
    }
    if (((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 3U) + (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) + 1U) {
...
{ 
  ...
  if (((unsigned int )(((((argc - 1) & - (argc >= 1)) >> 31) - ((argc - 1) & - (argc >= 1))) ^ (((argc - 1) & - (argc >= 1)) >> 31)) >> 31U) & 1) {
  ...
  while (1) {
    ...
    if (last.name.l) {
      p = & last.name;
      q = & seq->name;
      if ((int )((((((p->l - q->l) ^ ((long )(p->l - q->l) >> 31L)) - ((long )(p->l - q->l) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
        if ((int )((((~ 2UL & p->l) | (~ (2UL ^ p->l) & (2UL - p->l))) >> 31UL) & 1UL)) {
          if (((unsigned int )(((((int )*(p->s + ((p->l & ~ 2UL) - (~ p->l & 2UL))) - 47) + (1 << 31)) ^ ((((int )*(p->s + ((p->l & ~ 2UL) - (~ p->l & 2UL))) - 47) + (1 << 31)) >> 31)) - ((((int )*(p->s + ((p->l & ~ 2UL) - (~ p->l & 2UL))) - 47) + (1 << 31)) >> 31)) >> 31U) & 1) {
            if (((unsigned int )(~ (((int )*(q->s + (((q->l & ~ 2UL) << 1UL) - (q->l ^ 2UL))) - 47) | (47 - (int )*(q->s + (((q->l & ~ 2UL) << 1UL) - (q->l ^ 2UL)))))) >> 31U) & 1) {
              tmp___9 = isdigit((int )*(p->s + ((p->l & ~ 1UL) - (~ p->l & 1UL))));
              if (tmp___9) {
                tmp___10 = isdigit((int )*(q->s + ((q->l ^ 1UL) - ((~ q->l & 1UL) << 1UL))));
                if (tmp___10) {
                  tmp___8 = (p->l & ~ 2UL) - (~ p->l & 2UL);
                } else {
                  tmp___8 = p->l;
                }
              } else {
...
{ 
  ...
  {
  if ((int )((((((line_len - 4294967295U) + (line_len - 4294967295U)) & ((int )(line_len - 4294967295U) >> 31)) - (line_len - 4294967295U)) >> 31U) & 1U)) {
    if (line_len != 0U) {
      rest = (int )s->l;
      i = 0;
      while ((int )((((~ ((size_t___0 )i) & (size_t___0 )s->l) | ((~ ((size_t___0 )i) | (size_t___0 )s->l) & ((size_t___0 )i - (size_t___0 )s->l))) >> 31UL) & 1UL)) {
        putchar('\n');
        if ((int )((((~ line_len & (unsigned int )rest) | ((~ line_len | (unsigned int )rest) & (line_len - (unsigned int )rest))) >> 31U) & 1U)) {
        ...
        i = (int )(((unsigned int )i - ~ line_len) - 1U);
        rest = (int )(((unsigned int )rest + ~ line_len) + 1U);
      }
      putchar('\n');
    } else {
      putchar('\n');
...
{ 
  ...
  n_start = 5;
  is_lower_mask = 0;
  if (((unsigned int )(((argc - 1) - (((argc - 1) + (argc - 1)) & ((argc - 1) >> 31))) - 1) >> 31U) & 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  while (1) {
    ...
    cnt[0] = cnt[1];
    i = 0;
    while (((unsigned int )((~ (i ^ l) >> 1) + (i & ~ l)) >> 31U) & 1) {
      if (((unsigned int )((win_size | ~ i) & ((win_size ^ i) | ~ (i - win_size))) >> 31U) & 1) {
        if (((unsigned int )(~ (i % win_step | - (i % win_step))) >> 31U) & 1) {
          goto _L;
        } else {
          goto _L___0;
        }
      ...
      _L___0: 
      if (((unsigned int )(((i - l) + (1 << 31)) - ((((i - l) + (1 << 31)) + ((i - l) + (1 << 31))) & (((i - l) + (1 << 31)) >> 31))) >> 31U) & 1) {
        _L: 
        if (((unsigned int )(~ ((i - l) | (l - i))) >> 31U) & 1) {
          if (((unsigned int )((win_size | ~ l) & ((win_size ^ l) | ~ (l - win_size))) >> 31U) & 1) {
            y = (l & ~ win_size) - (~ l & win_size);
            while (((unsigned int )((y - next) ^ ((y ^ next) & ((y - next) ^ y))) >> 31U) & 1) {
              cnt[(int )*(buf + y % win_size)] = (cnt[(int )*(buf + y % win_size)] & ~ 1U) - (~ cnt[(int )*(buf + y % win_size)] & 1U);
              y = ((y ^ ~ 1) + ((y | 1) << 1)) + 1;
            }
          }
        }
        if (((cnt[1] ^ ~ cnt[2]) + ((cnt[1] | cnt[2]) << 1U)) + 1U > 0U) {
          printf((char const   */* __restrict  */)"%s\t%d\t%d\t%.2lf\t%d\t%d\n", seq->name.s,
                 next, i, ((double )cnt[2] / (double )(((cnt[1] ^ ~ cnt[2]) + ((cnt[1] | cnt[2]) + (cnt[1] | cnt[2]))) + 1U)) * (double )win_size,
                 (cnt[1] - ~ cnt[2]) - 1U, cnt[2]);
        }
        next = i;
      }
      if (((unsigned int )(((((l - i) & - (l >= i)) + ((l - i) & - (l >= i))) & (((l - i) & - (l >= i)) >> 31)) - ((l - i) & - (l >= i))) >> 31U) & 1) {
        y = i % win_size;
        c = (int )*(seq->seq.s + i);
        if (is_lower_mask) {
          tmp___5 = islower(c);
        ...
        x = bitcnt_table[c];
        if (((unsigned int )((win_size | ~ i) & ((win_size ^ i) | ~ (i - win_size))) >> 31U) & 1) {
          cnt[(int )*(buf + y)] = (cnt[(int )*(buf + y)] & ~ 1U) - (~ cnt[(int )*(buf + y)] & 1U);
        }
        if (((unsigned int )(((((x - 2) & - (x >= 2)) + ((x - 2) & - (x >= 2))) & (((x - 2) & - (x >= 2)) >> 31)) - ((x - 2) & - (x >= 2))) >> 31U) & 1) {
          z = 0;
        } else {
          if (((unsigned int )(~ ((x - 2) | (2 - x))) >> 31U) & 1) {
            tmp___6 = 2;
          } else {
            tmp___6 = 1;
          }
...
{ 
  ...
  tmp = ks->begin;
  ks->begin = ((ks->begin ^ ~ 1) + ((ks->begin | 1) << 1)) + 1;
...
{ 
  ...
  new_flags = (khint32_t *)0;
  j = (khint_t )1;
  new_n_buckets = (new_n_buckets + ~ 1U) + 1U;
  new_n_buckets = (new_n_buckets & ~ (new_n_buckets >> 1)) + (new_n_buckets >> 1);
  new_n_buckets = (new_n_buckets & ~ (new_n_buckets >> 2)) + (new_n_buckets >> 2);
  new_n_buckets = ((new_n_buckets + (new_n_buckets >> 4)) + 1U) + ((- new_n_buckets - 1U) | (- (new_n_buckets >> 4) - 1U));
  new_n_buckets = (new_n_buckets & ~ (new_n_buckets >> 8)) + (new_n_buckets >> 8);
  new_n_buckets = (new_n_buckets & ~ (new_n_buckets >> 16)) + (new_n_buckets >> 16);
  new_n_buckets = (new_n_buckets - ~ 1U) - 1U;
  if ((int )((((~ new_n_buckets & 4U) | ((~ new_n_buckets | 4U) & (new_n_buckets - 4U))) >> 31U) & 1U)) {
    new_n_buckets = (khint_t )4;
  }
  if ((int )((((~ ((khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5)) | h->size) & (((khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5) ^ h->size) | ~ (h->size - (khint_t )((double const   )new_n_buckets * __ac_HASH_UPPER + (double const   )0.5)))) >> 31U) & 1U)) {
    ...
    memset((void *)new_flags, 170, ((unsigned long )tmp___1 & sizeof(khint32_t )) * ((unsigned long )tmp___1 | sizeof(khint32_t )) + ((unsigned long )tmp___1 & ~ sizeof(khint32_t )) * (~ ((unsigned long )tmp___1) & sizeof(khint32_t )));
    if ((int )((((~ h->n_buckets & new_n_buckets) | ((~ h->n_buckets | new_n_buckets) & (h->n_buckets - new_n_buckets))) >> 31U) & 1U)) {
      tmp___2 = realloc((void *)h->keys, ((unsigned long )new_n_buckets & sizeof(kh_cstr_t )) * ((unsigned long )new_n_buckets | sizeof(kh_cstr_t )) + ((unsigned long )new_n_buckets & ~ sizeof(kh_cstr_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(kh_cstr_t )));
      h->keys = (kh_cstr_t *)tmp___2;
      tmp___3 = realloc((void *)h->vals, ((unsigned long )new_n_buckets & sizeof(reglist_t )) * ((unsigned long )new_n_buckets | sizeof(reglist_t )) + ((unsigned long )new_n_buckets & ~ sizeof(reglist_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(reglist_t )));
      h->vals = (reglist_t *)tmp___3;
    }
  }
  if (j) {
    j = (khint_t )0;
    while ((int )((((j - h->n_buckets) | (h->n_buckets - j)) >> 31U) & 1U)) {
      if ((~ (*(h->flags + (j >> 4)) >> ((((~ j | 15U) + j) + 1U) << 1)) | 3U) - ~ (*(h->flags + (j >> 4)) >> ((((~ j | 15U) + j) + 1U) << 1)) == 0U) {
        key = *(h->keys + j);
        new_mask = (new_n_buckets & ~ 1U) - (~ new_n_buckets & 1U);
        val = *(h->vals + j);
        *(h->flags + (j >> 4)) = (khint32_t )(((unsigned long )*(h->flags + (j >> 4)) & ~ (1UL << ((((~ j | 15U) + j) + 1U) << 1))) + (1UL << ((((~ j | 15U) + j) + 1U) << 1)));
        while (1) {
          k = __ac_X31_hash_string(key);
          i = (~ k | new_mask) - ~ k;
          inc = ((~ ((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) & ~ 1U) + 1U) | new_mask) + ((((((k >> 3) - (k << 3)) - (((k >> 3) | ~ (k << 3)) << 1U)) - 2U) & ~ 1U) + 1U)) + 1U;
          while (! (((~ (*(new_flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 2U) + (*(new_flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U)) {
            i = ((~ ((i | inc) + (i & inc)) | new_mask) + ((i | inc) + (i & inc))) + 1U;
          }
          *(new_flags + (i >> 4)) = (khint32_t )(((unsigned long )*(new_flags + (i >> 4)) | (2UL << ((((~ i | 15U) + i) + 1U) << 1))) - (2UL << ((((~ i | 15U) + i) + 1U) << 1)));
          if ((int )((((~ i & h->n_buckets) | (~ (i ^ h->n_buckets) & (i - h->n_buckets))) >> 31U) & 1U)) {
            if (((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 3U) + (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U == 0U) {
              tmp___4 = *(h->keys + i);
              *(h->keys + i) = key;
              key = tmp___4;
              tmp___5 = *(h->vals + i);
              *(h->vals + i) = val;
              val = tmp___5;
              *(h->flags + (i >> 4)) = (khint32_t )((((unsigned long )*(h->flags + (i >> 4)) + (1UL << ((((~ i | 15U) + i) + 1U) << 1))) + 1UL) + ((- ((unsigned long )*(h->flags + (i >> 4))) - 1UL) | (- (1UL << ((((~ i | 15U) + i) + 1U) << 1)) - 1UL)));
            } else {
              *(h->keys + i) = key;
              *(h->vals + i) = val;
              break;
    ...
    if ((int )((((~ new_n_buckets & h->n_buckets) | (~ (new_n_buckets ^ h->n_buckets) & (new_n_buckets - h->n_buckets))) >> 31U) & 1U)) {
      tmp___6 = realloc((void *)h->keys, ((unsigned long )new_n_buckets & sizeof(kh_cstr_t )) * ((unsigned long )new_n_buckets | sizeof(kh_cstr_t )) + ((unsigned long )new_n_buckets & ~ sizeof(kh_cstr_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(kh_cstr_t )));
      h->keys = (kh_cstr_t *)tmp___6;
      tmp___7 = realloc((void *)h->vals, ((unsigned long )new_n_buckets & sizeof(reglist_t )) * ((unsigned long )new_n_buckets | sizeof(reglist_t )) + ((unsigned long )new_n_buckets & ~ sizeof(reglist_t )) * (~ ((unsigned long )new_n_buckets) & sizeof(reglist_t )));
...
{ 
  ...
  {
  if (((unsigned int )((~ (end ^ begin) >> 1) + (end & ~ begin)) >> 31U) & 1) {
    return;
  }
  if (ks->qual.l) {
    tmp = '@';
  ...
  fprintf((FILE */* __restrict  */)fpout, (char const   */* __restrict  */)"%c%s:%d-%d",
          tmp, ks->name.s, ((begin ^ ~ 1) + ((begin | 1) + (begin | 1))) + 1, end);
  i = begin;
  while (1) {
    if (((unsigned int )((i & ~ end) | (~ (i ^ end) & (i - end))) >> 31U) & 1) {
      if (! ((int )((((~ ((size_t___0 )i) & (size_t___0 )ks->seq.l) | (~ ((size_t___0 )i ^ (size_t___0 )ks->seq.l) & ((size_t___0 )i - (size_t___0 )ks->seq.l))) >> 31UL) & 1UL))) {
        break;
      }
    } else {
      break;
    }
    if (((unsigned int )(~ (((i + ~ begin) + 1) % 60 | - (((i + ~ begin) + 1) % 60))) >> 31U) & 1) {
      fputc('\n', fpout);
    }
  ...
  while (1) {
    if (((unsigned int )((i & ~ end) | (~ (i ^ end) & (i - end))) >> 31U) & 1) {
      if (! ((int )((((~ ((size_t___0 )i) & (size_t___0 )ks->qual.l) | ((~ ((size_t___0 )i) | (size_t___0 )ks->qual.l) & ((size_t___0 )i - (size_t___0 )ks->qual.l))) >> 31UL) & 1UL))) {
        break;
      }
    } else {
      break;
    }
    if (((unsigned int )(~ (((i ^ begin) - ((~ i & begin) + (~ i & begin))) % 60 | - (((i ^ begin) - ((~ i & begin) + (~ i & begin))) % 60))) >> 31U) & 1) {
      fputc('\n', fpout);
    }
...
{ 
  ...
  if ((int )((((~ h->upper_bound | h->n_occupied) & ((h->upper_bound ^ h->n_occupied) | ~ (h->n_occupied - h->upper_bound))) >> 31U) & 1U)) {
    if ((int )((((~ (h->size << 1) & h->n_buckets) | (~ ((h->size << 1) ^ h->n_buckets) & ((h->size << 1) - h->n_buckets))) >> 31U) & 1U)) {
      kh_resize_64(h, ((h->n_buckets & ~ 1U) << 1U) - (h->n_buckets ^ 1U));
    } else {
      kh_resize_64(h, ((h->n_buckets ^ ~ 1U) + ((h->n_buckets | 1U) + (h->n_buckets | 1U))) + 1U);
    }
  }
  mask = (h->n_buckets + ~ 1U) + 1U;
  site = h->n_buckets;
  x = site;
  k = (khint32_t )(((((((key >> 33) - key) - (((key >> 33) | ~ key) << 1ULL)) - 2ULL) - (key << 11)) - ((((((key >> 33) - key) - (((key >> 33) | ~ key) << 1ULL)) - 2ULL) | ~ (key << 11)) + (((((key >> 33) - key) - (((key >> 33) | ~ key) << 1ULL)) - 2ULL) | ~ (key << 11)))) - 2ULL);
  i = (~ k | mask) - ~ k;
  if ((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) - ~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) {
    x = i;
  } else {
    inc = ((~ (((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) & ~ 1U) + 1U) | mask) + (((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) & ~ 1U) + 1U)) + 1U;
    last = i;
    while (1) {
      if (! (((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 2U) + (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U)) {
        if (! (((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 1U) + (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) + 1U)) {
          if (! (! ((int )((((((*(h->keys + i) - key) ^ ((long long )(*(h->keys + i) - key) >> 63LL)) - ((long long )(*(h->keys + i) - key) >> 63LL)) - 1ULL) >> 63ULL) & 1ULL)))) {
            break;
          }
        }
      ...
      i = (~ (((i ^ ~ inc) + ((i | inc) + (i | inc))) + 1U) | mask) - ~ (((i ^ ~ inc) + ((i | inc) + (i | inc))) + 1U);
      if ((int )((((((i - last) + (1U << 31)) + ((int )((i - last) + (1U << 31)) >> 31)) ^ ((int )((i - last) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
        x = site;
        break;
      }
    }
    if ((int )((((((x - h->n_buckets) ^ ((int )(x - h->n_buckets) >> 31)) - ((int )(x - h->n_buckets) >> 31)) - 1U) >> 31U) & 1U)) {
      if ((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) - ~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) {
        if ((int )((((site - h->n_buckets) | (h->n_buckets - site)) >> 31U) & 1U)) {
          x = site;
        } else {
          x = i;
        }
  ...
  if (((~ (*(h->flags + (x >> 4)) >> (((~ x | 15U) - ~ x) << 1)) | 2U) + (*(h->flags + (x >> 4)) >> (((~ x | 15U) - ~ x) << 1))) + 1U) {
    *(h->keys + x) = key;
    *(h->flags + (x >> 4)) = (khint32_t )(((unsigned long )*(h->flags + (x >> 4)) | (3UL << ((((~ x | 15U) + x) + 1U) << 1))) - (3UL << ((((~ x | 15U) + x) + 1U) << 1)));
    h->size = (h->size - ~ 1U) - 1U;
    h->n_occupied = ((h->n_occupied ^ ~ 1U) + ((h->n_occupied | 1U) + (h->n_occupied | 1U))) + 1U;
    *ret = 1;
  } else
  if (((~ (*(h->flags + (x >> 4)) >> ((((~ x | 15U) + x) + 1U) << 1)) | 1U) + (*(h->flags + (x >> 4)) >> ((((~ x | 15U) + x) + 1U) << 1))) + 1U) {
    *(h->keys + x) = key;
    *(h->flags + (x >> 4)) = (khint32_t )((unsigned long )*(h->flags + (x >> 4)) - ((unsigned long )*(h->flags + (x >> 4)) & (3UL << ((((~ x | 15U) + x) + 1U) << 1))));
    h->size = ((h->size ^ ~ 1U) + ((h->size | 1U) + (h->size | 1U))) + 1U;
    *ret = 2;
  } else {
    *ret = 0;
  }
...
{ 
  ...
  {
  if (h->n_buckets) {
    mask = (khint_t )((h->n_buckets + ~ 1U) + 1U);
    k = __ac_X31_hash_string(key);
    i = ((~ k | mask) + k) + 1U;
    inc = ((~ (((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) & ~ 1U) + 1U) | mask) + (((((k >> 3) | (k << 3)) - ((k >> 3) & (k << 3))) & ~ 1U) + 1U)) + 1U;
    last = i;
    while (1) {
      if (! (((~ (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1)) | 2U) + (*(h->flags + (i >> 4)) >> ((((~ i | 15U) + i) + 1U) << 1))) + 1U)) {
        if (! ((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 1U) - ~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)))) {
          tmp = strcmp(*(h->keys + i), key);
      ...
      i = (~ ((i - ~ inc) - 1U) | mask) - ~ ((i - ~ inc) - 1U);
      if ((int )((~ ((i - last) | (last - i)) >> 31U) & 1U)) {
        return ((khint_t )h->n_buckets);
      }
    }
    if (((~ (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1)) | 3U) + (*(h->flags + (i >> 4)) >> (((~ i | 15U) - ~ i) << 1))) + 1U) {
...
{ 
  ...
  while (1) {
    ...
    if (! (((unsigned int )(~ tmp___14) >> 31U) & 1)) {
      break;
    }
    beg = -1;
    end = -1;
    ...
    k = tmp___6;
    if ((int )((((((k - h->n_buckets) + ((int )(k - h->n_buckets) >> 31)) ^ ((int )(k - h->n_buckets) >> 31)) - 1U) >> 31U) & 1U)) {
    ...
    p = h->vals + k;
    if (((unsigned int )((((dret - 10) >> 31) - (dret - 10)) ^ ((dret - 10) >> 31)) >> 31U) & 1) {
      ...
      if (((unsigned int )(- tmp___10 & ~ tmp___10) >> 31U) & 1) {
        ...
        if (tmp___11) {
          ...
          if (((unsigned int )((dret - 10) | (10 - dret)) >> 31U) & 1) {
            tmp___8 = ks_getuntil(ks, 0, str, & dret);
            if (((unsigned int )((tmp___8 >> 1) - tmp___8) >> 31U) & 1) {
              tmp___9 = isdigit((int )*(str->s + 0));
              if (tmp___9) {
                end = atoi((char const   *)str->s);
                if (((unsigned int )end >> 31U) & 1) {
                  end = -1;
                }
              }
            }
    ...
    if (((unsigned int )end >> 31U) & 1) {
      if (((unsigned int )((beg >> 1) - beg) >> 31U) & 1) {
        end = beg;
        beg = (beg & ~ 1) - (~ beg & 1);
      }
    }
    if (((unsigned int )beg >> 31U) & 1) {
      beg = 0;
      end = 2147483647;
    }
    if (((unsigned int )((((p->n - p->m) + (1 << 31)) ^ (((p->n - p->m) + (1 << 31)) >> 31)) - (((p->n - p->m) + (1 << 31)) >> 31)) >> 31U) & 1) {
      ...
      tmp___12 = realloc((void *)p->a, (size_t___0 )((p->m & 8) * (p->m | 8) + (p->m & ~ 8) * (~ p->m & 8)));
      p->a = (uint64_t *)tmp___12;
    }
    tmp___13 = p->n;
    p->n = ((p->n | 1) << 1) - (p->n ^ 1);
    *(p->a + tmp___13) = ((((uint64_t )beg << 32) + (unsigned long long )end) + 1ULL) + ((- ((uint64_t )beg << 32) - 1ULL) | (- ((unsigned long long )end) - 1ULL));
  }
  ks_destroy(ks);
  gzclose(fp);
  free((void *)str->s);
...
{ 
  ...
  if ((int )((((((k - (khiter_t )h->n_buckets) ^ ((int )(k - (khiter_t )h->n_buckets) >> 31)) - ((int )(k - (khiter_t )h->n_buckets) >> 31)) - 1U) >> 31U) & 1U)) {
    if (is_complement) {
      if (mask_chr) {
        j = 0U;
        while ((int )((((~ ((size_t___0 )j) & seq->seq.l) | (~ ((size_t___0 )j ^ seq->seq.l) & ((size_t___0 )j - seq->seq.l))) >> 31UL) & 1UL)) {
    ...
    if (! is_complement) {
      i = 0U;
      while ((int )((((~ i & (unsigned int )p->n) | (~ (i ^ (unsigned int )p->n) & (i - (unsigned int )p->n))) >> 31U) & 1U)) {
        beg = (unsigned int )(*(p->a + i) >> 32);
        end = (unsigned int )*(p->a + i);
        if ((int )((((~ seq->seq.l | (size_t___0 )beg) & ((seq->seq.l ^ (size_t___0 )beg) | ~ ((size_t___0 )beg - seq->seq.l))) >> 31UL) & 1UL)) {
          goto __Cont;
        }
        if ((int )((((~ seq->seq.l & (size_t___0 )end) | ((~ seq->seq.l | (size_t___0 )end) & (seq->seq.l - (size_t___0 )end))) >> 31UL) & 1UL)) {
          end = (unsigned int )seq->seq.l;
        }
        if (! mask_chr) {
          j = beg;
          while ((int )((((~ j & end) | (~ (j ^ end) & (j - end))) >> 31U) & 1U)) {
      ...
      while ((int )((((~ i & (unsigned int )p->n) | (~ (i ^ (unsigned int )p->n) & (i - (unsigned int )p->n))) >> 31U) & 1U)) {
        ...
        if ((int )((((~ seq->seq.l | (size_t___0 )end___0) & ((seq->seq.l ^ (size_t___0 )end___0) | ~ ((size_t___0 )end___0 - seq->seq.l))) >> 31UL) & 1UL)) {
          end___0 = (unsigned int )seq->seq.l;
        }
        j = beg___0;
        while ((int )((((~ j & end___0) | (~ (j ^ end___0) & (j - end___0))) >> 31U) & 1U)) {
          *(mask + j) = (int8_t )1;
          j = (j | 1U) + (j & 1U);
        }
        i = ((i ^ ~ 1U) + ((i | 1U) << 1U)) + 1U;
      ...
      if (mask_chr) {
        j = 0U;
        while ((int )((((~ ((size_t___0 )j) & seq->seq.l) | ((~ ((size_t___0 )j) | seq->seq.l) & ((size_t___0 )j - seq->seq.l))) >> 31UL) & 1UL)) {
          if (((unsigned int )((((int )*(mask + j) ^ ((int )*(mask + j) >> 31)) - ((int )*(mask + j) >> 31)) - 1) >> 31U) & 1) {
            *(seq->seq.s + j) = (char )mask_chr;
          }
          j = (j | 1U) + (j & 1U);
        }
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )((((c - 113) + ((c - 113) >> 31)) ^ ((c - 113) >> 31)) - 1) >> 31U) & 1) {
      qthres = atoi((char const   *)optarg);
    }
  }
  if (((unsigned int )((((optind - argc) + (1 << 31)) ^ (((optind - argc) + (1 << 31)) >> 31)) - (((optind - argc) + (1 << 31)) >> 31)) >> 31U) & 1) {
  ...
  while (1) {
    ...
    n = ((n | 1LL) << 1LL) - (n ^ 1LL);
    tot_len = (int64_t )((((unsigned long long )tot_len ^ ~ ((unsigned long long )seq->seq.l)) + (((unsigned long long )tot_len | (unsigned long long )seq->seq.l) + ((unsigned long long )tot_len | (unsigned long long )seq->seq.l))) + 1ULL);
    if ((int )((((~ ((size_t___0 )min_len) & seq->seq.l) | (~ ((size_t___0 )min_len ^ seq->seq.l) & ((size_t___0 )min_len - seq->seq.l))) >> 31UL) & 1UL)) {
      min_len = min_len;
    } else {
      min_len = (int )seq->seq.l;
    }
    if ((int )((((~ seq->seq.l & (size_t___0 )max_len) | ((~ seq->seq.l | (size_t___0 )max_len) & (seq->seq.l - (size_t___0 )max_len))) >> 31UL) & 1UL)) {
      max_len = max_len;
    } else {
      max_len = (int )seq->seq.l;
    }
    if (((unsigned int )((max_alloc - max_len) ^ ((max_alloc ^ max_len) & ((max_alloc - max_len) ^ max_alloc))) >> 31U) & 1) {
      old_max = max_alloc;
      max_alloc = max_len;
      max_alloc = (max_alloc ^ 1) - ((~ max_alloc & 1) << 1);
      max_alloc = ((max_alloc + (max_alloc >> 1)) + 1) + ((- max_alloc - 1) | (- (max_alloc >> 1) - 1));
      max_alloc = (max_alloc & ~ (max_alloc >> 2)) + (max_alloc >> 2);
      max_alloc = (max_alloc & ~ (max_alloc >> 4)) + (max_alloc >> 4);
      max_alloc = (max_alloc & ~ (max_alloc >> 8)) + (max_alloc >> 8);
      max_alloc = ((max_alloc + (max_alloc >> 16)) + 1) + ((- max_alloc - 1) | (- (max_alloc >> 16) - 1));
      max_alloc = (max_alloc - ~ 1) - 1;
      tmp___4 = realloc((void *)pos, ((unsigned long )max_alloc & sizeof(posstat_t )) * ((unsigned long )max_alloc | sizeof(posstat_t )) + ((unsigned long )max_alloc & ~ sizeof(posstat_t )) * (~ ((unsigned long )max_alloc) & sizeof(posstat_t )));
      pos = (posstat_t *)tmp___4;
      memset((void *)(pos + old_max), 0, ((unsigned long )((max_alloc ^ old_max) - ((~ max_alloc & old_max) + (~ max_alloc & old_max))) & sizeof(posstat_t )) * ((unsigned long )((max_alloc ^ old_max) - ((~ max_alloc & old_max) + (~ max_alloc & old_max))) | sizeof(posstat_t )) + ((unsigned long )((max_alloc ^ old_max) - ((~ max_alloc & old_max) + (~ max_alloc & old_max))) & ~ sizeof(posstat_t )) * (~ ((unsigned long )((max_alloc ^ old_max) - ((~ max_alloc & old_max) + (~ max_alloc & old_max)))) & sizeof(posstat_t )));
    }
    i = 0;
    while ((int )((((~ ((size_t___0 )i) & seq->qual.l) | ((~ ((size_t___0 )i) | seq->qual.l) & ((size_t___0 )i - seq->qual.l))) >> 31UL) & 1UL)) {
      q = ((int )*(seq->qual.s + i) ^ offset) - ((~ ((int )*(seq->qual.s + i)) & offset) << 1);
      ...
      if (((unsigned int )(((((93 - q) & - (93 >= q)) >> 31) - ((93 - q) & - (93 >= q))) ^ (((93 - q) & - (93 >= q)) >> 31)) >> 31U) & 1) {
        q = q;
      } else {
        q = 93;
      }
      (pos + i)->q[q] = (((pos + i)->q[q] ^ ~ 1LL) + (((pos + i)->q[q] | 1LL) << 1LL)) + 1LL;
      (pos + i)->b[b] = ((pos + i)->b[b] | 1LL) + ((pos + i)->b[b] & 1LL);
      i = (i | 1) + (i & 1);
    }
  }
  kseq_destroy(seq);
  ...
  i = 0;
  while (((unsigned int )((i & ~ max_len) | (~ (i ^ max_len) & (i - max_len))) >> 31U) & 1) {
    k = 0;
    while (((unsigned int )((~ (k ^ 93) >> 1) + (k & ~ 93)) >> 31U) & 1) {
      all.q[k] = ((all.q[k] | (pos + i)->q[k]) << 1LL) - (all.q[k] ^ (pos + i)->q[k]);
      k = ((k | 1) + (k | 1)) - (k ^ 1);
    }
    k = 0;
    while (((unsigned int )((k | ~ 4) & ((k ^ 4) | ~ (4 - k))) >> 31U) & 1) {
      all.b[k] = (all.b[k] ^ (pos + i)->b[k]) + ((all.b[k] & (pos + i)->b[k]) << 1LL);
      k = (k ^ 1) + ((k & 1) << 1);
    }
    i = (i ^ 1) + ((i & 1) + (i & 1));
  }
  ...
  while (((unsigned int )((~ (k ^ 93) >> 1) + (k & ~ 93)) >> 31U) & 1) {
    if (all.q[k]) {
      n_diffQ = ((n_diffQ ^ ~ 1) + ((n_diffQ | 1) + (n_diffQ | 1))) + 1;
    }
    k = (k ^ 1) + ((k & 1) << 1);
  }
  ...
  if (((unsigned int )(qthres | ~ (- qthres)) >> 31U) & 1) {
    k = 0;
    while (((unsigned int )((~ (k ^ 93) >> 1) + (k & ~ 93)) >> 31U) & 1) {
      if ((int )(((unsigned long long )(- all.q[k] & ~ all.q[k]) >> 63ULL) & 1LL)) {
  ...
  i = 0;
  while (((unsigned int )((i - max_len) ^ ((i ^ max_len) & ((i - max_len) ^ i))) >> 31U) & 1) {
    fqc_aux(pos + i, (i ^ 1) + ((i & 1) << 1), all.q, perr, qthres);
    i = ((i | 1) << 1) - (i ^ 1);
  }
  free((void *)pos);
  return (0);
...
{ 
  ...
  k = (khint_t )0;
  while ((int )((((~ k & h->n_buckets) | ((~ k | h->n_buckets) & (k - h->n_buckets))) >> 31U) & 1U)) {
    if (! (((~ (*(h->flags + (k >> 4)) >> ((((~ k | 15U) + k) + 1U) << 1)) | 3U) + (*(h->flags + (k >> 4)) >> ((((~ k | 15U) + k) + 1U) << 1))) + 1U)) {
      free((void *)(h->vals + k)->a);
      free((void *)((char *)*(h->keys + k)));
    }
    k = ((k ^ ~ 1U) + ((k | 1U) << 1U)) + 1U;
...
{ 
  ...
  if ((int )((((~ ((size_t___0 const   )dst->m) & ((src->l | 1UL) + (src->l & 1UL))) | ((~ ((size_t___0 const   )dst->m) | ((src->l | 1UL) + (src->l & 1UL))) & ((size_t___0 const   )dst->m - ((src->l | 1UL) + (src->l & 1UL))))) >> (unsigned long const   )31) & 1UL)) {
    dst->m = (size_t___0 )(((src->l ^ ~ 1UL) + ((src->l | 1UL) + (src->l | 1UL))) + 1UL);
    dst->m = ((dst->m & ~ 1UL) + (dst->m & ~ 1UL)) - (dst->m ^ 1UL);
    dst->m = (dst->m & ~ (dst->m >> 1)) + (dst->m >> 1);
    dst->m = ((dst->m + (dst->m >> 2)) + 1UL) + ((- dst->m - 1UL) | (- (dst->m >> 2) - 1UL));
    dst->m = (dst->m & ~ (dst->m >> 4)) + (dst->m >> 4);
    dst->m = (dst->m & ~ (dst->m >> 8)) + (dst->m >> 8);
    dst->m = (dst->m & ~ (dst->m >> 16)) + (dst->m >> 16);
    dst->m = (dst->m - ~ 1UL) - 1UL;
  ...
  memcpy((void */* __restrict  */)dst->s, (void const   */* __restrict  */)src->s,
         (size_t___0 )((src->l ^ 1UL) + ((src->l & 1UL) << 1UL)));
  return;
}
}
...
{ 
  ...
  {
  while ((int )((((~ ((size_t___0 )k) & (size_t___0 )ks->seq.l) | ((~ ((size_t___0 )k) | (size_t___0 )ks->seq.l) & ((size_t___0 )k - (size_t___0 )ks->seq.l))) >> 31UL) & 1UL)) {
    if (((unsigned int )(((((int )seq_nt16_table[(int )*(ks->seq.s + k)] - 15) + (1 << 31)) + ((((int )seq_nt16_table[(int )*(ks->seq.s + k)] - 15) + (1 << 31)) >> 31)) ^ ((((int )seq_nt16_table[(int )*(ks->seq.s + k)] - 15) + (1 << 31)) >> 31)) >> 31U) & 1) {
      score = 0;
      max = -1;
      e = max;
      i = k;
      while (1) {
        if ((int )((((~ ((size_t___0 )i) & (size_t___0 )ks->seq.l) | ((~ ((size_t___0 )i) | (size_t___0 )ks->seq.l) & ((size_t___0 )i - (size_t___0 )ks->seq.l))) >> 31UL) & 1UL)) {
          if (! (((unsigned int )(~ score) >> 31U) & 1)) {
            break;
          }
        } else {
          break;
        }
        if (((unsigned int )(~ (((int )seq_nt16_table[(int )*(ks->seq.s + i)] - 15) | (15 - (int )seq_nt16_table[(int )*(ks->seq.s + i)]))) >> 31U) & 1) {
          score = ((score ^ ~ 1) + ((score | 1) + (score | 1))) + 1;
        } else {
          score = ((score & ~ cutN_nonN_penalty) + (score & ~ cutN_nonN_penalty)) - (score ^ cutN_nonN_penalty);
        }
        if (((unsigned int )(((((score - max) & - (score >= max)) << 1) & (((score - max) & - (score >= max)) >> 31)) - ((score - max) & - (score >= max))) >> 31U) & 1) {
          max = score;
          e = i;
        }
        i = (i - ~ 1) - 1;
      ...
      while (1) {
        ...
        if (((unsigned int )(~ (((int )seq_nt16_table[(int )*(ks->seq.s + i)] - 15) | (15 - (int )seq_nt16_table[(int )*(ks->seq.s + i)]))) >> 31U) & 1) {
          score = ((score ^ ~ 1) + ((score | 1) << 1)) + 1;
        } else {
          score = ((score & ~ cutN_nonN_penalty) + (score & ~ cutN_nonN_penalty)) - (score ^ cutN_nonN_penalty);
        }
        if (((unsigned int )((max - score) ^ ((max ^ score) & ((max - score) ^ max))) >> 31U) & 1) {
          max = score;
          b = i;
        }
        i = (i ^ 1) - ((~ i & 1) << 1);
      }
      if (((unsigned int )((cutN_min_N_tract | ~ ((((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b) + ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b)) - ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) ^ b))) & ((cutN_min_N_tract ^ ((((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b) + ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b)) - ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) ^ b))) | ~ (((((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b) + ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) & ~ b)) - ((((e ^ ~ 1) + ((e | 1) << 1)) + 1) ^ b)) - cutN_min_N_tract))) >> 31U) & 1) {
        *begin = b;
        *end = (e ^ 1) + ((e & 1) + (e & 1));
        return (*end);
      }
...
{ 
  ...
  if (((unsigned int )(((((((optind | 2) + (optind | 2)) - (optind ^ 2)) - argc) & - (((optind | 2) + (optind | 2)) - (optind ^ 2) >= argc)) >> 31) - ((((((optind | 2) + (optind | 2)) - (optind ^ 2)) - argc) & - (((optind | 2) + (optind | 2)) - (optind ^ 2) >= argc)) ^ ((((((optind | 2) + (optind | 2)) - (optind ^ 2)) - argc) & - (((optind | 2) + (optind | 2)) - (optind ^ 2) >= argc)) >> 31))) >> 31U) & 1) {
  ...
  i = 0;
  while (((unsigned int )((i & ~ 2) | (~ (i ^ 2) & (i - 2))) >> 31U) & 1) {
    tmp___3 = strcmp((char const   *)*(argv + ((optind | i) + (optind & i))), "-");
    if (tmp___3) {
      tmp___0 = gzopen((char const   *)*(argv + (((optind ^ ~ i) + ((optind | i) + (optind | i))) + 1)),
                       "r");
      fp[i] = tmp___0;
  ...
  while (1) {
    ...
    if (! (((unsigned int )(~ tmp___21) >> 31U) & 1)) {
      break;
    }
    kseq_read(seq[1]);
    tmp___4 = strcmp((char const   *)(seq[0])->name.s, (char const   *)(seq[1])->name.s);
    ...
    if ((int )(((((long )((seq[0])->seq.l - (seq[1])->seq.l) >> 31L) - (((seq[0])->seq.l - (seq[1])->seq.l) ^ ((long )((seq[0])->seq.l - (seq[1])->seq.l) >> 31L))) >> 31UL) & 1UL)) {
      fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[%s] Unequal sequence length: %ld != %ld\n",
    ...
    while (((unsigned int )((l & ~ min_l) | (~ (l ^ min_l) & (l - min_l))) >> 31U) & 1) {
      ...
      c___0[1] = (int )*((seq[1])->seq.s + l);
      if ((seq[0])->qual.l) {
        if (((unsigned int )((((qual - (((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) & - (qual >= ((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) >> 31) - (((qual - (((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) & - (qual >= ((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) ^ (((qual - (((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) & - (qual >= ((int )*((seq[0])->qual.s + l) ^ 33) - ((~ ((int )*((seq[0])->qual.s + l)) & 33) + (~ ((int )*((seq[0])->qual.s + l)) & 33)))) >> 31))) >> 31U) & 1) {
          c___0[0] = tolower(c___0[0]);
        }
      }
      if ((seq[1])->qual.l) {
        if (((unsigned int )(((((qual - (((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1))) & - (qual >= ((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1))) >> 31) - ((qual - (((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1))) & - (qual >= ((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1)))) ^ (((qual - (((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1))) & - (qual >= ((int )*((seq[1])->qual.s + l) ^ 33) - ((~ ((int )*((seq[1])->qual.s + l)) & 33) << 1))) >> 31)) >> 31U) & 1) {
      ...
      if (((unsigned int )(~ c___0[0] & (c___0[0] - 1)) >> 31U) & 1) {
        c___0[0] = 15;
      }
      if (((unsigned int )((c___0[1] + (1 << 31)) - (((c___0[1] + (1 << 31)) + (c___0[1] + (1 << 31))) & ((c___0[1] + (1 << 31)) >> 31))) >> 31U) & 1) {
        c___0[1] = 15;
      }
      b[0] = bitcnt_table[c___0[0]];
      b[1] = bitcnt_table[c___0[1]];
      if (is_upper) {
        if (((unsigned int )((((b[0] - 1) + (1 << 31)) + (((b[0] - 1) + (1 << 31)) >> 31)) ^ (((b[0] - 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
          if (((unsigned int )((((b[1] - 1) ^ ((b[1] - 1) >> 31)) - ((b[1] - 1) >> 31)) - 1) >> 31U) & 1) {
            if (((unsigned int )(~ ((c___0[0] - c___0[1]) | (c___0[1] - c___0[0]))) >> 31U) & 1) {
              cnt[0] = (cnt[0] | 1ULL) + (cnt[0] & 1ULL);
            } else {
              cnt[1] = ((cnt[1] | 1ULL) + (cnt[1] | 1ULL)) - (cnt[1] ^ 1ULL);
            }
          } else {
            goto _L___1;
          }
        ...
        _L___1: 
        if (((unsigned int )(~ ((b[0] - 1) | (1 - b[0]))) >> 31U) & 1) {
          if (((unsigned int )(~ ((b[1] - 2) | (2 - b[1]))) >> 31U) & 1) {
            cnt[2] = ((cnt[2] | 1ULL) + (cnt[2] | 1ULL)) - (cnt[2] ^ 1ULL);
          } else {
            goto _L___0;
          }
        } else
        _L___0: 
        if (((unsigned int )((((b[0] - 2) + (1 << 31)) ^ (((b[0] - 2) + (1 << 31)) >> 31)) - (((b[0] - 2) + (1 << 31)) >> 31)) >> 31U) & 1) {
          if (((unsigned int )(((b[1] - 1) + (1 << 31)) - ((((b[1] - 1) + (1 << 31)) + ((b[1] - 1) + (1 << 31))) & (((b[1] - 1) + (1 << 31)) >> 31))) >> 31U) & 1) {
            cnt[3] = (cnt[3] | 1ULL) + (cnt[3] & 1ULL);
          } else {
            goto _L;
          }
        } else
        _L: 
        if (((unsigned int )(~ ((b[0] - 2) | (2 - b[0]))) >> 31U) & 1) {
          if (((unsigned int )((((b[1] - 2) + (1 << 31)) + (((b[1] - 2) + (1 << 31)) >> 31)) ^ (((b[1] - 2) + (1 << 31)) >> 31)) >> 31U) & 1) {
            cnt[4] = (cnt[4] ^ 1ULL) + ((cnt[4] & 1ULL) + (cnt[4] & 1ULL));
          }
        }
      }
      if (is_haploid) {
        if (((unsigned int )(((((b[0] - 1) & - (b[0] >= 1)) >> 31) - ((b[0] - 1) & - (b[0] >= 1))) ^ (((b[0] - 1) & - (b[0] >= 1)) >> 31)) >> 31U) & 1) {
          is_upper = 0;
        } else
        if (((unsigned int )((1 & ~ b[1]) | (~ (1 ^ b[1]) & (1 - b[1]))) >> 31U) & 1) {
          is_upper = 0;
        }
      }
      if (is_intersect) {
        c___0[0] = (~ c___0[0] | c___0[1]) - ~ c___0[0];
        if (((unsigned int )(((c___0[0] + (1 << 31)) + ((c___0[0] + (1 << 31)) >> 31)) ^ ((c___0[0] + (1 << 31)) >> 31)) >> 31U) & 1) {
          is_upper = 0;
        }
      } else
      if (is_mask) {
        if (((unsigned int )(((c___0[0] - 15) - (((c___0[0] - 15) + (c___0[0] - 15)) & ((c___0[0] - 15) >> 31))) - 1) >> 31U) & 1) {
          is_upper = 0;
        } else
        if (((unsigned int )((((c___0[1] - 15) + (1 << 31)) ^ (((c___0[1] - 15) + (1 << 31)) >> 31)) - (((c___0[1] - 15) + (1 << 31)) >> 31)) >> 31U) & 1) {
          is_upper = 0;
        }
        c___0[0] = ((~ c___0[0] | c___0[1]) + c___0[0]) + 1;
        if (((unsigned int )(((c___0[0] ^ (c___0[0] >> 31)) - (c___0[0] >> 31)) - 1) >> 31U) & 1) {
          is_upper = 0;
        }
      } else
      if (is_randhet) {
        if (((unsigned int )((((b[0] - 1) ^ ((b[0] - 1) >> 31)) - ((b[0] - 1) >> 31)) - 1) >> 31U) & 1) {
          if (((unsigned int )(((b[1] - 1) + (1 << 31)) - ((((b[1] - 1) + (1 << 31)) << 1) & (((b[1] - 1) + (1 << 31)) >> 31))) >> 31U) & 1) {
            c___0[0] = ((c___0[0] + c___0[1]) + 1) + ((- c___0[0] - 1) | (- c___0[1] - 1));
          } else {
            goto _L___6;
          }
        } else
        _L___6: 
        if (((unsigned int )(((b[0] - 1) + (1 << 31)) - ((((b[0] - 1) + (1 << 31)) << 1) & (((b[0] - 1) + (1 << 31)) >> 31))) >> 31U) & 1) {
          if (((unsigned int )((((b[1] - 2) + (1 << 31)) + (((b[1] - 2) + (1 << 31)) >> 31)) ^ (((b[1] - 2) + (1 << 31)) >> 31)) >> 31U) & 1) {
            goto _L___3;
          } else {
            goto _L___5;
        ...
        _L___5: 
        if (((unsigned int )(~ ((b[0] - 2) | (2 - b[0]))) >> 31U) & 1) {
          if (((unsigned int )((((b[1] - 1) + (1 << 31)) + (((b[1] - 1) + (1 << 31)) >> 31)) ^ (((b[1] - 1) + (1 << 31)) >> 31)) >> 31U) & 1) {
            _L___3: 
            if (((~ c___0[0] | c___0[1]) + c___0[0]) + 1) {
              tmp___18 = lrand48();
              if (((~ tmp___18 | 1L) + tmp___18) + 1L) {
                c___0[0] = ((~ c___0[0] | c___0[1]) + c___0[0]) + 1;
              } else {
                c___0[0] = (c___0[0] & ~ c___0[1]) + c___0[1];
              }
            } else {
              goto _L___4;
            }
        ...
        _L___4: 
        if (((unsigned int )((((b[0] - 2) + ((b[0] - 2) >> 31)) ^ ((b[0] - 2) >> 31)) - 1) >> 31U) & 1) {
          if (((unsigned int )((((b[1] - 2) ^ ((b[1] - 2) >> 31)) - ((b[1] - 2) >> 31)) - 1) >> 31U) & 1) {
            if (((unsigned int )(((c___0[0] - c___0[1]) + (1 << 31)) - ((((c___0[0] - c___0[1]) + (1 << 31)) << 1) & (((c___0[0] - c___0[1]) + (1 << 31)) >> 31))) >> 31U) & 1) {
              tmp___20 = lrand48();
              if (((~ tmp___20 | 1L) + tmp___20) + 1L) {
                tmp___19 = lrand48();
                if (((~ tmp___19 | 1L) + tmp___19) + 1L) {
                  i = 8;
                  while (((unsigned int )((~ (1 ^ i) >> 1) + (1 & ~ i)) >> 31U) & 1) {
                    if (((~ c___0[0] | i) + c___0[0]) + 1) {
                      c___0[0] = (~ c___0[0] | i) - ~ c___0[0];
                    }
                    i >>= 1;
                  }
                } else {
                  i = 1;
                  while (((unsigned int )((~ (i ^ 8) >> 1) + (i & ~ 8)) >> 31U) & 1) {
                    if (((~ c___0[0] | i) + c___0[0]) + 1) {
                      c___0[0] = (~ c___0[0] | i) - ~ c___0[0];
                    }
                    i <<= 1;
      ...
      if (((unsigned int )(~ (l % 60 | - (l % 60))) >> 31U) & 1) {
        putchar('\n');
      }
      putchar(c___0[0]);
      l = (l | 1) + (l & 1);
...
{ 
  ...
  prefix = (char *)0;
  n = (uint64_t )1;
  if (((unsigned int )(((argc - 1) + (1 << 31)) - ((((argc - 1) + (1 << 31)) + ((argc - 1) + (1 << 31))) & (((argc - 1) + (1 << 31)) >> 31))) >> 31U) & 1) {
    tmp = fileno(stdin);
    tmp___0 = isatty(tmp);
    if (tmp___0) {
  ...
  if (((unsigned int )(((((argc - 1) & - (argc >= 1)) + ((argc - 1) & - (argc >= 1))) & (((argc - 1) & - (argc >= 1)) >> 31)) - ((argc - 1) & - (argc >= 1))) >> 31U) & 1) {
    tmp___5 = strcmp((char const   *)*(argv + 1), "-");
    if (tmp___5) {
      tmp___2 = gzopen((char const   *)*(argv + 1), "r");
      fp = tmp___2;
  ...
  seq = kseq_init(fp);
  if (((unsigned int )((2 - argc) ^ ((2 ^ argc) & ((2 - argc) ^ 2))) >> 31U) & 1) {
    prefix = *(argv + 2);
  }
  memset((void *)(& last), 0, sizeof(kseq_t ));
  while (1) {
    ...
    if (last.name.l) {
      p = & last.name;
      q = & seq->name;
      if ((int )((~ ((p->l - q->l) | (q->l - p->l)) >> 31UL) & 1UL)) {
        if ((int )((((~ 2UL & p->l) | ((~ 2UL | p->l) & (2UL - p->l))) >> 31UL) & 1UL)) {
          if (((unsigned int )(~ (((int )*(p->s + ((p->l + ~ 2UL) + 1UL)) - 47) | (47 - (int )*(p->s + ((p->l + ~ 2UL) + 1UL))))) >> 31U) & 1) {
            if (((unsigned int )(~ (((int )*(q->s + ((q->l ^ 2UL) - ((~ q->l & 2UL) << 1UL))) - 47) | (47 - (int )*(q->s + ((q->l ^ 2UL) - ((~ q->l & 2UL) << 1UL)))))) >> 31U) & 1) {
              tmp___9 = isdigit((int )*(p->s + ((p->l & ~ 1UL) - (~ p->l & 1UL))));
              if (tmp___9) {
                tmp___10 = isdigit((int )*(q->s + (((q->l & ~ 1UL) + (q->l & ~ 1UL)) - (q->l ^ 1UL))));
                if (tmp___10) {
                  tmp___8 = ((p->l & ~ 2UL) << 1UL) - (p->l ^ 2UL);
                } else {
                  tmp___8 = p->l;
                }
              } else {
      ...
      if (! is_diff) {
        ...
        last.name.l = (size_t___0 )0;
        n = (n ^ 1ULL) + ((n & 1ULL) + (n & 1ULL));
      } else {
        stk_printseq_renamed((kseq_t const   *)(& last), 0, (char const   *)prefix,
                             (int64_t )n);
        n = ((n | 1ULL) << 1ULL) - (n ^ 1ULL);
        cpy_kseq(& last, (kseq_t const   *)seq);
      }
    } else {
      cpy_kseq(& last, (kseq_t const   *)seq);
...
{ 
  ...
  while (1) {
    ...
    if (((unsigned int )((((c - 115) + (1 << 31)) ^ (((c - 115) + (1 << 31)) >> 31)) - (((c - 115) + (1 << 31)) >> 31)) >> 31U) & 1) {
      tmp = atol((char const   *)optarg);
      kr = kr_srand((krint64_t )tmp);
    } else
    if (((unsigned int )(~ ((c - 50) | (50 - c))) >> 31U) & 1) {
      twopass = 1;
    }
  }
  if (((unsigned int )((argc - ((optind - ~ 2) - 1)) ^ ((argc ^ ((optind - ~ 2) - 1)) & ((argc - ((optind - ~ 2) - 1)) ^ argc))) >> 31U) & 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  frac = atof((char const   *)*(argv + (((optind ^ ~ 1) + ((optind | 1) + (optind | 1))) + 1)));
  if (1.0 <= frac) {
  ...
  if (! twopass) {
    ...
    while (1) {
      ...
      if (! (((unsigned int )(~ tmp___8) >> 31U) & 1)) {
        break;
      }
      tmp___6 = kr_rand(kr);
      r = (double )(tmp___6 >> 11) * (1.0 / 9007199254740992.0);
      n_seqs = ((n_seqs ^ ~ 1ULL) + ((n_seqs | 1ULL) << 1ULL)) + 1ULL;
      if (num) {
        if ((int )((((~ ((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) & num) | ((~ ((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) | num) & (((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) - num))) >> 63ULL) & 1ULL)) {
          tmp___7 = (n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL);
        } else {
          tmp___7 = (uint64_t )(r * (double )n_seqs);
        }
        y = tmp___7;
        if ((int )((((~ y & num) | (~ (y ^ num) & (y - num))) >> 63ULL) & 1ULL)) {
    ...
    i = (uint64_t )0;
    while ((int )((((~ i & num) | (~ (i ^ num) & (i - num))) >> 63ULL) & 1ULL)) {
      p = buf + i;
      if (p->seq.l) {
    ...
    while (1) {
      ...
      n_seqs = (n_seqs - ~ 1ULL) - 1ULL;
      if ((int )((((~ ((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) & num) | (~ (((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) ^ num) & (((n_seqs & ~ 1ULL) - (~ n_seqs & 1ULL)) - num))) >> 63ULL) & 1ULL)) {
        y___0 = (n_seqs + ~ 1ULL) + 1ULL;
      } else {
        y___0 = (uint64_t )(r___0 * (double )n_seqs);
      }
      if ((int )((((~ y___0 & num) | ((~ y___0 | num) & (y___0 - num))) >> 63ULL) & 1ULL)) {
    ...
    while (1) {
      ...
      n_seqs = (n_seqs ^ 1ULL) + ((n_seqs & 1ULL) << 1ULL);
      tmp___13 = kh_get_64((kh_64_t const   *)hash, n_seqs);
      if ((int )((((tmp___13 - hash->n_buckets) | (hash->n_buckets - tmp___13)) >> 31U) & 1U)) {
        stk_printseq((kseq_t const   *)seq, -1);
      }
    }
    kh_destroy_64(hash);
...
{ 
  ...
  if (((unsigned int )((argc & ~ ((optind ^ 2) + ((optind & 2) + (optind & 2)))) | (~ (argc ^ ((optind ^ 2) + ((optind & 2) + (optind & 2)))) & (argc - ((optind ^ 2) + ((optind & 2) + (optind & 2)))))) >> 31U) & 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  h = stk_reg_read((char const   *)*(argv + ((optind ^ 1) + ((optind & 1) << 1))));
  ...
  while (1) {
    ...
    k = kh_get_reg((kh_reg_t const   *)h, (kh_cstr_t )seq->name.s);
    if ((int )((~ ((k - h->n_buckets) | (h->n_buckets - k)) >> 31U) & 1U)) {
      continue;
    }
    p = h->vals + k;
    i = 0;
    while (((unsigned int )(((((p->n - i) & - (p->n >= i)) << 1) & (((p->n - i) & - (p->n >= i)) >> 31)) - ((p->n - i) & - (p->n >= i))) >> 31U) & 1) {
      beg = (int )(*(p->a + i) >> 32);
      end = (int )*(p->a + i);
      if ((int )((((~ seq->seq.l | (size_t___0 )beg) & ((seq->seq.l ^ (size_t___0 )beg) | ~ ((size_t___0 )beg - seq->seq.l))) >> 31UL) & 1UL)) {
      ...
      if (((unsigned int )(((is_tab + (is_tab >> 31)) ^ (is_tab >> 31)) - 1) >> 31U) & 1) {
        if ((int )((((((seq->qual.l - seq->seq.l) + (1UL << 31)) ^ ((long )((seq->qual.l - seq->seq.l) + (1UL << 31)) >> 31L)) - ((long )((seq->qual.l - seq->seq.l) + (1UL << 31)) >> 31L)) >> 31UL) & 1UL)) {
          tmp___5 = '@';
        } else {
          tmp___5 = '>';
        }
        printf((char const   */* __restrict  */)"%c%s", tmp___5, seq->name.s);
        if (((unsigned int )(beg ^ (((beg >> 31) - beg) ^ (beg >> 31))) >> 31U) & 1) {
          goto _L;
        } else
        if (((unsigned int )(((int )*(p->a + i) - 2147483647) | (2147483647 - (int )*(p->a + i))) >> 31U) & 1) {
          _L: 
          if (((unsigned int )(((end - 2147483647) + (1 << 31)) - ((((end - 2147483647) + (1 << 31)) << 1) & (((end - 2147483647) + (1 << 31)) >> 31))) >> 31U) & 1) {
            if (beg) {
              printf((char const   */* __restrict  */)":%d", (beg ^ 1) + ((beg & 1) << 1));
            }
          } else {
            printf((char const   */* __restrict  */)":%d-%d", (beg ^ 1) + ((beg & 1) + (beg & 1)),
                   end);
          }
        }
        if (seq->comment.l) {
        ...
        printf((char const   */* __restrict  */)"%s\t%d\t", seq->name.s, (beg - ~ 1) - 1);
      }
      if ((int )((((~ seq->seq.l & (size_t___0 )end) | ((~ seq->seq.l | (size_t___0 )end) & (seq->seq.l - (size_t___0 )end))) >> 31UL) & 1UL)) {
        end = (int )seq->seq.l;
      }
      j = 0;
      while (((unsigned int )((j - ((end + ~ beg) + 1)) ^ ((j ^ ((end + ~ beg) + 1)) & ((j - ((end + ~ beg) + 1)) ^ j))) >> 31U) & 1) {
        if (((unsigned int )(((is_tab ^ (is_tab >> 31)) - (is_tab >> 31)) - 1) >> 31U) & 1) {
          if (((unsigned int )(~ j & (j - 1)) >> 31U) & 1) {
            putchar('\n');
          } else
          if (((unsigned int )(- line & ~ line) >> 31U) & 1) {
            if (((unsigned int )(~ (j % line | - (j % line))) >> 31U) & 1) {
              putchar('\n');
            }
          }
        }
        putchar((int )*(seq->seq.s + ((j - ~ beg) - 1)));
        j = (j | 1) + (j & 1);
      }
      putchar('\n');
      if ((int )((((((seq->qual.l - seq->seq.l) << 1UL) & ((long )(seq->qual.l - seq->seq.l) >> 31L)) - (seq->qual.l - seq->seq.l)) >> 31UL) & 1UL)) {
        goto __Cont;
      } else
      if (is_tab) {
        goto __Cont;
      ...
      j = 0;
      while (((unsigned int )((j - (((end & ~ beg) + (end & ~ beg)) - (end ^ beg))) ^ ((j ^ (((end & ~ beg) + (end & ~ beg)) - (end ^ beg))) & ((j - (((end & ~ beg) + (end & ~ beg)) - (end ^ beg))) ^ j))) >> 31U) & 1) {
        if (((unsigned int )(~ (j | - j)) >> 31U) & 1) {
          putchar('\n');
        } else
        if (((unsigned int )(- line & ~ line) >> 31U) & 1) {
          if (((unsigned int )(((j % line + (1 << 31)) + ((j % line + (1 << 31)) >> 31)) ^ ((j % line + (1 << 31)) >> 31)) >> 31U) & 1) {
            putchar('\n');
          }
        }
        putchar((int )*(seq->qual.s + ((j - ~ beg) - 1)));
        j = ((j ^ ~ 1) + ((j | 1) << 1)) + 1;
      }
      putchar('\n');
      __Cont: 
...
{ 
  ...
  if (((unsigned int )((optind - argc) ^ ((optind ^ argc) & ((optind - argc) ^ optind))) >> 31U) & 1) {
  ...
  seq = kseq_init(fp);
  qual_thres = (qual_thres - ~ qual_shift) - 1;
  while (1) {
    tmp___16 = kseq_read(seq);
    if (! (((unsigned int )(~ tmp___16) >> 31U) & 1)) {
      break;
    }
    n_seqs = ((n_seqs ^ ~ 1LL) + ((n_seqs | 1LL) + (n_seqs | 1LL))) + 1LL;
    if ((int )((((~ seq->seq.l & (size_t___0 )min_len) | ((~ seq->seq.l | (size_t___0 )min_len) & (seq->seq.l - (size_t___0 )min_len))) >> 31UL) & 1UL)) {
      continue;
    }
    if (frac < 1.) {
      tmp___8 = kr_rand(kr);
      if (frac <= (double )(tmp___8 >> 11) * (1.0 / 9007199254740992.0)) {
        continue;
      }
    }
    if ((~ flag | 48) - ~ flag) {
      if (((~ flag | 16) + flag) + 1) {
        if ((int )(((unsigned long long )(((((~ n_seqs | 1LL) - ~ n_seqs) + (1LL << 63)) + ((((~ n_seqs | 1LL) - ~ n_seqs) + (1LL << 63)) >> 63LL)) ^ ((((~ n_seqs | 1LL) - ~ n_seqs) + (1LL << 63)) >> 63LL)) >> 63ULL) & 1LL)) {
          continue;
        }
      }
      if ((~ flag | 32) - ~ flag) {
        if ((int )(((unsigned long long )(((((((~ n_seqs | 1LL) + n_seqs) + 1LL) - 1LL) + (((((~ n_seqs | 1LL) + n_seqs) + 1LL) - 1LL) >> 63LL)) ^ (((((~ n_seqs | 1LL) + n_seqs) + 1LL) - 1LL) >> 63LL)) - 1LL) >> 63ULL) & 1LL)) {
          continue;
        }
      }
    }
    ...
    if (seq->qual.l) {
      if (((unsigned int )((qual_shift - qual_thres) ^ ((qual_shift ^ qual_thres) & ((qual_shift - qual_thres) ^ qual_shift))) >> 31U) & 1) {
        if (mask_chr) {
          i = 0U;
          while ((int )((((~ ((size_t___0 )i) & seq->seq.l) | ((~ ((size_t___0 )i) | seq->seq.l) & ((size_t___0 )i - seq->seq.l))) >> 31UL) & 1UL)) {
            if (((unsigned int )(((int )*(seq->qual.s + i) & ~ qual_thres) | (~ ((int )*(seq->qual.s + i) ^ qual_thres) & ((int )*(seq->qual.s + i) - qual_thres))) >> 31U) & 1) {
              *(seq->seq.s + i) = (char )mask_chr;
            } else
            if (((unsigned int )((max_q - (int )*(seq->qual.s + i)) ^ ((max_q ^ (int )*(seq->qual.s + i)) & ((max_q - (int )*(seq->qual.s + i)) ^ max_q))) >> 31U) & 1) {
              *(seq->seq.s + i) = (char )mask_chr;
            }
            i = (i ^ 1U) + ((i & 1U) + (i & 1U));
          }
          ...
          i = 0U;
          while ((int )((((~ ((size_t___0 )i) & seq->seq.l) | ((~ ((size_t___0 )i) | seq->seq.l) & ((size_t___0 )i - seq->seq.l))) >> 31UL) & 1UL)) {
            if (((unsigned int )(((int )*(seq->qual.s + i) - qual_thres) ^ (((int )*(seq->qual.s + i) ^ qual_thres) & (((int )*(seq->qual.s + i) - qual_thres) ^ (int )*(seq->qual.s + i)))) >> 31U) & 1) {
              tmp___13 = tolower((int )*(seq->seq.s + i));
              *(seq->seq.s + i) = (char )tmp___13;
            } else
            if (((unsigned int )((max_q & ~ ((int )*(seq->qual.s + i))) | (~ (max_q ^ (int )*(seq->qual.s + i)) & (max_q - (int )*(seq->qual.s + i)))) >> 31U) & 1) {
              tmp___13 = tolower((int )*(seq->seq.s + i));
              *(seq->seq.s + i) = (char )tmp___13;
            }
            i = ((i | 1U) + (i | 1U)) - (i ^ 1U);
    ...
    if (((unsigned int )((33 | ~ fake_qual) & ((33 ^ fake_qual) | ~ (fake_qual - 33))) >> 31U) & 1) {
      if (((unsigned int )((~ (fake_qual ^ 127) >> 1) + (fake_qual & ~ 127)) >> 31U) & 1) {
        if ((int )((((~ seq->qual.m & seq->seq.m) | (~ (seq->qual.m ^ seq->seq.m) & (seq->qual.m - seq->seq.m))) >> 31UL) & 1UL)) {
          seq->qual.m = seq->seq.m;
    ...
    if (h) {
      stk_mask(seq, (kh_reg_t const   *)h, (~ flag | 8) - ~ flag, mask_chr);
    }
    if (((~ flag | 4) + flag) + 1) {
      i = 0U;
      while ((int )((((~ ((size_t___0 )i) & (seq->seq.l >> 1)) | ((~ ((size_t___0 )i) | (seq->seq.l >> 1)) & ((size_t___0 )i - (seq->seq.l >> 1)))) >> 31UL) & 1UL)) {
        c0 = (int )comp_tab[(int )*(seq->seq.s + i)];
        c1 = (int )comp_tab[(int )*(seq->seq.s + ((seq->seq.l - 1UL) - (size_t___0 )i))];
        *(seq->seq.s + i) = (char )c1;
        *(seq->seq.s + (((((seq->seq.l & ~ 1UL) << 1UL) - (seq->seq.l ^ 1UL)) ^ (size_t___0 )i) - ((~ (((seq->seq.l & ~ 1UL) << 1UL) - (seq->seq.l ^ 1UL)) & (size_t___0 )i) + (~ (((seq->seq.l & ~ 1UL) << 1UL) - (seq->seq.l ^ 1UL)) & (size_t___0 )i)))) = (char )c0;
        i = (i ^ 1U) + ((i & 1U) << 1U);
      }
      if (((~ seq->seq.l | 1UL) + seq->seq.l) + 1UL) {
      ...
      if (seq->qual.l) {
        ...
        while ((int )((((~ ((size_t___0 )i) & (seq->seq.l >> 1)) | (~ ((size_t___0 )i ^ (seq->seq.l >> 1)) & ((size_t___0 )i - (seq->seq.l >> 1)))) >> 31UL) & 1UL)) {
          c0 = (int )*(seq->qual.s + i);
          *(seq->qual.s + i) = *(seq->qual.s + ((((seq->qual.l + ~ 1UL) + 1UL) + ~ ((size_t___0 )i)) + 1UL));
          *(seq->qual.s + (((((seq->qual.l + ~ 1UL) + 1UL) & ~ ((size_t___0 )i)) << 1UL) - (((seq->qual.l + ~ 1UL) + 1UL) ^ (size_t___0 )i))) = (char )c0;
          i = (i | 1U) + (i & 1U);
        }
      }
    }
    if (((~ flag | 64) + flag) + 1) {
      if (seq->qual.l) {
        if (((unsigned int )((qual_shift - 33) | (33 - qual_shift)) >> 31U) & 1) {
          i = 0U;
          while ((int )((((~ ((size_t___0 )i) & seq->qual.l) | ((~ ((size_t___0 )i) | seq->qual.l) & ((size_t___0 )i - seq->qual.l))) >> 31UL) & 1UL)) {
            *(seq->qual.s + i) = (char )(((int )*(seq->qual.s + i) + ~ ((qual_shift ^ 33) - ((~ qual_shift & 33) << 1))) + 1);
            i = (i | 1U) + (i & 1U);
          }
        }
      }
    ...
    if ((~ flag | 128) - ~ flag) {
      i = 0U;
      while ((int )((((~ ((size_t___0 )i) & seq->seq.l) | (~ ((size_t___0 )i ^ seq->seq.l) & ((size_t___0 )i - seq->seq.l))) >> 31UL) & 1UL)) {
        if (((unsigned int )((3 & ~ ((int )seq_nt16to4_table[seq_nt16_table[(int )*(seq->seq.s + i)]])) | (~ (3 ^ (int )seq_nt16to4_table[seq_nt16_table[(int )*(seq->seq.s + i)]]) & (3 - (int )seq_nt16to4_table[seq_nt16_table[(int )*(seq->seq.s + i)]]))) >> 31U) & 1) {
          break;
        }
        i = ((i | 1U) + (i | 1U)) - (i ^ 1U);
      }
      if ((int )((((~ ((size_t___0 )i) & seq->seq.l) | ((~ ((size_t___0 )i) | seq->seq.l) & ((size_t___0 )i - seq->seq.l))) >> 31UL) & 1UL)) {
        continue;
      }
    }
