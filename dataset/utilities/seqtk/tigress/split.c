...
/* Generated by Tigress v3.2 (https://tigress.wtf), 08:48:48-2023/04/23 */
  ...
  "Transformations": [
    ...
    "TransformationUpdates": {
      "Modified Function Implementations": [
        "usage", "stk_trimfq", "stk_subseq", "stk_seq", "stk_sample",
        "stk_rename", "stk_reg_read", "stk_reg_destroy", "stk_randbase",
        "stk_printstr", "stk_printseq_renamed", "stk_printseq", "stk_mutfa",
        "stk_mergepe", "stk_mergefa", "stk_mask", "stk_listhet", "stk_kfreq",
        "stk_hrun", "stk_hety", "stk_gc", "stk_fqchk", "stk_famask",
        "stk_dropse", "stk_cutN", "stk_comp", "print_seq", "main",
        "kseq_read", "kseq_init", "kseq_destroy", "ks_init", "ks_getuntil2",
        "ks_getuntil", "ks_getc", "ks_destroy", "kr_srand0", "kr_srand",
        "kr_rand", "kh_resize_reg", "kh_resize_64", "kh_put_reg",
        "kh_put_64", "kh_init_reg", "kh_init_64", "kh_get_reg", "kh_get_64",
        "kh_destroy_reg", "kh_destroy_64", "fqc_aux", "find_next_cut",
        "cpy_kstr", "cpy_kseq", "__ac_X31_hash_string"
      ],
      "New Functions": [
        "_1_usage_split_8", "_1_usage_split_7", "_1_usage_split_6",
        "_1_usage_split_5", "_1_usage_split_4", "_1_usage_split_3",
        "_1_usage_split_2", "_1_usage_split_1", "_1_usage_split_0",
        "_1_stk_trimfq_split_1", "_1_stk_trimfq_split_0",
        "_1_stk_subseq_split_1", "_1_stk_subseq_split_0",
        "_1_stk_seq_split_1", "_1_stk_seq_split_0", "_1_stk_sample_split_1",
        "_1_stk_sample_split_0", "_1_stk_rename_split_1",
        "_1_stk_rename_split_0", "_1_stk_reg_read_split_1",
        "_1_stk_reg_read_split_0", "_1_stk_reg_destroy_split_1",
        "_1_stk_reg_destroy_split_0", "_1_stk_randbase_split_1",
        "_1_stk_randbase_split_0", "_1_stk_printstr_split_1",
        "_1_stk_printstr_split_0", "_1_stk_printseq_renamed_split_1",
        "_1_stk_printseq_renamed_split_0", "_1_stk_printseq_split_0",
        "_1_stk_mutfa_split_1", "_1_stk_mutfa_split_0",
        "_1_stk_mergepe_split_1", "_1_stk_mergepe_split_0",
        "_1_stk_mergefa_split_1", "_1_stk_mergefa_split_0",
        "_1_stk_mask_split_1", "_1_stk_mask_split_0",
        "_1_stk_listhet_split_1", "_1_stk_listhet_split_0",
        "_1_stk_kfreq_split_1", "_1_stk_kfreq_split_0",
        "_1_stk_hrun_split_1", "_1_stk_hrun_split_0", "_1_stk_hety_split_1",
        "_1_stk_hety_split_0", "_1_stk_gc_split_1", "_1_stk_gc_split_0",
        "_1_stk_fqchk_split_1", "_1_stk_fqchk_split_0",
        "_1_stk_famask_split_1", "_1_stk_famask_split_0",
        "_1_stk_dropse_split_1", "_1_stk_dropse_split_0",
        "_1_stk_cutN_split_1", "_1_stk_cutN_split_0", "_1_stk_comp_split_1",
        "_1_stk_comp_split_0", "_1_print_seq_split_1",
        "_1_print_seq_split_0", "_1_main_split_1", "_1_main_split_0",
        "_1_kseq_read_split_1", "_1_kseq_read_split_0",
        "_1_kseq_init_split_1", "_1_kseq_init_split_0",
        "_1_kseq_destroy_split_2", "_1_kseq_destroy_split_1",
        "_1_kseq_destroy_split_0", "_1_ks_init_split_1",
        "_1_ks_init_split_0", "_1_ks_getuntil2_split_1",
        "_1_ks_getuntil2_split_0", "_1_ks_getuntil_split_0",
        "_1_ks_getc_split_0", "_1_ks_destroy_split_1",
        "_1_ks_destroy_split_0", "_1_kr_srand0_split_1",
        "_1_kr_srand0_split_0", "_1_kr_srand_split_0", "_1_kr_rand_split_1",
        "_1_kr_rand_split_0", "_1_kh_resize_reg_split_1",
        "_1_kh_resize_reg_split_0", "_1_kh_resize_64_split_1",
        "_1_kh_resize_64_split_0", "_1_kh_put_reg_split_1",
        "_1_kh_put_reg_split_0", "_1_kh_put_64_split_1",
        "_1_kh_put_64_split_0", "_1_kh_init_reg_split_0",
        "_1_kh_init_64_split_0", "_1_kh_get_reg_split_1",
        "_1_kh_get_reg_split_0", "_1_kh_get_64_split_1",
        "_1_kh_get_64_split_0", "_1_kh_destroy_reg_split_1",
        "_1_kh_destroy_reg_split_0", "_1_kh_destroy_64_split_1",
        "_1_kh_destroy_64_split_0", "_1_fqc_aux_split_1",
        "_1_fqc_aux_split_0", "_1_find_next_cut_split_1",
        "_1_find_next_cut_split_0", "_1_cpy_kstr_split_1",
        "_1_cpy_kstr_split_0", "_1_cpy_kseq_split_1", "_1_cpy_kseq_split_0",
        "_1___ac_X31_hash_string_split_1", "_1___ac_X31_hash_string_split_0"
      ]
...
/* BEGIN FUNCTION-DECL _1___ac_X31_hash_string_split_1 LOC=UNKNOWN */
void _1___ac_X31_hash_string_split_1(char const   **s , khint_t *h ) ;
/* END FUNCTION-DECL _1___ac_X31_hash_string_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_cutN_split_1 LOC=UNKNOWN */
void _1_stk_cutN_split_1(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                         gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_cutN_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kseq_destroy_split_2 LOC=UNKNOWN */
void _1_kseq_destroy_split_2(kseq_t **ks ) ;
/* END FUNCTION-DECL _1_kseq_destroy_split_2 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_dropse_split_1 LOC=UNKNOWN */
void _1_stk_dropse_split_1(gzFile *fp , kseq_t **seq , kseq_t *last , kstring_t **p ,
                           kstring_t **q , int *is_diff , int *l , size_t___0 *tmp___8 ,
                           int *tmp___9 , int *tmp___10 , int *tmp___11 ) ;
/* END FUNCTION-DECL _1_stk_dropse_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_famask_split_0 LOC=UNKNOWN */
void _1_stk_famask_split_0(int *argc , char ***argv , int *c ) ;
/* END FUNCTION-DECL _1_stk_famask_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_resize_64_split_0 LOC=UNKNOWN */
void _1_kh_resize_64_split_0(khint_t *new_n_buckets , khint32_t **new_flags , khint_t *j ) ;
/* END FUNCTION-DECL _1_kh_resize_64_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_listhet_split_1 LOC=UNKNOWN */
void _1_stk_listhet_split_1(gzFile *fp , kseq_t **seq , int *i , int *l , int *b ) ;
/* END FUNCTION-DECL _1_stk_listhet_split_1 LOC=UNKNOWN */

/* BEGIN TYPEDEF kstream_t LOC=seqtk.c:39 */
typedef struct __kstream_t kstream_t;
/* END TYPEDEF kstream_t LOC=seqtk.c:39 */

/* BEGIN FUNCTION-DECL _1_ks_destroy_split_0 LOC=UNKNOWN */
void _1_ks_destroy_split_0(kstream_t **ks ) ;
/* END FUNCTION-DECL _1_ks_destroy_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kseq_read_split_1 LOC=UNKNOWN */
void _1_kseq_read_split_1(kseq_t **seq , int *c , int *r , kstream_t **ks , size_t___0 *tmp ,
                          size_t___0 *tmp___0 ) ;
/* END FUNCTION-DECL _1_kseq_read_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_mergepe_split_1 LOC=UNKNOWN */
void _1_stk_mergepe_split_1(gzFile *fp1 , gzFile *fp2 , kseq_t *(*seq)[2] , int *tmp___9 ,
                            int *tmp___10 , int *tmp___11 ) ;
/* END FUNCTION-DECL _1_stk_mergepe_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_printstr_split_1 LOC=UNKNOWN */
void _1_stk_printstr_split_1(kstring_t const   **s , unsigned int *line_len , int *i ,
                             int *rest ) ;
/* END FUNCTION-DECL _1_stk_printstr_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_rename_split_1 LOC=UNKNOWN */
void _1_stk_rename_split_1(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                           int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) ;
/* END FUNCTION-DECL _1_stk_rename_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_printseq_renamed_split_1 LOC=UNKNOWN */
void _1_stk_printseq_renamed_split_1(kseq_t const   **s , int *line_len ) ;
/* END FUNCTION-DECL _1_stk_printseq_renamed_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_get_64_split_0 LOC=UNKNOWN */
void _1_kh_get_64_split_0(kh_64_t const   **h , khint64_t *key , khint_t *inc , khint_t *k ,
                          khint_t *i , khint_t *last , khint_t *mask ) ;
/* END FUNCTION-DECL _1_kh_get_64_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_getuntil_split_0 LOC=UNKNOWN */
void _1_ks_getuntil_split_0(kstream_t **ks , int *delimiter , kstring_t **str , int **dret ,
                            int *tmp ) ;
/* END FUNCTION-DECL _1_ks_getuntil_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_sample_split_1 LOC=UNKNOWN */
void _1_stk_sample_split_1(char ***argv , int *twopass , uint64_t *num , double *frac ,
                           krand_t **kr ) ;
/* END FUNCTION-DECL _1_stk_sample_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_destroy_reg_split_0 LOC=UNKNOWN */
void _1_kh_destroy_reg_split_0(kh_reg_t **h ) ;
/* END FUNCTION-DECL _1_kh_destroy_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_listhet_split_0 LOC=UNKNOWN */
void _1_stk_listhet_split_0(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                            gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_listhet_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_reg_read_split_0 LOC=UNKNOWN */
void _1_stk_reg_read_split_0(char const   **fn , reghash_t **h , kh_reg_t **tmp ,
                             gzFile *fp , gzFile *tmp___1 , int *tmp___2 , gzFile *tmp___3 ,
                             int *tmp___4 ) ;
/* END FUNCTION-DECL _1_stk_reg_read_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_gc_split_0 LOC=UNKNOWN */
void _1_stk_gc_split_0(int *argc , char ***argv , int *c , int *is_at , int *min_l ,
                       double *frac , double *xdropoff ) ;
/* END FUNCTION-DECL _1_stk_gc_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_hrun_split_1 LOC=UNKNOWN */
void _1_stk_hrun_split_1(int *argc , char ***argv , gzFile *fp , int *min_len , int *tmp___0 ,
                         gzFile *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_hrun_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_kfreq_split_0 LOC=UNKNOWN */
void _1_stk_kfreq_split_0(int *argc , char ***argv , gzFile *fp , int *kmer , int *i ,
                          int *l , int *mask , char **nei , size_t___0 *tmp , int *c ,
                          int *tmp___0 , void **tmp___1 , int *j , int *x , int *tmp___3 ,
                          gzFile *tmp___4 , gzFile *tmp___5 , int *tmp___6 ) ;
/* END FUNCTION-DECL _1_stk_kfreq_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_seq_split_1 LOC=UNKNOWN */
void _1_stk_seq_split_1(int *argc , char ***argv , gzFile *fp , unsigned int *line_len ,
                        gzFile *tmp___4 , int *tmp___5 , gzFile *tmp___6 , int *tmp___7 ) ;
/* END FUNCTION-DECL _1_stk_seq_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_mergefa_split_0 LOC=UNKNOWN */
void _1_stk_mergefa_split_0(int *argc , char ***argv , int *c , int *is_intersect ,
                            int *is_haploid , int *qual , int *is_mask , int *is_randhet ) ;
/* END FUNCTION-DECL _1_stk_mergefa_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_subseq_split_0 LOC=UNKNOWN */
void _1_stk_subseq_split_0(int *argc , char ***argv , kh_reg_t **h , kh_reg_t **tmp ,
                           int *c , int *is_tab , int *line ) ;
/* END FUNCTION-DECL _1_stk_subseq_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_init_64_split_0 LOC=UNKNOWN */
void _1_kh_init_64_split_0(void **tmp ) ;
/* END FUNCTION-DECL _1_kh_init_64_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_get_64_split_1 LOC=UNKNOWN */
void _1_kh_get_64_split_1(kh_64_t const   **h , khint_t *i , khint_t *tmp ) ;
/* END FUNCTION-DECL _1_kh_get_64_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_kseq_destroy_split_1 LOC=UNKNOWN */
void _1_kseq_destroy_split_1(kseq_t **ks ) ;
/* END FUNCTION-DECL _1_kseq_destroy_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_hrun_split_0 LOC=UNKNOWN */
void _1_stk_hrun_split_0(int *min_len , int *l , int *c , int *beg ) ;
/* END FUNCTION-DECL _1_stk_hrun_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_kseq_read_split_0 LOC=UNKNOWN */
void _1_kseq_read_split_0(kseq_t **seq , kstream_t **ks ) ;
/* END FUNCTION-DECL _1_kseq_read_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_sample_split_0 LOC=UNKNOWN */
void _1_stk_sample_split_0(int *argc , char ***argv , int *c , int *twopass , uint64_t *num ,
                           uint64_t *n_seqs , double *frac , krand_t **kr , long *tmp ) ;
/* END FUNCTION-DECL _1_stk_sample_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_fqc_aux_split_1 LOC=UNKNOWN */
void _1_fqc_aux_split_1(posstat_t **p , int64_t **allq , double **perr , int *qthres ,
                        int *k , int64_t *sum , int64_t *qsum , int64_t *sum_low ,
                        double *psum , double *tmp ) ;
/* END FUNCTION-DECL _1_fqc_aux_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kr_srand0_split_0 LOC=UNKNOWN */
void _1_kr_srand0_split_0(krint64_t *seed , krand_t **kr ) ;
/* END FUNCTION-DECL _1_kr_srand0_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_trimfq_split_0 LOC=UNKNOWN */
void _1_stk_trimfq_split_0(int *argc , char ***argv , double *param , int *c , int *min_len ,
                           int *left , int *right , int *fixed_len ) ;
/* END FUNCTION-DECL _1_stk_trimfq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_usage_split_8 LOC=UNKNOWN */
void _1_usage_split_8(void) ;
/* END FUNCTION-DECL _1_usage_split_8 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_famask_split_1 LOC=UNKNOWN */
void _1_stk_famask_split_1(char ***argv , gzFile (*fp)[2] , kseq_t *(*seq)[2] , int *i ,
                           gzFile *tmp___0 , int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_famask_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_main_split_1 LOC=UNKNOWN */
void _1_main_split_1(char ***argv , int *tmp___37 ) ;
...
/* BEGIN FUNCTION-DECL _1_kh_destroy_64_split_0 LOC=UNKNOWN */
void _1_kh_destroy_64_split_0(kh_64_t **h ) ;
/* END FUNCTION-DECL _1_kh_destroy_64_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_cpy_kseq_split_0 LOC=UNKNOWN */
void _1_cpy_kseq_split_0(kseq_t **dst , kseq_t const   **src ) ;
/* END FUNCTION-DECL _1_cpy_kseq_split_0 LOC=UNKNOWN */

/* BEGIN VARIABLE-DEF seq_nt16_rev_table LOC=UNKNOWN */
char *seq_nt16_rev_table  ;
/* END VARIABLE-DEF seq_nt16_rev_table LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_kfreq_split_1 LOC=UNKNOWN */
void _1_stk_kfreq_split_1(gzFile *fp , kseq_t **ks , int *kmer , int *i , int *l ,
                          int *mask , char **nei , int *k , int (*x___0)[2] , int (*cnt)[2] ,
                          int (*cnt_nei)[2] , int *which , int *c___0 , int *tmp___7 ) ;
/* END FUNCTION-DECL _1_stk_kfreq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_randbase_split_0 LOC=UNKNOWN */
void _1_stk_randbase_split_0(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                             gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_randbase_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_fqchk_split_1 LOC=UNKNOWN */
void _1_stk_fqchk_split_1(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                          gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_fqchk_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_printseq_split_0 LOC=UNKNOWN */
void _1_stk_printseq_split_0(kseq_t const   **s , int *line_len ) ;
/* END FUNCTION-DECL _1_stk_printseq_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kr_srand0_split_1 LOC=UNKNOWN */
void _1_kr_srand0_split_1(krand_t **kr ) ;
/* END FUNCTION-DECL _1_kr_srand0_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_get_reg_split_1 LOC=UNKNOWN */
void _1_kh_get_reg_split_1(kh_reg_t const   **h , khint_t *i , khint_t *tmp___0 ) ;
/* END FUNCTION-DECL _1_kh_get_reg_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_hety_split_1 LOC=UNKNOWN */
void _1_stk_hety_split_1(int *argc , char ***argv , gzFile *fp , int *c , int *win_size ,
                         int *n_start , int *is_lower_mask , int *tmp___0 , gzFile *tmp___1 ,
                         gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_hety_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_init_reg_split_0 LOC=UNKNOWN */
void _1_kh_init_reg_split_0(void **tmp ) ;
/* END FUNCTION-DECL _1_kh_init_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_print_seq_split_0 LOC=UNKNOWN */
void _1_print_seq_split_0(FILE **fpout , kseq_t const   **ks , int *begin , int *end ,
                          int *i , int *tmp ) ;
/* END FUNCTION-DECL _1_print_seq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_comp_split_1 LOC=UNKNOWN */
void _1_stk_comp_split_1(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                         int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) ;
/* END FUNCTION-DECL _1_stk_comp_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_mask_split_1 LOC=UNKNOWN */
void _1_stk_mask_split_1(kseq_t **seq , kh_reg_t const   **h , int *is_complement ,
                         int *mask_chr , unsigned int *i , unsigned int *j , khiter_t *k ,
                         int *tmp , reglist_t **p , unsigned int *beg , unsigned int *end ,
                         int *tmp___0 , int8_t **mask , void **tmp___1 , unsigned int *beg___0 ,
                         unsigned int *end___0 , int *tmp___2 ) ;
/* END FUNCTION-DECL _1_stk_mask_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kr_rand_split_1 LOC=UNKNOWN */
void _1_kr_rand_split_1(krand_t **kr , krint64_t *x , int *tmp ) ;
/* END FUNCTION-DECL _1_kr_rand_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1___ac_X31_hash_string_split_0 LOC=UNKNOWN */
void _1___ac_X31_hash_string_split_0(char const   **s , khint_t *h ) ;
/* END FUNCTION-DECL _1___ac_X31_hash_string_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_put_reg_split_0 LOC=UNKNOWN */
void _1_kh_put_reg_split_0(kh_reg_t **h , kh_cstr_t *key , khint_t *x , khint_t *k ,
                           khint_t *i , khint_t *site , khint_t *mask ) ;
/* END FUNCTION-DECL _1_kh_put_reg_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_rename_split_0 LOC=UNKNOWN */
void _1_stk_rename_split_0(char **prefix , uint64_t *n ) ;
/* END FUNCTION-DECL _1_stk_rename_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kseq_init_split_0 LOC=UNKNOWN */
void _1_kseq_init_split_0(void **tmp ) ;
/* END FUNCTION-DECL _1_kseq_init_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_cpy_kstr_split_0 LOC=UNKNOWN */
void _1_cpy_kstr_split_0(kstring_t **dst , kstring_t const   **src , void **tmp ) ;
/* END FUNCTION-DECL _1_cpy_kstr_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_mergepe_split_0 LOC=UNKNOWN */
void _1_stk_mergepe_split_0(char ***argv , gzFile *fp1 , gzFile *fp2 , gzFile *tmp___0 ,
                            int *tmp___1 , gzFile *tmp___2 , int *tmp___3 , gzFile *tmp___5 ,
                            int *tmp___6 , gzFile *tmp___7 , int *tmp___8 ) ;
/* END FUNCTION-DECL _1_stk_mergepe_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kseq_destroy_split_0 LOC=UNKNOWN */
void _1_kseq_destroy_split_0(kseq_t **ks ) ;
/* END FUNCTION-DECL _1_kseq_destroy_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_find_next_cut_split_0 LOC=UNKNOWN */
void _1_find_next_cut_split_0(kseq_t const   **ks , int *k , int *i , int *b , int *e ,
                              int *score , int *max ) ;
/* END FUNCTION-DECL _1_find_next_cut_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kseq_init_split_1 LOC=UNKNOWN */
void _1_kseq_init_split_1(gzFile *fd , kseq_t **s , void **tmp ) ;
/* END FUNCTION-DECL _1_kseq_init_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_init_split_1 LOC=UNKNOWN */
void _1_ks_init_split_1(kstream_t **ks , void **tmp___0 ) ;
/* END FUNCTION-DECL _1_ks_init_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_put_64_split_1 LOC=UNKNOWN */
void _1_kh_put_64_split_1(kh_64_t **h , khint64_t *key , int **ret , khint_t *x ,
                          khint_t *inc , khint_t *k , khint_t *i , khint_t *site ,
                          khint_t *last , khint_t *mask ) ;
/* END FUNCTION-DECL _1_kh_put_64_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_getuntil2_split_1 LOC=UNKNOWN */
void _1_ks_getuntil2_split_1(int *delimiter , kstring_t **str , void **tmp___2 ) ;
/* END FUNCTION-DECL _1_ks_getuntil2_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_cpy_kstr_split_1 LOC=UNKNOWN */
void _1_cpy_kstr_split_1(kstring_t **dst , kstring_t const   **src ) ;
/* END FUNCTION-DECL _1_cpy_kstr_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_randbase_split_1 LOC=UNKNOWN */
void _1_stk_randbase_split_1(gzFile *fp , kseq_t **seq , int *l , int *i , int *c ,
                             int *b , int *a , int *j , int *k , int *m , double *tmp___4 ,
                             int *tmp___6 ) ;
/* END FUNCTION-DECL _1_stk_randbase_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_cpy_kseq_split_1 LOC=UNKNOWN */
void _1_cpy_kseq_split_1(kseq_t **dst , kseq_t const   **src ) ;
/* END FUNCTION-DECL _1_cpy_kseq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_comp_split_0 LOC=UNKNOWN */
void _1_stk_comp_split_0(int *argc , char ***argv , int *c , int *upper_only , reghash_t **h ) ;
/* END FUNCTION-DECL _1_stk_comp_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_dropse_split_0 LOC=UNKNOWN */
void _1_stk_dropse_split_0(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                           int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) ;
/* END FUNCTION-DECL _1_stk_dropse_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_put_64_split_0 LOC=UNKNOWN */
void _1_kh_put_64_split_0(kh_64_t **h , khint64_t *key , khint_t *x , khint_t *k ,
                          khint_t *i , khint_t *site , khint_t *mask ) ;
/* END FUNCTION-DECL _1_kh_put_64_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_destroy_split_1 LOC=UNKNOWN */
void _1_ks_destroy_split_1(kstream_t **ks ) ;
/* END FUNCTION-DECL _1_ks_destroy_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_6 LOC=UNKNOWN */
void _1_usage_split_6(void) ;
/* END FUNCTION-DECL _1_usage_split_6 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_printstr_split_0 LOC=UNKNOWN */
void _1_stk_printstr_split_0(kstring_t const   **s , int *i , int *rest ) ;
/* END FUNCTION-DECL _1_stk_printstr_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_resize_reg_split_1 LOC=UNKNOWN */
void _1_kh_resize_reg_split_1(kh_reg_t **h , khint_t *new_n_buckets , khint32_t **new_flags ,
                              khint_t *j , khint_t *tmp , void **tmp___0 , khint_t *tmp___1 ,
                              void **tmp___2 , void **tmp___3 , kh_cstr_t *key , reglist_t *val ,
                              khint_t *new_mask , khint_t *inc , khint_t *k , khint_t *i ,
                              kh_cstr_t *tmp___4 , reglist_t *tmp___5 , void **tmp___6 ,
                              void **tmp___7 ) ;
/* END FUNCTION-DECL _1_kh_resize_reg_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_fqchk_split_0 LOC=UNKNOWN */
void _1_stk_fqchk_split_0(int *argc , char ***argv , int *c , int *max_len , int *min_len ,
                          int *max_alloc , int *offset , int *n_diffQ , int *qthres ,
                          int64_t *tot_len , int64_t *n , posstat_t **pos ) ;
/* END FUNCTION-DECL _1_stk_fqchk_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_cutN_split_0 LOC=UNKNOWN */
void _1_stk_cutN_split_0(int *gap_only ) ;
/* END FUNCTION-DECL _1_stk_cutN_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_kh_destroy_64_split_1 LOC=UNKNOWN */
void _1_kh_destroy_64_split_1(kh_64_t **h ) ;
/* END FUNCTION-DECL _1_kh_destroy_64_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_hety_split_0 LOC=UNKNOWN */
void _1_stk_hety_split_0(int *win_size , int *n_start , int *is_lower_mask ) ;
/* END FUNCTION-DECL _1_stk_hety_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_seq_split_0 LOC=UNKNOWN */
void _1_stk_seq_split_0(int *argc , char ***argv , int *c , int *qual_thres , int *flag ,
                        int *qual_shift , int *mask_chr , int *min_len , int *max_q ,
                        int *fake_qual , unsigned int *line_len , int64_t *n_seqs ,
                        double *frac , kh_reg_t **h , krand_t **kr , int *tmp , long *tmp___0 ) ;
/* END FUNCTION-DECL _1_stk_seq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_reg_destroy_split_0 LOC=UNKNOWN */
void _1_stk_reg_destroy_split_0(khint_t *k ) ;
/* END FUNCTION-DECL _1_stk_reg_destroy_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_5 LOC=UNKNOWN */
void _1_usage_split_5(void) ;
/* END FUNCTION-DECL _1_usage_split_5 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_4 LOC=UNKNOWN */
void _1_usage_split_4(void) ;
/* END FUNCTION-DECL _1_usage_split_4 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_trimfq_split_1 LOC=UNKNOWN */
void _1_stk_trimfq_split_1(char ***argv , gzFile *fp , gzFile *tmp___0 , int *tmp___1 ,
                           gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_trimfq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_7 LOC=UNKNOWN */
void _1_usage_split_7(void) ;
/* END FUNCTION-DECL _1_usage_split_7 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_print_seq_split_1 LOC=UNKNOWN */
void _1_print_seq_split_1(FILE **fpout , kseq_t const   **ks , int *begin , int *end ,
                          int *i ) ;
/* END FUNCTION-DECL _1_print_seq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kr_srand_split_0 LOC=UNKNOWN */
void _1_kr_srand_split_0(krint64_t *seed , krand_t **kr , void **tmp ) ;
/* END FUNCTION-DECL _1_kr_srand_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_mutfa_split_0 LOC=UNKNOWN */
void _1_stk_mutfa_split_0(kh_reg_t **h , kh_reg_t **tmp ) ;
/* END FUNCTION-DECL _1_stk_mutfa_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_fqc_aux_split_0 LOC=UNKNOWN */
void _1_fqc_aux_split_0(posstat_t **p , int *pos , int *k , int64_t *sum , int64_t *qsum ,
                        int64_t *sum_low , double *psum ) ;
/* END FUNCTION-DECL _1_fqc_aux_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_init_split_0 LOC=UNKNOWN */
void _1_ks_init_split_0(gzFile *f , kstream_t **ks , void **tmp , void **tmp___0 ) ;
/* END FUNCTION-DECL _1_ks_init_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_mask_split_0 LOC=UNKNOWN */
void _1_stk_mask_split_0(kseq_t **seq , kh_reg_t const   **h , khiter_t *k ) ;
/* END FUNCTION-DECL _1_stk_mask_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_destroy_reg_split_1 LOC=UNKNOWN */
void _1_kh_destroy_reg_split_1(kh_reg_t **h ) ;
/* END FUNCTION-DECL _1_kh_destroy_reg_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_get_reg_split_0 LOC=UNKNOWN */
void _1_kh_get_reg_split_0(kh_reg_t const   **h , kh_cstr_t *key , khint_t *inc ,
                           khint_t *k , khint_t *i , khint_t *last , khint_t *mask ) ;
/* END FUNCTION-DECL _1_kh_get_reg_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_3 LOC=UNKNOWN */
void _1_usage_split_3(void) ;
/* END FUNCTION-DECL _1_usage_split_3 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_printseq_renamed_split_0 LOC=UNKNOWN */
void _1_stk_printseq_renamed_split_0(kseq_t const   **s , char const   **prefix ,
                                     int64_t *n , int *tmp ) ;
/* END FUNCTION-DECL _1_stk_printseq_renamed_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_reg_destroy_split_1 LOC=UNKNOWN */
void _1_stk_reg_destroy_split_1(reghash_t **h , khint_t *k ) ;
/* END FUNCTION-DECL _1_stk_reg_destroy_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_ks_getuntil2_split_0 LOC=UNKNOWN */
void _1_ks_getuntil2_split_0(kstring_t **str , int **dret , int *append , int *gotany ) ;
/* END FUNCTION-DECL _1_ks_getuntil2_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_kh_put_reg_split_1 LOC=UNKNOWN */
void _1_kh_put_reg_split_1(kh_reg_t **h , kh_cstr_t *key , int **ret , khint_t *x ,
                           khint_t *inc , khint_t *k , khint_t *i , khint_t *site ,
                           khint_t *last , khint_t *mask , int *tmp ) ;
/* END FUNCTION-DECL _1_kh_put_reg_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_reg_read_split_1 LOC=UNKNOWN */
void _1_stk_reg_read_split_1(reghash_t **h , gzFile *fp , kstream_t **ks , int *dret ,
                             kstring_t **str , void **tmp___5 , int *beg , int *end ,
                             reglist_t **p , khint_t *k , khint_t *tmp___6 , int *ret ,
                             char **s , char **tmp___7 , int *tmp___8 , int *tmp___9 ,
                             int *tmp___10 , int *tmp___11 , void **tmp___12 , int *tmp___13 ,
                             int *tmp___14 ) ;
/* END FUNCTION-DECL _1_stk_reg_read_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_stk_mutfa_split_1 LOC=UNKNOWN */
void _1_stk_mutfa_split_1(char ***argv , gzFile *fp , kstring_t **str , void **tmp___0 ,
                          gzFile *tmp___2 , int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) ;
/* END FUNCTION-DECL _1_stk_mutfa_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_resize_64_split_1 LOC=UNKNOWN */
void _1_kh_resize_64_split_1(kh_64_t **h , khint_t *new_n_buckets , khint32_t **new_flags ,
                             khint_t *j , khint_t *tmp , void **tmp___0 , khint_t *tmp___1 ,
                             void **tmp___2 , khint64_t *key , khint_t *new_mask ,
                             khint_t *inc , khint_t *k , khint_t *i , khint64_t *tmp___4 ,
                             void **tmp___6 ) ;
/* END FUNCTION-DECL _1_kh_resize_64_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_mergefa_split_1 LOC=UNKNOWN */
void _1_stk_mergefa_split_1(char ***argv , gzFile (*fp)[2] , kseq_t *(*seq)[2] , int *i ,
                            gzFile *tmp___0 , int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_mergefa_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_ks_getc_split_0 LOC=UNKNOWN */
void _1_ks_getc_split_0(kstream_t **ks ) ;
/* END FUNCTION-DECL _1_ks_getc_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_usage_split_2 LOC=UNKNOWN */
void _1_usage_split_2(void) ;
/* END FUNCTION-DECL _1_usage_split_2 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_subseq_split_1 LOC=UNKNOWN */
void _1_stk_subseq_split_1(char ***argv , kh_reg_t **h ) ;
/* END FUNCTION-DECL _1_stk_subseq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_find_next_cut_split_1 LOC=UNKNOWN */
void _1_find_next_cut_split_1(int *k , int *e ) ;
/* END FUNCTION-DECL _1_find_next_cut_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_stk_gc_split_1 LOC=UNKNOWN */
void _1_stk_gc_split_1(char ***argv , double *frac , double *q , gzFile *fp , gzFile *tmp___0 ,
                       int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) ;
/* END FUNCTION-DECL _1_stk_gc_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DECL _1_kr_rand_split_0 LOC=UNKNOWN */
void _1_kr_rand_split_0(krand_t **kr , krint64_t *x , int *i ) ;
/* END FUNCTION-DECL _1_kr_rand_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DECL _1_kh_resize_reg_split_0 LOC=UNKNOWN */
void _1_kh_resize_reg_split_0(khint_t *new_n_buckets , khint32_t **new_flags , khint_t *j ) ;
/* END FUNCTION-DECL _1_kh_resize_reg_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF _1_kh_get_reg_split_1 LOC=UNKNOWN */
void _1_kh_get_reg_split_1(kh_reg_t const   **h , khint_t *i , khint_t *tmp___0 ) 
{ 
...
/* END FUNCTION-DEF _1_kh_get_reg_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_getuntil_split_0 LOC=UNKNOWN */
void _1_ks_getuntil_split_0(kstream_t **ks , int *delimiter , kstring_t **str , int **dret ,
                            int *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_ks_getuntil_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_put_64_split_1 LOC=UNKNOWN */
void _1_kh_put_64_split_1(kh_64_t **h , khint64_t *key , int **ret , khint_t *x ,
                          khint_t *inc , khint_t *k , khint_t *i , khint_t *site ,
                          khint_t *last , khint_t *mask ) 
{ 
...
/* END FUNCTION-DEF _1_kh_put_64_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_getuntil2_split_1 LOC=UNKNOWN */
void _1_ks_getuntil2_split_1(int *delimiter , kstring_t **str , void **tmp___2 ) 
{ 
...
/* END FUNCTION-DEF _1_ks_getuntil2_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kh_resize_reg_split_0(& new_n_buckets, & new_flags, & j);
  _1_kh_resize_reg_split_1(& h, & new_n_buckets, & new_flags, & j, & tmp, & tmp___0,
                           & tmp___1, & tmp___2, & tmp___3, & key, & val, & new_mask,
                           & inc, & k, & i, & tmp___4, & tmp___5, & tmp___6, & tmp___7);
  return;
}
}
/* END FUNCTION-DEF kh_resize_reg LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mergefa_split_1 LOC=UNKNOWN */
void _1_stk_mergefa_split_1(char ***argv , gzFile (*fp)[2] , kseq_t *(*seq)[2] , int *i ,
                            gzFile *tmp___0 , int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mergefa_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_get_reg_split_0 LOC=UNKNOWN */
void _1_kh_get_reg_split_0(kh_reg_t const   **h , kh_cstr_t *key , khint_t *inc ,
                           khint_t *k , khint_t *i , khint_t *last , khint_t *mask ) 
{ 
...
/* END FUNCTION-DEF _1_kh_get_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_getc_split_0 LOC=UNKNOWN */
void _1_ks_getc_split_0(kstream_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_ks_getc_split_0 LOC=UNKNOWN */
...
{ 
  ...
  _1_stk_reg_destroy_split_0(& k);
  _1_stk_reg_destroy_split_1(& h, & k);
  return;
}
}
/* END FUNCTION-DEF stk_reg_destroy LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_listhet_split_1 LOC=UNKNOWN */
void _1_stk_listhet_split_1(gzFile *fp , kseq_t **seq , int *i , int *l , int *b ) 
{ 
...
/* END FUNCTION-DEF _1_stk_listhet_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_print_seq_split_0 LOC=UNKNOWN */
void _1_print_seq_split_0(FILE **fpout , kseq_t const   **ks , int *begin , int *end ,
                          int *i , int *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_print_seq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_cpy_kstr_split_0 LOC=UNKNOWN */
void _1_cpy_kstr_split_0(kstring_t **dst , kstring_t const   **src , void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_cpy_kstr_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_subseq_split_0(& argc, & argv, & h, & tmp, & c, & is_tab, & line);
  if (optind + 2 > argc) {
...
{ 
  ...
  {
  _1___ac_X31_hash_string_split_0(& s, & h);
  _1___ac_X31_hash_string_split_1(& s, & h);
  return (h);
}
}
...
{ 
  ...
  _1_stk_dropse_split_0(& argc, & argv, & fp, & tmp___2, & tmp___3, & tmp___4, & tmp___5);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_dropse");
    return (1);
  }
  _1_stk_dropse_split_1(& fp, & seq, & last, & p, & q, & is_diff, & l, & tmp___8,
...
/* BEGIN FUNCTION-DEF _1_kh_destroy_reg_split_0 LOC=UNKNOWN */
void _1_kh_destroy_reg_split_0(kh_reg_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_kh_destroy_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mutfa_split_1 LOC=UNKNOWN */
void _1_stk_mutfa_split_1(char ***argv , gzFile *fp , kstring_t **str , void **tmp___0 ,
                          gzFile *tmp___2 , int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mutfa_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_printseq_split_0(& s, & line_len);
  return;
}
}
/* END FUNCTION-DEF stk_printseq LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_rename_split_0 LOC=UNKNOWN */
void _1_stk_rename_split_0(char **prefix , uint64_t *n ) 
{ 
...
/* END FUNCTION-DEF _1_stk_rename_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_find_next_cut_split_0 LOC=UNKNOWN */
void _1_find_next_cut_split_0(kseq_t const   **ks , int *k , int *i , int *b , int *e ,
                              int *score , int *max ) 
{ 
...
/* END FUNCTION-DEF _1_find_next_cut_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_destroy_split_1 LOC=UNKNOWN */
void _1_ks_destroy_split_1(kstream_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_ks_destroy_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_fqc_aux_split_1 LOC=UNKNOWN */
void _1_fqc_aux_split_1(posstat_t **p , int64_t **allq , double **perr , int *qthres ,
                        int *k , int64_t *sum , int64_t *qsum , int64_t *sum_low ,
                        double *psum , double *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_fqc_aux_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_find_next_cut_split_1 LOC=UNKNOWN */
void _1_find_next_cut_split_1(int *k , int *e ) 
{ 
...
/* END FUNCTION-DEF _1_find_next_cut_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_reg_read_split_0 LOC=UNKNOWN */
void _1_stk_reg_read_split_0(char const   **fn , reghash_t **h , kh_reg_t **tmp ,
                             gzFile *fp , gzFile *tmp___1 , int *tmp___2 , gzFile *tmp___3 ,
                             int *tmp___4 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_reg_read_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  if (ks) {
    _1_ks_destroy_split_0(& ks);
    _1_ks_destroy_split_1(& ks);
  }
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_kh_put_reg_split_0 LOC=UNKNOWN */
void _1_kh_put_reg_split_0(kh_reg_t **h , kh_cstr_t *key , khint_t *x , khint_t *k ,
                           khint_t *i , khint_t *site , khint_t *mask ) 
{ 
...
/* END FUNCTION-DEF _1_kh_put_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_put_reg_split_1 LOC=UNKNOWN */
void _1_kh_put_reg_split_1(kh_reg_t **h , kh_cstr_t *key , int **ret , khint_t *x ,
                           khint_t *inc , khint_t *k , khint_t *i , khint_t *site ,
                           khint_t *last , khint_t *mask , int *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kh_put_reg_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_cpy_kseq_split_0(& dst, & src);
  _1_cpy_kseq_split_1(& dst, & src);
  return;
}
}
/* END FUNCTION-DEF cpy_kseq LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mask_split_0 LOC=UNKNOWN */
void _1_stk_mask_split_0(kseq_t **seq , kh_reg_t const   **h , khiter_t *k ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mask_split_0 LOC=UNKNOWN */
...
{ 
  ...
  _1_stk_randbase_split_0(& argv, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_randbase");
    return (1);
  }
  _1_stk_randbase_split_1(& fp, & seq, & l, & i, & c, & b, & a, & j, & k, & m, & tmp___4,
                          & tmp___6);
  return (0);
}
}
...
{ 
  ...
  {
  _1_kh_put_reg_split_0(& h, & key, & x, & k, & i, & site, & mask);
  _1_kh_put_reg_split_1(& h, & key, & ret, & x, & inc, & k, & i, & site, & last, & mask,
                        & tmp);
  return (x);
}
}
...
{ 
  ...
  _1_stk_kfreq_split_0(& argc, & argv, & fp, & kmer, & i, & l, & mask, & nei, & tmp,
                       & c, & tmp___0, & tmp___1, & j, & x, & tmp___3, & tmp___4,
                       & tmp___5, & tmp___6);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_kfreq");
  ...
  _1_stk_kfreq_split_1(& fp, & ks, & kmer, & i, & l, & mask, & nei, & k, & x___0,
                       & cnt, & cnt_nei, & which, & c___0, & tmp___7);
  return (0);
}
}
/* END FUNCTION-DEF stk_kfreq LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_init_split_0 LOC=UNKNOWN */
void _1_ks_init_split_0(gzFile *f , kstream_t **ks , void **tmp , void **tmp___0 ) 
{ 
...
/* END FUNCTION-DEF _1_ks_init_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_7 LOC=UNKNOWN */
void _1_usage_split_7(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_7 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_hrun_split_1 LOC=UNKNOWN */
void _1_stk_hrun_split_1(int *argc , char ***argv , gzFile *fp , int *min_len , int *tmp___0 ,
                         gzFile *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_hrun_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_printstr_split_1 LOC=UNKNOWN */
void _1_stk_printstr_split_1(kstring_t const   **s , unsigned int *line_len , int *i ,
                             int *rest ) 
{ 
...
/* END FUNCTION-DEF _1_stk_printstr_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_famask_split_0(& argc, & argv, & c);
  if (argc - optind < 2) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"Usage: seqtk famask <src.fa> <mask.fa>\n");
    return (1);
  }
  _1_stk_famask_split_1(& argv, & fp, & seq, & i, & tmp___0, & tmp___1, & tmp___2,
                        & tmp___3);
...
{ 
  ...
  {
  _1_stk_mergefa_split_0(& argc, & argv, & c, & is_intersect, & is_haploid, & qual,
                         & is_mask, & is_randhet);
  if (is_mask) {
    if (is_intersect) {
  ...
  _1_stk_mergefa_split_1(& argv, & fp, & seq, & i, & tmp___0, & tmp___1, & tmp___2,
                         & tmp___3);
  if ((unsigned long )fp[0] == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_mergefa");
...
/* BEGIN FUNCTION-DEF _1_stk_printseq_split_0 LOC=UNKNOWN */
void _1_stk_printseq_split_0(kseq_t const   **s , int *line_len ) 
{ 
...
/* END FUNCTION-DEF _1_stk_printseq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_listhet_split_0 LOC=UNKNOWN */
void _1_stk_listhet_split_0(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                            gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_listhet_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_hrun_split_0 LOC=UNKNOWN */
void _1_stk_hrun_split_0(int *min_len , int *l , int *c , int *beg ) 
{ 
...
/* END FUNCTION-DEF _1_stk_hrun_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_8 LOC=UNKNOWN */
void _1_usage_split_8(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_8 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_4 LOC=UNKNOWN */
void _1_usage_split_4(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_4 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_famask_split_0 LOC=UNKNOWN */
void _1_stk_famask_split_0(int *argc , char ***argv , int *c ) 
{ 
...
/* END FUNCTION-DEF _1_stk_famask_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kr_srand0_split_1 LOC=UNKNOWN */
void _1_kr_srand0_split_1(krand_t **kr ) 
{ 
...
/* END FUNCTION-DEF _1_kr_srand0_split_1 LOC=UNKNOWN */
...
{ 
  ...
  _1_kseq_destroy_split_0(& ks);
  _1_kseq_destroy_split_1(& ks);
  _1_kseq_destroy_split_2(& ks);
  return;
}
}
/* END FUNCTION-DEF kseq_destroy LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_destroy_split_0 LOC=UNKNOWN */
void _1_ks_destroy_split_0(kstream_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_ks_destroy_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_gc_split_0 LOC=UNKNOWN */
void _1_stk_gc_split_0(int *argc , char ***argv , int *c , int *is_at , int *min_l ,
                       double *frac , double *xdropoff ) 
{ 
...
/* END FUNCTION-DEF _1_stk_gc_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_rename_split_1 LOC=UNKNOWN */
void _1_stk_rename_split_1(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                           int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_rename_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_sample_split_0 LOC=UNKNOWN */
void _1_stk_sample_split_0(int *argc , char ***argv , int *c , int *twopass , uint64_t *num ,
                           uint64_t *n_seqs , double *frac , krand_t **kr , long *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_stk_sample_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kh_resize_64_split_0(& new_n_buckets, & new_flags, & j);
  _1_kh_resize_64_split_1(& h, & new_n_buckets, & new_flags, & j, & tmp, & tmp___0,
                          & tmp___1, & tmp___2, & key, & new_mask, & inc, & k, & i,
                          & tmp___4, & tmp___6);
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_stk_printstr_split_0 LOC=UNKNOWN */
void _1_stk_printstr_split_0(kstring_t const   **s , int *i , int *rest ) 
{ 
...
/* END FUNCTION-DEF _1_stk_printstr_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kr_srand0_split_0(& seed, & kr);
  _1_kr_srand0_split_1(& kr);
  return;
}
}
/* END FUNCTION-DEF kr_srand0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_destroy_reg_split_1 LOC=UNKNOWN */
void _1_kh_destroy_reg_split_1(kh_reg_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_kh_destroy_reg_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_read_split_0 LOC=UNKNOWN */
void _1_kseq_read_split_0(kseq_t **seq , kstream_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_read_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mergepe_split_1 LOC=UNKNOWN */
void _1_stk_mergepe_split_1(gzFile *fp1 , gzFile *fp2 , kseq_t *(*seq)[2] , int *tmp___9 ,
                            int *tmp___10 , int *tmp___11 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mergepe_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_reg_read_split_1 LOC=UNKNOWN */
void _1_stk_reg_read_split_1(reghash_t **h , gzFile *fp , kstream_t **ks , int *dret ,
                             kstring_t **str , void **tmp___5 , int *beg , int *end ,
                             reglist_t **p , khint_t *k , khint_t *tmp___6 , int *ret ,
                             char **s , char **tmp___7 , int *tmp___8 , int *tmp___9 ,
...
/* END FUNCTION-DEF _1_stk_reg_read_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kr_rand_split_1 LOC=UNKNOWN */
void _1_kr_rand_split_1(krand_t **kr , krint64_t *x , int *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kr_rand_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF _1_stk_hety_split_0 LOC=UNKNOWN */
void _1_stk_hety_split_0(int *win_size , int *n_start , int *is_lower_mask ) 
{ 
...
/* END FUNCTION-DEF _1_stk_hety_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_cutN_split_0 LOC=UNKNOWN */
void _1_stk_cutN_split_0(int *gap_only ) 
{ 
...
/* END FUNCTION-DEF _1_stk_cutN_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_5 LOC=UNKNOWN */
void _1_usage_split_5(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_5 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_read_split_1 LOC=UNKNOWN */
void _1_kseq_read_split_1(kseq_t **seq , int *c , int *r , kstream_t **ks , size_t___0 *tmp ,
                          size_t___0 *tmp___0 ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_read_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_resize_reg_split_0 LOC=UNKNOWN */
void _1_kh_resize_reg_split_0(khint_t *new_n_buckets , khint32_t **new_flags , khint_t *j ) 
{ 
...
/* END FUNCTION-DEF _1_kh_resize_reg_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_get_64_split_1 LOC=UNKNOWN */
void _1_kh_get_64_split_1(kh_64_t const   **h , khint_t *i , khint_t *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kh_get_64_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_cpy_kseq_split_1 LOC=UNKNOWN */
void _1_cpy_kseq_split_1(kseq_t **dst , kseq_t const   **src ) 
{ 
...
/* END FUNCTION-DEF _1_cpy_kseq_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  if (h->n_buckets) {
    _1_kh_get_reg_split_0(& h, & key, & inc, & k, & i, & last, & mask);
    while (1) {
      if (! ((*(h->flags + (i >> 4)) >> ((i & 15U) << 1)) & 2U)) {
        if (! ((*(h->flags + (i >> 4)) >> ((i & 15U) << 1)) & 1U)) {
          tmp = strcmp(*(h->keys + i), key);
    ...
    _1_kh_get_reg_split_1(& h, & i, & tmp___0);
    return (tmp___0);
  } else {
    return ((khint_t )0);
  }
...
{ 
  ...
  {
  _1_kr_rand_split_0(& kr, & x, & i);
  _1_kr_rand_split_1(& kr, & x, & tmp);
  return (x);
}
}
/* END FUNCTION-DEF kr_rand LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_dropse_split_1 LOC=UNKNOWN */
void _1_stk_dropse_split_1(gzFile *fp , kseq_t **seq , kseq_t *last , kstring_t **p ,
                           kstring_t **q , int *is_diff , int *l , size_t___0 *tmp___8 ,
                           int *tmp___9 , int *tmp___10 , int *tmp___11 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_dropse_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kh_init_64_split_0(& tmp);
  return ((kh_64_t *)tmp);
}
}
/* END FUNCTION-DEF kh_init_64 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_hety_split_1 LOC=UNKNOWN */
void _1_stk_hety_split_1(int *argc , char ***argv , gzFile *fp , int *c , int *win_size ,
                         int *n_start , int *is_lower_mask , int *tmp___0 , gzFile *tmp___1 ,
                         gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_hety_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_seq_split_0(& argc, & argv, & c, & qual_thres, & flag, & qual_shift, & mask_chr,
                     & min_len, & max_q, & fake_qual, & line_len, & n_seqs, & frac,
                     & h, & kr, & tmp, & tmp___0);
  if (argc == optind) {
    tmp___1 = fileno(stdin);
  ...
  _1_stk_seq_split_1(& argc, & argv, & fp, & line_len, & tmp___4, & tmp___5, & tmp___6,
                     & tmp___7);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_seq");
...
/* BEGIN FUNCTION-DEF _1_stk_subseq_split_0 LOC=UNKNOWN */
void _1_stk_subseq_split_0(int *argc , char ***argv , kh_reg_t **h , kh_reg_t **tmp ,
                           int *c , int *is_tab , int *line ) 
{ 
...
/* END FUNCTION-DEF _1_stk_subseq_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_fqc_aux_split_0(& p, & pos, & k, & sum, & qsum, & sum_low, & psum);
  _1_fqc_aux_split_1(& p, & allq, & perr, & qthres, & k, & sum, & qsum, & sum_low,
                     & psum, & tmp);
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_stk_cutN_split_1 LOC=UNKNOWN */
void _1_stk_cutN_split_1(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                         gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_cutN_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_trimfq_split_0(& argc, & argv, & param, & c, & min_len, & left, & right,
                        & fixed_len);
  if (optind == argc) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  _1_stk_trimfq_split_1(& argv, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_trimfq");
    return (1);
...
{ 
  ...
  {
  _1_kr_srand_split_0(& seed, & kr, & tmp);
  return (kr);
}
}
...
{ 
  ...
  {
  _1_ks_getuntil2_split_0(& str, & dret, & append, & gotany);
  while (1) {
    if (ks->end < 0) {
      return (-3);
    }
  ...
  _1_ks_getuntil2_split_1(& delimiter, & str, & tmp___2);
  return ((int )str->l);
}
}
/* END FUNCTION-DEF ks_getuntil2 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_put_64_split_0 LOC=UNKNOWN */
void _1_kh_put_64_split_0(kh_64_t **h , khint64_t *key , khint_t *x , khint_t *k ,
                          khint_t *i , khint_t *site , khint_t *mask ) 
{ 
...
/* END FUNCTION-DEF _1_kh_put_64_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_randbase_split_0 LOC=UNKNOWN */
void _1_stk_randbase_split_0(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                             gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_randbase_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_famask_split_1 LOC=UNKNOWN */
void _1_stk_famask_split_1(char ***argv , gzFile (*fp)[2] , kseq_t *(*seq)[2] , int *i ,
                           gzFile *tmp___0 , int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_famask_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_fqchk_split_0(& argc, & argv, & c, & max_len, & min_len, & max_alloc, & offset,
                       & n_diffQ, & qthres, & tot_len, & n, & pos);
  if (optind == argc) {
  ...
  _1_stk_fqchk_split_1(& argv, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_fqchk");
    return (1);
...
/* BEGIN FUNCTION-DEF _1_usage_split_2 LOC=UNKNOWN */
void _1_usage_split_2(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_2 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_randbase_split_1 LOC=UNKNOWN */
void _1_stk_randbase_split_1(gzFile *fp , kseq_t **seq , int *l , int *i , int *c ,
                             int *b , int *a , int *j , int *k , int *m , double *tmp___4 ,
                             int *tmp___6 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_randbase_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_comp_split_1 LOC=UNKNOWN */
void _1_stk_comp_split_1(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                         int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_comp_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_ks_init_split_0(& f, & ks, & tmp, & tmp___0);
  _1_ks_init_split_1(& ks, & tmp___0);
  return (ks);
}
}
...
{ 
  ...
  {
  _1_stk_comp_split_0(& argc, & argv, & c, & upper_only, & h);
  if (argc == optind) {
    tmp = fileno(stdin);
    tmp___0 = isatty(tmp);
    if (tmp___0) {
  ...
  _1_stk_comp_split_1(& argc, & argv, & fp, & tmp___2, & tmp___3, & tmp___4, & tmp___5);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_comp");
    return (1);
...
{ 
  ...
  {
  _1_stk_printseq_renamed_split_0(& s, & prefix, & n, & tmp);
  _1_stk_printseq_renamed_split_1(& s, & line_len);
  return;
}
}
...
{ 
  ...
  {
  if (h->n_buckets) {
    _1_kh_get_64_split_0(& h, & key, & inc, & k, & i, & last, & mask);
    while (1) {
      if (! ((*(h->flags + (i >> 4)) >> ((i & 15U) << 1)) & 2U)) {
        if (! ((*(h->flags + (i >> 4)) >> ((i & 15U) << 1)) & 1U)) {
          if (! (! (*(h->keys + i) == key))) {
...
{ 
  ...
  _1_print_seq_split_0(& fpout, & ks, & begin, & end, & i, & tmp);
  if (ks->qual.l == 0UL) {
    return;
  }
  _1_print_seq_split_1(& fpout, & ks, & begin, & end, & i);
  return;
}
}
...
{ 
  ...
  _1_cpy_kstr_split_0(& dst, & src, & tmp);
  _1_cpy_kstr_split_1(& dst, & src);
  return;
}
}
/* END FUNCTION-DEF cpy_kstr LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_fqc_aux_split_0 LOC=UNKNOWN */
void _1_fqc_aux_split_0(posstat_t **p , int *pos , int *k , int64_t *sum , int64_t *qsum ,
                        int64_t *sum_low , double *psum ) 
{ 
...
/* END FUNCTION-DEF _1_fqc_aux_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1___ac_X31_hash_string_split_1 LOC=UNKNOWN */
void _1___ac_X31_hash_string_split_1(char const   **s , khint_t *h ) 
{ 
...
/* END FUNCTION-DEF _1___ac_X31_hash_string_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_init_64_split_0 LOC=UNKNOWN */
void _1_kh_init_64_split_0(void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kh_init_64_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_dropse_split_0 LOC=UNKNOWN */
void _1_stk_dropse_split_0(int *argc , char ***argv , gzFile *fp , gzFile *tmp___2 ,
                           int *tmp___3 , gzFile *tmp___4 , int *tmp___5 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_dropse_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_seq_split_1 LOC=UNKNOWN */
void _1_stk_seq_split_1(int *argc , char ***argv , gzFile *fp , unsigned int *line_len ,
                        gzFile *tmp___4 , int *tmp___5 , gzFile *tmp___6 , int *tmp___7 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_seq_split_1 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF _1_stk_trimfq_split_1 LOC=UNKNOWN */
void _1_stk_trimfq_split_1(char ***argv , gzFile *fp , gzFile *tmp___0 , int *tmp___1 ,
                           gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_trimfq_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_init_split_1 LOC=UNKNOWN */
void _1_kseq_init_split_1(gzFile *fd , kseq_t **s , void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_init_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_fqchk_split_1 LOC=UNKNOWN */
void _1_stk_fqchk_split_1(char ***argv , gzFile *fp , int *tmp___0 , gzFile *tmp___1 ,
                          gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_fqchk_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_comp_split_0 LOC=UNKNOWN */
void _1_stk_comp_split_0(int *argc , char ***argv , int *c , int *upper_only , reghash_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_stk_comp_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_init_split_1 LOC=UNKNOWN */
void _1_ks_init_split_1(kstream_t **ks , void **tmp___0 ) 
{ 
...
/* END FUNCTION-DEF _1_ks_init_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_trimfq_split_0 LOC=UNKNOWN */
void _1_stk_trimfq_split_0(int *argc , char ***argv , double *param , int *c , int *min_len ,
                           int *left , int *right , int *fixed_len ) 
{ 
...
/* END FUNCTION-DEF _1_stk_trimfq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_resize_64_split_1 LOC=UNKNOWN */
void _1_kh_resize_64_split_1(kh_64_t **h , khint_t *new_n_buckets , khint32_t **new_flags ,
                             khint_t *j , khint_t *tmp , void **tmp___0 , khint_t *tmp___1 ,
                             void **tmp___2 , khint64_t *key , khint_t *new_mask ,
                             khint_t *inc , khint_t *k , khint_t *i , khint64_t *tmp___4 ,
...
/* END FUNCTION-DEF _1_kh_resize_64_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_printseq_renamed_split_0 LOC=UNKNOWN */
void _1_stk_printseq_renamed_split_0(kseq_t const   **s , char const   **prefix ,
                                     int64_t *n , int *tmp ) 
{ 
...
/* END FUNCTION-DEF _1_stk_printseq_renamed_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_sample_split_1 LOC=UNKNOWN */
void _1_stk_sample_split_1(char ***argv , int *twopass , uint64_t *num , double *frac ,
                           krand_t **kr ) 
{ 
...
/* END FUNCTION-DEF _1_stk_sample_split_1 LOC=UNKNOWN */
...
{ 
  ...
  _1_kseq_read_split_1(& seq, & c, & r, & ks, & tmp, & tmp___0);
  if (r < 0) {
    return (r);
  }
  if (c != 10) {
...
/* BEGIN FUNCTION-DEF _1_kr_srand0_split_0 LOC=UNKNOWN */
void _1_kr_srand0_split_0(krint64_t *seed , krand_t **kr ) 
{ 
...
/* END FUNCTION-DEF _1_kr_srand0_split_0 LOC=UNKNOWN */
...
/* BEGIN FUNCTION-DEF _1_kh_get_64_split_0 LOC=UNKNOWN */
void _1_kh_get_64_split_0(kh_64_t const   **h , khint64_t *key , khint_t *inc , khint_t *k ,
                          khint_t *i , khint_t *last , khint_t *mask ) 
{ 
...
/* END FUNCTION-DEF _1_kh_get_64_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_resize_reg_split_1 LOC=UNKNOWN */
void _1_kh_resize_reg_split_1(kh_reg_t **h , khint_t *new_n_buckets , khint32_t **new_flags ,
                              khint_t *j , khint_t *tmp , void **tmp___0 , khint_t *tmp___1 ,
                              void **tmp___2 , void **tmp___3 , kh_cstr_t *key , reglist_t *val ,
                              khint_t *new_mask , khint_t *inc , khint_t *k , khint_t *i ,
...
/* END FUNCTION-DEF _1_kh_resize_reg_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_resize_64_split_0 LOC=UNKNOWN */
void _1_kh_resize_64_split_0(khint_t *new_n_buckets , khint32_t **new_flags , khint_t *j ) 
{ 
...
/* END FUNCTION-DEF _1_kh_resize_64_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_reg_read_split_0(& fn, & h, & tmp, & fp, & tmp___1, & tmp___2, & tmp___3,
                          & tmp___4);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    return ((reghash_t *)0);
  }
  _1_stk_reg_read_split_1(& h, & fp, & ks, & dret, & str, & tmp___5, & beg, & end,
                          & p, & k, & tmp___6, & ret, & s, & tmp___7, & tmp___8, & tmp___9,
                          & tmp___10, & tmp___11, & tmp___12, & tmp___13, & tmp___14);
  return (h);
}
}
/* END FUNCTION-DEF stk_reg_read LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_kfreq_split_0 LOC=UNKNOWN */
void _1_stk_kfreq_split_0(int *argc , char ***argv , gzFile *fp , int *kmer , int *i ,
                          int *l , int *mask , char **nei , size_t___0 *tmp , int *c ,
                          int *tmp___0 , void **tmp___1 , int *j , int *x , int *tmp___3 ,
                          gzFile *tmp___4 , gzFile *tmp___5 , int *tmp___6 ) 
...
/* END FUNCTION-DEF _1_stk_kfreq_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kh_destroy_64_split_0 LOC=UNKNOWN */
void _1_kh_destroy_64_split_0(kh_64_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_kh_destroy_64_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1___ac_X31_hash_string_split_0 LOC=UNKNOWN */
void _1___ac_X31_hash_string_split_0(char const   **s , khint_t *h ) 
{ 
...
/* END FUNCTION-DEF _1___ac_X31_hash_string_split_0 LOC=UNKNOWN */
...
{ 
  ...
  _1_stk_mergepe_split_0(& argv, & fp1, & fp2, & tmp___0, & tmp___1, & tmp___2, & tmp___3,
                         & tmp___5, & tmp___6, & tmp___7, & tmp___8);
  ...
  _1_stk_mergepe_split_1(& fp1, & fp2, & seq, & tmp___9, & tmp___10, & tmp___11);
  return (0);
}
}
...
{ 
  ...
  {
  _1_stk_hrun_split_0(& min_len, & l, & c, & beg);
  if (argc == optind) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"Usage: seqtk hrun <in.fa> [minLen=%d]\n",
            min_len);
    return (1);
  }
  _1_stk_hrun_split_1(& argc, & argv, & fp, & min_len, & tmp___0, & tmp___1, & tmp___2,
                      & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_hrun");
...
/* BEGIN FUNCTION-DEF _1_kr_srand_split_0 LOC=UNKNOWN */
void _1_kr_srand_split_0(krint64_t *seed , krand_t **kr , void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kr_srand_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kr_rand_split_0 LOC=UNKNOWN */
void _1_kr_rand_split_0(krand_t **kr , krint64_t *x , int *i ) 
{ 
...
/* END FUNCTION-DEF _1_kr_rand_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_6 LOC=UNKNOWN */
void _1_usage_split_6(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_6 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_reg_destroy_split_0 LOC=UNKNOWN */
void _1_stk_reg_destroy_split_0(khint_t *k ) 
{ 
...
/* END FUNCTION-DEF _1_stk_reg_destroy_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_cpy_kseq_split_0 LOC=UNKNOWN */
void _1_cpy_kseq_split_0(kseq_t **dst , kseq_t const   **src ) 
{ 
...
/* END FUNCTION-DEF _1_cpy_kseq_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_mask_split_0(& seq, & h, & k);
  _1_stk_mask_split_1(& seq, & h, & is_complement, & mask_chr, & i, & j, & k, & tmp,
                      & p, & beg, & end, & tmp___0, & mask, & tmp___1, & beg___0,
                      & end___0, & tmp___2);
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_stk_mask_split_1 LOC=UNKNOWN */
void _1_stk_mask_split_1(kseq_t **seq , kh_reg_t const   **h , int *is_complement ,
                         int *mask_chr , unsigned int *i , unsigned int *j , khiter_t *k ,
                         int *tmp , reglist_t **p , unsigned int *beg , unsigned int *end ,
                         int *tmp___0 , int8_t **mask , void **tmp___1 , unsigned int *beg___0 ,
...
/* END FUNCTION-DEF _1_stk_mask_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_gc_split_1 LOC=UNKNOWN */
void _1_stk_gc_split_1(char ***argv , double *frac , double *q , gzFile *fp , gzFile *tmp___0 ,
                       int *tmp___1 , gzFile *tmp___2 , int *tmp___3 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_gc_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mergepe_split_0 LOC=UNKNOWN */
void _1_stk_mergepe_split_0(char ***argv , gzFile *fp1 , gzFile *fp2 , gzFile *tmp___0 ,
                            int *tmp___1 , gzFile *tmp___2 , int *tmp___3 , gzFile *tmp___5 ,
                            int *tmp___6 , gzFile *tmp___7 , int *tmp___8 ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mergepe_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_printseq_renamed_split_1 LOC=UNKNOWN */
void _1_stk_printseq_renamed_split_1(kseq_t const   **s , int *line_len ) 
{ 
...
/* END FUNCTION-DEF _1_stk_printseq_renamed_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_reg_destroy_split_1 LOC=UNKNOWN */
void _1_stk_reg_destroy_split_1(reghash_t **h , khint_t *k ) 
{ 
...
/* END FUNCTION-DEF _1_stk_reg_destroy_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_destroy_split_1 LOC=UNKNOWN */
void _1_kseq_destroy_split_1(kseq_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_destroy_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_sample_split_0(& argc, & argv, & c, & twopass, & num, & n_seqs, & frac, & kr,
                        & tmp);
  if (optind + 2 > argc) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  _1_stk_sample_split_1(& argv, & twopass, & num, & frac, & kr);
  if (! twopass) {
    buf = (kseq_t *)0;
    if (num > 0ULL) {
...
/* BEGIN FUNCTION-DEF _1_stk_mutfa_split_0 LOC=UNKNOWN */
void _1_stk_mutfa_split_0(kh_reg_t **h , kh_reg_t **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mutfa_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_fqchk_split_0 LOC=UNKNOWN */
void _1_stk_fqchk_split_0(int *argc , char ***argv , int *c , int *max_len , int *min_len ,
                          int *max_alloc , int *offset , int *n_diffQ , int *qthres ,
                          int64_t *tot_len , int64_t *n , posstat_t **pos ) 
{ 
...
/* END FUNCTION-DEF _1_stk_fqchk_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_stk_gc_split_0(& argc, & argv, & c, & is_at, & min_l, & frac, & xdropoff);
  if (optind + 1 > argc) {
  ...
  _1_stk_gc_split_1(& argv, & frac, & q, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_gc");
    return (1);
...
/* BEGIN FUNCTION-DEF _1_kseq_init_split_0 LOC=UNKNOWN */
void _1_kseq_init_split_0(void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_init_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_destroy_split_0 LOC=UNKNOWN */
void _1_kseq_destroy_split_0(kseq_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_destroy_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  if (h) {
    _1_kh_destroy_64_split_0(& h);
    _1_kh_destroy_64_split_1(& h);
  }
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_kh_destroy_64_split_1 LOC=UNKNOWN */
void _1_kh_destroy_64_split_1(kh_64_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_kh_destroy_64_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_usage_split_3 LOC=UNKNOWN */
void _1_usage_split_3(void) 
{ 
...
/* END FUNCTION-DEF _1_usage_split_3 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_subseq_split_1 LOC=UNKNOWN */
void _1_stk_subseq_split_1(char ***argv , kh_reg_t **h ) 
{ 
...
/* END FUNCTION-DEF _1_stk_subseq_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_seq_split_0 LOC=UNKNOWN */
void _1_stk_seq_split_0(int *argc , char ***argv , int *c , int *qual_thres , int *flag ,
                        int *qual_shift , int *mask_chr , int *min_len , int *max_q ,
                        int *fake_qual , unsigned int *line_len , int64_t *n_seqs ,
                        double *frac , kh_reg_t **h , krand_t **kr , int *tmp , long *tmp___0 ) 
...
/* END FUNCTION-DEF _1_stk_seq_split_0 LOC=UNKNOWN */
...
{ 
  ...
  _1_stk_listhet_split_0(& argv, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_listhet");
    return (1);
  }
  _1_stk_listhet_split_1(& fp, & seq, & i, & l, & b);
  return (0);
}
}
...
{ 
  ...
  _1_stk_mutfa_split_1(& argv, & fp, & str, & tmp___0, & tmp___2, & tmp___3, & tmp___4,
                       & tmp___5);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_mutfa");
...
{ 
  ...
  _1_stk_cutN_split_1(& argv, & fp, & tmp___0, & tmp___1, & tmp___2, & tmp___3);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_cutN");
    return (1);
...
{ 
  ...
  while ((size_t___0 )k < (size_t___0 )ks->seq.l) {
    if ((int )seq_nt16_table[(int )*(ks->seq.s + k)] == 15) {
      _1_find_next_cut_split_0(& ks, & k, & i, & b, & e, & score, & max);
      if ((e + 1) - b >= cutN_min_N_tract) {
        *begin = b;
        *end = e + 1;
        return (*end);
      }
      _1_find_next_cut_split_1(& k, & e);
    } else {
      k ++;
    }
  }
...
{ 
  ...
  {
  _1_stk_hety_split_0(& win_size, & n_start, & is_lower_mask);
  if (argc == 1) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"\n");
  ...
  _1_stk_hety_split_1(& argc, & argv, & fp, & c, & win_size, & n_start, & is_lower_mask,
...
/* BEGIN FUNCTION-DEF _1_cpy_kstr_split_1 LOC=UNKNOWN */
void _1_cpy_kstr_split_1(kstring_t **dst , kstring_t const   **src ) 
{ 
...
/* END FUNCTION-DEF _1_cpy_kstr_split_1 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_kseq_destroy_split_2 LOC=UNKNOWN */
void _1_kseq_destroy_split_2(kseq_t **ks ) 
{ 
...
/* END FUNCTION-DEF _1_kseq_destroy_split_2 LOC=UNKNOWN */
...
{ 
  ...
  if (line_len != 4294967295U) {
    if (line_len != 0U) {
      _1_stk_printstr_split_0(& s, & i, & rest);
      _1_stk_printstr_split_1(& s, & line_len, & i, & rest);
    } else {
      putchar('\n');
      puts((char const   *)s->s);
    }
...
/* BEGIN FUNCTION-DEF _1_kh_init_reg_split_0 LOC=UNKNOWN */
void _1_kh_init_reg_split_0(void **tmp ) 
{ 
...
/* END FUNCTION-DEF _1_kh_init_reg_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kh_put_64_split_0(& h, & key, & x, & k, & i, & site, & mask);
  _1_kh_put_64_split_1(& h, & key, & ret, & x, & inc, & k, & i, & site, & last, & mask);
  return (x);
}
}
...
{ 
  ...
  {
  _1_stk_rename_split_0(& prefix, & n);
  if (argc == 1) {
    tmp = fileno(stdin);
    tmp___0 = isatty(tmp);
    if (tmp___0) {
  ...
  _1_stk_rename_split_1(& argc, & argv, & fp, & tmp___2, & tmp___3, & tmp___4, & tmp___5);
  if ((unsigned long )fp == (unsigned long )((gzFile )0)) {
    fprintf((FILE */* __restrict  */)stderr, (char const   */* __restrict  */)"[E::%s] failed to open the input file/stream.\n",
            "stk_rename");
    return (1);
...
/* BEGIN FUNCTION-DEF _1_stk_kfreq_split_1 LOC=UNKNOWN */
void _1_stk_kfreq_split_1(gzFile *fp , kseq_t **ks , int *kmer , int *i , int *l ,
                          int *mask , char **nei , int *k , int (*x___0)[2] , int (*cnt)[2] ,
                          int (*cnt_nei)[2] , int *which , int *c___0 , int *tmp___7 ) 
{ 
  ...
  while (1) {
    ...
    *i = 0;
    ...
    printf((char const   */* __restrict  */)"%s\t%ld\t%c\t%d\t%d\n", (*ks)->name.s,
           (*ks)->seq.l, (int )*("+-" + *which), (*cnt_nei)[*which], (*cnt)[*which]);
  }
  kseq_destroy(*ks);
  gzclose(*fp);
}
}
/* END FUNCTION-DEF _1_stk_kfreq_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  if (h) {
    _1_kh_destroy_reg_split_0(& h);
    _1_kh_destroy_reg_split_1(& h);
  }
  return;
}
}
...
/* BEGIN FUNCTION-DEF _1_print_seq_split_1 LOC=UNKNOWN */
void _1_print_seq_split_1(FILE **fpout , kseq_t const   **ks , int *begin , int *end ,
                          int *i ) 
{ 
...
/* END FUNCTION-DEF _1_print_seq_split_1 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_kseq_init_split_0(& tmp);
  _1_kseq_init_split_1(& fd, & s, & tmp);
  return (s);
}
}
/* END FUNCTION-DEF kseq_init LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_ks_getuntil2_split_0 LOC=UNKNOWN */
void _1_ks_getuntil2_split_0(kstring_t **str , int **dret , int *append , int *gotany ) 
{ 
...
/* END FUNCTION-DEF _1_ks_getuntil2_split_0 LOC=UNKNOWN */

/* BEGIN FUNCTION-DEF _1_stk_mergefa_split_0 LOC=UNKNOWN */
void _1_stk_mergefa_split_0(int *argc , char ***argv , int *c , int *is_intersect ,
                            int *is_haploid , int *qual , int *is_mask , int *is_randhet ) 
{ 
...
/* END FUNCTION-DEF _1_stk_mergefa_split_0 LOC=UNKNOWN */
...
{ 
  ...
  {
  _1_ks_getuntil_split_0(& ks, & delimiter, & str, & dret, & tmp);
  return (tmp);
}
}
