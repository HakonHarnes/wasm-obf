...
/* Generated by Tigress v3.2 (https://tigress.wtf), 07:20:15-2023/04/23 */
...
{ 
  ...
  {
  tmp___4 = strcmp(path, "-");
  if (((unsigned int )(tmp___4 | - tmp___4) >> 31U) & 1) {
...
{ 
  ...
  diff = ((long )*(match_scores + *b) + ~ ((long )*(match_scores + *a))) + 1L;
  if ((int )(((unsigned long )(~ diff & (diff - 1L)) >> 31UL) & 1L)) {
    return ((int )((*a % (unsigned long const   )score_width & ~ (*b % (unsigned long const   )score_width)) - (~ (*a % (unsigned long const   )score_width) & *b % (unsigned long const   )score_width)));
  } else {
    if ((int )(((unsigned long )(diff ^ ((diff >> 31L) - (diff ^ (diff >> 31L)))) >> 31UL) & 1L)) {
      tmp___0 = 1;
    } else {
      tmp___0 = -1;
    }
...
{ 
  ...
  {
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = gzread2(file, (void *)(in->b + 1), (in->size ^ 1UL) - ((~ in->size & 1UL) << 1UL));
      in->end = (1UL ^ tmp) + ((1UL & tmp) + (1UL & tmp));
      in->begin = (size_t___1 )1;
      break;
    }
  }
  total_read = (size_t___1 )0;
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    offset = in->begin;
    while (1) {
      if ((int )((((~ offset & in->end) | (~ (offset ^ in->end) & (offset - in->end))) >> 31UL) & 1UL)) {
        tmp___0 = offset;
        offset = (offset | 1UL) + (offset & 1UL);
        if (! (((unsigned int )(((int )*(in->b + tmp___0) - 10) | (10 - (int )*(in->b + tmp___0))) >> 31U) & 1)) {
          break;
        }
      } else {
        break;
    ...
    buffered = (offset ^ in->begin) - ((~ offset & in->begin) + (~ offset & in->begin));
    cbuf_capacity(buf, size, (*len - ~ buffered) - 1UL);
    memcpy((void */* __restrict  */)(*buf + *len), (void const   */* __restrict  */)(in->b + in->begin),
           buffered);
    *len = ((*len | buffered) << 1UL) - (*len ^ buffered);
    in->begin = offset;
    total_read = (total_read | buffered) + (total_read & buffered);
    if (((unsigned int )(((((int )*(*buf + (((*len & ~ 1UL) << 1UL) - (*len ^ 1UL))) - 10) ^ (((int )*(*buf + (((*len & ~ 1UL) << 1UL) - (*len ^ 1UL))) - 10) >> 31)) - (((int )*(*buf + (((*len & ~ 1UL) << 1UL) - (*len ^ 1UL))) - 10) >> 31)) - 1) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size + ~ 1UL) + 1UL);
      in->end = (1UL | tmp___1) + (1UL & tmp___1);
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  scoring___0->wildcards[(int )c >> 5] = ((scoring___0->wildcards[(int )c >> 5] + (unsigned int )(1 << ((~ ((int )c) | 31) - ~ ((int )c)))) + 1U) + ((- scoring___0->wildcards[(int )c >> 5] - 1U) | (- ((unsigned int )(1 << ((~ ((int )c) | 31) - ~ ((int )c)))) - 1U));
  scoring___0->wildscores[(size_t___1 )c] = score;
  if (((unsigned int )((~ (scoring___0->min_penalty ^ score) >> 1) + (scoring___0->min_penalty & ~ score)) >> 31U) & 1) {
    scoring___0->min_penalty = scoring___0->min_penalty;
  } else {
    scoring___0->min_penalty = score;
  }
  if (((unsigned int )((score | ~ scoring___0->max_penalty) & ((score ^ scoring___0->max_penalty) | ~ (scoring___0->max_penalty - score))) >> 31U) & 1) {
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
      ...
      tmp___0 = in->begin;
      in->begin = (in->begin ^ 1UL) + ((in->begin & 1UL) << 1UL);
      tmp___1 = (int )*(in->b + tmp___0);
    }
    return (tmp___1);
  }
  tmp___2 = in->begin;
  in->begin = ((in->begin ^ ~ 1UL) + ((in->begin | 1UL) + (in->begin | 1UL))) + 1UL;
...
{ 
  ...
  {
  x = (x & ~ 1ULL) - (~ x & 1ULL);
  x = ((x + (x >> 1)) + 1ULL) + ((- x - 1ULL) | (- (x >> 1) - 1ULL));
  x = (x & ~ (x >> 2)) + (x >> 2);
  x = (x & ~ (x >> 4)) + (x >> 4);
  x = ((x + (x >> 8)) + 1ULL) + ((- x - 1ULL) | (- (x >> 8) - 1ULL));
  x = (x & ~ (x >> 16)) + (x >> 16);
  x = (x & ~ (x >> 32)) + (x >> 32);
  x = (x ^ 1ULL) + ((x & 1ULL) << 1ULL);
  return ((size_t___1 )x);
}
}
...
{ 
  ...
  while (1) {
    c = fgetc(sf->f_file);
    if (((unsigned int )((((c - -1) + (c - -1)) & ((c - -1) >> 31)) - (c - -1)) >> 31U) & 1) {
      tmp = isspace(c);
      if (! tmp) {
        break;
      }
    ...
    if (((unsigned int )((c - 10) | (10 - c)) >> 31U) & 1) {
      fskipline(sf->f_file);
    }
  }
  if (((unsigned int )((((c - -1) + (1 << 31)) + (((c - -1) + (1 << 31)) >> 31)) ^ (((c - -1) + (1 << 31)) >> 31)) >> 31U) & 1) {
    return (0);
  }
  if (((unsigned int )((((c - 64) + (1 << 31)) ^ (((c - 64) + (1 << 31)) >> 31)) - (((c - 64) + (1 << 31)) >> 31)) >> 31U) & 1) {
    sf->format = (seq_format )4;
    sf->origreadfunc = & _seq_read_fastq_f;
  } else
  if (((unsigned int )((((c - 62) + (1 << 31)) ^ (((c - 62) + (1 << 31)) >> 31)) - (((c - 62) + (1 << 31)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  {
  if ((int )((((~ hist->hits_capacity & arr_size) | ((~ hist->hits_capacity | arr_size) & (hist->hits_capacity - arr_size))) >> 31UL) & 1UL)) {
    ...
    mem = (hist->hits_capacity & sizeof(*(hist->sorted_match_indices))) * (hist->hits_capacity | sizeof(*(hist->sorted_match_indices))) + (hist->hits_capacity & ~ sizeof(*(hist->sorted_match_indices))) * (~ hist->hits_capacity & sizeof(*(hist->sorted_match_indices)));
...
{ 
  ...
  tmp___2 = strcmp(p, "-");
  if (((unsigned int )(((tmp___2 + (1 << 31)) ^ ((tmp___2 + (1 << 31)) >> 31)) - ((tmp___2 + (1 << 31)) >> 31)) >> 31U) & 1) {
  ...
  fmt = tmp___3;
  if ((int )(((((((unsigned int )fmt - 8U) ^ ((int )((unsigned int )fmt - 8U) >> 31)) - ((int )((unsigned int )fmt - 8U) >> 31)) - 1U) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
  if ((int )((((((unsigned int )fmt - 16U) - ((((unsigned int )fmt - 16U) << 1U) & ((int )((unsigned int )fmt - 16U) >> 31))) - 1U) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else
  if ((int )(((((((unsigned int )fmt - 16U) + ((int )((unsigned int )fmt - 16U) >> 31)) ^ ((int )((unsigned int )fmt - 16U) >> 31)) - 1U) >> 31U) & 1U)) {
    tmp___4 = 1;
  } else {
    tmp___4 = 0;
  }
...
{ 
  ...
  if (((unsigned int )((c - 64) | (64 - c)) >> 31U) & 1) {
    return (-1);
  } else {
  ...
  while (1) {
    c = fgetc(sf->f_file);
    if (! (((unsigned int )((c - 43) | (43 - c)) >> 31U) & 1)) {
      break;
    }
    if (((unsigned int )(~ ((c - -1) | (-1 - c))) >> 31U) & 1) {
      return (-1);
    }
    if (((unsigned int )((c - 13) | (13 - c)) >> 31U) & 1) {
      if (((unsigned int )((c - 10) | (10 - c)) >> 31U) & 1) {
  ...
  while (1) {
    c = fgetc(sf->f_file);
    if (((unsigned int )((((c - -1) >> 31) - (c - -1)) ^ ((c - -1) >> 31)) >> 31U) & 1) {
      if (! (((unsigned int )((((c - 10) << 1) & ((c - 10) >> 31)) - (c - 10)) >> 31U) & 1)) {
        break;
      }
    } else {
      break;
  ...
  if (((unsigned int )(((c - -1) + (1 << 31)) - ((((c - -1) + (1 << 31)) + ((c - -1) + (1 << 31))) & (((c - -1) + (1 << 31)) >> 31))) >> 31U) & 1) {
    return (-1);
  }
  while (1) {
    ...
    if (! ((int )((((~ r->qual.end & r->seq.end) | ((~ r->qual.end | r->seq.end) & (r->qual.end - r->seq.end))) >> 31UL) & 1UL))) {
      break;
    }
  }
  while (1) {
    c = fgetc(sf->f_file);
    if (((unsigned int )((((c - -1) << 1) & ((c - -1) >> 31)) - (c - -1)) >> 31U) & 1) {
      if (! (((unsigned int )((c - 64) | (64 - c)) >> 31U) & 1)) {
        break;
      }
    } else {
...
{ 
  ...
  {
  cbuf_capacity(buf, sizeptr, (*lenptr - ~ 1UL) - 1UL);
  tmp = *lenptr;
  *lenptr = ((*lenptr | 1UL) + (*lenptr | 1UL)) - (*lenptr ^ 1UL);
  *(*buf + tmp) = c;
  *(*buf + *lenptr) = (char )'\000';
  return;
}
...
{ 
  ...
  arr_size = (aligner->score_width & aligner->score_height) * (aligner->score_width | aligner->score_height) + (aligner->score_width & ~ aligner->score_height) * (~ aligner->score_width & aligner->score_height);
  _ensure_history_capacity(hist, arr_size);
  memset((void *)hist->match_scores_mask.b, 0, ((hist->match_scores_mask.l ^ 31UL) + ((hist->match_scores_mask.l & 31UL) << 1UL)) / 32UL);
  tmp = (size_t___1 )0;
  hist->next_hit = tmp;
  hist->num_of_hits = tmp;
  pos = (size_t___1 )0;
  while ((int )((((~ pos & arr_size) | (~ (pos ^ arr_size) & (pos - arr_size))) >> 31UL) & 1UL)) {
    if (((unsigned int )((*(aligner->match_scores + pos) >> 1) - *(aligner->match_scores + pos)) >> 31U) & 1) {
      tmp___0 = hist->num_of_hits;
      hist->num_of_hits = ((hist->num_of_hits ^ ~ 1UL) + ((hist->num_of_hits | 1UL) + (hist->num_of_hits | 1UL))) + 1UL;
      *(hist->sorted_match_indices + tmp___0) = pos;
    }
    pos = ((pos ^ ~ 1UL) + ((pos | 1UL) + (pos | 1UL))) + 1UL;
  }
...
{ 
  ...
  while (! response) {
    ...
    while (1) {
      r = getc(stdin);
      if (((unsigned int )((((r - -1) << 1) & ((r - -1) >> 31)) - (r - -1)) >> 31U) & 1) {
        if (((unsigned int )((r - 10) | (10 - r)) >> 31U) & 1) {
          if (! (((unsigned int )((r - 13) | (13 - r)) >> 31U) & 1)) {
            break;
          }
        } else {
          break;
      ...
      if (((unsigned int )((((r - 104) ^ ((r - 104) >> 31)) - ((r - 104) >> 31)) - 1) >> 31U) & 1) {
        next_hit = (char)1;
        response = (char)1;
      } else
      if (((unsigned int )(~ ((r - 72) | (72 - r))) >> 31U) & 1) {
        next_hit = (char)1;
        response = (char)1;
      } else
      if (((unsigned int )((((r - 97) ^ ((r - 97) >> 31)) - ((r - 97) >> 31)) - 1) >> 31U) & 1) {
        next_hit = (char)0;
        response = (char)1;
      } else
      if (((unsigned int )((((r - 65) + (1 << 31)) ^ (((r - 65) + (1 << 31)) >> 31)) - (((r - 65) + (1 << 31)) >> 31)) >> 31U) & 1) {
        next_hit = (char)0;
        response = (char)1;
      }
    }
    if (((unsigned int )(~ ((r - -1) | (-1 - r))) >> 31U) & 1) {
      putc('\n', stdout);
      exit(0);
    }
  }
...
{ 
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = ((sf->gz_file)->have + ~ 1U) + 1U;
      (sf->gz_file)->pos = ((sf->gz_file)->pos | 1LL) + ((sf->gz_file)->pos & 1LL);
      tmp = (sf->gz_file)->next;
      ((sf->gz_file)->next) ++;
      c = (int )*tmp;
    } else {
  ...
  if (((unsigned int )((((c - -1) + ((c - -1) >> 31)) ^ ((c - -1) >> 31)) - 1) >> 31U) & 1) {
    return (0);
  }
  cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
...
{ 
  ...
  tmp___0 = malloc((sizeof(char *) & cmd___0->file_list_capacity) * (sizeof(char *) | cmd___0->file_list_capacity) + (sizeof(char *) & ~ cmd___0->file_list_capacity) * (~ sizeof(char *) & cmd___0->file_list_capacity));
  cmd___0->file_paths1 = (char **)tmp___0;
  tmp___1 = malloc((sizeof(char *) & cmd___0->file_list_capacity) * (sizeof(char *) | cmd___0->file_list_capacity) + (sizeof(char *) & ~ cmd___0->file_list_capacity) * (~ sizeof(char *) & cmd___0->file_list_capacity));
  ...
  if (((unsigned int )(~ ((argc - 1) | (1 - argc))) >> 31U) & 1) {
  ...
  mismatch_set = (char)0;
  argi = 1;
  while (((unsigned int )((((argc - argi) & - (argc >= argi)) >> 31) - (((argc - argi) & - (argc >= argi)) ^ (((argc - argi) & - (argc >= argi)) >> 31))) >> 31U) & 1) {
    tmp___10 = strcasecmp((char const   *)*(argv + argi), "--help");
    if (((unsigned int )(~ (tmp___10 | - tmp___10)) >> 31U) & 1) {
      print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
    } else {
      tmp___11 = strcasecmp((char const   *)*(argv + argi), "-help");
      if (((unsigned int )(~ tmp___11 & (tmp___11 - 1)) >> 31U) & 1) {
        print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
      } else {
        tmp___12 = strcasecmp((char const   *)*(argv + argi), "-h");
        if (((unsigned int )(((tmp___12 + (1 << 31)) ^ ((tmp___12 + (1 << 31)) >> 31)) - ((tmp___12 + (1 << 31)) >> 31)) >> 31U) & 1) {
          print_usage(cmd_type, defaults, (char const   *)*(argv + 0), (char const   *)((void *)0));
        } else {
          tmp___9 = strcasecmp((char const   *)*(argv + argi), "--case_sensitive");
          if (((unsigned int )(~ (tmp___9 | - tmp___9)) >> 31U) & 1) {
            cmd___0->case_sensitive = (_Bool)1;
          } else {
            tmp___8 = strcasecmp((char const   *)*(argv + argi), "--scoring");
            if (((unsigned int )(~ tmp___8 & (tmp___8 - 1)) >> 31U) & 1) {
              if (scoring_set) {
                print_usage(cmd_type, defaults, (char const   *)*(argv + 0), "More than one scoring system specified - not permitted");
              }
              tmp___7 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)),
                                   "PAM30");
              if (((unsigned int )(~ (tmp___7 | - tmp___7)) >> 31U) & 1) {
                scoring_system_PAM30(scoring___0);
              } else {
                tmp___6 = strcasecmp((char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                     "PAM70");
                if (((unsigned int )(((tmp___6 ^ (tmp___6 >> 31)) - (tmp___6 >> 31)) - 1) >> 31U) & 1) {
                  scoring_system_PAM70(scoring___0);
                } else {
                  tmp___5 = strcasecmp((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                       "BLOSUM80");
                  if (((unsigned int )(~ (tmp___5 | - tmp___5)) >> 31U) & 1) {
                    scoring_system_BLOSUM80(scoring___0);
                  } else {
                    tmp___4 = strcasecmp((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                         "BLOSUM62");
                    if (((unsigned int )(~ tmp___4 & (tmp___4 - 1)) >> 31U) & 1) {
                      scoring_system_BLOSUM62(scoring___0);
                    } else {
                      tmp___3 = strcasecmp((char const   *)*(argv + ((argi ^ 1) + ((argi & 1) + (argi & 1)))),
                                           "DNA_HYBRIDIZATION");
                      if (((unsigned int )(((tmp___3 ^ (tmp___3 >> 31)) - (tmp___3 >> 31)) - 1) >> 31U) & 1) {
  ...
  argi = 1;
  while (((unsigned int )(((((argc - argi) & - (argc >= argi)) + ((argc - argi) & - (argc >= argi))) & (((argc - argi) & - (argc >= argi)) >> 31)) - ((argc - argi) & - (argc >= argi))) >> 31U) & 1) {
    if (((unsigned int )(~ (((int )*(*(argv + argi) + 0) - 45) | (45 - (int )*(*(argv + argi) + 0)))) >> 31U) & 1) {
      tmp___53 = strcasecmp((char const   *)*(argv + argi), "--freestartgap");
      if (((unsigned int )(~ tmp___53 & (tmp___53 - 1)) >> 31U) & 1) {
        if ((int )(((((unsigned int )cmd_type - 1U) | (1U - (unsigned int )cmd_type)) >> 31U) & 1U)) {
        ...
        if (((unsigned int )(((tmp___52 + (1 << 31)) ^ ((tmp___52 + (1 << 31)) >> 31)) - ((tmp___52 + (1 << 31)) >> 31)) >> 31U) & 1) {
          if ((int )(((((unsigned int )cmd_type - 1U) | (1U - (unsigned int )cmd_type)) >> 31U) & 1U)) {
          ...
          if (((unsigned int )(((tmp___51 + (1 << 31)) ^ ((tmp___51 + (1 << 31)) >> 31)) - ((tmp___51 + (1 << 31)) >> 31)) >> 31U) & 1) {
            scoring___0->no_gaps_in_a = (_Bool)1;
            scoring___0->no_gaps_in_b = (_Bool)1;
          } else {
            tmp___50 = strcasecmp((char const   *)*(argv + argi), "--nogapsin1");
            if (((unsigned int )((tmp___50 + (1 << 31)) - (((tmp___50 + (1 << 31)) << 1) & ((tmp___50 + (1 << 31)) >> 31))) >> 31U) & 1) {
              scoring___0->no_gaps_in_a = (_Bool)1;
            } else {
              tmp___49 = strcasecmp((char const   *)*(argv + argi), "--nogapsin2");
              if (((unsigned int )((tmp___49 + (1 << 31)) - (((tmp___49 + (1 << 31)) + (tmp___49 + (1 << 31))) & ((tmp___49 + (1 << 31)) >> 31))) >> 31U) & 1) {
                scoring___0->no_gaps_in_b = (_Bool)1;
              } else {
                tmp___48 = strcasecmp((char const   *)*(argv + argi), "--nomismatches");
                if (((unsigned int )((tmp___48 - ((tmp___48 + tmp___48) & (tmp___48 >> 31))) - 1) >> 31U) & 1) {
                  scoring___0->no_mismatches = (_Bool)1;
                } else {
                  tmp___47 = strcasecmp((char const   *)*(argv + argi), "--case_sensitive");
                  if (! (((unsigned int )(~ tmp___47 & (tmp___47 - 1)) >> 31U) & 1)) {
                    tmp___46 = strcasecmp((char const   *)*(argv + argi), "--printseq");
                    if (((unsigned int )((tmp___46 - ((tmp___46 << 1) & (tmp___46 >> 31))) - 1) >> 31U) & 1) {
                      ...
                      if (((unsigned int )((tmp___45 - ((tmp___45 + tmp___45) & (tmp___45 >> 31))) - 1) >> 31U) & 1) {
                        cmd___0->print_matrices = (_Bool)1;
                      } else {
                        tmp___44 = strcasecmp((char const   *)*(argv + argi), "--printscores");
                        if (((unsigned int )(((tmp___44 + (tmp___44 >> 31)) ^ (tmp___44 >> 31)) - 1) >> 31U) & 1) {
                          if ((int )(((((unsigned int )cmd_type - 1U) | (1U - (unsigned int )cmd_type)) >> 31U) & 1U)) {
                            print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                          ...
                          if (((unsigned int )(((tmp___43 ^ (tmp___43 >> 31)) - (tmp___43 >> 31)) - 1) >> 31U) & 1) {
                            cmd___0->print_fasta = (_Bool)1;
                          } else {
                            tmp___42 = strcasecmp((char const   *)*(argv + argi),
                                                  "--pretty");
                            if (((unsigned int )(~ tmp___42 & (tmp___42 - 1)) >> 31U) & 1) {
                              cmd___0->print_pretty = (_Bool)1;
                            } else {
                              tmp___41 = strcasecmp((char const   *)*(argv + argi),
                                                    "--colour");
                              if (((unsigned int )(~ tmp___41 & (tmp___41 - 1)) >> 31U) & 1) {
                                cmd___0->print_colour = (_Bool)1;
                              } else {
                                tmp___40 = strcasecmp((char const   *)*(argv + argi),
                                                      "--zam");
                                if (((unsigned int )(~ (tmp___40 | - tmp___40)) >> 31U) & 1) {
                                  if ((int )(((((int )((unsigned int )cmd_type - 1U) >> 31) - (((unsigned int )cmd_type - 1U) ^ ((int )((unsigned int )cmd_type - 1U) >> 31))) >> 31U) & 1U)) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                  ...
                                  tmp___39 = strcasecmp((char const   *)*(argv + argi),
                                                        "--stdin");
                                  if (((unsigned int )(((tmp___39 ^ (tmp___39 >> 31)) - (tmp___39 >> 31)) - 1) >> 31U) & 1) {
                                    cmdline_add_files(cmd___0, (char *)"", (char *)((void *)0));
                                    cmd___0->interactive = (_Bool)1;
                                  } else
                                  if (((unsigned int )(((argi - ((argc & ~ 1) - (~ argc & 1))) + (1 << 31)) - ((((argi - ((argc & ~ 1) - (~ argc & 1))) + (1 << 31)) + ((argi - ((argc & ~ 1) - (~ argc & 1))) + (1 << 31))) & (((argi - ((argc & ~ 1) - (~ argc & 1))) + (1 << 31)) >> 31))) >> 31U) & 1) {
                                    print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                    ...
                                    tmp___38 = strcasecmp((char const   *)*(argv + argi),
                                                          "--scoring");
                                    if (((unsigned int )((tmp___38 + (1 << 31)) - (((tmp___38 + (1 << 31)) + (tmp___38 + (1 << 31))) & ((tmp___38 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                      argi = ((argi | 1) + (argi | 1)) - (argi ^ 1);
                                    } else {
                                      tmp___37 = strcasecmp((char const   *)*(argv + argi),
                                                            "--substitution_matrix");
                                      if (((unsigned int )(~ (tmp___37 | - tmp___37)) >> 31U) & 1) {
                                        tmp___13 = gzopen((char const   *)*(argv + ((argi ^ 1) + ((argi & 1) + (argi & 1)))),
                                                          "r");
                                        sub_matrix_file = tmp___13;
                                        if ((unsigned long )sub_matrix_file == (unsigned long )((void *)0)) {
                                          print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                      "Couldn\'t read: %s", *(argv + ((argi - ~ 1) - 1)));
                                        }
                                        align_scoring_load_matrix(sub_matrix_file,
                                                                  (char const   *)*(argv + ((argi ^ 1) + ((argi & 1) << 1))),
                                                                  scoring___0, (char )cmd___0->case_sensitive);
                                        gzclose(sub_matrix_file);
                                        substitutions_set = (char)1;
                                        argi = (argi ^ 1) + ((argi & 1) << 1);
                                      } else {
                                        tmp___36 = strcasecmp((char const   *)*(argv + argi),
                                                              "--substitution_pairs");
                                        if (((unsigned int )(~ tmp___36 & (tmp___36 - 1)) >> 31U) & 1) {
                                          tmp___14 = gzopen((char const   *)*(argv + ((argi - ~ 1) - 1)),
                                                            "r");
                                          sub_pairs_file = tmp___14;
                                          if ((unsigned long )sub_pairs_file == (unsigned long )((void *)0)) {
                                            print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                        "Couldn\'t read: %s", *(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)));
                                          }
                                          align_scoring_load_pairwise(sub_pairs_file,
                                                                      (char const   *)*(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                                      scoring___0,
                                                                      (char )cmd___0->case_sensitive);
                                          gzclose(sub_pairs_file);
                                          substitutions_set = (char)1;
                                          argi = ((argi | 1) << 1) - (argi ^ 1);
                                        } else {
                                          tmp___35 = strcasecmp((char const   *)*(argv + argi),
                                                                "--minscore");
                                          if (((unsigned int )(((tmp___35 + (1 << 31)) ^ ((tmp___35 + (1 << 31)) >> 31)) - ((tmp___35 + (1 << 31)) >> 31)) >> 31U) & 1) {
                                            if ((unsigned int )cmd_type != 0U) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                          "--minscore only valid with Smith-Waterman");
                                            }
                                            tmp___15 = parse_entire_int(*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)),
                                                                        & cmd___0->min_score);
                                            if (! tmp___15) {
                                              print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                            ...
                                            tmp___34 = strcasecmp((char const   *)*(argv + argi),
                                                                  "--maxhits");
                                            if (((unsigned int )(~ tmp___34 & (tmp___34 - 1)) >> 31U) & 1) {
                                              if ((unsigned int )cmd_type != 0U) {
                                                print_usage(cmd_type, defaults, (char const   *)*(argv + 0),
                                                            "--maxhits only valid with Smith-Waterman");
                                              }
                                              tmp___16 = parse_entire_uint(*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)),
                                              ...
                                              tmp___33 = strcasecmp((char const   *)*(argv + argi),
                                                                    "--context");
                                              if (((unsigned int )(((tmp___33 ^ (tmp___33 >> 31)) - (tmp___33 >> 31)) - 1) >> 31U) & 1) {
                                                if ((unsigned int )cmd_type != 0U) {
                                                  print_usage(cmd_type, defaults,
                                                              (char const   *)*(argv + 0),
                                                              "--context only valid with Smith-Waterman");
                                                }
                                                tmp___17 = parse_entire_uint(*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                                ...
                                                tmp___32 = strcasecmp((char const   *)*(argv + argi),
                                                                      "--match");
                                                if (((unsigned int )(~ tmp___32 & (tmp___32 - 1)) >> 31U) & 1) {
                                                  tmp___18 = parse_entire_int(*(argv + ((argi | 1) + (argi & 1))),
                                                                              & scoring___0->match);
                                                  if (! tmp___18) {
                                                    print_usage(cmd_type, defaults,
                                                                (char const   *)*(argv + 0),
                                                                "Invalid --match argument (\'%s\') must be an int",
                                                                *(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1)));
                                                  }
                                                  match_set = (char)1;
                                                  argi = (argi | 1) + (argi & 1);
                                                } else {
                                                  tmp___31 = strcasecmp((char const   *)*(argv + argi),
                                                                        "--mismatch");
                                                  if (((unsigned int )((tmp___31 + (1 << 31)) - (((tmp___31 + (1 << 31)) << 1) & ((tmp___31 + (1 << 31)) >> 31))) >> 31U) & 1) {
                                                    tmp___19 = parse_entire_int(*(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                                    ...
                                                    tmp___30 = strcasecmp((char const   *)*(argv + argi),
                                                                          "--gapopen");
                                                    if (((unsigned int )(((tmp___30 ^ (tmp___30 >> 31)) - (tmp___30 >> 31)) - 1) >> 31U) & 1) {
                                                      tmp___20 = parse_entire_int(*(argv + (((argi | 1) << 1) - (argi ^ 1))),
                                                      ...
                                                      tmp___29 = strcasecmp((char const   *)*(argv + argi),
                                                                            "--gapextend");
                                                      if (((unsigned int )((tmp___29 - ((tmp___29 << 1) & (tmp___29 >> 31))) - 1) >> 31U) & 1) {
                                                        tmp___21 = parse_entire_int(*(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                                                    & scoring___0->gap_extend);
                                                        if (! tmp___21) {
                                                          print_usage(cmd_type, defaults,
                                                                      (char const   *)*(argv + 0),
                                                                      "Invalid --gapextend argument (\'%s\') must be an int",
                                                                      *(argv + (((argi | 1) << 1) - (argi ^ 1))));
                                                        }
                                                        argi = ((argi ^ ~ 1) + ((argi | 1) << 1)) + 1;
                                                      } else {
                                                        tmp___28 = strcasecmp((char const   *)*(argv + argi),
                                                                              "--file");
                                                        if (((unsigned int )(~ (tmp___28 | - tmp___28)) >> 31U) & 1) {
                                                          cmdline_add_files(cmd___0,
                                                                            *(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                                            (char *)((void *)0));
                                                          argi = (argi | 1) + (argi & 1);
                                                        } else {
                                                          tmp___27 = strcasecmp((char const   *)*(argv + argi),
                                                                                "--files");
                                                          if (((unsigned int )(~ (tmp___27 | - tmp___27)) >> 31U) & 1) {
                                                            if (((unsigned int )((~ (((argc ^ 2) - ((~ argc & 2) << 1)) ^ argi) >> 1) + (((argc ^ 2) - ((~ argc & 2) << 1)) & ~ argi)) >> 31U) & 1) {
                                                              print_usage(cmd_type,
                                                                          defaults,
                                                                          (char const   *)*(argv + 0),
                                                                          "--files option takes 2 arguments");
                                                            } else {
                                                              tmp___22 = strcmp((char const   *)*(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                                                "-");
                                                              if (((unsigned int )(((tmp___22 + (tmp___22 >> 31)) ^ (tmp___22 >> 31)) - 1) >> 31U) & 1) {
                                                                tmp___23 = strcmp((char const   *)*(argv + (((argi ^ ~ 2) + ((argi | 2) + (argi | 2))) + 1)),
                                                                                  "-");
                                                                if (((unsigned int )(~ (tmp___23 | - tmp___23)) >> 31U) & 1) {
                                                                  cmdline_add_files(cmd___0,
                                                                                    *(argv + (((argi ^ ~ 1) + ((argi | 1) + (argi | 1))) + 1)),
                                                                                    (char *)((void *)0));
                                                                } else {
                                                                  cmdline_add_files(cmd___0,
                                                                                    *(argv + (((argi | 1) + (argi | 1)) - (argi ^ 1))),
                                                            ...
                                                            tmp___26 = strcasecmp((char const   *)*(argv + argi),
                                                                                  "--wildcard");
                                                            if (((unsigned int )(~ (tmp___26 | - tmp___26)) >> 31U) & 1) {
                                                              wildscore = 0;
                                                              if (((unsigned int )((((argi - ((argc + ~ 2) + 1)) ^ ((argi - ((argc + ~ 2) + 1)) >> 31)) - ((argi - ((argc + ~ 2) + 1)) >> 31)) - 1) >> 31U) & 1) {
                                                                print_usage(cmd_type,
                                                                            defaults,
                                                                            (char const   *)*(argv + 0),
                                                                            "--wildcard <w> <s> takes a single character and a number");
                                                              } else {
                                                                tmp___24 = strlen((char const   *)*(argv + ((argi - ~ 1) - 1)));
                                                                if ((int )((((((tmp___24 - 1UL) + (tmp___24 - 1UL)) & ((long )(tmp___24 - 1UL) >> 31L)) - (tmp___24 - 1UL)) >> 31UL) & 1UL)) {
                                                                  print_usage(cmd_type,
                                                                              defaults,
                                                                              (char const   *)*(argv + 0),
                                                                              "--wildcard <w> <s> takes a single character and a number");
                                                                } else {
                                                                  tmp___25 = parse_entire_int(*(argv + ((argi - ~ 2) - 1)),
                                                                                              & wildscore);
                                                                  if (! tmp___25) {
                                                                    print_usage(cmd_type,
                                                                                defaults,
      ...
      if (((unsigned int )(((((((argc & ~ argi) + (argc & ~ argi)) - (argc ^ argi)) - 2) << 1) & (((((argc & ~ argi) + (argc & ~ argi)) - (argc ^ argi)) - 2) >> 31)) - ((((argc & ~ argi) + (argc & ~ argi)) - (argc ^ argi)) - 2)) >> 31U) & 1) {
  ...
  if (scoring___0->use_match_mismatch) {
    if (((unsigned int )((scoring___0->match - scoring___0->mismatch) ^ ((scoring___0->match ^ scoring___0->mismatch) & ((scoring___0->match - scoring___0->mismatch) ^ scoring___0->match))) >> 31U) & 1) {
  ...
  if (((unsigned int )((argi - argc) ^ ((argi ^ argc) & ((argi - argc) ^ argi))) >> 31U) & 1) {
    cmd___0->seq1 = (char const   *)*(argv + argi);
    cmd___0->seq2 = (char const   *)*(argv + (((argi ^ ~ 1) + ((argi | 1) << 1)) + 1));
  }
...
{ 
  ...
  if ((int )(((unsigned int const   )(~ ((int const   )*(seq_a + 0) | - ((int const   )*(seq_a + 0)))) >> (unsigned int const   )31) & 1)) {
    goto _L___0;
  } else
  if ((int )(((unsigned int const   )(((int const   )*(seq_b + 0) + (1 << 31)) - ((((int const   )*(seq_b + 0) + (1 << 31)) << 1) & (((int const   )*(seq_b + 0) + (1 << 31)) >> (int const   )31))) >> (unsigned int const   )31) & 1)) {
    _L___0: 
  ...
  aligner = tmp;
  len_a = (aligner->score_width + ~ 1UL) + 1UL;
  len_b = (aligner->score_height + ~ 1UL) + 1UL;
  ...
  if (! cmd->min_score_set) {
    if (wait_on_keystroke) {
      ...
      if ((int )((((~ len_a | len_b) & ((len_a ^ len_b) | ~ (len_b - len_a))) >> 31UL) & 1UL)) {
        tmp___3 = len_a;
      } else {
        tmp___3 = len_b;
      }
      if ((double )2 <= 0.2 * (double )tmp___3) {
        if ((int )((((~ len_a | len_b) & ((len_a ^ len_b) | ~ (len_b - len_a))) >> 31UL) & 1UL)) {
          tmp___1 = len_a;
        } else {
          tmp___1 = len_b;
  ...
  while (1) {
    ...
    if (tmp___7) {
      ...
      if (tmp___8) {
        if (((unsigned int )((~ (cmd->min_score ^ result->score) >> 1) + (cmd->min_score & ~ result->score)) >> 31U) & 1) {
          if (! (! cmd->max_hits_per_alignment_set)) {
            if (! ((int )((((~ hit_index & (size_t___1 )cmd->max_hits_per_alignment) | (~ (hit_index ^ (size_t___1 )cmd->max_hits_per_alignment) & (hit_index - (size_t___1 )cmd->max_hits_per_alignment))) >> 31UL) & 1UL))) {
              break;
            }
          }
        } else {
    ...
    tmp___4 = hit_index;
    hit_index = ((hit_index ^ ~ 1UL) + ((hit_index | 1UL) + (hit_index | 1UL))) + 1UL;
    printf((char const   *)((char const   */* __restrict  */)"hit %zu.%zu score: %i\n"),
           alignment_index, tmp___4, result->score);
    if (cmd->print_context) {
      if ((int )((((~ result->pos_b | result->pos_a) & ((result->pos_b ^ result->pos_a) | ~ (result->pos_a - result->pos_b))) >> 31UL) & 1UL)) {
        context_left = result->pos_a;
      } else {
        context_left = result->pos_b;
      }
      if ((int )((((~ context_left | (size_t___1 )cmd->print_context) & ((context_left ^ (size_t___1 )cmd->print_context) | ~ ((size_t___1 )cmd->print_context - context_left))) >> 31UL) & 1UL)) {
        context_left = context_left;
      } else {
        context_left = (size_t___1 )cmd->print_context;
      }
      rem_a = (len_a ^ ((result->pos_a | result->len_a) + (result->pos_a & result->len_a))) - ((~ len_a & ((result->pos_a | result->len_a) + (result->pos_a & result->len_a))) << 1UL);
      rem_b = (len_b + ~ ((result->pos_b ^ result->len_b) + ((result->pos_b & result->len_b) << 1UL))) + 1UL;
      if ((int )((((~ rem_b | rem_a) & ((rem_b ^ rem_a) | ~ (rem_a - rem_b))) >> 31UL) & 1UL)) {
        context_right = rem_a;
      } else {
        context_right = rem_b;
      }
      if ((int )((((~ context_right | (size_t___1 )cmd->print_context) & ((context_right ^ (size_t___1 )cmd->print_context) | ~ ((size_t___1 )cmd->print_context - context_right))) >> 31UL) & 1UL)) {
        context_right = context_right;
      } else {
        context_right = (size_t___1 )cmd->print_context;
      }
      if ((int )((((~ result->pos_a & context_left) | (~ (result->pos_a ^ context_left) & (result->pos_a - context_left))) >> 31UL) & 1UL)) {
        left_spaces_a = (context_left & ~ result->pos_a) - (~ context_left & result->pos_a);
      } else {
        left_spaces_a = (size_t___1 )0;
      }
      if ((int )((((~ result->pos_b & context_left) | ((~ result->pos_b | context_left) & (result->pos_b - context_left))) >> 31UL) & 1UL)) {
        left_spaces_b = (context_left + ~ result->pos_b) + 1UL;
      } else {
        left_spaces_b = (size_t___1 )0;
      }
      if ((int )((((~ rem_a & context_right) | (~ (rem_a ^ context_right) & (rem_a - context_right))) >> 31UL) & 1UL)) {
        right_spaces_a = (context_right + ~ rem_a) + 1UL;
      } else {
        right_spaces_a = (size_t___1 )0;
      }
      if ((int )((((~ rem_b & context_right) | ((~ rem_b | context_right) & (rem_b - context_right))) >> 31UL) & 1UL)) {
        right_spaces_b = (context_right + ~ rem_b) + 1UL;
      } else {
        right_spaces_b = (size_t___1 )0;
      }
    }
    print_alignment_part((char const   *)result->result_a, (char const   *)result->result_b,
                         ...
                         (context_left + ~ left_spaces_a) + 1UL, ((context_right & ~ right_spaces_a) + (context_right & ~ right_spaces_a)) - (context_right ^ right_spaces_a));
    if (cmd->print_pretty) {
      fputs((char const   *)((char const   */* __restrict  */)"  "), (FILE *)((FILE */* __restrict  */)stdout));
      if ((int )((((~ left_spaces_b | left_spaces_a) & ((left_spaces_b ^ left_spaces_a) | ~ (left_spaces_a - left_spaces_b))) >> 31UL) & 1UL)) {
        tmp___5 = left_spaces_a;
      } else {
        tmp___5 = left_spaces_b;
      }
      max_left_spaces = tmp___5;
      if ((int )((((~ right_spaces_b | right_spaces_a) & ((right_spaces_b ^ right_spaces_a) | ~ (right_spaces_a - right_spaces_b))) >> 31UL) & 1UL)) {
      ...
      spacer = (size_t___1 )0;
      while ((int )((((~ spacer & max_left_spaces) | (~ (spacer ^ max_left_spaces) & (spacer - max_left_spaces))) >> 31UL) & 1UL)) {
        putc(' ', stdout);
        spacer = ((spacer ^ ~ 1UL) + ((spacer | 1UL) << 1UL)) + 1UL;
      }
      spacer = (size_t___1 )0;
      while ((int )((((~ spacer & (((context_left & ~ max_left_spaces) << 1UL) - (context_left ^ max_left_spaces))) | (~ (spacer ^ (((context_left & ~ max_left_spaces) << 1UL) - (context_left ^ max_left_spaces))) & (spacer - (((context_left & ~ max_left_spaces) << 1UL) - (context_left ^ max_left_spaces))))) >> 31UL) & 1UL)) {
        putc('.', stdout);
        spacer = (spacer - ~ 1UL) - 1UL;
      }
      alignment_print_spacer((char const   *)result->result_a, (char const   *)result->result_b,
                             (scoring_t const   *)(& scoring));
      spacer = (size_t___1 )0;
      while ((int )((((~ spacer & ((context_right + ~ max_right_spaces) + 1UL)) | ((~ spacer | ((context_right + ~ max_right_spaces) + 1UL)) & (spacer - ((context_right + ~ max_right_spaces) + 1UL)))) >> 31UL) & 1UL)) {
        putc('.', stdout);
        spacer = (spacer - ~ 1UL) - 1UL;
      }
      spacer = (size_t___1 )0;
      while ((int )((((~ spacer & max_right_spaces) | ((~ spacer | max_right_spaces) & (spacer - max_right_spaces))) >> 31UL) & 1UL)) {
        putc(' ', stdout);
        spacer = (spacer | 1UL) + (spacer & 1UL);
      }
      putc('\n', stdout);
    }
    print_alignment_part((char const   *)result->result_b, (char const   *)result->result_a,
                         ...
                         (context_left ^ left_spaces_b) - ((~ context_left & left_spaces_b) + (~ context_left & left_spaces_b)),
                         (context_right + ~ right_spaces_b) + 1UL);
    printf((char const   *)((char const   */* __restrict  */)"\n"));
    fflush(stdout);
  }
  fputs((char const   *)((char const   */* __restrict  */)"==\n"), (FILE *)((FILE */* __restrict  */)stdout));
  fflush(stdout);
  alignment_index = ((alignment_index ^ ~ 1UL) + ((alignment_index | 1UL) << 1UL)) + 1UL;
  return;
}
}
...
{ 
  ...
  in->begin = ((in->begin & ~ 1UL) + (in->begin & ~ 1UL)) - (in->begin ^ 1UL);
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size & ~ 1UL) - (~ in->size & 1UL),
                  (FILE */* __restrict  */)file);
      in->end = ((1UL ^ ~ tmp) + ((1UL | tmp) << 1UL)) + 1UL;
      in->begin = (size_t___1 )1;
      break;
    }
  }
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      if ((int )((((~ offset & in->end) | (~ (offset ^ in->end) & (offset - in->end))) >> 31UL) & 1UL)) {
        tmp___0 = offset;
        offset = ((offset | 1UL) + (offset | 1UL)) - (offset ^ 1UL);
        if (! (((unsigned int )(((((int )*(in->b + tmp___0) - 10) >> 31) - ((int )*(in->b + tmp___0) - 10)) ^ (((int )*(in->b + tmp___0) - 10) >> 31)) >> 31U) & 1)) {
          break;
        }
      } else {
        break;
    ...
    buffered = (offset & ~ in->begin) - (~ offset & in->begin);
    cbuf_capacity(buf, size, ((*len | buffered) + (*len | buffered)) - (*len ^ buffered));
    memcpy((void */* __restrict  */)(*buf + *len), (void const   */* __restrict  */)(in->b + in->begin),
           buffered);
    *len = ((*len ^ ~ buffered) + ((*len | buffered) + (*len | buffered))) + 1UL;
    in->begin = offset;
    total_read = (total_read | buffered) + (total_read & buffered);
    if (((unsigned int )(((((int )*(*buf + ((*len + ~ 1UL) + 1UL)) - 10) + (((int )*(*buf + ((*len + ~ 1UL) + 1UL)) - 10) >> 31)) ^ (((int )*(*buf + ((*len + ~ 1UL) + 1UL)) - 10) >> 31)) - 1) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size + ~ 1UL) + 1UL,
                      (FILE */* __restrict  */)file);
      in->end = (1UL ^ tmp___1) + ((1UL & tmp___1) << 1UL);
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, (in->size ^ 1UL) - ((~ in->size & 1UL) + (~ in->size & 1UL)),
                  (FILE */* __restrict  */)file);
      in->end = (1UL - ~ tmp) - 1UL;
      in->begin = (size_t___1 )1;
      break;
  ...
  while ((int )((((~ in->begin & in->end) | ((~ in->begin | in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      ...
      skipped_bytes = ((skipped_bytes | ((offset ^ in->begin) - ((~ offset & in->begin) << 1UL))) << 1UL) - (skipped_bytes ^ ((offset ^ in->begin) - ((~ offset & in->begin) << 1UL)));
    }
    in->begin = offset;
    if (((unsigned int )(~ (((int )*(in->b + ((offset ^ 1UL) - ((~ offset & 1UL) + (~ offset & 1UL)))) - 10) | (10 - (int )*(in->b + ((offset ^ 1UL) - ((~ offset & 1UL) + (~ offset & 1UL))))))) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = fread((void */* __restrict  */)(in->b + 1), (size_t___1 )1, ((in->size & ~ 1UL) << 1UL) - (in->size ^ 1UL),
                      (FILE */* __restrict  */)file);
      in->end = (1UL | tmp___1) + (1UL & tmp___1);
      in->begin = (size_t___1 )1;
      break;
...
{ 
  ...
  green = (char)0;
  i = 0;
  while ((int )(((unsigned int const   )((int const   )*(alignment_a + i) | - ((int const   )*(alignment_a + i))) >> (unsigned int const   )31) & 1)) {
    if ((int )(((unsigned int const   )(~ (((int const   )*(alignment_b + i) - 45) | (45 - (int const   )*(alignment_b + i)))) >> (unsigned int const   )31) & 1)) {
      if (! red) {
    ...
    if (case_sensitive) {
      if ((int )(((unsigned int const   )((((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) >> (int const   )31) - (((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) ^ (((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) >> (int const   )31))) >> (unsigned int const   )31) & 1)) {
        goto _L___1;
      } else {
        goto _L___3;
      }
    ...
    if (! case_sensitive) {
      ...
      if (((unsigned int )(((tmp - tmp___0) >> 31) - ((tmp - tmp___0) ^ ((tmp - tmp___0) >> 31))) >> 31U) & 1) {
        _L___1: 
        if ((int )(((unsigned int const   )(((((int const   )*(alignment_a + i) - 45) >> (int const   )31) - ((int const   )*(alignment_a + i) - 45)) ^ (((int const   )*(alignment_a + i) - 45) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
          if ((int )(((unsigned int const   )(((int const   )*(alignment_b + i) - 45) | (45 - (int const   )*(alignment_b + i))) >> (unsigned int const   )31) & 1)) {
            if (! green) {
...
{ 
  ...
  if ((unsigned long )sf->gz_file != (unsigned long )((void *)0)) {
    ...
    if (((unsigned int )(((e >> 31) - e) ^ (e >> 31)) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )((((line_num - -1) >> 31) - (line_num - -1)) ^ ((line_num - -1) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  {
  b = (char *)base;
  end = b + ((nel & w) * (nel | w) + (nel & ~ w) * (~ nel & w));
  if ((int )((((~ nel & 7UL) | ((~ nel | 7UL) & (nel - 7UL))) >> 31UL) & 1UL)) {
    pi = b + w;
    while ((int )((((~ ((unsigned long )pi) & (unsigned long )end) | ((~ ((unsigned long )pi) | (unsigned long )end) & ((unsigned long )pi - (unsigned long )end))) >> 31UL) & 1UL)) {
      pj = pi;
      while (1) {
        if ((int )((((~ ((unsigned long )b) & (unsigned long )pj) | ((~ ((unsigned long )b) | (unsigned long )pj) & ((unsigned long )b - (unsigned long )pj))) >> 31UL) & 1UL)) {
    ...
    last = b + ((w & ((nel ^ 1UL) - ((~ nel & 1UL) + (~ nel & 1UL)))) * (w | ((nel ^ 1UL) - ((~ nel & 1UL) + (~ nel & 1UL)))) + (w & ~ ((nel ^ 1UL) - ((~ nel & 1UL) + (~ nel & 1UL)))) * (~ w & ((nel ^ 1UL) - ((~ nel & 1UL) + (~ nel & 1UL)))));
    l[0] = b;
    l[1] = b + ((w & nel / 2UL) * (w | nel / 2UL) + (w & ~ (nel / 2UL)) * (~ w & nel / 2UL));
    l[2] = last;
    tmp___1 = (*compar)((void const   *)l[0], (void const   *)l[1], arg);
    if (((unsigned int )(tmp___1 ^ (((tmp___1 << 1) & (tmp___1 >> 31)) - tmp___1)) >> 31U) & 1) {
      tmp___0 = l[0];
      l[0] = l[1];
      l[1] = tmp___0;
    }
    tmp___3 = (*compar)((void const   *)l[1], (void const   *)l[2], arg);
    if (((unsigned int )(tmp___3 ^ ((tmp___3 >> 31) - (tmp___3 ^ (tmp___3 >> 31)))) >> 31U) & 1) {
      tmp___0 = l[1];
      l[1] = l[2];
      l[2] = tmp___0;
      tmp___2 = (*compar)((void const   *)l[0], (void const   *)l[1], arg);
      if (((unsigned int )(- tmp___2 & ~ tmp___2) >> 31U) & 1) {
        tmp___0 = l[0];
        l[0] = l[1];
        l[1] = tmp___0;
      }
    ...
    y = last;
    xend = x + w;
    while ((int )((((~ ((unsigned long )x) & (unsigned long )xend) | ((~ ((unsigned long )x) | (unsigned long )xend) & ((unsigned long )x - (unsigned long )xend))) >> 31UL) & 1UL)) {
      ch = *x;
      *x = *y;
      *y = ch;
      x ++;
    ...
    pl = b;
    pr = last;
    while ((int )((((~ ((unsigned long )pl) & (unsigned long )pr) | (~ ((unsigned long )pl ^ (unsigned long )pr) & ((unsigned long )pl - (unsigned long )pr))) >> 31UL) & 1UL)) {
      while ((int )((((~ ((unsigned long )pl) & (unsigned long )pr) | ((~ ((unsigned long )pl) | (unsigned long )pr) & ((unsigned long )pl - (unsigned long )pr))) >> 31UL) & 1UL)) {
...
{ 
  ...
  {
  if ((int )((((~ *size | (((*len | 1UL) << 1UL) - (*len ^ 1UL))) & ((*size ^ (((*len | 1UL) << 1UL) - (*len ^ 1UL))) | ~ ((((*len | 1UL) << 1UL) - (*len ^ 1UL)) - *size))) >> 31UL) & 1UL)) {
    cbuf_capacity(buf, size, ((*len ^ ~ 1UL) + ((*len | 1UL) << 1UL)) + 1UL);
  }
  if ((int )((((~ 4294967295UL & ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) | (~ (4294967295UL ^ ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) & (4294967295UL - ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))))) >> 31UL) & 1UL)) {
    tmp = (size_t___1 )4294967295U;
  } else {
    tmp = (*size & ~ *len) - (~ *size & *len);
  }
  r = tmp;
  origlen = *len;
  while (1) {
    ...
    *len = ((*len ^ ~ tmp___0) + ((*len | tmp___0) + (*len | tmp___0))) + 1UL;
    if (((unsigned int )(~ (((int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL))) - 10) | (10 - (int )*(*buf + (((*len & ~ 1UL) + (*len & ~ 1UL)) - (*len ^ 1UL)))))) >> 31U) & 1) {
      return (((*len & ~ origlen) << 1UL) - (*len ^ origlen));
    } else {
      tmp___1 = (*size & 2UL) * (*size | 2UL) + (*size & ~ 2UL) * (~ *size & 2UL);
      *size = tmp___1;
    ...
    if ((int )((((~ 4294967295UL & ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) | ((~ 4294967295UL | ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) & (4294967295UL - ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))))) >> 31UL) & 1UL)) {
      ...
      r = (*size ^ *len) - ((~ *size & *len) << 1UL);
    }
  }
  return ((*len + ~ origlen) + 1UL);
}
}
...
{ 
  ...
  *is_match = (_Bool )(((unsigned int )(((((int )a - (int )b) ^ (((int )a - (int )b) >> 31)) - (((int )a - (int )b) >> 31)) - 1) >> 31U) & 1);
  if (scoring___0->no_mismatches) {
    if (! *is_match) {
  ...
  if (((~ (scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b))) | 1U) + (scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] >> ((~ ((int )b) | 31) - ~ ((int )b)))) + 1U) {
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
      ...
      tmp___0 = in->begin;
      in->begin = (in->begin | 1UL) + (in->begin & 1UL);
      tmp___1 = (int )*(in->b + tmp___0);
    }
    return (tmp___1);
  }
...
{ 
  ...
  gap_open_penalty = (int )((scoring___0->gap_extend ^ scoring___0->gap_open) + ((scoring___0->gap_extend & scoring___0->gap_open) + (scoring___0->gap_extend & scoring___0->gap_open)));
  gap_extend_penalty = (int )scoring___0->gap_extend;
  if (is_sw) {
    tmp___0 = 0;
  } else {
    tmp = abs((int )scoring___0->min_penalty);
    tmp___0 = ((-0x7FFFFFFF-1) ^ tmp) + (((-0x7FFFFFFF-1) & tmp) << 1);
  }
  min = tmp___0;
  len_i = (score_width & ~ 1UL) - (~ score_width & 1UL);
  len_j = ((score_height & ~ 1UL) + (score_height & ~ 1UL)) - (score_height ^ 1UL);
  *(match_scores + 0) = 0;
  *(gap_a_scores + 0) = 0;
  *(gap_b_scores + 0) = 0;
  if (is_sw) {
    i = (size_t___1 )1;
    while ((int )((((~ i & score_width) | (~ (i ^ score_width) & (i - score_width))) >> 31UL) & 1UL)) {
      tmp___2 = 0;
    ...
    while ((int )((((~ j & score_height) | ((~ j | score_height) & (j - score_height))) >> 31UL) & 1UL)) {
      tmp___4 = min;
      *(gap_b_scores + index___0) = tmp___4;
      tmp___3 = tmp___4;
      *(gap_a_scores + index___0) = tmp___3;
      *(match_scores + index___0) = tmp___3;
      j = ((j ^ ~ 1UL) + ((j | 1UL) << 1UL)) + 1UL;
      index___0 = ((index___0 ^ ~ score_width) + ((index___0 | score_width) + (index___0 | score_width))) + 1UL;
    }
  } else {
    i = (size_t___1 )1;
    while ((int )((((~ i & score_width) | ((~ i | score_width) & (i - score_width))) >> 31UL) & 1UL)) {
      ...
      *(gap_a_scores + i) = min;
      if (scoring___0->no_start_gap_penalty) {
        ...
        *(gap_b_scores + i) = (score_t )((scoring___0->gap_open - ~ ((int const   )(((int )i & (int )scoring___0->gap_extend) * ((int )i | (int )scoring___0->gap_extend) + ((int )i & ~ ((int )scoring___0->gap_extend)) * (~ ((int )i) & (int )scoring___0->gap_extend)))) - 1);
      }
      i = ((i | 1UL) + (i | 1UL)) - (i ^ 1UL);
    }
    j = (size_t___1 )1;
    ...
    while ((int )((((~ j & score_height) | (~ (j ^ score_height) & (j - score_height))) >> 31UL) & 1UL)) {
      *(match_scores + index___0) = min;
      if (scoring___0->no_start_gap_penalty) {
        ...
        *(gap_a_scores + index___0) = (score_t )((scoring___0->gap_open | (int const   )(((int )j & (int )scoring___0->gap_extend) * ((int )j | (int )scoring___0->gap_extend) + ((int )j & ~ ((int )scoring___0->gap_extend)) * (~ ((int )j) & (int )scoring___0->gap_extend))) + (scoring___0->gap_open & (int const   )(((int )j & (int )scoring___0->gap_extend) * ((int )j | (int )scoring___0->gap_extend) + ((int )j & ~ ((int )scoring___0->gap_extend)) * (~ ((int )j) & (int )scoring___0->gap_extend))));
      }
  ...
  index___0 = (score_width ^ 1UL) + ((score_width & 1UL) << 1UL);
  seq_j = (size_t___1 )0;
  while ((int )((((~ seq_j & len_j) | (~ (seq_j ^ len_j) & (seq_j - len_j))) >> 31UL) & 1UL)) {
    seq_i = (size_t___1 )0;
    while ((int )((((~ seq_i & len_i) | ((~ seq_i | len_i) & (seq_i - len_i))) >> 31UL) & 1UL)) {
      ...
      if (scoring___0->no_mismatches) {
        ...
        _L___2: 
        if (((unsigned int )((((*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1) | ~ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) & ((((*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1) ^ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) | ~ ((((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1) - ((*(gap_a_scores + index_upleft) - ~ substitution_penalty) - 1)))) >> 31U) & 1) {
          if (((unsigned int )((((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1) | ~ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) & ((((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1) ^ (((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1)) | ~ ((((*(match_scores + index_upleft) ^ ~ substitution_penalty) + ((*(match_scores + index_upleft) | substitution_penalty) << 1)) + 1) - ((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1)))) >> 31U) & 1) {
            tmp___10 = ((*(match_scores + index_upleft) | substitution_penalty) << 1) - (*(match_scores + index_upleft) ^ substitution_penalty);
          } else {
            goto _L___1;
          }
        } else {
          _L___1: 
          if (((unsigned int )((((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1) | ~ ((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) << 1))) & ((((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1) ^ ((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) << 1))) | ~ (((*(gap_a_scores + index_upleft) ^ substitution_penalty) + ((*(gap_a_scores + index_upleft) & substitution_penalty) << 1)) - ((*(gap_b_scores + index_upleft) - ~ substitution_penalty) - 1)))) >> 31U) & 1) {
            tmp___9 = ((*(gap_a_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_a_scores + index_upleft) | substitution_penalty) << 1)) + 1;
          } else {
            tmp___9 = ((*(gap_b_scores + index_upleft) ^ ~ substitution_penalty) + ((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) | substitution_penalty))) + 1;
          }
          tmp___10 = tmp___9;
        }
        if (((unsigned int )((min | ~ tmp___10) & ((min ^ tmp___10) | ~ (tmp___10 - min))) >> 31U) & 1) {
          if (((unsigned int )((~ (((*(gap_a_scores + index_upleft) | substitution_penalty) + (*(gap_a_scores + index_upleft) & substitution_penalty)) ^ ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) & substitution_penalty))) >> 1) + (((*(gap_a_scores + index_upleft) | substitution_penalty) + (*(gap_a_scores + index_upleft) & substitution_penalty)) & ~ ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) & substitution_penalty)))) >> 31U) & 1) {
            if (((unsigned int )((~ (((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) & substitution_penalty)) ^ ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) & substitution_penalty))) >> 1) + (((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) & substitution_penalty)) & ~ ((*(match_scores + index_upleft) | substitution_penalty) + (*(match_scores + index_upleft) & substitution_penalty)))) >> 31U) & 1) {
              tmp___8 = ((*(match_scores + index_upleft) | substitution_penalty) << 1) - (*(match_scores + index_upleft) ^ substitution_penalty);
            } else {
              goto _L___0;
            }
          } else {
            _L___0: 
            if (((unsigned int )((~ (((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) & substitution_penalty)) ^ (((*(gap_a_scores + index_upleft) | substitution_penalty) + (*(gap_a_scores + index_upleft) | substitution_penalty)) - (*(gap_a_scores + index_upleft) ^ substitution_penalty))) >> 1) + (((*(gap_b_scores + index_upleft) | substitution_penalty) + (*(gap_b_scores + index_upleft) & substitution_penalty)) & ~ (((*(gap_a_scores + index_upleft) | substitution_penalty) + (*(gap_a_scores + index_upleft) | substitution_penalty)) - (*(gap_a_scores + index_upleft) ^ substitution_penalty)))) >> 31U) & 1) {
              tmp___7 = ((*(gap_a_scores + index_upleft) | substitution_penalty) + (*(gap_a_scores + index_upleft) | substitution_penalty)) - (*(gap_a_scores + index_upleft) ^ substitution_penalty);
            } else {
              tmp___7 = (*(gap_b_scores + index_upleft) ^ substitution_penalty) + ((*(gap_b_scores + index_upleft) & substitution_penalty) << 1);
            }
            tmp___8 = tmp___7;
          }
      ...
      if ((int )(((((seq_i - ((len_i & ~ 1UL) - (~ len_i & 1UL))) - (((seq_i - ((len_i & ~ 1UL) - (~ len_i & 1UL))) << 1UL) & ((long )(seq_i - ((len_i & ~ 1UL) - (~ len_i & 1UL))) >> 31L))) - 1UL) >> 31UL) & 1UL)) {
        if (scoring___0->no_end_gap_penalty) {
          if (((unsigned int )((*(gap_a_scores + index_up) | ~ *(match_scores + index_up)) & ((*(gap_a_scores + index_up) ^ *(match_scores + index_up)) | ~ (*(match_scores + index_up) - *(gap_a_scores + index_up)))) >> 31U) & 1) {
            if (((unsigned int )((*(gap_b_scores + index_up) | ~ *(match_scores + index_up)) & ((*(gap_b_scores + index_up) ^ *(match_scores + index_up)) | ~ (*(match_scores + index_up) - *(gap_b_scores + index_up)))) >> 31U) & 1) {
            ...
            _L___3: 
            if (((unsigned int )((*(gap_b_scores + index_up) | ~ *(gap_a_scores + index_up)) & ((*(gap_b_scores + index_up) ^ *(gap_a_scores + index_up)) | ~ (*(gap_a_scores + index_up) - *(gap_b_scores + index_up)))) >> 31U) & 1) {
      ...
      if ((int )((~ ((seq_i - ((len_i ^ 1UL) - ((~ len_i & 1UL) + (~ len_i & 1UL)))) | (((len_i ^ 1UL) - ((~ len_i & 1UL) + (~ len_i & 1UL))) - seq_i)) >> 31UL) & 1UL)) {
        _L___7: 
        if (((unsigned int )((~ (((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)) ^ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) << 1)) + 1)) >> 1) + (((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)) & ~ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) << 1)) + 1))) >> 31U) & 1) {
          if (((unsigned int )(((((*(gap_b_scores + index_up) | gap_open_penalty) << 1) - (*(gap_b_scores + index_up) ^ gap_open_penalty)) | ~ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1)) & (((((*(gap_b_scores + index_up) | gap_open_penalty) << 1) - (*(gap_b_scores + index_up) ^ gap_open_penalty)) ^ (((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1)) | ~ ((((*(match_scores + index_up) ^ ~ gap_open_penalty) + ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) | gap_open_penalty))) + 1) - (((*(gap_b_scores + index_up) | gap_open_penalty) << 1) - (*(gap_b_scores + index_up) ^ gap_open_penalty))))) >> 31U) & 1) {
            tmp___17 = ((*(match_scores + index_up) | gap_open_penalty) << 1) - (*(match_scores + index_up) ^ gap_open_penalty);
          } else {
            goto _L___6;
          }
        } else {
          _L___6: 
          if (((unsigned int )((((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty))) | ~ ((*(gap_a_scores + index_up) ^ gap_extend_penalty) + ((*(gap_a_scores + index_up) & gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)))) & ((((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty))) ^ ((*(gap_a_scores + index_up) ^ gap_extend_penalty) + ((*(gap_a_scores + index_up) & gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)))) | ~ (((*(gap_a_scores + index_up) ^ gap_extend_penalty) + ((*(gap_a_scores + index_up) & gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty))) - ((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty)))))) >> 31U) & 1) {
            tmp___16 = ((*(gap_a_scores + index_up) | gap_extend_penalty) << 1) - (*(gap_a_scores + index_up) ^ gap_extend_penalty);
          } else {
            tmp___16 = ((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) | gap_open_penalty)) - (*(gap_b_scores + index_up) ^ gap_open_penalty);
          }
          tmp___17 = tmp___16;
        }
        if (((unsigned int )((min | ~ tmp___17) & ((min ^ tmp___17) | ~ (tmp___17 - min))) >> 31U) & 1) {
          if (((unsigned int )(((((*(gap_a_scores + index_up) | gap_extend_penalty) << 1) - (*(gap_a_scores + index_up) ^ gap_extend_penalty)) | ~ ((*(match_scores + index_up) ^ gap_open_penalty) + ((*(match_scores + index_up) & gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty)))) & (((((*(gap_a_scores + index_up) | gap_extend_penalty) << 1) - (*(gap_a_scores + index_up) ^ gap_extend_penalty)) ^ ((*(match_scores + index_up) ^ gap_open_penalty) + ((*(match_scores + index_up) & gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty)))) | ~ (((*(match_scores + index_up) ^ gap_open_penalty) + ((*(match_scores + index_up) & gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty))) - (((*(gap_a_scores + index_up) | gap_extend_penalty) << 1) - (*(gap_a_scores + index_up) ^ gap_extend_penalty))))) >> 31U) & 1) {
            if (((unsigned int )((~ (((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty)) ^ ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty))) >> 1) + (((*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty)) & ~ ((*(match_scores + index_up) | gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty)))) >> 31U) & 1) {
              tmp___15 = (*(match_scores + index_up) ^ gap_open_penalty) + ((*(match_scores + index_up) & gap_open_penalty) + (*(match_scores + index_up) & gap_open_penalty));
            } else {
              goto _L___5;
            }
          } else {
            _L___5: 
            if (((unsigned int )((~ (((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) << 1)) ^ ((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty))) >> 1) + (((*(gap_b_scores + index_up) ^ gap_open_penalty) + ((*(gap_b_scores + index_up) & gap_open_penalty) << 1)) & ~ ((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) & gap_extend_penalty)))) >> 31U) & 1) {
              tmp___14 = ((*(gap_a_scores + index_up) ^ ~ gap_extend_penalty) + ((*(gap_a_scores + index_up) | gap_extend_penalty) + (*(gap_a_scores + index_up) | gap_extend_penalty))) + 1;
            } else {
              tmp___14 = (*(gap_b_scores + index_up) | gap_open_penalty) + (*(gap_b_scores + index_up) & gap_open_penalty);
            }
            tmp___15 = tmp___14;
          }
      ...
      if ((int )(((((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) - (((seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) + (seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL))))) & ((long )(seq_j - ((len_j ^ 1UL) - ((~ len_j & 1UL) + (~ len_j & 1UL)))) >> 31L))) - 1UL) >> 31UL) & 1UL)) {
        if (scoring___0->no_end_gap_penalty) {
          if (((unsigned int )((~ (*(gap_a_scores + index_left) ^ *(match_scores + index_left)) >> 1) + (*(gap_a_scores + index_left) & ~ *(match_scores + index_left))) >> 31U) & 1) {
            if (((unsigned int )((~ (*(gap_b_scores + index_left) ^ *(match_scores + index_left)) >> 1) + (*(gap_b_scores + index_left) & ~ *(match_scores + index_left))) >> 31U) & 1) {
            ...
            _L___9: 
            if (((unsigned int )((~ (*(gap_b_scores + index_left) ^ *(gap_a_scores + index_left)) >> 1) + (*(gap_b_scores + index_left) & ~ *(gap_a_scores + index_left))) >> 31U) & 1) {
      ...
      if ((int )(((((seq_j - (((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL))) + (1UL << 31)) - ((((seq_j - (((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL))) + (1UL << 31)) + ((seq_j - (((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL))) + (1UL << 31))) & ((long )((seq_j - (((len_j & ~ 1UL) + (len_j & ~ 1UL)) - (len_j ^ 1UL))) + (1UL << 31)) >> 31L))) >> 31UL) & 1UL)) {
        _L___13: 
        if (((unsigned int )((~ (((*(gap_a_scores + index_left) - ~ gap_open_penalty) - 1) ^ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty)))) >> 1) + (((*(gap_a_scores + index_left) - ~ gap_open_penalty) - 1) & ~ ((*(match_scores + index_left) ^ gap_open_penalty) + ((*(match_scores + index_left) & gap_open_penalty) + (*(match_scores + index_left) & gap_open_penalty))))) >> 31U) & 1) {
          if (((unsigned int )(((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) | ~ (((*(match_scores + index_left) | gap_open_penalty) << 1) - (*(match_scores + index_left) ^ gap_open_penalty))) & (((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) ^ (((*(match_scores + index_left) | gap_open_penalty) << 1) - (*(match_scores + index_left) ^ gap_open_penalty))) | ~ ((((*(match_scores + index_left) | gap_open_penalty) << 1) - (*(match_scores + index_left) ^ gap_open_penalty)) - (((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1)))) >> 31U) & 1) {
            tmp___24 = ((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) << 1)) + 1;
          } else {
            goto _L___12;
          }
        } else {
          _L___12: 
          if (((unsigned int )((~ (((*(gap_b_scores + index_left) - ~ gap_extend_penalty) - 1) ^ ((*(gap_a_scores + index_left) ^ gap_open_penalty) + ((*(gap_a_scores + index_left) & gap_open_penalty) << 1))) >> 1) + (((*(gap_b_scores + index_left) - ~ gap_extend_penalty) - 1) & ~ ((*(gap_a_scores + index_left) ^ gap_open_penalty) + ((*(gap_a_scores + index_left) & gap_open_penalty) << 1)))) >> 31U) & 1) {
            tmp___23 = (*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty);
          } else {
            tmp___23 = ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1) - (*(gap_b_scores + index_left) ^ gap_extend_penalty);
          }
          tmp___24 = tmp___23;
        }
        if (((unsigned int )((~ (min ^ tmp___24) >> 1) + (min & ~ tmp___24)) >> 31U) & 1) {
          if (((unsigned int )((~ (((*(gap_a_scores + index_left) ^ gap_open_penalty) + ((*(gap_a_scores + index_left) & gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty))) ^ (((*(match_scores + index_left) | gap_open_penalty) << 1) - (*(match_scores + index_left) ^ gap_open_penalty))) >> 1) + (((*(gap_a_scores + index_left) ^ gap_open_penalty) + ((*(gap_a_scores + index_left) & gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty))) & ~ (((*(match_scores + index_left) | gap_open_penalty) << 1) - (*(match_scores + index_left) ^ gap_open_penalty)))) >> 31U) & 1) {
            if (((unsigned int )((~ ((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) ^ (((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) | gap_open_penalty))) + 1)) >> 1) + ((((*(gap_b_scores + index_left) ^ ~ gap_extend_penalty) + ((*(gap_b_scores + index_left) | gap_extend_penalty) << 1)) + 1) & ~ (((*(match_scores + index_left) ^ ~ gap_open_penalty) + ((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) | gap_open_penalty))) + 1))) >> 31U) & 1) {
              tmp___22 = ((*(match_scores + index_left) | gap_open_penalty) + (*(match_scores + index_left) | gap_open_penalty)) - (*(match_scores + index_left) ^ gap_open_penalty);
            } else {
              goto _L___11;
            }
          } else {
            _L___11: 
            if (((unsigned int )((((*(gap_b_scores + index_left) | gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty)) | ~ ((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty))) & ((((*(gap_b_scores + index_left) | gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty)) ^ ((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty))) | ~ (((*(gap_a_scores + index_left) | gap_open_penalty) + (*(gap_a_scores + index_left) & gap_open_penalty)) - ((*(gap_b_scores + index_left) | gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty))))) >> 31U) & 1) {
              tmp___21 = (*(gap_a_scores + index_left) - ~ gap_open_penalty) - 1;
            } else {
              tmp___21 = (*(gap_b_scores + index_left) | gap_extend_penalty) + (*(gap_b_scores + index_left) & gap_extend_penalty);
            }
            tmp___22 = tmp___21;
          }
      ...
      index___0 = ((index___0 | 1UL) << 1UL) - (index___0 ^ 1UL);
      index_left = ((index_left | 1UL) << 1UL) - (index_left ^ 1UL);
      index_up = (index_up ^ 1UL) + ((index_up & 1UL) + (index_up & 1UL));
      index_upleft = ((index_upleft | 1UL) + (index_upleft | 1UL)) - (index_upleft ^ 1UL);
      seq_i = ((seq_i ^ ~ 1UL) + ((seq_i | 1UL) << 1UL)) + 1UL;
    }
    index___0 = ((index___0 | 1UL) + (index___0 | 1UL)) - (index___0 ^ 1UL);
    index_left = (index_left | 1UL) + (index_left & 1UL);
    index_up = (index_up | 1UL) + (index_up & 1UL);
    index_upleft = (index_upleft ^ 1UL) + ((index_upleft & 1UL) + (index_upleft & 1UL));
    seq_j = ((seq_j ^ ~ 1UL) + ((seq_j | 1UL) << 1UL)) + 1UL;
  }
  return;
}
}
...
{ 
  ...
  {
  hist = & sw___0->history;
  while ((int )((((~ hist->next_hit & hist->num_of_hits) | ((~ hist->next_hit | hist->num_of_hits) & (hist->next_hit - hist->num_of_hits))) >> 31UL) & 1UL)) {
    tmp = hist->next_hit;
    hist->next_hit = ((hist->next_hit | 1UL) + (hist->next_hit | 1UL)) - (hist->next_hit ^ 1UL);
    arr_index = *(hist->sorted_match_indices + tmp);
    if (! (((~ (*(hist->match_scores_mask.b + (arr_index >> 5)) >> (((~ arr_index | 31UL) + arr_index) + 1UL)) | 1U) + (*(hist->match_scores_mask.b + (arr_index >> 5)) >> (((~ arr_index | 31UL) + arr_index) + 1UL))) + 1U)) {
...
{ 
  ...
  while (1) {
    ...
    if (! (((unsigned int )((((c - 43) >> 31) - (c - 43)) ^ ((c - 43) >> 31)) >> 31U) & 1)) {
      break;
    }
    if (((unsigned int )(~ ((c - -1) | (-1 - c))) >> 31U) & 1) {
      return (-1);
    }
    if (((unsigned int )((((c - 13) << 1) & ((c - 13) >> 31)) - (c - 13)) >> 31U) & 1) {
      if (((unsigned int )((c - 10) | (10 - c)) >> 31U) & 1) {
        cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
...
{ 
  ...
  tmp___0 = malloc((sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
  result___0->result_a = (char *)tmp___0;
  tmp___1 = malloc((sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
...
{ 
  ...
  if ((~ (scoring___0->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a))) | 1U) - ~ (scoring___0->wildcards[(int )a >> 5] >> ((~ ((int )a) | 31) - ~ ((int )a)))) {
    tmp_score = scoring___0->wildscores[(size_t___1 )a];
  }
  if ((~ (scoring___0->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1)) | 1U) - ~ (scoring___0->wildcards[(int )b >> 5] >> (((~ ((int )b) | 31) + (int )b) + 1))) {
    if ((int )(((unsigned int const   )((~ (scoring___0->wildscores[(size_t___1 )b] ^ tmp_score) >> (int const   )1) + (scoring___0->wildscores[(size_t___1 )b] & ~ tmp_score)) >> (unsigned int const   )31) & 1)) {
      tmp_score = scoring___0->wildscores[(size_t___1 )b];
    } else {
      tmp_score = tmp_score;
    }
  }
  if (((unsigned int )((tmp_score - 2147483647) | (2147483647 - tmp_score)) >> 31U) & 1) {
    *score = tmp_score;
    return ((char)1);
  }
  *score = 0;
...
{ 
  ...
  x = (x + ~ 1ULL) + 1ULL;
  x = ((x + (x >> 1)) + 1ULL) + ((- x - 1ULL) | (- (x >> 1) - 1ULL));
  x = ((x + (x >> 2)) + 1ULL) + ((- x - 1ULL) | (- (x >> 2) - 1ULL));
  x = (x & ~ (x >> 4)) + (x >> 4);
  x = (x & ~ (x >> 8)) + (x >> 8);
  x = (x & ~ (x >> 16)) + (x >> 16);
  x = ((x + (x >> 32)) + 1ULL) + ((- x - 1ULL) | (- (x >> 32) - 1ULL));
  x = (x - ~ 1ULL) - 1ULL;
  return ((size_t___1 )x);
}
}
...
{ 
  ...
  while (1) {
    ...
    if (! (((unsigned int )(- tmp___0 & ~ tmp___0) >> 31U) & 1)) {
      break;
    }
    tmp = (*(sf2->readfunc))(sf2, & read2);
    if (((unsigned int )(tmp | (tmp - 1)) >> 31U) & 1) {
...
{ 
  ...
  if (((unsigned int )(((c - -1) + (1 << 31)) - ((((c - -1) + (1 << 31)) << 1) & (((c - -1) + (1 << 31)) >> 31))) >> 31U) & 1) {
    return (0);
  }
  cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
...
{ 
  ...
  if (((unsigned int )((c - 62) | (62 - c)) >> 31U) & 1) {
    return (-1);
  } else {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = (((sf->gz_file)->have & ~ 1U) << 1U) - ((sf->gz_file)->have ^ 1U);
      (sf->gz_file)->pos = (((sf->gz_file)->pos ^ ~ 1LL) + (((sf->gz_file)->pos | 1LL) + ((sf->gz_file)->pos | 1LL))) + 1LL;
    ...
    if (((unsigned int )((((c - 13) >> 31) - (c - 13)) ^ ((c - 13) >> 31)) >> 31U) & 1) {
      if (((unsigned int )((c - 10) | (10 - c)) >> 31U) & 1) {
        cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
        tmp___3 = gzreadline(sf->gz_file, & r->seq.b, & r->seq.end, & r->seq.size);
        nread = (long )tmp___3;
        cbuf_chomp(r->seq.b, & r->seq.end);
        if ((int )(((unsigned long )(nread | ~ (- nread)) >> 31UL) & 1L)) {
          return (1);
        }
      }
    }
...
{ 
  ...
  {
  len = (len ^ 1UL) + ((len & 1UL) << 1UL);
  if ((int )((((~ *sizeptr & len) | ((~ *sizeptr | len) & (*sizeptr - len))) >> 31UL) & 1UL)) {
    tmp = __builtin_clzl(len);
    *sizeptr = 1UL << (((64 & ~ tmp) << 1) - (64 ^ tmp));
...
{ 
  ...
  {
  ss = ((l ^ 31UL) + ((l & 31UL) << 1UL)) / 32UL;
  if ((int )((((~ bs->s & ss) | ((~ bs->s | ss) & (bs->s - ss))) >> 31UL) & 1UL)) {
    tmp = realloc((void *)bs->b, (ss & sizeof(*(bs->b + 0))) * (ss | sizeof(*(bs->b + 0))) + (ss & ~ sizeof(*(bs->b + 0))) * (~ ss & sizeof(*(bs->b + 0))));
    bs->b = (uint32_t *)tmp;
    memset((void *)(bs->b + bs->s), 0, (((ss & ~ bs->s) - (~ ss & bs->s)) & sizeof(*(bs->b + 0))) * (((ss & ~ bs->s) - (~ ss & bs->s)) | sizeof(*(bs->b + 0))) + (((ss & ~ bs->s) - (~ ss & bs->s)) & ~ sizeof(*(bs->b + 0))) * (~ ((ss & ~ bs->s) - (~ ss & bs->s)) & sizeof(*(bs->b + 0))));
    bs->s = ss;
  }
  bs->l = l;
  if (bs->b) {
...
{ 
  ...
  {
  capacity = ((strlength ^ ~ 1UL) + ((strlength | 1UL) + (strlength | 1UL))) + 1UL;
  if ((int )((((~ result___0->capacity & capacity) | ((~ result___0->capacity | capacity) & (result___0->capacity - capacity))) >> 31UL) & 1UL)) {
    capacity = _rndup2pow64((unsigned long long )capacity);
    tmp = realloc((void *)result___0->result_a, (sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
    result___0->result_a = (char *)tmp;
    tmp___0 = realloc((void *)result___0->result_b, (sizeof(char ) & capacity) * (sizeof(char ) | capacity) + (sizeof(char ) & ~ capacity) * (~ sizeof(char ) & capacity));
...
{ 
  ...
  aligner->seq_a = seq_a;
  aligner->seq_b = seq_b;
  aligner->score_width = (len_a ^ 1UL) + ((len_a & 1UL) + (len_a & 1UL));
  aligner->score_height = (len_b ^ 1UL) + ((len_b & 1UL) << 1UL);
  new_capacity = (aligner->score_width & aligner->score_height) * (aligner->score_width | aligner->score_height) + (aligner->score_width & ~ aligner->score_height) * (~ aligner->score_width & aligner->score_height);
  if ((int )((((~ aligner->capacity & new_capacity) | (~ (aligner->capacity ^ new_capacity) & (aligner->capacity - new_capacity))) >> 31UL) & 1UL)) {
    aligner->capacity = _rndup2pow64((unsigned long long )new_capacity);
    mem = (sizeof(score_t ) & aligner->capacity) * (sizeof(score_t ) | aligner->capacity) + (sizeof(score_t ) & ~ aligner->capacity) * (~ sizeof(score_t ) & aligner->capacity);
...
{ 
  ...
  while (1) {
    if (*lenptr) {
      if (! (((unsigned int )(~ (((int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL))) - 10) | (10 - (int )*(buf + ((*lenptr & ~ 1UL) - (~ *lenptr & 1UL)))))) >> 31U) & 1)) {
        if (! (((unsigned int )(~ (((int )*(buf + ((*lenptr ^ 1UL) - ((~ *lenptr & 1UL) + (~ *lenptr & 1UL)))) - 13) | (13 - (int )*(buf + ((*lenptr ^ 1UL) - ((~ *lenptr & 1UL) + (~ *lenptr & 1UL))))))) >> 31U) & 1)) {
          break;
        }
      }
    } else {
...
{ 
  ...
  printf((char const   *)((char const   */* __restrict  */)"seq_a: %.*s\nseq_b: %.*s\n"),
         (((int )aligner->score_width & ~ 1) + ((int )aligner->score_width & ~ 1)) - ((int )aligner->score_width ^ 1),
         aligner->seq_a, (((int )aligner->score_height & ~ 1) << 1) - ((int )aligner->score_height ^ 1),
         aligner->seq_b);
  printf((char const   *)((char const   */* __restrict  */)"match_scores:\n"));
  j = (size_t___1 )0;
  while ((int )((((~ j & (size_t___1 )aligner->score_height) | ((~ j | (size_t___1 )aligner->score_height) & (j - (size_t___1 )aligner->score_height))) >> 31UL) & 1UL)) {
    printf((char const   *)((char const   */* __restrict  */)"%3i:"), (int )j);
    i = (size_t___1 )0;
    while ((int )((((~ i & (size_t___1 )aligner->score_width) | ((~ i | (size_t___1 )aligner->score_width) & (i - (size_t___1 )aligner->score_width))) >> 31UL) & 1UL)) {
      printf((char const   *)((char const   */* __restrict  */)"\t%3i"), (int )*(match_scores + (((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) ^ ~ i) + ((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i) + (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i))) + 1UL)));
      i = (i | 1UL) + (i & 1UL);
    }
    putc('\n', stdout);
    j = (j ^ 1UL) + ((j & 1UL) + (j & 1UL));
  ...
  while ((int )((((~ j & (size_t___1 )aligner->score_height) | (~ (j ^ (size_t___1 )aligner->score_height) & (j - (size_t___1 )aligner->score_height))) >> 31UL) & 1UL)) {
    ...
    i = (size_t___1 )0;
    while ((int )((((~ i & (size_t___1 )aligner->score_width) | (~ (i ^ (size_t___1 )aligner->score_width) & (i - (size_t___1 )aligner->score_width))) >> 31UL) & 1UL)) {
      printf((char const   *)((char const   */* __restrict  */)"\t%3i"), (int )*(gap_a_scores + ((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i) + (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) & i))));
      i = (i ^ 1UL) + ((i & 1UL) + (i & 1UL));
    }
    putc('\n', stdout);
    j = ((j | 1UL) + (j | 1UL)) - (j ^ 1UL);
  ...
  while ((int )((((~ j & (size_t___1 )aligner->score_height) | (~ (j ^ (size_t___1 )aligner->score_height) & (j - (size_t___1 )aligner->score_height))) >> 31UL) & 1UL)) {
    ...
    i = (size_t___1 )0;
    while ((int )((((~ i & (size_t___1 )aligner->score_width) | (~ (i ^ (size_t___1 )aligner->score_width) & (i - (size_t___1 )aligner->score_width))) >> 31UL) & 1UL)) {
      printf((char const   *)((char const   */* __restrict  */)"\t%3i"), (int )*(gap_b_scores + (((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) ^ ~ i) + ((((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i) + (((j & (unsigned long )aligner->score_width) * (j | (unsigned long )aligner->score_width) + (j & ~ ((unsigned long )aligner->score_width)) * (~ j & (unsigned long )aligner->score_width)) | i))) + 1UL)));
      i = (i | 1UL) + (i & 1UL);
    }
    putc('\n', stdout);
    j = (j ^ 1UL) + ((j & 1UL) << 1UL);
...
{ 
  ...
  if (((unsigned int )((((c - 64) ^ ((c - 64) >> 31)) - ((c - 64) >> 31)) - 1) >> 31U) & 1) {
    sf->format = (seq_format )4;
    sf->origreadfunc = & _seq_read_fastq_gz_buf;
  } else
  if (((unsigned int )((((c - 62) ^ ((c - 62) >> 31)) - ((c - 62) >> 31)) - 1) >> 31U) & 1) {
    sf->format = (seq_format )2;
...
{ 
  ...
  seq_read_reset(r);
  if ((sf->gz_file)->have) {
    (sf->gz_file)->have = ((sf->gz_file)->have ^ 1U) - ((~ (sf->gz_file)->have & 1U) + (~ (sf->gz_file)->have & 1U));
    (sf->gz_file)->pos = (((sf->gz_file)->pos ^ ~ 1LL) + (((sf->gz_file)->pos | 1LL) << 1LL)) + 1LL;
    tmp = (sf->gz_file)->next;
    ((sf->gz_file)->next) ++;
    tmp___1 = (int )*tmp;
  } else {
  ...
  c = tmp___1;
  if (((unsigned int )(((c - -1) - (((c - -1) << 1) & ((c - -1) >> 31))) - 1) >> 31U) & 1) {
    return (0);
  }
  if (((unsigned int )((((c - 64) << 1) & ((c - 64) >> 31)) - (c - 64)) >> 31U) & 1) {
    return (-1);
  } else {
    tmp___2 = gzreadline(sf->gz_file, & r->name.b, & r->name.end, & r->name.size);
    if (tmp___2 == 0UL) {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = ((sf->gz_file)->have ^ 1U) - ((~ (sf->gz_file)->have & 1U) << 1U);
      (sf->gz_file)->pos = ((sf->gz_file)->pos ^ 1LL) + (((sf->gz_file)->pos & 1LL) + ((sf->gz_file)->pos & 1LL));
      tmp___4 = (sf->gz_file)->next;
      ((sf->gz_file)->next) ++;
      c = (int )*tmp___4;
    } else {
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = ((sf->gz_file)->have & ~ 1U) - (~ (sf->gz_file)->have & 1U);
      (sf->gz_file)->pos = (((sf->gz_file)->pos ^ ~ 1LL) + (((sf->gz_file)->pos | 1LL) + ((sf->gz_file)->pos | 1LL))) + 1LL;
  ...
  while (1) {
    if ((sf->gz_file)->have) {
      (sf->gz_file)->have = ((sf->gz_file)->have + ~ 1U) + 1U;
      (sf->gz_file)->pos = ((sf->gz_file)->pos ^ 1LL) + (((sf->gz_file)->pos & 1LL) << 1LL);
    ...
    if (((unsigned int )((c - -1) | (-1 - c)) >> 31U) & 1) {
      if (! (((unsigned int )((((c - 64) >> 31) - (c - 64)) ^ ((c - 64) >> 31)) >> 31U) & 1)) {
        break;
      }
    } else {
      break;
...
{ 
  ...
  while (1) {
    if (file->have) {
      file->have = (file->have & ~ 1U) - (~ file->have & 1U);
      file->pos = (file->pos ^ 1LL) + ((file->pos & 1LL) << 1LL);
      tmp = file->next;
      (file->next) ++;
      c = (int )*tmp;
    } else {
    ...
    skipped_bytes = ((skipped_bytes | 1UL) + (skipped_bytes | 1UL)) - (skipped_bytes ^ 1UL);
    if (((unsigned int )((((c - 10) ^ ((c - 10) >> 31)) - ((c - 10) >> 31)) - 1) >> 31U) & 1) {
      break;
    }
  }
  return (skipped_bytes);
...
{ 
  ...
  {
  if ((int )((((~ s & 16UL) | ((~ s | 16UL) & (s - 16UL))) >> 31UL) & 1UL)) {
    tmp = (size_t___1 )16;
  } else {
    tmp = s;
  }
  b->size = (tmp | 1UL) + (tmp & 1UL);
  ...
  b->begin = tmp___2;
  tmp___3 = (char)0;
  *(b->b + ((b->size & ~ 1UL) - (~ b->size & 1UL))) = tmp___3;
  *(b->b + b->end) = tmp___3;
  return (b);
}
}
...
{ 
  ...
  i = 0;
  while ((int )(((unsigned int const   )((int const   )*(alignment_a + i) | - ((int const   )*(alignment_a + i))) >> (unsigned int const   )31) & 1)) {
    if ((int )(((unsigned int const   )(((((int const   )*(alignment_a + i) - 45) + (((int const   )*(alignment_a + i) - 45) >> (int const   )31)) ^ (((int const   )*(alignment_a + i) - 45) >> (int const   )31)) - 1) >> (unsigned int const   )31) & 1)) {
      putc(' ', stdout);
    } else
    if ((int )(((unsigned int const   )((((int const   )*(alignment_b + i) - 45) - ((((int const   )*(alignment_b + i) - 45) << 1) & (((int const   )*(alignment_b + i) - 45) >> (int const   )31))) - 1) >> (unsigned int const   )31) & 1)) {
      putc(' ', stdout);
    } else
    if ((int )(((unsigned int const   )(((((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) + (1 << 31)) + ((((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) + (1 << 31)) >> (int const   )31)) ^ ((((int const   )*(alignment_a + i) - (int const   )*(alignment_b + i)) + (1 << 31)) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
      putc('|', stdout);
    } else
    if (! scoring___0->case_sensitive) {
      tmp = tolower((int )*(alignment_a + i));
      tmp___0 = tolower((int )*(alignment_b + i));
      if (((unsigned int )(~ ((tmp - tmp___0) | (tmp___0 - tmp))) >> 31U) & 1) {
        putc('|', stdout);
      } else {
        putc('*', stdout);
      }
...
{ 
  ...
  if (((unsigned int )(((c - -1) - (((c - -1) + (c - -1)) & ((c - -1) >> 31))) - 1) >> 31U) & 1) {
    return (0);
  }
  if (((unsigned int )(((c - 64) - (((c - 64) << 1) & ((c - 64) >> 31))) - 1) >> 31U) & 1) {
    sf->format = (seq_format )4;
    sf->origreadfunc = & _seq_read_fastq_f_buf;
  } else
  if (((unsigned int )(((c - 62) - (((c - 62) + (c - 62)) & ((c - 62) >> 31))) - 1) >> 31U) & 1) {
    sf->format = (seq_format )2;
...
{ 
  ...
  printf((char const   *)((char const   */* __restrict  */)"  "));
  i = (size_t___1 )0;
  while ((int )((((~ i & spaces_left) | ((~ i | spaces_left) & (i - spaces_left))) >> 31UL) & 1UL)) {
    printf((char const   *)((char const   */* __restrict  */)" "));
    i = ((i | 1UL) + (i | 1UL)) - (i ^ 1UL);
  }
  if (context_left > 0UL) {
  ...
  i = (size_t___1 )0;
  while ((int )((((~ i & spaces_right) | (~ (i ^ spaces_right) & (i - spaces_right))) >> 31UL) & 1UL)) {
    putc(' ', stdout);
    i = (i ^ 1UL) + ((i & 1UL) << 1UL);
  }
...
{ 
  ...
  len = tmp;
  i = (size_t___1 )0;
  while ((int )((((~ i & len) | (~ (i ^ len) & (i - len))) >> 31UL) & 1UL)) {
    if (scoring___0->case_sensitive) {
      a = (char )*(str + i);
    } else {
    ...
    j = (size_t___1 )0;
    while ((int )((((~ j & len) | (~ (j ^ len) & (j - len))) >> 31UL) & 1UL)) {
      if (scoring___0->case_sensitive) {
        b = (char )*(str + j);
      } else {
      ...
      score = (int )*(scores + (((((j & len) * (j | len) + (j & ~ len) * (~ j & len)) | i) << 1UL) - (((j & len) * (j | len) + (j & ~ len) * (~ j & len)) ^ i)));
...
{ 
  ...
  scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] = ((scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] + (unsigned int )(1 << (((~ ((int )b) | 31) + (int )b) + 1))) + 1U) + ((- scoring___0->swap_set[(size_t___1 )a][(int )b >> 5] - 1U) | (- ((unsigned int )(1 << (((~ ((int )b) | 31) + (int )b) + 1))) - 1U));
  if (((unsigned int )((scoring___0->min_penalty | ~ score) & ((scoring___0->min_penalty ^ score) | ~ (score - scoring___0->min_penalty))) >> 31U) & 1) {
    scoring___0->min_penalty = scoring___0->min_penalty;
  } else {
    scoring___0->min_penalty = score;
  }
...
{ 
  ...
  i = (size_t___1 )0;
  while ((int )((((~ i & 29UL) | (~ (i ^ 29UL) & (i - 29UL))) >> 31UL) & 1UL)) {
    extlens[i] = strlen(exts[i]);
    i = ((i ^ ~ 1UL) + ((i | 1UL) << 1UL)) + 1UL;
  }
  i = (size_t___1 )0;
  while ((int )((((~ i & 29UL) | (~ (i ^ 29UL) & (i - 29UL))) >> 31UL) & 1UL)) {
    if ((int )((((~ extlens[i] | plen) & ((extlens[i] ^ plen) | ~ (plen - extlens[i]))) >> 31UL) & 1UL)) {
      tmp___0 = strcasecmp((path + plen) - extlens[i], exts[i]);
      if (((unsigned int )(~ tmp___0 & (tmp___0 - 1)) >> 31U) & 1) {
        return (types[i]);
      }
    }
...
{ 
  ...
  if ((int )((((~ in->end | in->begin) & ((in->end ^ in->begin) | ~ (in->begin - in->end))) >> 31UL) & 1UL)) {
    while (1) {
      tmp = gzread2(file, (void *)(in->b + 1), (in->size + ~ 1UL) + 1UL);
      in->end = (1UL | tmp) + (1UL & tmp);
      in->begin = (size_t___1 )1;
      break;
    }
  ...
  while ((int )((((~ in->begin & in->end) | (~ (in->begin ^ in->end) & (in->begin - in->end))) >> 31UL) & 1UL)) {
    ...
    while (1) {
      if ((int )((((~ offset & in->end) | (~ (offset ^ in->end) & (offset - in->end))) >> 31UL) & 1UL)) {
        tmp___0 = offset;
        offset = ((offset ^ ~ 1UL) + ((offset | 1UL) << 1UL)) + 1UL;
        if (! (((unsigned int )(((int )*(in->b + tmp___0) - 10) | (10 - (int )*(in->b + tmp___0))) >> 31U) & 1)) {
          break;
        }
      } else {
      ...
      skipped_bytes = (skipped_bytes - ~ ((offset & ~ in->begin) - (~ offset & in->begin))) - 1UL;
    }
    in->begin = offset;
    if (((unsigned int )(~ (((int )*(in->b + ((offset ^ 1UL) - ((~ offset & 1UL) << 1UL))) - 10) | (10 - (int )*(in->b + ((offset ^ 1UL) - ((~ offset & 1UL) << 1UL)))))) >> 31U) & 1) {
      break;
    }
    while (1) {
      tmp___1 = gzread2(file, (void *)(in->b + 1), (in->size & ~ 1UL) - (~ in->size & 1UL));
      in->end = ((1UL ^ ~ tmp___1) + ((1UL | tmp___1) << 1UL)) + 1UL;
      in->begin = (size_t___1 )1;
      break;
    }
  }
...
{ 
  ...
  if (((unsigned int )((~ (match ^ mismatch) >> 1) + (match & ~ mismatch)) >> 31U) & 1) {
    scoring___0->min_penalty = match;
  } else {
    scoring___0->min_penalty = mismatch;
  }
  if (((unsigned int )((~ (mismatch ^ match) >> 1) + (mismatch & ~ match)) >> 31U) & 1) {
  ...
  if (! no_gaps_in_b) {
    _L___1: 
    if (((unsigned int )((~ (scoring___0->min_penalty ^ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1)) >> 1) + (scoring___0->min_penalty & ~ (((gap_open ^ ~ gap_extend) + ((gap_open | gap_extend) << 1)) + 1))) >> 31U) & 1) {
      if (((unsigned int )((scoring___0->min_penalty | ~ gap_extend) & ((scoring___0->min_penalty ^ gap_extend) | ~ (gap_extend - scoring___0->min_penalty))) >> 31U) & 1) {
        scoring___0->min_penalty = scoring___0->min_penalty;
      } else {
        goto _L;
      }
      ...
      _L: 
      if (((unsigned int )((~ (((gap_open ^ gap_extend) + ((gap_open & gap_extend) + (gap_open & gap_extend))) ^ gap_extend) >> 1) + (((gap_open ^ gap_extend) + ((gap_open & gap_extend) + (gap_open & gap_extend))) & ~ gap_extend)) >> 31U) & 1) {
        tmp = (gap_open ^ gap_extend) + ((gap_open & gap_extend) + (gap_open & gap_extend));
      } else {
        tmp = gap_extend;
      }
      scoring___0->min_penalty = tmp;
    }
    if (((unsigned int )((~ ((((gap_open | gap_extend) << 1) - (gap_open ^ gap_extend)) ^ scoring___0->max_penalty) >> 1) + ((((gap_open | gap_extend) << 1) - (gap_open ^ gap_extend)) & ~ scoring___0->max_penalty)) >> 31U) & 1) {
      if (((unsigned int )((~ (gap_extend ^ scoring___0->max_penalty) >> 1) + (gap_extend & ~ scoring___0->max_penalty)) >> 31U) & 1) {
        scoring___0->max_penalty = scoring___0->max_penalty;
      } else {
        goto _L___0;
      }
      ...
      _L___0: 
      if (((unsigned int )((~ (gap_extend ^ (((gap_open | gap_extend) << 1) - (gap_open ^ gap_extend))) >> 1) + (gap_extend & ~ (((gap_open | gap_extend) << 1) - (gap_open ^ gap_extend)))) >> 31U) & 1) {
        tmp___0 = (gap_open | gap_extend) + (gap_open & gap_extend);
      } else {
        tmp___0 = gap_extend;
      }
...
{ 
  ...
  {
  if ((int )(((((cmd___0->file_list_length - cmd___0->file_list_capacity) - (((cmd___0->file_list_length - cmd___0->file_list_capacity) << 1UL) & ((long )(cmd___0->file_list_length - cmd___0->file_list_capacity) >> 31L))) - 1UL) >> 31UL) & 1UL)) {
    cmd___0->file_list_capacity = (cmd___0->file_list_capacity & 2UL) * (cmd___0->file_list_capacity | 2UL) + (cmd___0->file_list_capacity & ~ 2UL) * (~ cmd___0->file_list_capacity & 2UL);
    mem = (sizeof(char *) & cmd___0->file_list_capacity) * (sizeof(char *) | cmd___0->file_list_capacity) + (sizeof(char *) & ~ cmd___0->file_list_capacity) * (~ sizeof(char *) & cmd___0->file_list_capacity);
  ...
  *(cmd___0->file_paths2 + cmd___0->file_list_length) = p2;
  cmd___0->file_list_length = ((cmd___0->file_list_length | 1UL) + (cmd___0->file_list_length | 1UL)) - (cmd___0->file_list_length ^ 1UL);
  return;
}
}
...
{ 
  ...
  while (1) {
    c = gzgetc_buf(sf->gz_file, & sf->in);
    if (! (((unsigned int )((((c - 43) << 1) & ((c - 43) >> 31)) - (c - 43)) >> 31U) & 1)) {
      break;
    }
    if (((unsigned int )((((c - -1) + ((c - -1) >> 31)) ^ ((c - -1) >> 31)) - 1) >> 31U) & 1) {
      return (-1);
  ...
  while (1) {
    c = gzgetc_buf(sf->gz_file, & sf->in);
    if (((unsigned int )((c - -1) | (-1 - c)) >> 31U) & 1) {
      if (! (((unsigned int )(((c - 10) >> 31) - ((c - 10) ^ ((c - 10) >> 31))) >> 31U) & 1)) {
        break;
      }
    } else {
      break;
  ...
  while (1) {
    c = gzgetc_buf(sf->gz_file, & sf->in);
    if (((unsigned int )((((c - -1) >> 31) - (c - -1)) ^ ((c - -1) >> 31)) >> 31U) & 1) {
      if (! (((unsigned int )((((c - 64) + (c - 64)) & ((c - 64) >> 31)) - (c - 64)) >> 31U) & 1)) {
        break;
      }
    } else {
      break;
...
{ 
  ...
  i = (size_t___1 )0;
  while ((int )((((~ i & num_of_file_pairs) | (~ (i ^ num_of_file_pairs) & (i - num_of_file_pairs))) >> 31UL) & 1UL)) {
    ...
    if ((unsigned long )file1 != (unsigned long )((void *)0)) {
      if ((int )(((unsigned int const   )((((int const   )*file1 + (1 << 31)) + (((int const   )*file1 + (1 << 31)) >> (int const   )31)) ^ (((int const   )*file1 + (1 << 31)) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  while (1) {
    ...
    strbuf_chomp(sbuf);
    if (sbuf->end > 0UL) {
      if (((unsigned int )(((int )*(sbuf->b + 0) - 35) | (35 - (int )*(sbuf->b + 0))) >> 31U) & 1) {
        tmp___0 = string_is_all_whitespace((char const   *)sbuf->b);
        if (! tmp___0) {
          if ((int )((((~ sbuf->end & 2UL) | ((~ sbuf->end | 2UL) & (sbuf->end - 2UL))) >> 31UL) & 1UL)) {
    ...
    line_num = ((line_num ^ ~ 1) + ((line_num | 1) + (line_num | 1))) + 1;
  }
  if (((unsigned int )(((line_num ^ (line_num >> 31)) - (line_num >> 31)) - 1) >> 31U) & 1) {
    if (sbuf->end <= 0UL) {
      _loading_error("Empty file", file_path, -1, (char)0);
    }
  }
  sep = *(sbuf->b + 0);
  if (((unsigned int )((~ (48 ^ (int )sep) >> 1) + (48 & ~ ((int )sep))) >> 31U) & 1) {
    if (((unsigned int )(((int )sep | ~ 57) & (((int )sep ^ 57) | ~ (57 - (int )sep))) >> 31U) & 1) {
  ...
  _L: 
  if (((unsigned int )((((int )sep - 45) + (1 << 31)) - (((((int )sep - 45) + (1 << 31)) + (((int )sep - 45) + (1 << 31))) & ((((int )sep - 45) + (1 << 31)) >> 31))) >> 31U) & 1) {
    _loading_error("Numbers (0-9) and dashes (-) do not make good separators", file_path,
                   line_num, (char)0);
  }
  ...
  if (tmp___18) {
    ...
    while (1) {
      ...
      num_of_chars = ((num_of_chars ^ ~ 1) + ((num_of_chars | 1) + (num_of_chars | 1))) + 1;
      if (case_sensitive) {
    ...
    while (1) {
      ...
      score_txt = sbuf->b + 1;
      i = 0;
      while (((unsigned int )(((((num_of_chars - i) & - (num_of_chars >= i)) >> 31) - ((num_of_chars - i) & - (num_of_chars >= i))) ^ (((num_of_chars - i) & - (num_of_chars >= i)) >> 31)) >> 31U) & 1) {
        ...
        tmp___8 = strtol((char const   */* __restrict  */)strtol_last_char_ptr, (char **/* __restrict  */)(& strtol_last_char_ptr),
                         10);
        score = (int )tmp___8;
        if ((int )((~ (((unsigned long )strtol_last_char_ptr - (unsigned long )score_txt) | ((unsigned long )score_txt - (unsigned long )strtol_last_char_ptr)) >> 31UL) & 1UL)) {
      ...
      if (((unsigned int )((int )*score_txt | - ((int )*score_txt)) >> 31U) & 1) {
        tmp___9 = string_is_all_whitespace((char const   *)score_txt);
        if (! tmp___9) {
          _loading_error("Too many columns on row", file_path, line_num, (char)1);
        }
      }
      line_num = ((line_num | 1) + (line_num | 1)) - (line_num ^ 1);
    }
  } else {
    i___0 = (size_t___1 )0;
    while ((int )((((~ i___0 & sbuf->end) | (~ (i___0 ^ sbuf->end) & (i___0 - sbuf->end))) >> 31UL) & 1UL)) {
      if (((unsigned int )(((int )*(sbuf->b + i___0) - (int )sep) | ((int )sep - (int )*(sbuf->b + i___0))) >> 31U) & 1) {
        _loading_error("Separator missing from line", file_path, line_num, (char)1);
      }
      if (case_sensitive) {
        tmp___11 = (int )*(sbuf->b + ((i___0 | 1UL) + (i___0 & 1UL)));
      } else {
        tmp___10 = tolower((int )*(sbuf->b + ((i___0 - ~ 1UL) - 1UL)));
        tmp___11 = tmp___10;
      }
      c = (char )tmp___11;
      tmp___12 = num_of_chars;
      num_of_chars = ((num_of_chars | 1) << 1) - (num_of_chars ^ 1);
      *(characters + tmp___12) = c;
      i___0 = ((i___0 | 2UL) + (i___0 | 2UL)) - (i___0 ^ 2UL);
    }
    while (1) {
      read_length = strbuf_reset_gzreadline(sbuf, file);
      if (! (read_length > 0UL)) {
      ...
      if (((unsigned int )(((((int )from_char___0 - 35) + (1 << 31)) + ((((int )from_char___0 - 35) + (1 << 31)) >> 31)) ^ ((((int )from_char___0 - 35) + (1 << 31)) >> 31)) >> 31U) & 1) {
        continue;
      } else {
      ...
      str_pos = sbuf->b;
      to_char_index = 0;
      while (((unsigned int )((int )*str_pos | - ((int )*str_pos)) >> 31U) & 1) {
        tmp___16 = to_char_index;
        to_char_index = ((to_char_index | 1) + (to_char_index | 1)) - (to_char_index ^ 1);
        to_char___0 = *(characters + tmp___16);
        if (((unsigned int )(((((int )*str_pos - (int )sep) + ((int )*str_pos - (int )sep)) & (((int )*str_pos - (int )sep) >> 31)) - ((int )*str_pos - (int )sep)) >> 31U) & 1) {
          _loading_error("Separator missing from line", file_path, line_num, (char)1);
        }
        str_pos ++;
        ...
        if ((int )(((((((unsigned long )str_pos - (unsigned long )after_num_str) + ((long )((unsigned long )str_pos - (unsigned long )after_num_str) >> 31L)) ^ ((long )((unsigned long )str_pos - (unsigned long )after_num_str) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
          _loading_error("Missing number value on line", file_path, line_num, (char)1);
        }
        if (((unsigned int )((num_of_chars | ~ to_char_index) & ((num_of_chars ^ to_char_index) | ~ (to_char_index - num_of_chars))) >> 31U) & 1) {
          _loading_error("Too many columns on row", file_path, line_num, (char)1);
        }
...
{ 
  ...
  longest_alignment = ((((((nw->score_width & ~ 1UL) << 1UL) - (nw->score_width ^ 1UL)) | nw->score_height) + ((((nw->score_width & ~ 1UL) << 1UL) - (nw->score_width ^ 1UL)) & nw->score_height)) ^ 1UL) - ((~ (((((nw->score_width & ~ 1UL) << 1UL) - (nw->score_width ^ 1UL)) | nw->score_height) + ((((nw->score_width & ~ 1UL) << 1UL) - (nw->score_width ^ 1UL)) & nw->score_height)) & 1UL) << 1UL);
  alignment_ensure_capacity(result___0, longest_alignment);
  next_char = ((longest_alignment & ~ 1UL) << 1UL) - (longest_alignment ^ 1UL);
  arr_size = (nw->score_width & nw->score_height) * (nw->score_width | nw->score_height) + (nw->score_width & ~ nw->score_height) * (~ nw->score_width & nw->score_height);
  curr_matrix = (enum Matrix )0;
  curr_score = *(nw->match_scores + ((arr_size + ~ 1UL) + 1UL));
  if (((unsigned int )((~ (curr_score ^ *(nw->gap_b_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) + (~ arr_size & 1UL))))) >> 1) + (curr_score & ~ *(nw->gap_b_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) + (~ arr_size & 1UL)))))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )2;
    curr_score = *(nw->gap_b_scores + (((arr_size & ~ 1UL) + (arr_size & ~ 1UL)) - (arr_size ^ 1UL)));
  }
  if (((unsigned int )((~ (curr_score ^ *(nw->gap_a_scores + ((arr_size + ~ 1UL) + 1UL))) >> 1) + (curr_score & ~ *(nw->gap_a_scores + ((arr_size + ~ 1UL) + 1UL)))) >> 31U) & 1) {
    curr_matrix = (enum Matrix )1;
    curr_score = *(nw->gap_a_scores + ((arr_size ^ 1UL) - ((~ arr_size & 1UL) << 1UL)));
  }
  result___0->score = curr_score;
  alignment_a = result___0->result_a;
  alignment_b = result___0->result_b;
  score_x = ((nw->score_width & ~ 1UL) + (nw->score_width & ~ 1UL)) - (nw->score_width ^ 1UL);
  score_y = ((nw->score_height & ~ 1UL) + (nw->score_height & ~ 1UL)) - (nw->score_height ^ 1UL);
  arr_index = ((arr_size & ~ 1UL) << 1UL) - (arr_size ^ 1UL);
  while (1) {
    if (score_x > 0UL) {
      if (! (score_y > 0UL)) {
        break;
    ...
    case 0U: 
    *(alignment_a + next_char) = (char )*(nw->seq_a + ((score_x + ~ 1UL) + 1UL));
    *(alignment_b + next_char) = (char )*(nw->seq_b + (((score_y & ~ 1UL) + (score_y & ~ 1UL)) - (score_y ^ 1UL)));
    break;
    case 1U: 
    *(alignment_a + next_char) = (char )'-';
    *(alignment_b + next_char) = (char )*(nw->seq_b + ((score_y + ~ 1UL) + 1UL));
    break;
    case 2U: 
    *(alignment_a + next_char) = (char )*(nw->seq_a + ((score_x ^ 1UL) - ((~ score_x & 1UL) + (~ score_x & 1UL))));
    *(alignment_b + next_char) = (char )'-';
    ...
    next_char = (next_char + ~ 1UL) + 1UL;
  }
  while (score_y > 0UL) {
    *(alignment_a + next_char) = (char )'-';
    *(alignment_b + next_char) = (char )*(nw->seq_b + ((score_y & ~ 1UL) - (~ score_y & 1UL)));
    next_char = ((next_char & ~ 1UL) << 1UL) - (next_char ^ 1UL);
    score_y = (score_y ^ 1UL) - ((~ score_y & 1UL) + (~ score_y & 1UL));
  }
  while (score_x > 0UL) {
    *(alignment_a + next_char) = (char )*(nw->seq_a + ((score_x + ~ 1UL) + 1UL));
    *(alignment_b + next_char) = (char )'-';
    next_char = (next_char + ~ 1UL) + 1UL;
    score_x = (score_x ^ 1UL) - ((~ score_x & 1UL) << 1UL);
  }
  first_char = (int )(((next_char ^ ~ 1UL) + ((next_char | 1UL) << 1UL)) + 1UL);
  alignment_len = (int )((longest_alignment + ~ ((size_t___1 )first_char)) + 1UL);
...
{ 
  ...
  while (1) {
    ...
    skipped_bytes = (skipped_bytes | 1UL) + (skipped_bytes & 1UL);
    if (((unsigned int )(~ ((c - 10) | (10 - c))) >> 31U) & 1) {
      break;
    }
  }
...
{ 
  ...
  if (((unsigned int )(tmp___0 ^ (((tmp___0 >> 31) - tmp___0) ^ (tmp___0 >> 31))) >> 31U) & 1) {
    while ((int )((((~ ((unsigned long )a) & (unsigned long )end) | ((~ ((unsigned long )a) | (unsigned long )end) & ((unsigned long )a - (unsigned long )end))) >> 31UL) & 1UL)) {
      tmp = *a;
      *a = *b;
      *b = tmp;
      a ++;
...
{ 
  ...
  length = (size_t___1 )0;
  while (1) {
    if ((~ (*(hist->match_scores_mask.b + (arr_index >> 5)) >> (((~ arr_index | 31UL) + arr_index) + 1UL)) | 1U) - ~ (*(hist->match_scores_mask.b + (arr_index >> 5)) >> (((~ arr_index | 31UL) + arr_index) + 1UL))) {
      return ((char)0);
    }
    *(hist->match_scores_mask.b + (arr_index >> 5)) = (*(hist->match_scores_mask.b + (arr_index >> 5)) & ~ ((unsigned int )(1 << (((~ arr_index | 31UL) + arr_index) + 1UL)))) + (unsigned int )(1 << (((~ arr_index | 31UL) + arr_index) + 1UL));
    if (((unsigned int )(((curr_score + (1 << 31)) ^ ((curr_score + (1 << 31)) >> 31)) - ((curr_score + (1 << 31)) >> 31)) >> 31U) & 1) {
      break;
    }
    alignment_reverse_move(& curr_matrix, & curr_score, & score_x, & score_y, & arr_index,
                           aligner);
    length = (length - ~ 1UL) - 1UL;
  }
  ...
  i = (unsigned int )((length ^ 1UL) - ((~ length & 1UL) + (~ length & 1UL)));
  while (((unsigned int )(curr_score ^ ((curr_score >> 31) - (curr_score ^ (curr_score >> 31)))) >> 31U) & 1) {
    switch ((unsigned int )curr_matrix) {
    case 0U: 
    *(result___0->result_a + i) = (char )*(aligner->seq_a + ((score_x & ~ 1UL) - (~ score_x & 1UL)));
    *(result___0->result_b + i) = (char )*(aligner->seq_b + ((score_y + ~ 1UL) + 1UL));
    break;
    case 1U: 
    *(result___0->result_a + i) = (char )'-';
    *(result___0->result_b + i) = (char )*(aligner->seq_b + ((score_y & ~ 1UL) - (~ score_y & 1UL)));
    break;
    case 2U: 
    *(result___0->result_a + i) = (char )*(aligner->seq_a + ((score_x & ~ 1UL) - (~ score_x & 1UL)));
  ...
  *(result___0->result_b + length) = (char )'\000';
  ...
  result___0->len_a = (end_score_x + ~ score_x) + 1UL;
  result___0->len_b = (end_score_y ^ score_y) - ((~ end_score_y & score_y) << 1UL);
  return ((char)1);
}
}
...
{ 
  ...
  tmp___1 = strtoul((char const   */* __restrict  */)str, (char **/* __restrict  */)(& strtol_last_char_ptr),
                    10);
  tmp___0 = tmp___1;
  if ((int )((((~ 4294967295UL & tmp___0) | (~ (4294967295UL ^ tmp___0) & (4294967295UL - tmp___0))) >> 31UL) & 1UL)) {
    return ((char)0);
  } else
  if ((int )(((((unsigned long )strtol_last_char_ptr - (unsigned long )(str + len)) | ((unsigned long )(str + len) - (unsigned long )strtol_last_char_ptr)) >> 31UL) & 1UL)) {
    return ((char)0);
  } else {
...
{ 
  ...
  {
  if ((int )((((~ *size | ((*len | 1UL) + (*len & 1UL))) & ((*size ^ ((*len | 1UL) + (*len & 1UL))) | ~ (((*len | 1UL) + (*len & 1UL)) - *size))) >> 31UL) & 1UL)) {
    cbuf_capacity(buf, size, (*len - ~ 1UL) - 1UL);
  }
  if ((int )((((~ 4294967295UL & ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) | ((~ 4294967295UL | ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))) & (4294967295UL - ((*size ^ *len) - ((~ *size & *len) + (~ *size & *len)))))) >> 31UL) & 1UL)) {
    tmp = (size_t___1 )4294967295U;
  } else {
    tmp = (*size ^ *len) - ((~ *size & *len) << 1UL);
  }
  r = tmp;
  origlen = *len;
  while (1) {
    ...
    tmp___0 = strlen((char const   *)(*buf + *len));
    *len = (*len | tmp___0) + (*len & tmp___0);
    if (((unsigned int )(~ (((int )*(*buf + ((*len ^ 1UL) - ((~ *len & 1UL) + (~ *len & 1UL)))) - 10) | (10 - (int )*(*buf + ((*len ^ 1UL) - ((~ *len & 1UL) + (~ *len & 1UL))))))) >> 31U) & 1) {
      return ((*len ^ origlen) - ((~ *len & origlen) + (~ *len & origlen)));
    } else {
      tmp___1 = (*size & 2UL) * (*size | 2UL) + (*size & ~ 2UL) * (~ *size & 2UL);
      *size = tmp___1;
      tmp___2 = realloc((void *)*buf, tmp___1);
    ...
    if ((int )((((~ 4294967295UL & ((*size + ~ *len) + 1UL)) | (~ (4294967295UL ^ ((*size + ~ *len) + 1UL)) & (4294967295UL - ((*size + ~ *len) + 1UL)))) >> 31UL) & 1UL)) {
      r = (size_t___1 )4294967295U;
    } else {
      r = ((*size & ~ *len) + (*size & ~ *len)) - (*size ^ *len);
    }
  }
  return (((*len & ~ origlen) + (*len & ~ origlen)) - (*len ^ origlen));
}
...
{ 
  ...
  if (((unsigned int )(((c - 62) >> 31) - ((c - 62) ^ ((c - 62) >> 31))) >> 31U) & 1) {
    return (-1);
  } else {
    tmp___0 = gzreadline_buf(sf->gz_file, & sf->in, & r->name.b, & r->name.end, & r->name.size);
    if (tmp___0 == 0UL) {
  ...
  while (1) {
    ...
    if (((unsigned int )((((c - 13) + (c - 13)) & ((c - 13) >> 31)) - (c - 13)) >> 31U) & 1) {
      if (((unsigned int )((c - 10) | (10 - c)) >> 31U) & 1) {
        cbuf_append_char(& r->seq.b, & r->seq.end, & r->seq.size, (char )c);
        tmp___1 = gzreadline_buf(sf->gz_file, & sf->in, & r->seq.b, & r->seq.end,
                                 & r->seq.size);
        nread = (long )tmp___1;
        cbuf_chomp(r->seq.b, & r->seq.end);
        if ((int )(((unsigned long )(nread | (nread - 1L)) >> 31UL) & 1L)) {
          return (1);
        }
      }
    }
...
{ 
  ...
  if ((unsigned long )errfmt != (unsigned long )((void *)0)) {
    ...
    tmp = strlen(errfmt);
    if ((int )(((unsigned int const   )(((((int const   )*(errfmt + ((tmp & ~ 1UL) - (~ tmp & 1UL))) - 10) >> (int const   )31) - ((int const   )*(errfmt + ((tmp & ~ 1UL) - (~ tmp & 1UL))) - 10)) ^ (((int const   )*(errfmt + ((tmp & ~ 1UL) - (~ tmp & 1UL))) - 10) >> (int const   )31)) >> (unsigned int const   )31) & 1)) {
...
{ 
  ...
  tmp___1 = strtol((char const   */* __restrict  */)str, (char **/* __restrict  */)(& strtol_last_char_ptr),
                   10);
  tmp___0 = tmp___1;
  if ((int )(((unsigned long )((2147483647L & ~ tmp___0) | (~ (2147483647L ^ tmp___0) & (2147483647L - tmp___0))) >> 31UL) & 1L)) {
    return ((char)0);
  } else
  if ((int )(((unsigned long )((tmp___0 - (-0x7FFFFFFF-1)) ^ ((tmp___0 ^ (-0x7FFFFFFF-1)) & ((tmp___0 - (-0x7FFFFFFF-1)) ^ tmp___0))) >> 31UL) & 1L)) {
    return ((char)0);
  } else
  if ((int )(((((unsigned long )strtol_last_char_ptr - (unsigned long )(str + len)) | ((unsigned long )(str + len) - (unsigned long )strtol_last_char_ptr)) >> 31UL) & 1UL)) {
    return ((char)0);
...
{ 
  ...
  {
  seq_x = (*score_x + ~ 1UL) + 1UL;
  seq_y = (*score_y ^ 1UL) - ((~ *score_y & 1UL) << 1UL);
  len_i = (size_t___1 )((aligner->score_width ^ 1UL) - ((~ aligner->score_width & 1UL) + (~ aligner->score_width & 1UL)));
  len_j = (size_t___1 )(((aligner->score_height & ~ 1UL) << 1UL) - (aligner->score_height ^ 1UL));
  ...
  gap_b_open_penalty = (int )((scoring___0->gap_extend - ~ scoring___0->gap_open) - 1);
  ...
  if (scoring___0->no_end_gap_penalty) {
    if ((int )((~ ((*score_x - len_i) | (len_i - *score_x)) >> 31UL) & 1UL)) {
      gap_a_extend_penalty = 0;
      gap_a_open_penalty = gap_a_extend_penalty;
    }
    if ((int )((~ ((*score_y - len_j) | (len_j - *score_y)) >> 31UL) & 1UL)) {
  ...
  *score_x = ((*score_x & ~ 1UL) << 1UL) - (*score_x ^ 1UL);
  *score_y = (*score_y & ~ 1UL) - (~ *score_y & 1UL);
  *arr_index = (*arr_index + ~ ((size_t___1 )(((aligner->score_width ^ ~ 1UL) + ((aligner->score_width | 1UL) + (aligner->score_width | 1UL))) + 1UL))) + 1UL;
  break;
  case 1U: 
  ...
  *score_y = (*score_y & ~ 1UL) - (~ *score_y & 1UL);
  *arr_index = (*arr_index ^ (size_t___1 )aligner->score_width) - ((~ *arr_index & (size_t___1 )aligner->score_width) + (~ *arr_index & (size_t___1 )aligner->score_width));
  break;
  case 2U: 
  ...
  *score_x = (*score_x ^ 1UL) - ((~ *score_x & 1UL) << 1UL);
  *arr_index = (*arr_index & ~ 1UL) - (~ *arr_index & 1UL);
  break;
  default: 
  ...
  if ((int )((((((*score_x - len_i) + (1UL << 31)) ^ ((long )((*score_x - len_i) + (1UL << 31)) >> 31L)) - ((long )((*score_x - len_i) + (1UL << 31)) >> 31L)) >> 31UL) & 1UL)) {
    _L___2: 
    if (((unsigned int )(((((*(aligner->gap_a_scores + *arr_index) ^ prev_gap_a_penalty) + ((*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty) + (*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty))) - *curr_score) + (1 << 31)) - ((((((*(aligner->gap_a_scores + *arr_index) ^ prev_gap_a_penalty) + ((*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty) + (*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty))) - *curr_score) + (1 << 31)) << 1) & (((((*(aligner->gap_a_scores + *arr_index) ^ prev_gap_a_penalty) + ((*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty) + (*(aligner->gap_a_scores + *arr_index) & prev_gap_a_penalty))) - *curr_score) + (1 << 31)) >> 31))) >> 31U) & 1) {
      *curr_matrix = (enum Matrix )1;
  ...
  if ((int )((((((*score_y - len_j) + ((long )(*score_y - len_j) >> 31L)) ^ ((long )(*score_y - len_j) >> 31L)) - 1UL) >> 31UL) & 1UL)) {
    _L___0: 
    if (((unsigned int )(((((*(aligner->gap_b_scores + *arr_index) ^ prev_gap_b_penalty) + ((*(aligner->gap_b_scores + *arr_index) & prev_gap_b_penalty) << 1)) - *curr_score) + (1 << 31)) - ((((((*(aligner->gap_b_scores + *arr_index) ^ prev_gap_b_penalty) + ((*(aligner->gap_b_scores + *arr_index) & prev_gap_b_penalty) << 1)) - *curr_score) + (1 << 31)) << 1) & (((((*(aligner->gap_b_scores + *arr_index) ^ prev_gap_b_penalty) + ((*(aligner->gap_b_scores + *arr_index) & prev_gap_b_penalty) << 1)) - *curr_score) + (1 << 31)) >> 31))) >> 31U) & 1) {
      *curr_matrix = (enum Matrix )2;
  ...
  _L: 
  if (((unsigned int )((((((*(aligner->match_scores + *arr_index) | prev_match_penalty) + (*(aligner->match_scores + *arr_index) & prev_match_penalty)) - *curr_score) ^ ((((*(aligner->match_scores + *arr_index) | prev_match_penalty) + (*(aligner->match_scores + *arr_index) & prev_match_penalty)) - *curr_score) >> 31)) - ((((*(aligner->match_scores + *arr_index) | prev_match_penalty) + (*(aligner->match_scores + *arr_index) & prev_match_penalty)) - *curr_score) >> 31)) - 1) >> 31U) & 1) {
    *curr_matrix = (enum Matrix )0;
    *curr_score = *(aligner->match_scores + *arr_index);
  } else {
    ...
    if ((unsigned int )*curr_matrix == 0U) {
      ...
      if ((int )(((((((unsigned int )*curr_matrix - 1U) + (1U << 31)) + ((int )(((unsigned int )*curr_matrix - 1U) + (1U << 31)) >> 31)) ^ ((int )(((unsigned int )*curr_matrix - 1U) + (1U << 31)) >> 31)) >> 31U) & 1U)) {
        tmp = (char *)"GAP_A";
      } else {
        tmp = (char *)"GAP_B";
      }
...
{ 
  ...
  {
  nread = (size_t___1 )0;
  while ((int )((((~ nread & len) | ((~ nread | len) & (nread - len))) >> 31UL) & 1UL)) {
    n = (len + ~ nread) + 1UL;
    if ((int )((((~ 4294967295UL & n) | (~ (4294967295UL ^ n) & (4294967295UL - n))) >> 31UL) & 1UL)) {
      n = (size_t___1 )4294967295U;
    }
    s = gzread(gz, (voidp )((char *)ptr + nread), (unsigned int )n);
    if (((unsigned int )(s | (s - 1)) >> 31U) & 1) {
      break;
    }
    nread = ((nread | (size_t___1 )s) + (nread | (size_t___1 )s)) - (nread ^ (size_t___1 )s);
  }
  return (nread);
}
}
...
{ 
  ...
  while (1) {
    ...
    strbuf_chomp(sbuf);
    if (sbuf->end > 0UL) {
      if (((unsigned int )((((int )*(sbuf->b + 0) - 35) >> 31) - (((int )*(sbuf->b + 0) - 35) ^ (((int )*(sbuf->b + 0) - 35) >> 31))) >> 31U) & 1) {
        tmp___7 = string_is_all_whitespace((char const   *)sbuf->b);
        if (! tmp___7) {
          if ((int )((((~ read_length & 5UL) | ((~ read_length | 5UL) & (read_length - 5UL))) >> 31UL) & 1UL)) {
          ...
          if (tmp___4) {
            ...
            while (1) {
              if (((unsigned int )(((unsigned int )((int )*(sbuf->b + char2_pos)) >> 1U) - (int )*(sbuf->b + char2_pos)) >> 31U) & 1) {
              ...
              char2_pos = ((char2_pos ^ ~ 1UL) + ((char2_pos | 1UL) + (char2_pos | 1UL))) + 1UL;
            }
            if ((int )((((~ sbuf->end | ((char2_pos - ~ 2UL) - 1UL)) & ((sbuf->end ^ ((char2_pos - ~ 2UL) - 1UL)) | ~ (((char2_pos - ~ 2UL) - 1UL) - sbuf->end))) >> 31UL) & 1UL)) {
              _loading_error("Line too short", file_path, line_num, (char)0);
            } else {
              tmp___1 = isspace((int )*(sbuf->b + ((char2_pos - ~ 1UL) - 1UL)));
              if (! tmp___1) {
                _loading_error("Line too short", file_path, line_num, (char)0);
              }
            }
            ...
            if (((unsigned int )(((((int )*(sbuf->b + 1) - (int )*(sbuf->b + 3)) << 1) & (((int )*(sbuf->b + 1) - (int )*(sbuf->b + 3)) >> 31)) - ((int )*(sbuf->b + 1) - (int )*(sbuf->b + 3))) >> 31U) & 1) {
          ...
          scoring_add_mutation(scoring___0, a, b, score);
          num_pairs_added = ((num_pairs_added ^ ~ 1) + ((num_pairs_added | 1) + (num_pairs_added | 1))) + 1;
        }
      }
    }
  ...
  strbuf_free(sbuf);
  if (((unsigned int )(((num_pairs_added ^ (num_pairs_added >> 31)) - (num_pairs_added >> 31)) - 1) >> 31U) & 1) {
