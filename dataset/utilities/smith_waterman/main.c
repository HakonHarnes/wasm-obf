...
#line 67
        *(gap_b_scores + i) = (score_t )(scoring___0->gap_open + (int )((int )i * (int )scoring___0->gap_extend));
      }
#line 61
      i ++;
    }
...
#line 77
        *(gap_a_scores + index___0) = (score_t )(scoring___0->gap_open + (int )((int )j * (int )scoring___0->gap_extend));
      }
#line 79
...
#line 103 "/usr/local/bin/emcc-non-obf/emscripten/cache/sysroot/include/stdio.h"
extern int getc(FILE * ) ;
#line 27 "src/tools/sw_cmdline.c"
cmdline_t *cmd  ;
#line 28 "src/tools/sw_cmdline.c"
scoring_t scoring  ;
#line 31 "src/tools/sw_cmdline.c"
sw_aligner_t *sw  ;
#line 32 "src/tools/sw_cmdline.c"
alignment_t *result  ;
#line 34 "src/tools/sw_cmdline.c"
size_t___0 alignment_index  =    (size_t___0 )0;
#line 35 "src/tools/sw_cmdline.c"
_Bool wait_on_keystroke  =    (_Bool)0;
#line 37 "src/tools/sw_cmdline.c"
...
#line 49 "src/tools/sw_cmdline.c"
...
#line 62
    if (cmd->print_colour) {
#line 62
      fputs((char const   * __restrict  )(align_col_context), (FILE * __restrict  )stdout);
    }
#line 63
    printf((char const   * __restrict  )"%.*s", (int )context_left, (context_str + pos) - context_left);
#line 64
    if (cmd->print_colour) {
#line 64
      fputs((char const   * __restrict  )(align_col_stop), (FILE * __restrict  )stdout);
...
#line 70
    fputs((char const   * __restrict  )seq1, (FILE * __restrict  )stdout);
  }
#line 72
...
#line 75
    printf((char const   * __restrict  )"%.*s", (int )context_right, (context_str + pos) + len);
#line 76
    if (cmd->print_colour) {
#line 76
      fputs((char const   * __restrict  )(align_col_stop), (FILE * __restrict  )stdout);
...
#line 81
  printf((char const   * __restrict  )"  [pos: %li; len: %lu]\n", pos, len);
#line 82
  return;
}
}
#line 84 "src/tools/sw_cmdline.c"
...
#line 94
  while (! response) {
#line 96
    printf((char const   * __restrict  )"next [h]it or [a]lignment: ");
#line 97
    fflush((FILE *)stdout);
#line 99
    while (1) {
...
#line 125 "src/tools/sw_cmdline.c"
...
#line 128
    if (wait_on_keystroke) {
#line 130
      fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"Error: Interactive input takes seq only (no FASTA/FASTQ) \'%s:%s\'\n",
...
#line 137
  if ((int const   )*(seq_b + 0) == 0) {
    _L___0: /* CIL Label */ 
#line 139
    fprintf((FILE * __restrict  )stderr, (char const   * __restrict  )"Error: Sequences must have length > 0\n");
#line 140
    fflush((FILE *)stderr);
#line 142
    if (cmd->print_fasta) {
...
#line 157
  printf((char const   * __restrict  )"== Alignment %zu lengths (%lu, %lu):\n", alignment_index,
         len_a, len_b);
#line 159
...
#line 171
  if (cmd->print_seq) {
#line 173
    fputs((char const   * __restrict  )seq_a, (FILE * __restrict  )stdout);
#line 174
    putc('\n', (FILE *)stdout);
  }
#line 178
...
#line 184
  if (cmd->print_seq) {
#line 186
    fputs((char const   * __restrict  )seq_b, (FILE * __restrict  )stdout);
#line 187
    putc('\n', (FILE *)stdout);
  }
#line 190
...
#line 219
    hit_index ++;
#line 219
    printf((char const   * __restrict  )"hit %zu.%zu score: %i\n", alignment_index,
           tmp___4, result->score);
#line 221
...
#line 316 "src/tools/sw_cmdline.c"
...
#line 323 "src/tools/sw_cmdline.c"
